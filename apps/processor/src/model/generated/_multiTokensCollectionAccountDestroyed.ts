...
export class MultiTokensCollectionAccountDestroyed {
    public readonly isTypeOf = 'MultiTokensCollectionAccountDestroyed'
    private _collectionId!: bigint
    private _account!: string

    constructor(props?: Partial<Omit<MultiTokensCollectionAccountDestroyed, 'toJSON'>>, json?: any) {

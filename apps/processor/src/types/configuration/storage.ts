...
export const activeConfig =  {
     ...
     */
    enjinV100: new StorageType('Configuration.ActiveConfig', 'Default', [], enjinV100.HostConfiguration) as ActiveConfigEnjinV100,
    /**
     *  The active configuration for the current session.
     */
    enjinV101: new StorageType('Configuration.ActiveConfig', 'Default', [], enjinV101.HostConfiguration) as ActiveConfigEnjinV101,
    /**
     *  The active configuration for the current session.
     */
    enjinV1032: new StorageType('Configuration.ActiveConfig', 'Default', [], enjinV1032.HostConfiguration) as ActiveConfigEnjinV1032,
    /**
     *  The active configuration for the current session.
     */
...
export const pendingConfigs =  {
     ...
     */
    enjinV100: new StorageType('Configuration.PendingConfigs', 'Default', [], sts.array(() => sts.tuple(() => [sts.number(), enjinV100.HostConfiguration]))) as PendingConfigsEnjinV100,
    /**
     *  Pending configuration changes.
     * 
     *  This is a list of configuration changes, each with a session index at which it should
     ...
     *  2 items: for the next session and for the `scheduled_session`.
     */
    enjinV101: new StorageType('Configuration.PendingConfigs', 'Default', [], sts.array(() => sts.tuple(() => [sts.number(), enjinV101.HostConfiguration]))) as PendingConfigsEnjinV101,
    /**
     *  Pending configuration changes.
     * 
     *  This is a list of configuration changes, each with a session index at which it should
     ...
     *  2 items: for the next session and for the `scheduled_session`.
     */
    enjinV1032: new StorageType('Configuration.PendingConfigs', 'Default', [], sts.array(() => sts.tuple(() => [sts.number(), enjinV1032.HostConfiguration]))) as PendingConfigsEnjinV1032,
    /**
     *  Pending configuration changes.
     * 
     *  This is a list of configuration changes, each with a session index at which it should
     ...
     *  2 items: for the next session and for the `scheduled_session`.
     */
    v100: new StorageType('Configuration.PendingConfigs', 'Default', [], sts.array(() => sts.tuple(() => [sts.number(), v100.HostConfiguration]))) as PendingConfigsV100,
    /**
     *  Pending configuration changes.
     * 
     *  This is a list of configuration changes, each with a session index at which it should
     ...
     *  2 items: for the next session and for the `scheduled_session`.
     */
    v104: new StorageType('Configuration.PendingConfigs', 'Default', [], sts.array(() => sts.tuple(() => [sts.number(), v104.HostConfiguration]))) as PendingConfigsV104,
    /**
     *  Pending configuration changes.
     * 
     *  This is a list of configuration changes, each with a session index at which it should
     ...
     *  2 items: for the next session and for the `scheduled_session`.
     */
    v105: new StorageType('Configuration.PendingConfigs', 'Default', [], sts.array(() => sts.tuple(() => [sts.number(), v105.HostConfiguration]))) as PendingConfigsV105,
    /**
     *  Pending configuration changes.
     * 
     *  This is a list of configuration changes, each with a session index at which it should
     ...
     *  2 items: for the next session and for the `scheduled_session`.
     */
    v1030: new StorageType('Configuration.PendingConfigs', 'Default', [], sts.array(() => sts.tuple(() => [sts.number(), v1030.HostConfiguration]))) as PendingConfigsV1030,
}
...
export const bypassConsistencyCheck =  {
     ...
     */
    enjinV100: new StorageType('Configuration.BypassConsistencyCheck', 'Default', [], sts.boolean()) as BypassConsistencyCheckEnjinV100,
}

...
export const referendumCount =  {
     ...
     */
    enjinV100: new StorageType('FellowshipReferenda.ReferendumCount', 'Default', [], sts.number()) as ReferendumCountEnjinV100,
}
...
export const referendumInfoFor =  {
     ...
     */
    enjinV100: new StorageType('FellowshipReferenda.ReferendumInfoFor', 'Optional', [sts.number()], enjinV100.Type_940) as ReferendumInfoForEnjinV100,
    /**
     *  Information concerning any given referendum.
     */
    enjinV101: new StorageType('FellowshipReferenda.ReferendumInfoFor', 'Optional', [sts.number()], enjinV101.Type_951) as ReferendumInfoForEnjinV101,
    /**
     *  Information concerning any given referendum.
     */
    enjinV1032: new StorageType('FellowshipReferenda.ReferendumInfoFor', 'Optional', [sts.number()], enjinV1032.Type_1095) as ReferendumInfoForEnjinV1032,
    /**
     *  Information concerning any given referendum.
     */
    v100: new StorageType('FellowshipReferenda.ReferendumInfoFor', 'Optional', [sts.number()], v100.Type_780) as ReferendumInfoForV100,
    /**
     *  Information concerning any given referendum.
     */
    v105: new StorageType('FellowshipReferenda.ReferendumInfoFor', 'Optional', [sts.number()], v105.Type_935) as ReferendumInfoForV105,
    /**
     *  Information concerning any given referendum.
     */
    v1030: new StorageType('FellowshipReferenda.ReferendumInfoFor', 'Optional', [sts.number()], v1030.Type_1093) as ReferendumInfoForV1030,
}
...
export interface ReferendumInfoForEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV100.Type_940 | undefined)][]>
}
...
export interface ReferendumInfoForEnjinV101  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV101.Type_951 | undefined)][]>
}
...
export interface ReferendumInfoForEnjinV1032  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV1032.Type_1095 | undefined)][]>
}
...
export interface ReferendumInfoForV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v100.Type_780 | undefined)][]>
}
...
export interface ReferendumInfoForV105  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v105.Type_935 | undefined)][]>
}
...
export interface ReferendumInfoForV1030  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v1030.Type_1093 | undefined)][]>
}
...
export const trackQueue =  {
     ...
     */
    enjinV100: new StorageType('FellowshipReferenda.TrackQueue', 'Default', [sts.number()], sts.array(() => sts.tuple(() => [sts.number(), sts.number()]))) as TrackQueueEnjinV100,
}
...
export const decidingCount =  {
     ...
     */
    enjinV100: new StorageType('FellowshipReferenda.DecidingCount', 'Default', [sts.number()], sts.number()) as DecidingCountEnjinV100,
}
...
export const metadataOf =  {
     ...
     *  large preimages.
     */
    enjinV100: new StorageType('FellowshipReferenda.MetadataOf', 'Optional', [sts.number()], enjinV100.H256) as MetadataOfEnjinV100,
}
...
export interface MetadataOfEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV100.H256 | undefined)][]>
}

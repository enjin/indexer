...
export const postUnbondingPoolsWindow =  {
     ...
     */
    enjinV100: new ConstantType(
        'NominationPools.PostUnbondingPoolsWindow',
        sts.number()
    ),
}
...
export const poolCollectionId =  {
     ...
     */
    enjinV100: new ConstantType(
        'NominationPools.PoolCollectionId',
        sts.bigint()
    ),
}
...
export const stakedEnjCollectionId =  {
     ...
     */
    enjinV100: new ConstantType(
        'NominationPools.StakedEnjCollectionId',
        sts.bigint()
    ),
}
...
export const stakedEnjCollectionOwner =  {
     ...
     */
    enjinV100: new ConstantType(
        'NominationPools.StakedEnjCollectionOwner',
...
export const bonusPercentage =  {
     ...
     */
    enjinV100: new ConstantType(
        'NominationPools.BonusPercentage',
        enjinV100.Perbill
    ),
}
...
export const baseBonusRewardPercentage =  {
     ...
     */
    enjinV100: new ConstantType(
        'NominationPools.BaseBonusRewardPercentage',
        enjinV100.Perbill
    ),
}
...
export const unclaimedBalanceReceiver =  {
     ...
     */
    enjinV100: new ConstantType(
        'NominationPools.UnclaimedBalanceReceiver',
        enjinV100.AccountId32
    ),
}
...
export const capacityMutationPeriod =  {
     ...
     */
    enjinV100: new ConstantType(
        'NominationPools.CapacityMutationPeriod',
        sts.number()
    ),
}
...
export const collatorRewardPool =  {
     ...
     */
    enjinV101: new ConstantType(
        'NominationPools.CollatorRewardPool',
        enjinV101.PalletId
    ),
}
...
export const earlyBirdBonusDistributionBlock =  {
     ...
     */
    enjinV101: new ConstantType(
        'NominationPools.EarlyBirdBonusDistributionBlock',
        sts.number()
    ),
}
...
export const earlyBirdBonusTotalAmount =  {
     ...
     */
    enjinV101: new ConstantType(
        'NominationPools.EarlyBirdBonusTotalAmount',
        sts.bigint()
    ),
}
...
export const maxEarlyBirdBonusQueueItems =  {
     ...
     */
    enjinV101: new ConstantType(
        'NominationPools.MaxEarlyBirdBonusQueueItems',
        sts.number()
    ),
}
...
export const earlyBirdBonusAccount =  {
     ...
     */
    enjinV101: new ConstantType(
        'NominationPools.EarlyBirdBonusAccount',
        enjinV101.AccountId32
    ),
}
...
export const globalMaxCapacity =  {
    ...
    enjinV120: new ConstantType(
        'NominationPools.GlobalMaxCapacity',
        sts.bigint()
    ),
}
...
export const defaultMaxCapacity =  {
     ...
     */
    enjinV120: new ConstantType(
        'NominationPools.DefaultMaxCapacity',
        sts.bigint()
    ),
}
...
export const attributeKeyMaxLength =  {
     ...
     */
    enjinV120: new ConstantType(
        'NominationPools.AttributeKeyMaxLength',
        sts.number()
    ),
}
...
export const attributeValueMaxLength =  {
     ...
     */
    enjinV120: new ConstantType(
        'NominationPools.AttributeValueMaxLength',
        sts.number()
    ),
}
...
export const maxCapacityAttributeKey =  {
     ...
     */
    enjinV120: new ConstantType(
        'NominationPools.MaxCapacityAttributeKey',
        sts.bytes()
    ),
}
...
export const earlyBirdPaymentPeriod =  {
     ...
     */
    enjinV1022: new ConstantType(
        'NominationPools.EarlyBirdPaymentPeriod',
        sts.number()
    ),
}
...
export const earlyBirdPaymentCount =  {
     ...
     */
    enjinV1022: new ConstantType(
        'NominationPools.EarlyBirdPaymentCount',
        sts.number()
    ),
}
...
export const maxPoolNameLength =  {
     ...
     */
    enjinV1023: new ConstantType(
        'NominationPools.MaxPoolNameLength',
        sts.number()
    ),
}
...
export const earlyBirdReimbursementAccountId =  {
     ...
     */
    enjinV1025: new ConstantType(
        'NominationPools.EarlyBirdReimbursementAccountId',
        enjinV1025.AccountId32
    ),
}
...
export const orphanedPoolAccountId =  {
     ...
     *  The account that will receive the deposit and commission if the pool's token is burned
     */
    v101: new ConstantType(
        'NominationPools.OrphanedPoolAccountId',
        v101.AccountId32
    ),
}

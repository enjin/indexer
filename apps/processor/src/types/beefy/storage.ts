...
export const authorities =  {
     ...
     */
    enjinV100: new StorageType('Beefy.Authorities', 'Default', [], sts.array(() => sts.bytes())) as AuthoritiesEnjinV100,
}
...
export const nextAuthorities =  {
     ...
     */
    enjinV100: new StorageType('Beefy.NextAuthorities', 'Default', [], sts.array(() => sts.bytes())) as NextAuthoritiesEnjinV100,
}
...
export const genesisBlock =  {
     ...
     */
    enjinV100: new StorageType('Beefy.GenesisBlock', 'Default', [], sts.option(() => sts.number())) as GenesisBlockEnjinV100,
}

...
export const proposalOf =  {
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    matrixEnjinV1012: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixEnjinV1012.H256], matrixEnjinV1012.Call) as ProposalOfMatrixEnjinV1012,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixEnjinV1022: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixEnjinV1022.H256], matrixEnjinV1022.Call) as ProposalOfMatrixEnjinV1022,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV500: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV500.H256], matrixV500.Call) as ProposalOfMatrixV500,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV600: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV600.H256], matrixV600.Call) as ProposalOfMatrixV600,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV601: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV601.H256], matrixV601.Call) as ProposalOfMatrixV601,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV602: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV602.H256], matrixV602.Call) as ProposalOfMatrixV602,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV604: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV604.H256], matrixV604.Call) as ProposalOfMatrixV604,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV1000: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV1000.H256], matrixV1000.Call) as ProposalOfMatrixV1000,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV1003: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV1003.H256], matrixV1003.Call) as ProposalOfMatrixV1003,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV1004: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV1004.H256], matrixV1004.Call) as ProposalOfMatrixV1004,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV1005: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV1005.H256], matrixV1005.Call) as ProposalOfMatrixV1005,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV1010: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV1010.H256], matrixV1010.Call) as ProposalOfMatrixV1010,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV1011: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV1011.H256], matrixV1011.Call) as ProposalOfMatrixV1011,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV1012: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV1012.H256], matrixV1012.Call) as ProposalOfMatrixV1012,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV1020: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV1020.H256], matrixV1020.Call) as ProposalOfMatrixV1020,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    matrixV1022: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [matrixV1022.H256], matrixV1022.Call) as ProposalOfMatrixV1022,
}

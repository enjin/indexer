...
export const executedUpward =  {
    ...
    enjinV100: new EventType(
        'Ump.ExecutedUpward',
        sts.tuple([sts.bytes(), enjinV100.V3Outcome])
    ),
}
...
export const weightExhausted =  {
    ...
    enjinV100: new EventType(
        'Ump.WeightExhausted',
        sts.tuple([sts.bytes(), enjinV100.Weight, enjinV100.Weight])
    ),
}
...
export const upwardMessagesReceived =  {
    ...
    enjinV100: new EventType(
        ...
        sts.tuple([enjinV100.Id, sts.number(), sts.number()])
    ),
}
...
export const overweightServiced =  {
    ...
    enjinV100: new EventType(
        ...
        sts.tuple([sts.bigint(), enjinV100.Weight])
    ),
}

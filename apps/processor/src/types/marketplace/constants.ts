...
export const minimumBidIncreasePercentage =  {
    ...
    matrixEnjinV603: new ConstantType(
        'Marketplace.MinimumBidIncreasePercentage',
...
export const listingActiveDelay =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'Marketplace.ListingActiveDelay',
        sts.number()
    ),
}
...
export const maxListingConversions =  {
     ...
     */
    matrixEnjinV1005: new ConstantType(
        'Marketplace.MaxListingConversions',
        sts.number()
    ),
}
...
export const counterOfferDeposit =  {
    ...
    matrixEnjinV1012: new ConstantType(
        'Marketplace.CounterOfferDeposit',
        sts.bigint()
    ),
}
...
export const maxPendingListingIds =  {
     ...
     */
    matrixEnjinV1012: new ConstantType(
        'Marketplace.MaxPendingListingIds',
        sts.number()
    ),
}
...
export const whitelistedAccountDeposit =  {
    ...
    matrixEnjinV1022: new ConstantType(
        'Marketplace.WhitelistedAccountDeposit',
        sts.bigint()
    ),
}
...
export const maxUpgradeBatchSize =  {
     ...
     */
    matrixEnjinV1022: new ConstantType(
        'Marketplace.MaxUpgradeBatchSize',
        sts.number()
    ),
}

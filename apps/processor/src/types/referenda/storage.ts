...
export const referendumInfoFor =  {
     ...
     */
    enjinV100: new StorageType('Referenda.ReferendumInfoFor', 'Optional', [sts.number()], enjinV100.ReferendumInfo) as ReferendumInfoForEnjinV100,
    /**
     *  Information concerning any given referendum.
     */
    enjinV101: new StorageType('Referenda.ReferendumInfoFor', 'Optional', [sts.number()], enjinV101.ReferendumInfo) as ReferendumInfoForEnjinV101,
    /**
     *  Information concerning any given referendum.
     */
    enjinV1032: new StorageType('Referenda.ReferendumInfoFor', 'Optional', [sts.number()], enjinV1032.ReferendumInfo) as ReferendumInfoForEnjinV1032,
    /**
     *  Information concerning any given referendum.
     */
     ...
     *  Information concerning any given referendum.
     */
    v105: new StorageType('Referenda.ReferendumInfoFor', 'Optional', [sts.number()], v105.ReferendumInfo) as ReferendumInfoForV105,
    /**
     *  Information concerning any given referendum.
     */
    v1030: new StorageType('Referenda.ReferendumInfoFor', 'Optional', [sts.number()], v1030.ReferendumInfo) as ReferendumInfoForV1030,
}
...
export interface ReferendumInfoForEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV100.ReferendumInfo | undefined)][]>
}
...
export interface ReferendumInfoForEnjinV101  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV101.ReferendumInfo | undefined)][]>
}
...
export interface ReferendumInfoForEnjinV1032  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (enjinV1032.ReferendumInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV1032.ReferendumInfo | undefined)][]>
}
...
export interface ReferendumInfoForV105  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v105.ReferendumInfo | undefined)][]>
}
...
export interface ReferendumInfoForV1030  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v1030.ReferendumInfo | undefined)][]>
}
...
export const trackQueue =  {
     ...
     */
    enjinV100: new StorageType('Referenda.TrackQueue', 'Default', [sts.number()], sts.array(() => sts.tuple(() => [sts.number(), sts.bigint()]))) as TrackQueueEnjinV100,
}
...
export const decidingCount =  {
     ...
     */
    enjinV100: new StorageType('Referenda.DecidingCount', 'Default', [sts.number()], sts.number()) as DecidingCountEnjinV100,
}
...
export const metadataOf =  {
     ...
     *  large preimages.
     */
    enjinV100: new StorageType('Referenda.MetadataOf', 'Optional', [sts.number()], enjinV100.H256) as MetadataOfEnjinV100,
}

...
export const pendingChange =  {
     ...
     */
    enjinV100: new StorageType('Grandpa.PendingChange', 'Optional', [], enjinV100.StoredPendingChange) as PendingChangeEnjinV100,
}
...
export const stalled =  {
     ...
     */
    enjinV100: new StorageType('Grandpa.Stalled', 'Optional', [], sts.tuple(() => [sts.number(), sts.number()])) as StalledEnjinV100,
}
...
export const setIdSession =  {
     ...
     */
    enjinV100: new StorageType('Grandpa.SetIdSession', 'Optional', [sts.bigint()], sts.number()) as SetIdSessionEnjinV100,
}
...
export const authorities =  {
     ...
     */
    enjinV1032: new StorageType('Grandpa.Authorities', 'Default', [], sts.array(() => sts.tuple(() => [enjinV1032.Public, sts.bigint()]))) as AuthoritiesEnjinV1032,
}

...
export const liquidityConfigs =  {
     ...
     */
    enjinV100: new StorageType('StakeExchange.LiquidityConfigs', 'Optional', [enjinV100.AccountId32], enjinV100.LiquidityAccountConfig) as LiquidityConfigsEnjinV100,
}
...
export interface LiquidityConfigsEnjinV100  {
    ...
    getPairs(block: Block, key: enjinV100.AccountId32): Promise<[k: enjinV100.AccountId32, v: (enjinV100.LiquidityAccountConfig | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.AccountId32, v: (enjinV100.LiquidityAccountConfig | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.AccountId32): AsyncIterable<[k: enjinV100.AccountId32, v: (enjinV100.LiquidityAccountConfig | undefined)][]>
}
...
export const offers =  {
     ...
     *  Mapping of LPAccountId to their active offer
     */
    enjinV1021: new StorageType('StakeExchange.Offers', 'Optional', [sts.bigint()], enjinV1021.Offer) as OffersEnjinV1021,
    /**
     *  Mapping of LPAccountId to their active offer
     */
    enjinV1023: new StorageType('StakeExchange.Offers', 'Optional', [sts.bigint()], enjinV1023.Offer) as OffersEnjinV1023,
    /**
     *  Mapping of LPAccountId to their active offer
     */
...
export interface OffersEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: bigint): AsyncIterable<[k: bigint, v: (enjinV100.Offer | undefined)][]>
}
...
export interface OffersEnjinV120  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: bigint): AsyncIterable<[k: bigint, v: (enjinV120.Offer | undefined)][]>
}
...
export interface OffersEnjinV1021  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: bigint): AsyncIterable<[k: bigint, v: (enjinV1021.Offer | undefined)][]>
}
...
export interface OffersEnjinV1023  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: bigint): AsyncIterable<[k: bigint, v: (enjinV1023.Offer | undefined)][]>
}

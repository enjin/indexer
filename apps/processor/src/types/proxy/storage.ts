...
export const proxies =  {
     ...
     *  which are being delegated to, together with the amount held on deposit.
     */
    enjinV1050: new StorageType('Proxy.Proxies', 'Default', [enjinV1050.AccountId32], sts.tuple(() => [sts.array(() => enjinV1050.ProxyDefinition), sts.bigint()])) as ProxiesEnjinV1050,
    /**
     *  The set of account proxies. Maps the account which has delegated to the accounts
     *  which are being delegated to, together with the amount held on deposit.
     */
    v1030: new StorageType('Proxy.Proxies', 'Default', [v1030.AccountId32], sts.tuple(() => [sts.array(() => v1030.ProxyDefinition), sts.bigint()])) as ProxiesV1030,
    /**
     *  The set of account proxies. Maps the account which has delegated to the accounts
     *  which are being delegated to, together with the amount held on deposit.
     */
    v1050: new StorageType('Proxy.Proxies', 'Default', [v1050.AccountId32], sts.tuple(() => [sts.array(() => v1050.ProxyDefinition), sts.bigint()])) as ProxiesV1050,
}
...
export interface ProxiesEnjinV1050  {
    ...
    getMany(block: Block, keys: enjinV1050.AccountId32[]): Promise<([enjinV1050.ProxyDefinition[], bigint] | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: enjinV1050.AccountId32, v: ([enjinV1050.ProxyDefinition[], bigint] | undefined)][]>
    getPairs(block: Block, key: enjinV1050.AccountId32): Promise<[k: enjinV1050.AccountId32, v: ([enjinV1050.ProxyDefinition[], bigint] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV1050.AccountId32, v: ([enjinV1050.ProxyDefinition[], bigint] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV1050.AccountId32): AsyncIterable<[k: enjinV1050.AccountId32, v: ([enjinV1050.ProxyDefinition[], bigint] | undefined)][]>
}
...
export interface ProxiesV1030  {
    ...
    getPairs(block: Block, key: v1030.AccountId32): Promise<[k: v1030.AccountId32, v: ([v1030.ProxyDefinition[], bigint] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v1030.AccountId32, v: ([v1030.ProxyDefinition[], bigint] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v1030.AccountId32): AsyncIterable<[k: v1030.AccountId32, v: ([v1030.ProxyDefinition[], bigint] | undefined)][]>
}
...
export interface ProxiesV1050  {
    ...
    getPairs(block: Block, key: v1050.AccountId32): Promise<[k: v1050.AccountId32, v: ([v1050.ProxyDefinition[], bigint] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v1050.AccountId32, v: ([v1050.ProxyDefinition[], bigint] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v1050.AccountId32): AsyncIterable<[k: v1050.AccountId32, v: ([v1050.ProxyDefinition[], bigint] | undefined)][]>
}

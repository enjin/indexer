...
export const currentSessionIndex =  {
     ...
     */
    enjinV100: new StorageType('ParasShared.CurrentSessionIndex', 'Default', [], sts.number()) as CurrentSessionIndexEnjinV100,
}
...
export const activeValidatorIndices =  {
     ...
     */
    enjinV100: new StorageType('ParasShared.ActiveValidatorIndices', 'Default', [], sts.array(() => enjinV100.V4ValidatorIndex)) as ActiveValidatorIndicesEnjinV100,
}
...
export const activeValidatorKeys =  {
     ...
     */
    enjinV100: new StorageType('ParasShared.ActiveValidatorKeys', 'Default', [], sts.array(() => sts.bytes())) as ActiveValidatorKeysEnjinV100,
}
...
export const allowedRelayParents =  {
     ...
     */
    enjinV1032: new StorageType('ParasShared.AllowedRelayParents', 'Default', [], enjinV1032.AllowedRelayParentsTracker) as AllowedRelayParentsEnjinV1032,
}

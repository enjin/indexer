...
export function collectionTransferred(event: EventItem): CollectionTransferredType {
    return match(event)
        .returnType<CollectionTransferredType>()
        .when(
...
export function collectionTransferredEventModel(
    item: EventItem,
    data: CollectionTransferredType

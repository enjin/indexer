...
export function getTankDataFromCall(call: CallItem) {
    if (call.name === 'FuelTanks.dispatch') {
        ...
        throw new UnsupportedEventError(fuelTanks.dispatch)
    }
    ...
    throw new UnsupportedEventError(fuelTanks.dispatchAndTouch)
}

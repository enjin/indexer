...
export function poolMutated(event: EventItem): PoolMutated {
    return match(event)
        ...
        .when(nominationPools.poolMutated.v1023.is, nominationPools.poolMutated.v1023.decode)
        .when(nominationPools.poolMutated.v110.is, nominationPools.poolMutated.v110.decode)
        .when(nominationPools.poolMutated.v104.is, nominationPools.poolMutated.v104.decode)
        .when(nominationPools.poolMutated.v102.is, nominationPools.poolMutated.v102.decode)
        .otherwise(() => {

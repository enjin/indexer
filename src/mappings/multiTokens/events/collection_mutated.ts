...
// import { ShouldMutate, ShouldMutate_NoMutation, ShouldMutate_SomeMutation } from '../../../types/generated/v3010'
//
// interface EventData {
//     collectionId: bigint
//     owner: Uint8Array | undefined
//     royalty: Option<DefaultRoyalty | undefined> | ShouldMutate_NoMutation | ShouldMutate | ShouldMutate_SomeMutation
...
//     }
//     if (data.isV3010) {
//         const { collectionId, mutation } = data.asV3010
//         return {
//             collectionId,
//             owner: mutation.owner,
//             royalty: mutation.royalty,
...
//     }
//
//     if (data.royalty.__kind == 'NoMutation') {
//         // do nothing
//     } else if (data.royalty.__kind == 'SomeMutation') {
//         // do nothing
//     } else if (data.royalty.__kind == 'Mutate') {
//         // do nothing
//     } else if (data.royalty.__kind !== 'None') {

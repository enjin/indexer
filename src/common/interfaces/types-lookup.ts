...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletDemocracyMetadataOwner (45) */
  ...
  /** @name PalletMultisigTimepoint (52) */
  interface PalletMultisigTimepoint extends Struct {
    readonly height: u32;
    readonly index: u32;
  }

  /** @name PalletCollatorStakingEvent (53) */
  ...
  /** @name CumulusPalletXcmpQueueEvent (57) */
  ...
  /** @name XcmV3QueryResponseInfo (95) */
  ...
  /** @name XcmV3MultiassetMultiAssetFilter (96) */
  ...
  /** @name XcmV3MultiassetWildMultiAsset (97) */
  ...
  /** @name XcmV3MultiassetWildFungibility (98) */
  ...
  /** @name XcmV2MultiassetMultiAssets (101) */
  interface XcmV2MultiassetMultiAssets extends Vec<XcmV2MultiAsset> {}

  /** @name XcmV2MultiAsset (103) */
  interface XcmV2MultiAsset extends Struct {
    readonly id: XcmV2MultiassetAssetId;
    readonly fun: XcmV2MultiassetFungibility;
  }

  /** @name XcmV2MultiassetAssetId (104) */
  ...
  /** @name XcmV2MultiLocation (105) */
  interface XcmV2MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV2MultilocationJunctions;
  }

  /** @name XcmV2MultilocationJunctions (106) */
  ...
  /** @name XcmV2MultiassetFungibility (112) */
  ...
  /** @name XcmV2MultiassetAssetInstance (113) */
  ...
  /** @name XcmVersionedMultiLocation (114) */
  ...
  /** @name PalletMultiTokensEvent (123) */
  interface PalletMultiTokensEvent extends Enum {
    ...
    readonly isMigrationStatusUpdated: boolean;
    readonly asMigrationStatusUpdated: {
      readonly stage: EpCoreFrameMigrationsMigrationStage;
    } & Struct;
  ...
  /** @name EpMultiTokensRootOrSigned (134) */
  ...
  /** @name EpMultiTokensTokenDefaultTokenMutation (135) */
  interface EpMultiTokensTokenDefaultTokenMutation extends Struct {
    ...
    readonly metadata: EpMultiTokensShouldMutateDefaultTokenMetadata;
  }
  ...
  /** @name EnjinMatrixRuntimeForeignTokenNameLength (139) */
  type EnjinMatrixRuntimeForeignTokenNameLength = Null;

  /** @name EnjinMatrixRuntimeForeignTokenSymbolLength (142) */
  ...
  /** @name EpMultiTokensShouldMutateBool (148) */
  ...
  /** @name EpMultiTokensShouldMutateDefaultTokenMetadata (149) */
  interface EpMultiTokensShouldMutateDefaultTokenMetadata extends Enum {
    readonly isNoMutation: boolean;
    readonly isSomeMutation: boolean;
    readonly asSomeMutation: EpMultiTokensFrameDefaultTokenMetadata;
    readonly type: 'NoMutation' | 'SomeMutation';
  }
  ...
  /** @name EnjinMatrixRuntimeMaxOperatorsPerAccount (178) */
  ...
  /** @name EnjinMatrixRuntimeMaxReserves (186) */
  type EnjinMatrixRuntimeMaxReserves = Null;

  /** @name EnjinMatrixRuntimeMaxLocks (187) */
  type EnjinMatrixRuntimeMaxLocks = Null;

  /** @name EpCoreFrameMigrationsMigrationStage (197) */
  interface EpCoreFrameMigrationsMigrationStage extends Enum {
    readonly isNotStarted: boolean;
    readonly isInProgress: boolean;
    readonly isCompleted: boolean;
    readonly isFailed: boolean;
    readonly type: 'NotStarted' | 'InProgress' | 'Completed' | 'Failed';
  }

  /** @name PalletMultiTokensFeaturesClaimAssetIdWithEth (201) */
  ...
  /** @name PalletPoolsPoolsMutation (203) */
  ...
  interface PalletFuelTanksEvent extends Enum {
    ...
    readonly type: 'FuelTankCreated' | 'FuelTankMutated' | 'FuelTankDestroyed' | 'CallDispatched' | 'AccountAdded' | 'AccountRemoved' | 'AccountRuleDataRemoved' | 'RuleSetInserted' | 'RuleSetRemoved' | 'FreezeStateMutated' | 'DispatchFailed' | 'ConsumptionSet';
  }

  /** @name EnjinMatrixRuntimeMaxFuelTankNameLength (207) */
  type EnjinMatrixRuntimeMaxFuelTankNameLength = Null;

  /** @name PalletFuelTanksImplsDefaultTankMutation (209) */
  interface PalletFuelTanksImplsDefaultTankMutation extends Struct {
    ...
    readonly providesDeposit: Option<bool>;
    readonly accountRules: Option<Vec<PalletFuelTanksRulesAccountRuleDescriptor>>;
  }

  /** @name EnjinMatrixRuntimeRuntime (210) */
  type EnjinMatrixRuntimeRuntime = Null;

  /** @name EpMultiTokensShouldMutateOption (211) */
  ...
  /** @name PalletFuelTanksUserAccountManagement (213) */
  interface PalletFuelTanksUserAccountManagement extends Struct {
    readonly tankReservesExistentialDeposit: bool;
    readonly tankReservesAccountCreationDeposit: bool;
  }

  /** @name PalletFuelTanksRulesAccountRuleDescriptor (217) */
  ...
  interface PalletFuelTanksRulesDispatchRuleKind extends Enum {
    ...
    readonly type: 'WhitelistedCallers' | 'WhitelistedCollections' | 'MaxFuelBurnPerTransaction' | 'UserFuelBudget' | 'TankFuelBudget' | 'RequireToken' | 'PermittedCalls' | 'PermittedExtrinsics' | 'WhitelistedPallets';
  }

  /** @name PalletFuelTanksConsumption (225) */
  interface PalletFuelTanksConsumption extends Struct {
    readonly totalConsumed: Compact<u128>;
    readonly lastResetBlock: Option<u32>;
  }

  /** @name PalletMarketplaceEvent (226) */
  interface PalletMarketplaceEvent extends Enum {
    ...
    readonly type: 'ListingCreated' | 'ListingCancelled' | 'ListingFilled' | 'BidPlaced' | 'AuctionFinalized' | 'ProtocolFeeSet';
  }

  /** @name PalletMarketplaceFeaturesListing (227) */
  interface PalletMarketplaceFeaturesListing extends Struct {
    ...
    readonly minTakeValue: Compact<u128>;
  ...
  /** @name PalletMarketplaceFeaturesListingFeeSide (229) */
  ...
  /** @name PalletMarketplaceFeaturesListingListingData (230) */
  ...
  /** @name PalletMarketplaceFeaturesAuctionAuctionData (231) */
  ...
  /** @name PalletMarketplaceFeaturesListingListingState (232) */
  ...
  /** @name PalletMarketplaceFeaturesAuctionAuctionState (233) */
  ...
  /** @name EnjinMatrixRuntimeMaxNameLength (238) */
  type EnjinMatrixRuntimeMaxNameLength = Null;

  /** @name PalletMatrixUtilityEvent (240) */
  ...
  /** @name PalletMultiTokensCrossChainMigrationEvent (243) */
  interface PalletMultiTokensCrossChainMigrationEvent extends Enum {
    readonly isMigratedCollections: boolean;
    readonly asMigratedCollections: u32;
    readonly isMigratedTokens: boolean;
    readonly asMigratedTokens: u32;
    readonly isMigratedCollectionAccounts: boolean;
    readonly asMigratedCollectionAccounts: u32;
    readonly isMigratedTokenAccounts: boolean;
    readonly asMigratedTokenAccounts: u32;
    readonly isMigratedAttributes: boolean;
    readonly asMigratedAttributes: u32;
    readonly isMigrationFinished: boolean;
    readonly type: 'MigratedCollections' | 'MigratedTokens' | 'MigratedCollectionAccounts' | 'MigratedTokenAccounts' | 'MigratedAttributes' | 'MigrationFinished';
  }

  /** @name PalletClaimsEvent (244) */
  ...
  /** @name PolkadotPrimitivesV4PersistedValidationData (269) */
  ...
  /** @name PolkadotPrimitivesV4UpgradeRestriction (272) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotRelayDispachQueueSize (276) */
  interface CumulusPalletParachainSystemRelayStateSnapshotRelayDispachQueueSize extends Struct {
    readonly remainingCount: u32;
    readonly remainingSize: u32;
  }

  /** @name PolkadotPrimitivesV4AbridgedHrmpChannel (279) */
  ...
  /** @name PolkadotPrimitivesV4AbridgedHostConfiguration (281) */
  ...
  /** @name CumulusPalletParachainSystemCodeUpgradeAuthorization (288) */
  ...
  /** @name PalletSchedulerScheduled (309) */
  ...
  /** @name EnjinMatrixRuntimeOriginCaller (316) */
  ...
  /** @name PalletDemocracyConviction (327) */
  ...
  /** @name PalletCollatorStakingCall (334) */
  ...
  /** @name EnjinMatrixRuntimeSessionKeys (336) */
  interface EnjinMatrixRuntimeSessionKeys extends Struct {
    readonly aura: SpConsensusAuraSr25519AppSr25519Public;
    readonly pools: SpConsensusAuraSr25519AppSr25519Public;
  }

  /** @name SpConsensusAuraSr25519AppSr25519Public (337) */
  interface SpConsensusAuraSr25519AppSr25519Public extends SpCoreSr25519Public {}

  /** @name SpCoreSr25519Public (338) */
  interface SpCoreSr25519Public extends U8aFixed {}

  /** @name CumulusPalletXcmpQueueCall (339) */
  ...
  /** @name XcmV2MultiassetMultiAssetFilter (349) */
  ...
  /** @name XcmV2MultiassetWildMultiAsset (350) */
  ...
  /** @name XcmV2MultiassetWildFungibility (351) */
  ...
  /** @name CumulusPalletXcmCall (361) */
  type CumulusPalletXcmCall = Null;

  /** @name CumulusPalletDmpQueueCall (362) */
  ...
  /** @name MatrixPalletXcmImplsParachainId (365) */
  ...
  /** @name EpCoreFrameTypesAccount (366) */
  ...
  /** @name MatrixPalletXcmCurrencyIdAmountPair (367) */
  interface MatrixPalletXcmCurrencyIdAmountPair extends Struct {
    readonly currencyId: EpMultiTokensTokenAssetId;
    readonly amount: Compact<u128>;
  }

  /** @name MatrixPalletXcmXcmOperation (368) */
  ...
  /** @name OrmlXtokensModuleCall (369) */
  ...
  /** @name XcmVersionedMultiAsset (370) */
  ...
  /** @name PalletMultiTokensCall (374) */
  ...
  /** @name EpMultiTokensBatchAttributeKeyValuePair (377) */
  interface EpMultiTokensBatchAttributeKeyValuePair extends Struct {
    readonly key: Bytes;
    readonly value: Bytes;
  }

  /** @name EpMultiTokensPolicyDefaultCollectionPolicyDescriptor (379) */
  ...
  /** @name EpMultiTokensPolicyMintDefaultMintPolicyDescriptor (380) */
  ...
  /** @name EpMultiTokensPolicyBurnDefaultBurnPolicyDescriptor (381) */
  type EpMultiTokensPolicyBurnDefaultBurnPolicyDescriptor = Null;

  /** @name EpMultiTokensPolicyTransferDefaultTransferPolicyDescriptor (382) */
  type EpMultiTokensPolicyTransferDefaultTransferPolicyDescriptor = Null;

  /** @name EpMultiTokensPolicyAttributeDefaultAttributePolicyDescriptor (383) */
  type EpMultiTokensPolicyAttributeDefaultAttributePolicyDescriptor = Null;

  /** @name EpMultiTokensPolicyMarketDefaultMarketPolicyDescriptor (384) */
  interface EpMultiTokensPolicyMarketDefaultMarketPolicyDescriptor extends Struct {
    readonly royalty: Option<EpMultiTokensPolicyMarketDefaultRoyalty>;
  }

  /** @name EpMultiTokensPolicyMintDefaultMintParams (385) */
  interface EpMultiTokensPolicyMintDefaultMintParams extends Enum {
    ...
    readonly asCreateToken: {
      ...
      readonly sufficiency: EpMultiTokensPolicyMintSufficiencyParam;
      readonly cap: Option<EpMultiTokensTokenTokenCap>;
    ...
    readonly asMint: {
      readonly tokenId: Compact<u128>;
      readonly amount: Compact<u128>;
      readonly unitPrice: Option<u128>;
    } & Struct;
    readonly type: 'CreateToken' | 'Mint';
  }

  /** @name EpMultiTokensPolicyMintSufficiencyParam (386) */
  interface EpMultiTokensPolicyMintSufficiencyParam extends Enum {
    readonly isInsufficient: boolean;
    readonly asInsufficient: {
      readonly unitPrice: Option<u128>;
    } & Struct;
    readonly isSufficient: boolean;
    readonly asSufficient: {
      readonly minimumBalance: u128;
    } & Struct;
    readonly type: 'Insufficient' | 'Sufficient';
  }

  /** @name EpMultiTokensPolicyMintForeignTokenCreationParams (388) */
  ...
  /** @name EpMultiTokensPolicyBurnDefaultBurnParams (389) */
  ...
  /** @name EpMultiTokensPolicyTransferDefaultTransferParams (390) */
  ...
  /** @name EpMultiTokensBatchRecipientDefaultTransferParams (392) */
  interface EpMultiTokensBatchRecipientDefaultTransferParams extends Struct {
    readonly accountId: AccountId32;
    readonly params: EpMultiTokensPolicyTransferDefaultTransferParams;
  }

  /** @name EpMultiTokensBatchRecipientDefaultMintParams (395) */
  interface EpMultiTokensBatchRecipientDefaultMintParams extends Struct {
    readonly accountId: AccountId32;
    readonly params: EpMultiTokensPolicyMintDefaultMintParams;
  }

  /** @name SpCoreEcdsaSignature (397) */
  interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name EpMultiTokensAttribute (401) */
  interface EpMultiTokensAttribute extends Struct {
    readonly value: Bytes;
    readonly deposit: Compact<u128>;
  }

  /** @name EpMultiTokensPolicyMintFlexibleMintParams (403) */
  interface EpMultiTokensPolicyMintFlexibleMintParams extends Enum {
    ...
    readonly type: 'CreateToken' | 'Mint' | 'CreateOrMint';
  }

  /** @name PalletPoolsCall (406) */
  ...
  /** @name PalletFuelTanksFuelTankDescriptor (408) */
  interface PalletFuelTanksFuelTankDescriptor extends Struct {
    ...
    readonly providesDeposit: bool;
    readonly accountRules: Vec<PalletFuelTanksRulesAccountRuleDescriptor>;
  }

  /** @name PalletFuelTanksRulesRuleSetDescriptor (410) */
  interface PalletFuelTanksRulesRuleSetDescriptor extends Vec<PalletFuelTanksRulesDispatchRuleDescriptor> {}

  /** @name PalletFuelTanksRulesDispatchRuleDescriptor (411) */
  ...
  interface PalletMarketplaceCall extends Enum {
    ...
    readonly asCreateListing: {
      ...
      readonly price: Compact<u128>;
      readonly salt: Bytes;
      readonly auctionData: Option<PalletMarketplaceFeaturesAuctionAuctionData>;
    } & Struct;
    ...
    readonly type: 'CreateListing' | 'CancelListing' | 'FillListing' | 'PlaceBid' | 'FinalizeAuction' | 'SetProtocolFee' | 'ForceCreateListing' | 'ForcePlaceBid';
  }

  /** @name PalletExtrinsicPauseCall (442) */
  ...
  /** @name PalletMatrixUtilityCall (443) */
  ...
  /** @name PalletMultiTokensCrossChainMigrationCall (444) */
  interface PalletMultiTokensCrossChainMigrationCall extends Enum {
    readonly isMigrateCollections: boolean;
    readonly asMigrateCollections: {
      readonly collections: Vec<ITuple<[u128, EpMultiTokensCollection]>>;
    } & Struct;
    readonly isMigrateTokens: boolean;
    readonly asMigrateTokens: {
      readonly tokens: Vec<ITuple<[u128, u128, EpMultiTokensToken]>>;
    } & Struct;
    readonly isMigrateCollectionAccounts: boolean;
    readonly asMigrateCollectionAccounts: {
      readonly accounts: Vec<ITuple<[u128, AccountId32, PalletMultiTokensFeaturesCollectionTypesCollectionAccount]>>;
    } & Struct;
    readonly isMigrateTokenAccounts: boolean;
    readonly asMigrateTokenAccounts: {
      readonly accounts: Vec<ITuple<[u128, u128, AccountId32, PalletMultiTokensFeaturesTokenTypesTokenAccount]>>;
    } & Struct;
    readonly isMigrateAttributes: boolean;
    readonly asMigrateAttributes: {
      readonly attributes: Vec<ITuple<[u128, Option<u128>, Bytes, EpMultiTokensAttribute]>>;
    } & Struct;
    readonly isFinalize: boolean;
    readonly asFinalize: {
      readonly nextCollectionId: u128;
    } & Struct;
    readonly type: 'MigrateCollections' | 'MigrateTokens' | 'MigrateCollectionAccounts' | 'MigrateTokenAccounts' | 'MigrateAttributes' | 'Finalize';
  }

  /** @name PalletClaimsCall (460) */
  ...
  /** @name PalletIdentityIdentityInfo (469) */
  ...
  /** @name PalletIdentityBitFlags (505) */
  ...
  /** @name PalletIdentityIdentityField (506) */
  ...
  /** @name PalletIdentityJudgement (507) */
  ...
  /** @name PalletBalancesIdAmount (520) */
  ...
  /** @name PalletTransactionPaymentReleases (524) */
  ...
  /** @name PalletDemocracyReferendumInfo (530) */
  ...
  /** @name PalletDemocracyReferendumStatus (531) */
  ...
  /** @name PalletDemocracyVoteVoting (533) */
  ...
  /** @name PalletDemocracyDelegations (537) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (538) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (541) */
  ...
  /** @name PalletCollectiveVotes (543) */
  ...
  /** @name PalletCollectiveError (544) */
  ...
  /** @name PalletMembershipError (554) */
  ...
  /** @name PalletCollatorStakingCollator (560) */
  ...
  /** @name EnjinMatrixRuntimeMaxCollators (570) */
  type EnjinMatrixRuntimeMaxCollators = Null;

  /** @name PalletCollatorStakingCollatorSessionInfo (572) */
  ...
  /** @name PalletCollatorStakingError (573) */
  ...
  /** @name SpCoreCryptoKeyTypeId (577) */
  interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (578) */
  ...
  /** @name CumulusPalletXcmpQueueInboundChannelDetails (580) */
  ...
  /** @name CumulusPalletXcmpQueueInboundState (581) */
  ...
  /** @name PolkadotParachainPrimitivesXcmpMessageFormat (584) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundChannelDetails (587) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundState (588) */
  ...
  /** @name CumulusPalletXcmpQueueError (592) */
  ...
  /** @name PalletXcmVersionMigrationStage (603) */
  ...
  /** @name PalletXcmRemoteLockedFungibleRecord (607) */
  ...
  /** @name CumulusPalletXcmError (615) */
  type CumulusPalletXcmError = Null;

  /** @name CumulusPalletDmpQueueConfigData (616) */
  interface CumulusPalletDmpQueueConfigData extends Struct {
    readonly maxIndividual: SpWeightsWeightV2Weight;
  }

  /** @name CumulusPalletDmpQueuePageIndexData (617) */
  ...
  /** @name CumulusPalletDmpQueueError (620) */
  ...
  /** @name OrmlUnknownTokensModuleError (623) */
  ...
  /** @name OrmlXtokensModuleError (624) */
  ...
  /** @name EpCoreFrameMigrationsMigration (634) */
  interface EpCoreFrameMigrationsMigration extends Struct {
    readonly stage: EpCoreFrameMigrationsMigrationStage;
    readonly lastIteratedKey: Option<Bytes>;
  }

  /** @name EnjinMatrixRuntimeMaxMigrationKeyLength (635) */
  type EnjinMatrixRuntimeMaxMigrationKeyLength = Null;

  /** @name EpMultiTokensNativeAssetInfo (638) */
  interface EpMultiTokensNativeAssetInfo extends Struct {
    readonly id: EpMultiTokensTokenAssetId;
    readonly unitsPerSecond: u128;
  }

  /** @name EpCoreFrameTypesExtrinsicInfo (640) */
  interface EpCoreFrameTypesExtrinsicInfo extends Struct {
    readonly palletName: Bytes;
    readonly extrinsicName: Option<Bytes>;
  }

  /** @name PalletMultiTokensError (643) */
  interface PalletMultiTokensError extends Enum {
    ...
    readonly isInvalidUnitPrice: boolean;
    readonly isBalanceBelowMinimumRequirement: boolean;
  ...
  /** @name EpCoreFrameTypesPoolAccountIds (648) */
  ...
  /** @name PalletFuelTanksFuelTank (650) */
  ...
  /** @name PalletFuelTanksRulesRuleSet (652) */
  ...
  /** @name PalletFuelTanksRulesDispatchRuleWrapper (653) */
  ...
  /** @name PalletFuelTanksRulesUserFuelBudgetUserFuelBudgetRule (654) */
  ...
  /** @name PalletFuelTanksRulesAccountRuleWrapper (675) */
  ...
  /** @name PalletFuelTanksUserAccount (680) */
  ...
  /** @name EnjinMatrixRuntimeMaxRuleSets (681) */
  type EnjinMatrixRuntimeMaxRuleSets = Null;

  /** @name EnjinMatrixRuntimeMaxAccountRuleDataLength (682) */
  type EnjinMatrixRuntimeMaxAccountRuleDataLength = Null;

  /** @name PalletFuelTanksError (692) */
  ...
  interface PalletMarketplaceError extends Enum {
    ...
    readonly isTransferParamCreationFailed: boolean;
    readonly isTakeValueUnderMinimum: boolean;
  ...
  /** @name PalletExtrinsicPauseError (695) */
  ...
  /** @name PalletMatrixUtilityError (696) */
  interface PalletMatrixUtilityError extends Enum {
    readonly isTooManyCalls: boolean;
    readonly type: 'TooManyCalls';
  }

  /** @name PalletMultiTokensCrossChainMigrationError (697) */
  interface PalletMultiTokensCrossChainMigrationError extends Enum {
    readonly isMigrationAlreadyCompleted: boolean;
    readonly isOnlyFinalizeOngoing: boolean;
    readonly type: 'MigrationAlreadyCompleted' | 'OnlyFinalizeOngoing';
  }

  /** @name PalletClaimsClaimData (699) */
  ...
  /** @name PalletIdentityRegistration (702) */
  ...
  /** @name PalletIdentityRegistrarInfo (710) */
  ...
  /** @name SpRuntimeMultiSignature (714) */
  ...
  /** @name SpCoreEd25519Signature (715) */
  interface SpCoreEd25519Signature extends U8aFixed {}

  /** @name SpCoreSr25519Signature (717) */
  interface SpCoreSr25519Signature extends U8aFixed {}

  /** @name FrameSystemExtensionsCheckSpecVersion (719) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (720) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (721) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (724) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (725) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (726) */
  interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name PalletFuelTanksExtensionCheckFuelTank (727) */

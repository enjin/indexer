...
import { TeleportAssets } from '~/pallet/polkadot-xcm/calls/types'
...
export const teleportAssets = withDispatchCheck((call: CallItem): TeleportAssets => {
    return match(call)
        ...
        .when(
            () => calls.polkadotXcm.teleportAssets.matrixEnjinV1031.is(call),
            () => calls.polkadotXcm.teleportAssets.matrixEnjinV1031.decode(call)
        )
        .when(

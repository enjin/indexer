...
export function dispatchAndTouch(call: CallItem): DispatchAndTouch {
    return match(call)
        ...
        .when(
            () => calls.fuelTanks.dispatchAndTouch.matrixV1030.is(call),
            () => calls.fuelTanks.dispatchAndTouch.matrixV1030.decode(call)
        )
        .when(
        ...
        .when(
            () => calls.fuelTanks.dispatchAndTouch.enjinV1070.is(call),
            () => calls.fuelTanks.dispatchAndTouch.enjinV1070.decode(call)
        )
        .when(

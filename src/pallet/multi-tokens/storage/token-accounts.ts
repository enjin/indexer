...
> {
    ...
    return match(block)
        ...
        >()
        .when(
            () => multiTokens.tokenAccounts.matrixV1040.is(block),
            () => getTokenAccounts(multiTokens.tokenAccounts.matrixV1040)
        )
        .when(
            () => multiTokens.tokenAccounts.matrixEnjinV1031.is(block),
            () => getTokenAccounts(multiTokens.tokenAccounts.matrixEnjinV1031)
        )
        .when(
        ...
        .when(
            () => multiTokens.tokenAccounts.matrixV1023.is(block),
            () => getTokenAccounts(multiTokens.tokenAccounts.matrixV1023)
        )
        .when(
        ...
        .when(
            () => multiTokens.tokenAccounts.enjinV1070.is(block),
            () => getTokenAccounts(multiTokens.tokenAccounts.enjinV1070)
        )
        .when(

...
export function listingCreated(event: EventItem): ListingCreated {
    return match(event)
        ...
        .when(
            () => marketplace.listingCreated.enjinV1070.is(event),
            () => marketplace.listingCreated.enjinV1070.decode(event)
        )
        .when(
            () => marketplace.listingCreated.v1070.is(event),
            () => marketplace.listingCreated.v1070.decode(event)
        )
        .when(

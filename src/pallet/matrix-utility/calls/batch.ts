...
export const batch = withDispatchCheck((call: CallItem): Batch => {
    return match(call)
        .returnType<Batch>()
        .when(
            () => calls.matrixUtility.batch.matrixEnjinV1031.is(call),
            () => calls.matrixUtility.batch.matrixEnjinV1031.decode(call)
        )
        .when(
        ...
        .when(
            () => calls.matrixUtility.batch.matrixV1030.is(call),
            () => calls.matrixUtility.batch.matrixV1030.decode(call)
        )
        .when(
            () => calls.matrixUtility.batch.matrixV1023.is(call),
            () => calls.matrixUtility.batch.matrixV1023.decode(call)
        )
        .when(

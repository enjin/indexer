...
export class MultiTokensLoanReturnFailed {
    public readonly isTypeOf = 'MultiTokensLoanReturnFailed'
    ...
    constructor(props?: Partial<Omit<MultiTokensLoanReturnFailed, 'toJSON'>>, json?: any) {

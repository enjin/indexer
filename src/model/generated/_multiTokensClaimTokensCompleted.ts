...
export class MultiTokensClaimTokensCompleted {
    public readonly isTypeOf = 'MultiTokensClaimTokensCompleted'
    private _account!: string
    private _ethAccount!: string

    constructor(props?: Partial<Omit<MultiTokensClaimTokensCompleted, 'toJSON'>>, json?: any) {

...
export class MultiTokensTokenGroupAdded {
    public readonly isTypeOf = 'MultiTokensTokenGroupAdded'
    private _collectionId!: bigint
    private _tokenId!: bigint
    private _tokenGroupId!: bigint

    constructor(props?: Partial<Omit<MultiTokensTokenGroupAdded, 'toJSON'>>, json?: any) {

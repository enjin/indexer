...
export class MarketplaceWhitelistedAccountsAdded {
    public readonly isTypeOf = 'MarketplaceWhitelistedAccountsAdded'
    private _listing!: string
    private _accounts!: (string | undefined | null)[]

    constructor(props?: Partial<Omit<MarketplaceWhitelistedAccountsAdded, 'toJSON'>>, json?: any) {

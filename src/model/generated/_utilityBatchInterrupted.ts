...
export class UtilityBatchInterrupted {
    public readonly isTypeOf = 'UtilityBatchInterrupted'
    private _error!: string | undefined | null
    private _itemIndex!: number | undefined | null

    constructor(props?: Partial<Omit<UtilityBatchInterrupted, 'toJSON'>>, json?: any) {

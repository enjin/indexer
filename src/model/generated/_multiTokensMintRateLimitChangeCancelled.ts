...
export class MultiTokensMintRateLimitChangeCancelled {
    public readonly isTypeOf = 'MultiTokensMintRateLimitChangeCancelled'
    private _collectionId!: bigint
    private _tokenId!: bigint | undefined | null

    constructor(props?: Partial<Omit<MultiTokensMintRateLimitChangeCancelled, 'toJSON'>>, json?: any) {

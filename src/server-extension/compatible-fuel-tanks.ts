...
export enum ExtrinsicName {
    ...
    BatchAddAccount = 'batch_add_account',
    BatchRemoveAccount = 'batch_remove_account',
    CreateFuelTank = 'create_fuel_tank',
    DestroyFuelTank = 'destroy_fuel_tank',
    Dispatch = 'dispatch',
    DispatchAndTouch = 'dispatch_and_touch',
    ForceBatchAddAccount = 'force_batch_add_account',
    ForceCreateFuelTank = 'force_create_fuel_tank',
    ForceInsertRuleSet = 'force_insert_rule_set',
    ForceSetConsumption = 'force_set_consumption',
    InsertRuleSet = 'insert_rule_set',
    MutateFreezeState = 'mutate_freeze_state',
    MutateFuelTank = 'mutate_fuel_tank',
    RemoveAccount = 'remove_account',
    RemoveAccountRuleData = 'remove_account_rule_data',
    RemoveExpiredAccount = 'remove_expired_account',
    RemoveExpiredAccountUnsigned = 'remove_expired_account_unsigned',
    RemoveRuleSet = 'remove_rule_set',
    // Identity
    AcceptUsername = 'accept_username',
    AddRegistrar = 'add_registrar',
    AddSub = 'add_sub',
    AddUsernameAuthority = 'add_username_authority',
    CancelRequest = 'cancel_request',
    ClearIdentity = 'clear_identity',
    KillIdentity = 'kill_identity',
    KillUsername = 'kill_username',
    ProvideJudgement = 'provide_judgement',
    QuitSub = 'quit_sub',
    RemoveExpiredApproval = 'remove_expired_approval',
    RemoveSub = 'remove_sub',
    RemoveUsername = 'remove_username',
    RemoveUsernameAuthority = 'remove_username_authority',
    RenameSub = 'rename_sub',
    RequestJudgement = 'request_judgement',
    SetAccountId = 'set_account_id',
    SetFee = 'set_fee',
    SetFields = 'set_fields',
    SetIdentity = 'set_identity',
    SetPrimaryUsername = 'set_primary_username',
    SetSubs = 'set_subs',
    SetUsernameFor = 'set_username_for',
    UnbindUsername = 'unbind_username',
    // Marketplace
    AddWhitelistedAccounts = 'add_whitelisted_accounts',
    AnswerCounterOffer = 'answer_counter_offer',
    CancelListing = 'cancel_listing',
    CreateListing = 'create_listing',
    FillListing = 'fill_listing',
    FinalizeAuction = 'finalize_auction',
    FinalizeAuctionUnsigned = 'finalize_auction_unsigned',
    ForceCancelListing = 'force_cancel_listing',
    ForceCreateListing = 'force_create_listing',
    ForcePlaceBid = 'force_place_bid',
    PlaceBid = 'place_bid',
    PlaceCounterOffer = 'place_counter_offer',
    RemoveExpiredListing = 'remove_expired_listing',
    RemoveExpiredListingUnsigned = 'remove_expired_listing_unsigned',
    RemoveWhitelistedAccounts = 'remove_whitelisted_accounts',
    SetProtocolFee = 'set_protocol_fee',
    // MultiTokens
    AcceptCollectionTransfer = 'accept_collection_transfer',
    AddTokenToGroup = 'add_token_to_group',
    ApproveCollection = 'approve_collection',
    ApproveToken = 'approve_token',
    BatchInfuse = 'batch_infuse',
    BatchMint = 'batch_mint',
    BatchSetAttribute = 'batch_set_attribute',
    BatchTransfer = 'batch_transfer',
    CancelCollectionTransfer = 'cancel_collection_transfer',
    ClaimCollections = 'claim_collections',
    ClaimTokens = 'claim_tokens',
    CreateCollection = 'create_collection',
    CreateTokenGroup = 'create_token_group',
    DestroyCollection = 'destroy_collection',
    DestroyTokenGroup = 'destroy_token_group',
    FinishClaimTokens = 'finish_claim_tokens',
    ForceApproveCollection = 'force_approve_collection',
    ForceBurn = 'force_burn',
    ForceCreateCollection = 'force_create_collection',
    ForceCreateEthereumCollection = 'force_create_ethereum_collection',
    ForceFreeze = 'force_freeze',
    ForceMint = 'force_mint',
    ForceMutateCollection = 'force_mutate_collection',
    ForceSetAttribute = 'force_set_attribute',
    ForceSetCollection = 'force_set_collection',
    ForceSetCollectionAccount = 'force_set_collection_account',
    ForceSetEthereumAccount = 'force_set_ethereum_account',
    ForceSetEthereumCollectionId = 'force_set_ethereum_collection_id',
    ForceSetEthereumUnmintableTokenIds = 'force_set_ethereum_unmintable_token_ids',
    ForceSetNextCollectionId = 'force_set_next_collection_id',
    ForceSetToken = 'force_set_token',
    ForceSetTokenAccount = 'force_set_token_account',
    ForceSetUnmintableTokenIds = 'force_set_unmintable_token_ids',
    Freeze = 'freeze',
    Infuse = 'infuse',
    Mint = 'mint',
    MutateCollection = 'mutate_collection',
    MutateToken = 'mutate_token',
    RemoveAllAttributes = 'remove_all_attributes',
    RemoveAttribute = 'remove_attribute',
    RemoveTokenFromGroup = 'remove_token_from_group',
    RemoveTokenGroupAttribute = 'remove_token_group_attribute',
    SetAttribute = 'set_attribute',
    SetTokenGroupAttribute = 'set_token_group_attribute',
    SetTokenGroups = 'set_token_groups',
    Thaw = 'thaw',
    Transfer = 'transfer',
    UnapproveCollection = 'unapprove_collection',
    UnapproveToken = 'unapprove_token',
    UpdateAccountDeposit = 'update_account_deposit',
    // Multisig
    ApproveAsMulti = 'approve_as_multi',
    AsMulti = 'as_multi',
    AsMultiThreshold1 = 'as_multi_threshold_1',
    ...
    Create = 'create',
    Destroy = 'destroy',
    FullyUnbondDeletedPool = 'fully_unbond_deleted_pool',
    Mutate = 'mutate',
    Nominate = 'nominate',
    PayoutRewards = 'payout_rewards',
    PayoutRewardsUnsigned = 'payout_rewards_unsigned',
    PayoutValidatorBonus = 'payout_validator_bonus',
    PoolWithdrawUnbonded = 'pool_withdraw_unbonded',
    RemoveEmptyUnbondingMembers = 'remove_empty_unbonding_members',
    SetConfigs = 'set_configs',
    SetStakingInfo = 'set_staking_info',
    SetValidatorBonusConfig = 'set_validator_bonus_config',
    Unbond = 'unbond',
    UnbondDeposit = 'unbond_deposit',
    WithdrawDeposit = 'withdraw_deposit',
    WithdrawFreeBalance = 'withdraw_free_balance',
    WithdrawUnbonded = 'withdraw_unbonded',
    // StakeExchange
    AddLiquidity = 'add_liquidity',
    Buy = 'buy',
    CancelOffer = 'cancel_offer',
    ConfigureLiquidityAccount = 'configure_liquidity_account',

...
exports.Conviction =
    ...
    exports.HeadData =
    exports.V8PersistedValidationData =
...
exports.WhitelistedAccount = support_1.sts.struct(function () {
    return {
        allowance: support_1.sts.option(function () {
            return support_1.sts.bigint()
        }),
        amountUsed: support_1.sts.bigint(),
        deposit: support_1.sts.bigint(),
    }
})
exports.PendingAction = support_1.sts.closedEnum(function () {
    return {
        RemoveCounterOffers: support_1.sts.enumStruct({
            listingId: exports.H256,
        }),
        RemoveWhitelistedAccounts: support_1.sts.enumStruct({
            listingId: exports.H256,
            listingCreator: exports.AccountId32,
        }),
    }
})
...
exports.TokenGroup = support_1.sts.struct(function () {
    return {
        collectionId: support_1.sts.bigint(),
        attributeCount: support_1.sts.number(),
        tokenCount: support_1.sts.bigint(),
        deposit: exports.AmbiguousDeposit,
    }
})
...
exports.MultiTokensEvent = support_1.sts.closedEnum(function () {
    return {
        ...
        CollectionAccountApprovalsMismatch: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
            accountId: exports.AccountId32,
        }),
        CollectionAccountApprovalsUpdated: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
            accountId: exports.AccountId32,
        ...
        TokenGroupAdded: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
            tokenId: support_1.sts.bigint(),
            tokenGroupId: support_1.sts.bigint(),
        }),
        TokenGroupAttributeRemoved: support_1.sts.enumStruct({
            tokenGroupId: support_1.sts.bigint(),
            key: support_1.sts.bytes(),
        }),
        TokenGroupAttributeSet: support_1.sts.enumStruct({
            tokenGroupId: support_1.sts.bigint(),
            key: support_1.sts.bytes(),
            value: support_1.sts.bytes(),
        }),
        TokenGroupCreated: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
            tokenGroupId: support_1.sts.bigint(),
        }),
        TokenGroupDestroyed: support_1.sts.enumStruct({
            tokenGroupId: support_1.sts.bigint(),
        }),
        TokenGroupRemoved: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
            tokenId: support_1.sts.bigint(),
            tokenGroupId: support_1.sts.bigint(),
        }),
        TokenGroupsUpdated: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
            tokenId: support_1.sts.bigint(),
...
exports.MarketplaceEvent = support_1.sts.closedEnum(function () {
    return {
        ...
        WhitelistedAccountsAdded: support_1.sts.enumStruct({
            listingId: exports.H256,
            accounts: support_1.sts.array(function () {
                return exports.WhitelistAddAccount
            }),
        }),
        WhitelistedAccountsRemoved: support_1.sts.enumStruct({
            listingId: exports.H256,
...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_251,
...
exports.Type_251 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_489 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
...
exports.DefaultTransferParams = support_1.sts.closedEnum(function () {
    return {
        Operator: support_1.sts.enumStruct({
            ...
            source: exports.AccountId32,
            amount: support_1.sts.bigint(),
            operatorPaysDeposit: support_1.sts.boolean(),
            depositor: support_1.sts.option(function () {
                return exports.AccountId32
            }),
        }),
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Council: exports.Type_388,
        CumulusXcm: exports.Type_391,
        PolkadotXcm: exports.Origin,
        TechnicalCommittee: exports.Type_389,
        Void: exports.Void,
...
exports.Type_389 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_391 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_388 = support_1.sts.closedEnum(function () {
    return {
        Member: exports.AccountId32,
        Members: support_1.sts.tuple(function () {
            return [support_1.sts.number(), support_1.sts.number()]
...
exports.Type_438 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_441
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_445
        }),
        V4: support_1.sts.array(function () {
            return exports.Type_448
        }),
    }
})
...
exports.Type_442 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
exports.Type_445 = support_1.sts.closedEnum(function () {
    return {
        AliasOrigin: exports.V3MultiLocation,
        BurnAsset: support_1.sts.array(function () {
            return exports.V3MultiAsset
...
exports.ParachainInherentData = support_1.sts.struct(function () {
    return {
        validationData: exports.V8PersistedValidationData,
...
exports.V8PersistedValidationData = support_1.sts.struct(function () {
    return {
...
exports.MultiTokensCall = support_1.sts.closedEnum(function () {
    return {
        ...
        add_token_to_group: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
            tokenId: support_1.sts.bigint(),
            tokenGroupId: support_1.sts.bigint(),
        }),
        ...
        create_token_group: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
            depositor: support_1.sts.option(function () {
                return exports.MultiAddress
            }),
        ...
        destroy_token_group: support_1.sts.enumStruct({
            tokenGroupId: support_1.sts.bigint(),
        }),
        ...
        remove_token_from_group: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
            tokenId: support_1.sts.bigint(),
            tokenGroupId: support_1.sts.bigint(),
        }),
        remove_token_group_attribute: support_1.sts.enumStruct({
            tokenGroupId: support_1.sts.bigint(),
            key: support_1.sts.bytes(),
        }),
        ...
        set_token_group_attribute: support_1.sts.enumStruct({
            tokenGroupId: support_1.sts.bigint(),
            key: support_1.sts.bytes(),
            value: support_1.sts.bytes(),
            depositor: support_1.sts.option(function () {
        ...
        set_token_groups: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
            tokenId: support_1.sts.bigint(),
            tokenGroups: support_1.sts.array(function () {
                return support_1.sts.bigint()
        ...
        update_collection_account_approvals: support_1.sts.enumStruct({
...
exports.Collection = support_1.sts.struct(function () {
    return {
        ...
        tokenGroupCount: support_1.sts.number(),
    }
})
...
exports.RuntimeHoldReason = support_1.sts.closedEnum(function () {
    return {
        CollatorStaking: exports.Type_184,
        FuelTanks: exports.Type_186,
        Marketplace: exports.Type_187,
        MultiTokens: exports.Type_185,
        Preimage: exports.HoldReason,
        SafeMode: exports.Type_183,
    }
})
...
exports.Type_186 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_184 = support_1.sts.closedEnum(function () {
    return {
        CollatorStaking: support_1.sts.unit(),
    }
})
exports.AccountId32 = support_1.sts.bytes()
exports.DefaultTokenMutation = support_1.sts.struct(function () {
    return {
        behavior: exports.Type_167,
        listingForbidden: exports.Type_170,
        anyoneCanInfuse: exports.Type_170,
        name: exports.Type_171,
    }
})
exports.Type_171 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: exports.BoundedString,
    }
})
exports.Type_170 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),

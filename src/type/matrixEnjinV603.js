...
exports.V2AssetInstance =
    ...
    exports.ConfigData =
    exports.PageIndexData =
    exports.BountyStatus =
    exports.Bounty =
    exports.Migration =
    exports.EthereumSupplyModel =
    exports.EthereumTransferable =
    exports.EthereumToken =
    exports.EthereumAccount =
    ...
    exports.FuelTank =
    exports.UserAccount =
    exports.FreezeQueueItem =
    exports.MarketPlaceInfo =
    exports.ExtrinsicInfo =
    exports.ClaimData =
    exports.WeightsPerClass =
    exports.Type_257 =
    exports.BlockWeights =
    exports.Type_261 =
    exports.BlockLength =
    exports.RuntimeDbWeight =
...
exports.Phase =
    ...
    exports.RelayDispachQueueSize =
    exports.V4AbridgedHrmpChannel =
    exports.MessagingStateSnapshot =
    exports.V4AbridgedHostConfiguration =
    exports.MessageQueueChain =
    exports.OutboundHrmpMessage =
    exports.CodeUpgradeAuthorization =
    ...
    exports.Nomination =
    exports.Round =
    exports.CollatorSessionInfo =
    exports.KeyTypeId =
    exports.InboundState =
    exports.XcmpMessageFormat =
    exports.InboundChannelDetails =
    exports.OutboundState =
    exports.OutboundChannelDetails =
    exports.QueueConfigData =
    exports.V2NetworkId =
...
exports.Attribute =
    ...
    exports.Event =
    exports.EventRecord =
    exports.LastRuntimeUpgradeInfo =
        void 0
exports.Conviction =
    exports.Public =
    exports.SessionKeys =
...
exports.PoolAccountIds = support_1.sts.struct(function () {
    return {
        collator: exports.AccountId32,
        community: exports.AccountId32,
        fuelTanks: exports.AccountId32,
        priceDiscovery: exports.AccountId32,
    }
})
exports.NativeAssetInfo = support_1.sts.struct(function () {
    return {
        id: exports.AssetId,
        unitsPerSecond: support_1.sts.bigint(),
    }
})
exports.PalletId = support_1.sts.bytes()
exports.Permill = support_1.sts.number()
exports.RuntimeVersion = support_1.sts.struct(function () {
    return {
        specName: support_1.sts.string(),
        implName: support_1.sts.string(),
        authoringVersion: support_1.sts.number(),
        specVersion: support_1.sts.number(),
        implVersion: support_1.sts.number(),
        apis: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
                return [support_1.sts.bytes(), support_1.sts.number()]
            })
        }),
        transactionVersion: support_1.sts.number(),
        stateVersion: support_1.sts.number(),
    }
})
exports.RuntimeDbWeight = support_1.sts.struct(function () {
    return {
        read: support_1.sts.bigint(),
        write: support_1.sts.bigint(),
    }
})
exports.BlockLength = support_1.sts.struct(function () {
    return {
        max: exports.Type_261,
    }
})
exports.Type_261 = support_1.sts.struct(function () {
    return {
        normal: support_1.sts.number(),
        operational: support_1.sts.number(),
        mandatory: support_1.sts.number(),
    }
})
exports.BlockWeights = support_1.sts.struct(function () {
    return {
        baseBlock: exports.Weight,
        maxBlock: exports.Weight,
        perClass: exports.Type_257,
    }
})
exports.Type_257 = support_1.sts.struct(function () {
    return {
        normal: exports.WeightsPerClass,
        operational: exports.WeightsPerClass,
        mandatory: exports.WeightsPerClass,
    }
})
exports.WeightsPerClass = support_1.sts.struct(function () {
    return {
        baseExtrinsic: exports.Weight,
        maxExtrinsic: support_1.sts.option(function () {
            return exports.Weight
        }),
        maxTotal: support_1.sts.option(function () {
            return exports.Weight
        }),
        reserved: support_1.sts.option(function () {
            return exports.Weight
        }),
    }
})
...
exports.ExtrinsicInfo = support_1.sts.struct(function () {
    return {
        ...
        extrinsicName: support_1.sts.option(function () {
            return support_1.sts.bytes()
        }),
    }
})
exports.MarketPlaceInfo = support_1.sts.struct(function () {
    return {
        protocolFee: support_1.sts.number(),
    }
})
exports.FreezeQueueItem = support_1.sts.struct(function () {
    return {
...
exports.Type_621 = support_1.sts.struct(function () {
    return {
        palletName: support_1.sts.bytes(),
...
exports.EthereumAccount = support_1.sts.struct(function () {
    return {
        claimableCollectionIds: support_1.sts.array(function () {
            return support_1.sts.bigint()
        }),
        nonce: support_1.sts.number(),
    }
})
exports.EthereumToken = support_1.sts.struct(function () {
    return {
        name: support_1.sts.bytes(),
        creator: exports.H160,
        supplyModel: exports.EthereumSupplyModel,
        totalSupply: support_1.sts.bigint(),
        circulatingSupply: support_1.sts.bigint(),
        transferable: exports.EthereumTransferable,
        fungible: support_1.sts.boolean(),
        uri: support_1.sts.bytes(),
    }
})
exports.EthereumTransferable = support_1.sts.closedEnum(function () {
    return {
        Bound: support_1.sts.unit(),
        Permanent: support_1.sts.unit(),
        Temporary: support_1.sts.unit(),
    }
})
exports.EthereumSupplyModel = support_1.sts.closedEnum(function () {
    return {
        AnnualPercentage: support_1.sts.unit(),
        AnnualValue: support_1.sts.unit(),
        Collapsing: support_1.sts.unit(),
        Fixed: support_1.sts.unit(),
        Infinite: support_1.sts.unit(),
        Settable: support_1.sts.unit(),
    }
})
exports.Migration = support_1.sts.struct(function () {
    return {
        stage: exports.MigrationStage,
        lastIteratedKey: support_1.sts.option(function () {
            return support_1.sts.bytes()
        }),
    }
})
exports.Bounty = support_1.sts.struct(function () {
    return {
        proposer: exports.AccountId32,
        value: support_1.sts.bigint(),
        fee: support_1.sts.bigint(),
        curatorDeposit: support_1.sts.bigint(),
        bond: support_1.sts.bigint(),
        status: exports.BountyStatus,
    }
})
exports.BountyStatus = support_1.sts.closedEnum(function () {
    return {
        Active: support_1.sts.enumStruct({
            curator: exports.AccountId32,
            updateDue: support_1.sts.number(),
        }),
        Approved: support_1.sts.unit(),
        CuratorProposed: support_1.sts.enumStruct({
            curator: exports.AccountId32,
        }),
        Funded: support_1.sts.unit(),
        PendingPayout: support_1.sts.enumStruct({
            curator: exports.AccountId32,
            beneficiary: exports.AccountId32,
            unlockAt: support_1.sts.number(),
        }),
        Proposed: support_1.sts.unit(),
    }
})
exports.PageIndexData = support_1.sts.struct(function () {
    return {
        beginUsed: support_1.sts.number(),
        endUsed: support_1.sts.number(),
        overweightCount: support_1.sts.bigint(),
    }
})
exports.ConfigData = support_1.sts.struct(function () {
    return {
        maxIndividual: exports.Weight,
    }
})
...
exports.QueueConfigData = support_1.sts.struct(function () {
    return {
        suspendThreshold: support_1.sts.number(),
        dropThreshold: support_1.sts.number(),
        resumeThreshold: support_1.sts.number(),
        thresholdWeight: exports.Weight,
        weightRestrictDecay: exports.Weight,
        xcmpMaxIndividualWeight: exports.Weight,
    }
})
exports.OutboundChannelDetails = support_1.sts.struct(function () {
    return {
        recipient: exports.Id,
        state: exports.OutboundState,
        signalsExist: support_1.sts.boolean(),
        firstIndex: support_1.sts.number(),
        lastIndex: support_1.sts.number(),
    }
})
exports.OutboundState = support_1.sts.closedEnum(function () {
    return {
        Ok: support_1.sts.unit(),
        Suspended: support_1.sts.unit(),
    }
})
exports.InboundChannelDetails = support_1.sts.struct(function () {
    return {
        sender: exports.Id,
        state: exports.InboundState,
        messageMetadata: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
                return [support_1.sts.number(), exports.XcmpMessageFormat]
            })
        }),
    }
})
exports.XcmpMessageFormat = support_1.sts.closedEnum(function () {
    return {
        ConcatenatedEncodedBlob: support_1.sts.unit(),
        ConcatenatedVersionedXcm: support_1.sts.unit(),
        Signals: support_1.sts.unit(),
    }
})
exports.InboundState = support_1.sts.closedEnum(function () {
    return {
        Ok: support_1.sts.unit(),
        Suspended: support_1.sts.unit(),
    }
})
exports.KeyTypeId = support_1.sts.bytes()
exports.CollatorSessionInfo = support_1.sts.struct(function () {
    return {
        authoredBlockCount: support_1.sts.number(),
        uptime: support_1.sts.number(),
    }
})
exports.Round = support_1.sts.struct(function () {
    return {
        number: support_1.sts.number(),
        startingBlock: support_1.sts.number(),
        collators: support_1.sts.array(function () {
            return exports.Collator
        }),
    }
})
exports.Nomination = support_1.sts.struct(function () {
    return {
        account: exports.AccountId32,
        amount: support_1.sts.bigint(),
    }
})
exports.Collator = support_1.sts.struct(function () {
    return {
        account: exports.AccountId32,
        amount: support_1.sts.bigint(),
        totalStake: support_1.sts.bigint(),
        rewardsCut: exports.Perbill,
        nominators: support_1.sts.array(function () {
            return exports.AccountId32
        }),
    }
})
exports.Multisig = support_1.sts.struct(function () {
    return {
        when: exports.Timepoint,
...
exports.Votes = support_1.sts.struct(function () {
    return {
        index: support_1.sts.number(),
        threshold: support_1.sts.number(),
        ayes: support_1.sts.array(function () {
            return exports.AccountId32
        }),
        nays: support_1.sts.array(function () {
            return exports.AccountId32
        }),
...
exports.Voting = support_1.sts.closedEnum(function () {
    return {
        Delegating: support_1.sts.enumStruct({
        ...
        Direct: support_1.sts.enumStruct({
...
exports.ReferendumInfo = support_1.sts.closedEnum(function () {
    return {
        Finished: support_1.sts.enumStruct({
            approved: support_1.sts.boolean(),
            end: support_1.sts.number(),
        }),
...
exports.Tally = support_1.sts.struct(function () {
    return {
        ...
        turnout: support_1.sts.bigint(),
    }
})
exports.Releases = support_1.sts.closedEnum(function () {
    return {
        V1Ancient: support_1.sts.unit(),
        V2: support_1.sts.unit(),
    }
})
...
exports.ReserveData = support_1.sts.struct(function () {
    return {
        id: support_1.sts.bytes(),
        amount: support_1.sts.bigint(),
    }
})
exports.BalanceLock = support_1.sts.struct(function () {
    return {
        id: support_1.sts.bytes(),
        amount: support_1.sts.bigint(),
        reasons: exports.Reasons,
    }
})
exports.Reasons = support_1.sts.closedEnum(function () {
    return {
        All: support_1.sts.unit(),
        Fee: support_1.sts.unit(),
        Misc: support_1.sts.unit(),
    }
})
exports.AccountData = support_1.sts.struct(function () {
    return {
        ...
        frozen: support_1.sts.bigint(),
        flags: exports.ExtraFlags,
    }
})
exports.ExtraFlags = support_1.sts.bigint()
...
exports.RequestStatus = support_1.sts.closedEnum(function () {
    return {
        Requested: support_1.sts.enumStruct({
            ...
            count: support_1.sts.number(),
            len: support_1.sts.option(function () {
                return support_1.sts.number()
            }),
        }),
        Unrequested: support_1.sts.enumStruct({
            deposit: support_1.sts.tuple(function () {
                return [exports.AccountId32, support_1.sts.bigint()]
            }),
...
exports.CodeUpgradeAuthorization = support_1.sts.struct(function () {
    return {
...
exports.MessageQueueChain = support_1.sts.bytes()
exports.V4AbridgedHostConfiguration = support_1.sts.struct(function () {
    return {
...
exports.MessagingStateSnapshot = support_1.sts.struct(function () {
    return {
        dmqMqcHead: exports.H256,
        relayDispatchQueueSize: exports.RelayDispachQueueSize,
        ingressChannels: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
                return [exports.Id, exports.V4AbridgedHrmpChannel]
            })
        }),
        egressChannels: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
                return [exports.Id, exports.V4AbridgedHrmpChannel]
            })
        }),
...
exports.V4AbridgedHrmpChannel = support_1.sts.struct(function () {
    return {
...
exports.RelayDispachQueueSize = support_1.sts.struct(function () {
    return {
        remainingCount: support_1.sts.number(),
...
exports.LastRuntimeUpgradeInfo = support_1.sts.struct(function () {
    return {
        specVersion: support_1.sts.number(),
        specName: support_1.sts.string(),
    }
...
exports.PerDispatchClass = support_1.sts.struct(function () {
    return {
        normal: exports.Weight,
        operational: exports.Weight,
        mandatory: exports.Weight,
    }
})

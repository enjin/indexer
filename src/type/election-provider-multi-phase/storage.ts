...
export const signedSubmissionNextIndex = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        sts.number()
    ) as SignedSubmissionNextIndexEnjinV100,
}
...
export const signedSubmissionIndices = {
    ...
    enjinV100: new StorageType(
        ...
        'Default',
        [],
        sts.array(() => sts.tuple(() => [enjinV100.ElectionScore, sts.number(), sts.number()]))
    ) as SignedSubmissionIndicesEnjinV100,
}
...
export const signedSubmissionsMap = {
    ...
    ) as SignedSubmissionsMapEnjinV100,
}
...
export interface SignedSubmissionsMapEnjinV100 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: enjinV100.SignedSubmission | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export const minimumUntrustedScore = {
    ...
    ) as MinimumUntrustedScoreEnjinV100,
}

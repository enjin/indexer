...
export const send = {
    ...
    matrixEnjinV1031: new CallType(
        'PolkadotXcm.send',
        sts.struct({
            dest: matrixEnjinV1031.VersionedLocation,
            message: matrixEnjinV1031.VersionedXcm,
        })
    ),
...
export const teleportAssets = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            dest: matrixEnjinV1031.VersionedLocation,
            beneficiary: matrixEnjinV1031.VersionedLocation,
...
export const execute = {
    ...
    matrixEnjinV1031: new CallType(
        'PolkadotXcm.execute',
        sts.struct({
            message: matrixEnjinV1031.Type_472,
...
export const limitedReserveTransferAssets = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            ...
            assets: matrixEnjinV1031.VersionedAssets,
            feeAssetItem: sts.number(),
            weightLimit: matrixEnjinV1031.V3WeightLimit,
        })
    ),
    /**
     * Transfer some assets from the local chain to the sovereign account of a destination
...
export const transferAssetsUsingTypeAndThen = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            dest: matrixEnjinV1031.VersionedLocation,
            assets: matrixEnjinV1031.VersionedAssets,
            assetsTransferType: matrixEnjinV1031.TransferType,
            remoteFeesId: matrixEnjinV1031.VersionedAssetId,
            feesTransferType: matrixEnjinV1031.TransferType,
            customXcmOnDest: matrixEnjinV1031.VersionedXcm,
            weightLimit: matrixEnjinV1031.V3WeightLimit,
        })
    ),
    /**
...
export const addAuthorizedAlias = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            aliaser: matrixEnjinV1031.VersionedLocation,
...
export const removeAllAuthorizedAliases = {
     ...
     * making this call.
     */
    matrixEnjinV1031: new CallType('PolkadotXcm.remove_all_authorized_aliases', sts.unit()),
}

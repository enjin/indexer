...
exports.Type_951 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_952 = support_1.sts.struct(function () {
    return {
...
exports.Type_593 = support_1.sts.struct(function () {
    return {
...
exports.RemoteLockedFungibleRecord = support_1.sts.struct(function () {
    return {
        ...
        consumers: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
                return [support_1.sts.unit(), support_1.sts.bigint()]
            })
        }),
    }
})
...
exports.EarlyBirdInfo = support_1.sts.struct(function () {
    return {
        hasBeenQueued: support_1.sts.boolean(),
        queuedItems: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
...
exports.Page = support_1.sts.struct(function () {
    return {
        remaining: support_1.sts.number(),
        remainingSize: support_1.sts.number(),
        firstIndex: support_1.sts.number(),
        first: support_1.sts.number(),
        last: support_1.sts.number(),
        heap: support_1.sts.bytes(),
    }
})
exports.BookState = support_1.sts.struct(function () {
    return {
        begin: support_1.sts.number(),
        end: support_1.sts.number(),
        count: support_1.sts.number(),
        readyNeighbours: support_1.sts.option(function () {
            return exports.Neighbours
        }),
        messageCount: support_1.sts.bigint(),
        size: support_1.sts.bigint(),
    }
})
exports.Neighbours = support_1.sts.struct(function () {
    return {
        prev: exports.AggregateMessageOrigin,
        next: exports.AggregateMessageOrigin,
    }
})
exports.RangeInclusive = support_1.sts.struct(function () {
    return {
        start: support_1.sts.bigint(),
        end: support_1.sts.bigint(),
    }
})
...
exports.NominationPoolsEvent = support_1.sts.closedEnum(function () {
    return {
        ...
        EarlyBirdBonusQueued: support_1.sts.enumStruct({
            totalAmount: support_1.sts.bigint(),
        }),
    ...
    return {
        ...
        ClaimedCollections: support_1.sts.enumStruct({
            ...
            collectionIds: support_1.sts.array(function () {
                return exports.CollectionIdPair
            }),
        }),
...
exports.DefaultTokenMutation = support_1.sts.struct(function () {
    return {
        behavior: exports.Type_196,
        listingForbidden: exports.Type_199,
        metadata: exports.Type_200,
    }
})
exports.Type_200 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: exports.DefaultTokenMetadata,
    }
})
exports.Type_199 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.boolean(),
    }
})
exports.Type_196 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.TokenMarketBehavior
...
exports.Type_183 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.DefaultRoyalty
...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_259,
...
exports.Type_259 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
...
exports.Type_595 = support_1.sts.closedEnum(function () {
    return {
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Origins: exports.Type_412,
        ParachainsOrigin: exports.Origin,
        Void: exports.Void,
        XcmPallet: exports.Type_411,
...
exports.Type_411 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_412 = support_1.sts.closedEnum(function () {
    return {
        AuctionAdmin: support_1.sts.unit(),
        BigSpender: support_1.sts.unit(),
        BigTipper: support_1.sts.unit(),
        ClaimsAdmin: support_1.sts.unit(),
        ExtrinsicPauseAdmin: support_1.sts.unit(),
        ...
        PreimageAdmin: support_1.sts.unit(),
...
exports.Type_488 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_491
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_495
        }),
    }
})
exports.Type_495 = support_1.sts.closedEnum(function () {
    return {
        AliasOrigin: exports.V3MultiLocation,
        BurnAsset: support_1.sts.array(function () {
            return exports.V3MultiAsset
...
exports.Type_492 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
exports.Type_491 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
            fees: exports.V2MultiAsset,
            weightLimit: exports.V2WeightLimit,
...
exports.StakingCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_staking_configs: support_1.sts.enumStruct({
            ...
            maxNominatorCount: exports.Type_371,
            maxValidatorCount: exports.Type_371,
            chillThreshold: exports.Type_372,
            minCommission: exports.Type_373,
        }),
...
exports.Type_373 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_372 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Percent,
...
exports.Type_371 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
...
exports.NominationPoolsCall = support_1.sts.closedEnum(function () {
    return {
        ...
        distribute_early_bird_bonus: support_1.sts.enumStruct({
        ...
        queue_early_bird_bonus: support_1.sts.unit(),
        set_configs: support_1.sts.enumStruct({
            minJoinBond: exports.Type_402,
            minCreateBond: exports.Type_402,
            globalMaxCommission: exports.Type_403,
        }),
...
exports.Type_402 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: support_1.sts.bigint(),
...
exports.GrandpaCall = support_1.sts.closedEnum(function () {
    return {
        ...
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_380,
            keyOwnerProof: exports.MembershipProof,
        }),
...
exports.Equivocation = support_1.sts.closedEnum(function () {
    return {
        Precommit: exports.Type_387,
        Prevote: exports.Type_382,
    }
})
exports.Type_382 = support_1.sts.struct(function () {
    return {
...
exports.Type_387 = support_1.sts.struct(function () {
    return {
        roundNumber: support_1.sts.bigint(),
        identity: exports.Public,
        first: support_1.sts.tuple(function () {
...
exports.BeefyCall = support_1.sts.closedEnum(function () {
    return {
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_561,
            keyOwnerProof: exports.MembershipProof,
        }),
        report_equivocation_unsigned: support_1.sts.enumStruct({
            equivocationProof: exports.Type_561,
...
exports.Type_561 = support_1.sts.struct(function () {
    return {
...
exports.CollectionIdPair = support_1.sts.struct(function () {
    return {
        ethereum: support_1.sts.bigint(),
        native: support_1.sts.bigint(),
    }
})

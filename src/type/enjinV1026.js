...
exports.Listing =
    ...
    exports.V5Public =
    exports.V5Signature =
    exports.V5CandidateDescriptor =
    exports.V5CandidateReceipt =
        void 0
exports.Type_415 =
    exports.RawOrigin =
...
exports.NominationPoolsCall =
    ...
    exports.V5AvailabilityBitfield =
    exports.V5UncheckedSigned =
    exports.OutboundHrmpMessage =
    exports.V5CandidateCommitments =
    exports.V5CommittedCandidateReceipt =
    exports.V5ValidityAttestation =
    exports.V5BackedCandidate =
    exports.V5InvalidDisputeStatementKind =
    exports.V5ValidDisputeStatementKind =
    exports.V5DisputeStatement =
    exports.V5DisputeStatementSet =
    exports.DigestItem =
    exports.Digest =
    exports.Header =
    ...
    exports.V5DisputesTimeSlot =
    exports.V5SlashingOffenceKind =
    exports.V5ValidatorIndex =
    exports.V5DisputeProof =
...
exports.AccountId32 =
    ...
    exports.V5PvfExecTimeoutKind =
    exports.V5PvfPrepTimeoutKind =
    exports.V5ExecutorParam =
...
exports.ParaInclusionEvent = support_1.sts.closedEnum(function () {
    return {
        CandidateBacked: support_1.sts.tuple(function () {
            return [exports.V5CandidateReceipt, exports.HeadData, exports.V5CoreIndex, exports.V5GroupIndex]
        }),
        CandidateIncluded: support_1.sts.tuple(function () {
            return [exports.V5CandidateReceipt, exports.HeadData, exports.V5CoreIndex, exports.V5GroupIndex]
        }),
        CandidateTimedOut: support_1.sts.tuple(function () {
            return [exports.V5CandidateReceipt, exports.HeadData, exports.V5CoreIndex]
        }),
...
exports.V5GroupIndex = support_1.sts.number()
exports.V5CoreIndex = support_1.sts.number()
exports.HeadData = support_1.sts.bytes()
exports.V5CandidateReceipt = support_1.sts.struct(function () {
    return {
        descriptor: exports.V5CandidateDescriptor,
        commitmentsHash: exports.H256,
    }
})
exports.V5CandidateDescriptor = support_1.sts.struct(function () {
    return {
        paraId: exports.Id,
        relayParent: exports.H256,
        collator: exports.V5Public,
        persistedValidationDataHash: exports.H256,
        povHash: exports.H256,
        erasureRoot: exports.H256,
        signature: exports.V5Signature,
        paraHead: exports.H256,
        validationCodeHash: exports.ValidationCodeHash,
    }
})
exports.V5Signature = support_1.sts.bytes()
exports.V5Public = support_1.sts.bytes()
/**
 * Events type.
 */
...
exports.Type_648 = support_1.sts.closedEnum(function () {
    return {
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Origins: exports.Type_416,
        ParachainsOrigin: exports.Origin,
        Void: exports.Void,
        XcmPallet: exports.Type_415,
...
exports.Type_416 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_492 = support_1.sts.closedEnum(function () {
    return {
        ...
        V3: support_1.sts.array(function () {
            return exports.Type_499
        }),
    }
})
exports.Type_499 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_496 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
...
exports.ParasSlashingCall = support_1.sts.closedEnum(function () {
    return {
        report_dispute_lost_unsigned: support_1.sts.enumStruct({
            disputeProof: exports.V5DisputeProof,
...
exports.V5DisputeProof = support_1.sts.struct(function () {
    return {
        timeSlot: exports.V5DisputesTimeSlot,
        kind: exports.V5SlashingOffenceKind,
        validatorIndex: exports.V5ValidatorIndex,
        validatorId: support_1.sts.bytes(),
    }
})
exports.V5ValidatorIndex = support_1.sts.number()
exports.V5SlashingOffenceKind = support_1.sts.closedEnum(function () {
    return {
        AgainstValid: support_1.sts.unit(),
        ForInvalid: support_1.sts.unit(),
    }
})
exports.V5DisputesTimeSlot = support_1.sts.struct(function () {
    return {
        sessionIndex: support_1.sts.number(),
...
exports.ParasCall = support_1.sts.closedEnum(function () {
    return {
        ...
        include_pvf_check_statement: support_1.sts.enumStruct({
            stmt: exports.V5PvfCheckStatement,
...
exports.V5PvfCheckStatement = support_1.sts.struct(function () {
    return {
...
exports.ParaInherentCall = support_1.sts.closedEnum(function () {
    return {
        enter: support_1.sts.enumStruct({
            data: exports.V5InherentData,
        }),
    }
})
exports.V5InherentData = support_1.sts.struct(function () {
    return {
        bitfields: support_1.sts.array(function () {
            return exports.V5UncheckedSigned
        }),
        backedCandidates: support_1.sts.array(function () {
            return exports.V5BackedCandidate
        }),
        disputes: support_1.sts.array(function () {
            return exports.V5DisputeStatementSet
        }),
...
exports.V5DisputeStatementSet = support_1.sts.struct(function () {
    return {
        candidateHash: exports.CandidateHash,
        session: support_1.sts.number(),
        statements: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
                return [exports.V5DisputeStatement, exports.V5ValidatorIndex, support_1.sts.bytes()]
            })
        }),
    }
})
exports.V5DisputeStatement = support_1.sts.closedEnum(function () {
    return {
        Invalid: exports.V5InvalidDisputeStatementKind,
        Valid: exports.V5ValidDisputeStatementKind,
    }
})
exports.V5ValidDisputeStatementKind = support_1.sts.closedEnum(function () {
    return {
...
exports.V5InvalidDisputeStatementKind = support_1.sts.closedEnum(function () {
    return {
        Explicit: support_1.sts.unit(),
    }
})
exports.V5BackedCandidate = support_1.sts.struct(function () {
    return {
        candidate: exports.V5CommittedCandidateReceipt,
        validityVotes: support_1.sts.array(function () {
            return exports.V5ValidityAttestation
        }),
        validatorIndices: support_1.sts.bitseq(),
    }
})
exports.V5ValidityAttestation = support_1.sts.closedEnum(function () {
    return {
        Explicit: support_1.sts.bytes(),
        Implicit: support_1.sts.bytes(),
    }
})
exports.V5CommittedCandidateReceipt = support_1.sts.struct(function () {
    return {
        descriptor: exports.V5CandidateDescriptor,
        commitments: exports.V5CandidateCommitments,
    }
})
exports.V5CandidateCommitments = support_1.sts.struct(function () {
    return {
...
exports.V5UncheckedSigned = support_1.sts.struct(function () {
    return {
        payload: exports.V5AvailabilityBitfield,
        validatorIndex: exports.V5ValidatorIndex,
        signature: support_1.sts.bytes(),
    }
})
exports.V5AvailabilityBitfield = support_1.sts.bitseq()
/**
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
...
exports.NominationPoolsCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_configs: support_1.sts.enumStruct({
            minJoinBond: exports.Type_405,
            minCreateBond: exports.Type_405,
            globalMaxCommission: exports.Type_406,
            requiredPayoutCount: exports.Type_406,
        }),
...
exports.Type_527 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
        params: exports.DefaultMintParams,
    }
    ...
    return {
        ...
        set_executor_params: support_1.sts.enumStruct({
            new: support_1.sts.array(function () {
                return exports.V5ExecutorParam
            }),
        }),
...
exports.V5ExecutorParam = support_1.sts.closedEnum(function () {
    return {
        MaxMemoryPages: support_1.sts.number(),
        PrecheckingMaxMemory: support_1.sts.bigint(),
        PvfExecTimeout: support_1.sts.tuple(function () {
            return [exports.V5PvfExecTimeoutKind, support_1.sts.bigint()]
        }),
        PvfPrepTimeout: support_1.sts.tuple(function () {
            return [exports.V5PvfPrepTimeoutKind, support_1.sts.bigint()]
        }),
...
exports.V5PvfPrepTimeoutKind = support_1.sts.closedEnum(function () {
    return {
        Lenient: support_1.sts.unit(),
        Precheck: support_1.sts.unit(),
    }
})
exports.V5PvfExecTimeoutKind = support_1.sts.closedEnum(function () {
    return {
...
exports.BeefyCall = support_1.sts.closedEnum(function () {
    return {
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_571,
            keyOwnerProof: exports.MembershipProof,
        }),
        report_equivocation_unsigned: support_1.sts.enumStruct({
            equivocationProof: exports.Type_571,
...
exports.Type_571 = support_1.sts.struct(function () {
    return {

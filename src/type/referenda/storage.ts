...
export interface ReferendumInfoForEnjinV1062 {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: number): Promise<enjinV1062.ReferendumInfo | undefined>
    getMany(block: Block, keys: number[]): Promise<(enjinV1062.ReferendumInfo | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: enjinV1062.ReferendumInfo | undefined][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: enjinV1062.ReferendumInfo | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: enjinV1062.ReferendumInfo | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export interface ReferendumInfoForEnjinV1070 {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: number): Promise<enjinV1070.ReferendumInfo | undefined>
    getMany(block: Block, keys: number[]): Promise<(enjinV1070.ReferendumInfo | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: enjinV1070.ReferendumInfo | undefined][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: enjinV1070.ReferendumInfo | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: enjinV1070.ReferendumInfo | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export interface ReferendumInfoForV1070 {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: number): Promise<v1070.ReferendumInfo | undefined>
    getMany(block: Block, keys: number[]): Promise<(v1070.ReferendumInfo | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: v1070.ReferendumInfo | undefined][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: v1070.ReferendumInfo | undefined][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: v1070.ReferendumInfo | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
    ): AsyncIterable<[k: number, v: v1070.ReferendumInfo | undefined][]>
}

...
exports.Type_659 = support_1.sts.struct(function () {
    return {
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Council: exports.Type_310,
        CumulusXcm: exports.Type_313,
        PolkadotXcm: exports.Origin,
        TechnicalCommittee: exports.Type_311,
        Void: exports.Void,
...
exports.Type_311 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_313 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_347 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_350
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_354
        }),
    }
})
exports.Type_354 = support_1.sts.closedEnum(function () {
    return {
        AliasOrigin: exports.V3MultiLocation,
        BurnAsset: support_1.sts.array(function () {
            return exports.V3MultiAsset
...
exports.Type_351 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
exports.Type_350 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
            fees: exports.V2MultiAsset,
            weightLimit: exports.V2WeightLimit,

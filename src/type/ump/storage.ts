...
export const relayDispatchQueues = {
    ...
    enjinV100: new StorageType(
        ...
        [enjinV100.Id],
        sts.array(() => sts.bytes())
    ) as RelayDispatchQueuesEnjinV100,
}
...
export interface RelayDispatchQueuesEnjinV100 {
    ...
    getPairsPaged(
        ...
        block: Block,
        key: enjinV100.Id
    ): AsyncIterable<[k: enjinV100.Id, v: Bytes[] | undefined][]>
}
...
export const relayDispatchQueueSize = {
    ...
    ) as RelayDispatchQueueSizeEnjinV100,
}
...
export const nextDispatchRoundStartWith = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        enjinV100.Id
    ) as NextDispatchRoundStartWithEnjinV100,
}
...
export const overweight = {
    ...
    enjinV100: new StorageType(
        ...
        'Optional',
        [sts.bigint()],
        sts.tuple(() => [enjinV100.Id, sts.bytes()])
    ) as OverweightEnjinV100,
}
...
export interface OverweightEnjinV100 {
    ...
    getPairsPaged(
        ...
        block: Block,
        key: bigint
    ): AsyncIterable<[k: bigint, v: [enjinV100.Id, Bytes] | undefined][]>
}
...
export const counterForOverweight = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        sts.number()
    ) as CounterForOverweightEnjinV100,
}

...
export const minimumValidatorCount = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        sts.number()
    ) as MinimumValidatorCountEnjinV100,
}
...
export interface BondedEnjinV100 {
    ...
    ): Promise<[k: enjinV100.AccountId32, v: enjinV100.AccountId32 | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.AccountId32, v: enjinV100.AccountId32 | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.AccountId32
...
export const minimumActiveStake = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        sts.bigint()
    ) as MinimumActiveStakeEnjinV100,
}
...
export interface LedgerEnjinV100 {
    ...
    getPairs(
        block: Block,
        key: enjinV100.AccountId32
    ): Promise<[k: enjinV100.AccountId32, v: enjinV100.StakingLedger | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.AccountId32, v: enjinV100.StakingLedger | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.AccountId32
...
export interface LedgerEnjinV1032 {
    ...
    ): Promise<[k: enjinV1032.AccountId32, v: enjinV1032.StakingLedger | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV1032.AccountId32, v: enjinV1032.StakingLedger | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV1032.AccountId32
...
export interface LedgerV100 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: v100.AccountId32, v: v100.StakingLedger | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
...
export interface LedgerV1030 {
    ...
    ): Promise<[k: v1030.AccountId32, v: v1030.StakingLedger | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: v1030.AccountId32, v: v1030.StakingLedger | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: v1030.AccountId32
...
export interface PayeeEnjinV100 {
    ...
    getPairs(
        block: Block,
        key: enjinV100.AccountId32
    ): Promise<[k: enjinV100.AccountId32, v: enjinV100.RewardDestination | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.AccountId32, v: enjinV100.RewardDestination | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.AccountId32
...
export interface PayeeEnjinV1032 {
    ...
    getPairs(
        block: Block,
        key: enjinV1032.AccountId32
    ): Promise<[k: enjinV1032.AccountId32, v: enjinV1032.RewardDestination | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV1032.AccountId32, v: enjinV1032.RewardDestination | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV1032.AccountId32
...
export interface PayeeV100 {
    ...
    getPairs(
        block: Block,
        key: v100.AccountId32
    ): Promise<[k: v100.AccountId32, v: v100.RewardDestination | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: v100.AccountId32, v: v100.RewardDestination | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: v100.AccountId32
...
export interface PayeeV1030 {
    ...
    getPairs(
        block: Block,
        key: v1030.AccountId32
    ): Promise<[k: v1030.AccountId32, v: v1030.RewardDestination | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: v1030.AccountId32, v: v1030.RewardDestination | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: v1030.AccountId32
...
export interface ValidatorsEnjinV100 {
    ...
    getPairs(
        block: Block,
        key: enjinV100.AccountId32
    ): Promise<[k: enjinV100.AccountId32, v: enjinV100.ValidatorPrefs | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.AccountId32, v: enjinV100.ValidatorPrefs | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.AccountId32
...
export const counterForValidators = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        sts.number()
    ) as CounterForValidatorsEnjinV100,
}
...
export const maxValidatorsCount = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        sts.number()
    ) as MaxValidatorsCountEnjinV100,
}
...
export interface NominatorsEnjinV100 {
    ...
    getPairs(
        block: Block,
        key: enjinV100.AccountId32
    ): Promise<[k: enjinV100.AccountId32, v: enjinV100.Nominations | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.AccountId32, v: enjinV100.Nominations | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.AccountId32
...
export const counterForNominators = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        sts.number()
    ) as CounterForNominatorsEnjinV100,
}
...
export const maxNominatorsCount = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        sts.number()
    ) as MaxNominatorsCountEnjinV100,
}
...
export const erasStartSessionIndex = {
    ...
    enjinV100: new StorageType(
        ...
        [sts.number()],
        sts.number()
    ) as ErasStartSessionIndexEnjinV100,
}
...
export interface ErasStakersEnjinV100 {
    ...
    getPairs(
        block: Block,
        key1: number
    ): Promise<[k: [number, enjinV100.AccountId32], v: enjinV100.Exposure | undefined][]>
    getPairs(
        block: Block,
        key1: number,
        key2: enjinV100.AccountId32
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [number, enjinV100.AccountId32], v: enjinV100.Exposure | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: number
...
export const erasStakersClipped = {
    ...
    enjinV100: new StorageType(
        ...
        [sts.number(), enjinV100.AccountId32],
        enjinV100.Exposure
    ) as ErasStakersClippedEnjinV100,
}
...
export const erasValidatorPrefs = {
    ...
    enjinV100: new StorageType(
        ...
        [sts.number(), enjinV100.AccountId32],
        enjinV100.ValidatorPrefs
    ) as ErasValidatorPrefsEnjinV100,
}
...
export interface ErasValidatorPrefsEnjinV100 {
    ...
    getPairs(
        block: Block,
        key1: number
    ): Promise<[k: [number, enjinV100.AccountId32], v: enjinV100.ValidatorPrefs | undefined][]>
    getPairs(
        block: Block,
        key1: number,
        key2: enjinV100.AccountId32
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [number, enjinV100.AccountId32], v: enjinV100.ValidatorPrefs | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: number
...
export const erasValidatorReward = {
    ...
    enjinV100: new StorageType(
        ...
        [sts.number()],
        sts.bigint()
    ) as ErasValidatorRewardEnjinV100,
}
...
export interface ErasRewardPointsEnjinV100 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: enjinV100.EraRewardPoints | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export const slashRewardFraction = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        enjinV100.Perbill
    ) as SlashRewardFractionEnjinV100,
}
...
export const canceledSlashPayout = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        sts.bigint()
    ) as CanceledSlashPayoutEnjinV100,
}
...
export const unappliedSlashes = {
    ...
    enjinV100: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => enjinV100.UnappliedSlash)
...
export interface UnappliedSlashesEnjinV100 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: enjinV100.UnappliedSlash[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export const validatorSlashInEra = {
    ...
    enjinV100: new StorageType(
        ...
        'Optional',
        [sts.number(), enjinV100.AccountId32],
        sts.tuple(() => [enjinV100.Perbill, sts.bigint()])
    ) as ValidatorSlashInEraEnjinV100,
}
...
export interface ValidatorSlashInEraEnjinV100 {
    ...
    getPairs(
        block: Block,
        key1: number
    ): Promise<[k: [number, enjinV100.AccountId32], v: [enjinV100.Perbill, bigint] | undefined][]>
    getPairs(
        block: Block,
        key1: number,
        key2: enjinV100.AccountId32
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [number, enjinV100.AccountId32], v: [enjinV100.Perbill, bigint] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: number
...
export const nominatorSlashInEra = {
    ...
    enjinV100: new StorageType(
        ...
        [sts.number(), enjinV100.AccountId32],
        sts.bigint()
    ) as NominatorSlashInEraEnjinV100,
}
...
export interface NominatorSlashInEraEnjinV100 {
    ...
    getPairs(
        ...
        key1: number,
        key2: enjinV100.AccountId32
    ): Promise<[k: [number, enjinV100.AccountId32], v: bigint | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [number, enjinV100.AccountId32], v: bigint | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: number
...
export interface SlashingSpansEnjinV100 {
    ...
    getPairs(
        block: Block,
        key: enjinV100.AccountId32
    ): Promise<[k: enjinV100.AccountId32, v: enjinV100.SlashingSpans | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.AccountId32, v: enjinV100.SlashingSpans | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.AccountId32
...
export const spanSlash = {
    ...
    enjinV100: new StorageType(
        'Staking.SpanSlash',
        'Default',
        [sts.tuple(() => [enjinV100.AccountId32, sts.number()])],
        enjinV100.SpanRecord
    ) as SpanSlashEnjinV100,
}
...
export interface SpanSlashEnjinV100 {
    ...
    getKeysPaged(
        pageSize: number,
        block: Block,
        key: [enjinV100.AccountId32, number]
    ...
    getPairs(
        block: Block,
        key: [enjinV100.AccountId32, number]
    ): Promise<[k: [enjinV100.AccountId32, number], v: enjinV100.SpanRecord | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [enjinV100.AccountId32, number], v: enjinV100.SpanRecord | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: [enjinV100.AccountId32, number]
...
export const currentPlannedSession = {
    ...
    enjinV100: new StorageType(
        ...
        [],
        sts.number()
    ) as CurrentPlannedSessionEnjinV100,
}
...
export const offendingValidators = {
    ...
    enjinV100: new StorageType(
        ...
        'Default',
        [],
        sts.array(() => sts.tuple(() => [sts.number(), sts.boolean()]))
    ) as OffendingValidatorsEnjinV100,
}
...
export const erasStakersOverview = {
    ...
    enjinV1032: new StorageType(
        ...
        'Optional',
        [sts.number(), enjinV1032.AccountId32],
        enjinV1032.PagedExposureMetadata
    ) as ErasStakersOverviewEnjinV1032,
}
...
export interface ErasStakersOverviewEnjinV1032 {
    ...
    getMany(
        block: Block,
        keys: [number, enjinV1032.AccountId32][]
    ): Promise<(enjinV1032.PagedExposureMetadata | undefined)[]>
    ...
    ): AsyncIterable<[number, enjinV1032.AccountId32][]>
    getPairs(
        block: Block
    ): Promise<[k: [number, enjinV1032.AccountId32], v: enjinV1032.PagedExposureMetadata | undefined][]>
    getPairs(
        block: Block,
        key1: number
    ): Promise<[k: [number, enjinV1032.AccountId32], v: enjinV1032.PagedExposureMetadata | undefined][]>
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [number, enjinV1032.AccountId32], v: enjinV1032.PagedExposureMetadata | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: number
...
export const erasStakersPaged = {
    ...
    enjinV1032: new StorageType(
        ...
        'Optional',
        [sts.number(), enjinV1032.AccountId32, sts.number()],
        enjinV1032.ExposurePage
    ) as ErasStakersPagedEnjinV1032,
}
...
export interface ErasStakersPagedEnjinV1032 {
    ...
    get(
        ...
        key2: enjinV1032.AccountId32,
        key3: number
    ): Promise<enjinV1032.ExposurePage | undefined>
    getMany(
        block: Block,
        keys: [number, enjinV1032.AccountId32, number][]
    ): Promise<(enjinV1032.ExposurePage | undefined)[]>
    ...
    getKeys(
        ...
        key1: number,
        key2: enjinV1032.AccountId32
    ): Promise<[number, enjinV1032.AccountId32, number][]>
    getKeys(
        block: Block,
        key1: number,
        key2: enjinV1032.AccountId32,
    ...
    getKeysPaged(
        ...
        block: Block,
        key1: number
    ): AsyncIterable<[number, enjinV1032.AccountId32, number][]>
    getKeysPaged(
        pageSize: number,
        block: Block,
        key1: number,
    ...
    getPairs(
        block: Block
    ): Promise<[k: [number, enjinV1032.AccountId32, number], v: enjinV1032.ExposurePage | undefined][]>
    getPairs(
        block: Block,
        key1: number
    ): Promise<[k: [number, enjinV1032.AccountId32, number], v: enjinV1032.ExposurePage | undefined][]>
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [number, enjinV1032.AccountId32, number], v: enjinV1032.ExposurePage | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: number
...
export interface ClaimedRewardsEnjinV1032 {
    ...
    getPairs(
        ...
        key1: number,
        key2: enjinV1032.AccountId32
    ): Promise<[k: [number, enjinV1032.AccountId32], v: number[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [number, enjinV1032.AccountId32], v: number[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: number

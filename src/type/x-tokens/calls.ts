...
export const transfer = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            ...
            destWeightLimit: matrixEnjinV1031.V3WeightLimit,
        })
    ),
    /**
     * Transfer native currencies.
...
export const transferMultiasset = {
    ...
    matrixEnjinV1031: new CallType(
        'XTokens.transfer_multiasset',
        sts.struct({
            asset: matrixEnjinV1031.VersionedAsset,
            dest: matrixEnjinV1031.VersionedLocation,
            destWeightLimit: matrixEnjinV1031.V3WeightLimit,
        })
    ),
...
export const transferMultiassetWithFee = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            asset: matrixEnjinV1031.VersionedAsset,
            fee: matrixEnjinV1031.VersionedAsset,
            dest: matrixEnjinV1031.VersionedLocation,
            destWeightLimit: matrixEnjinV1031.V3WeightLimit,
        })
    ),
...
export const transferMulticurrencies = {
    ...
    matrixEnjinV1031: new CallType(
        'XTokens.transfer_multicurrencies',
        sts.struct({
            currencies: sts.array(() => sts.tuple(() => [matrixEnjinV1031.AssetId, sts.bigint()])),
            feeItem: sts.number(),
            dest: matrixEnjinV1031.VersionedLocation,
            destWeightLimit: matrixEnjinV1031.V3WeightLimit,
        })

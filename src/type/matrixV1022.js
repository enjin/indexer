...
exports.DefaultTokenMutation = support_1.sts.struct(function () {
    return {
        behavior: exports.Type_168,
        listingForbidden: exports.Type_171,
        anyoneCanInfuse: exports.Type_171,
        name: exports.Type_172,
    }
})
exports.Type_172 = support_1.sts.closedEnum(function () {
    return {
...
exports.RuntimeHoldReason = support_1.sts.closedEnum(function () {
    return {
        CollatorStaking: exports.Type_185,
        FuelTanks: exports.Type_187,
        Marketplace: exports.Type_188,
        MultiTokens: exports.Type_186,
        Preimage: exports.HoldReason,
        SafeMode: exports.Type_184,
    }
})
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Council: exports.Type_376,
        CumulusXcm: exports.Type_379,
        PolkadotXcm: exports.Origin,
        TechnicalCommittee: exports.Type_377,
        Void: exports.Void,
...
exports.Type_429 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_432
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_436
        }),
        V4: support_1.sts.array(function () {
            return exports.Type_439
        }),
    }
})
exports.Type_439 = support_1.sts.closedEnum(function () {
    return {
        AliasOrigin: exports.V4Location,
        BurnAsset: support_1.sts.array(function () {
            return exports.V4Asset
...
exports.Type_433 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
exports.Type_436 = support_1.sts.closedEnum(function () {
    return {
        AliasOrigin: exports.V3MultiLocation,
        BurnAsset: support_1.sts.array(function () {
            return exports.V3MultiAsset
...
exports.Type_432 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
            fees: exports.V2MultiAsset,
            weightLimit: exports.V2WeightLimit,
...
exports.Type_480 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
        params: exports.DefaultMintParams,
    }

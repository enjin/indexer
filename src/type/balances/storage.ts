...
export const holds = {
    ...
    matrixEnjinV1031: new StorageType(
        ...
        sts.array(() => matrixEnjinV1031.IdAmount)
    ) as HoldsMatrixEnjinV1031,
    /**
     *  Holds on account balances.
     */
    matrixV602: new StorageType(
    ...
    matrixV1023: new StorageType(
        'Balances.Holds',
        'Default',
        [matrixV1023.AccountId32],
        sts.array(() => matrixV1023.IdAmount)
    ) as HoldsMatrixV1023,
    /**
     *  Holds on account balances.
     */
    matrixV1030: new StorageType(
        ...
        sts.array(() => matrixV1030.IdAmount)
    ) as HoldsMatrixV1030,
    /**
     *  Holds on account balances.
     */
    matrixV1040: new StorageType(
        ...
        sts.array(() => matrixV1040.IdAmount)
    ) as HoldsMatrixV1040,
    /**
     *  Holds on account balances.
     */
 ...
 *  Holds on account balances.
 */
export interface HoldsMatrixEnjinV1031 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): matrixEnjinV1031.IdAmount[]
    get(block: Block, key: matrixEnjinV1031.AccountId32): Promise<matrixEnjinV1031.IdAmount[] | undefined>
    getMany(block: Block, keys: matrixEnjinV1031.AccountId32[]): Promise<(matrixEnjinV1031.IdAmount[] | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: matrixEnjinV1031.AccountId32, v: matrixEnjinV1031.IdAmount[] | undefined][]>
    getPairs(
        block: Block,
        key: matrixEnjinV1031.AccountId32
    ): Promise<[k: matrixEnjinV1031.AccountId32, v: matrixEnjinV1031.IdAmount[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: matrixEnjinV1031.AccountId32, v: matrixEnjinV1031.IdAmount[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: matrixEnjinV1031.AccountId32
 ...
 *  Holds on account balances.
 */
export interface HoldsMatrixV1023 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): matrixV1023.IdAmount[]
    get(block: Block, key: matrixV1023.AccountId32): Promise<matrixV1023.IdAmount[] | undefined>
    getMany(block: Block, keys: matrixV1023.AccountId32[]): Promise<(matrixV1023.IdAmount[] | undefined)[]>
    getKeys(block: Block): Promise<matrixV1023.AccountId32[]>
    getKeys(block: Block, key: matrixV1023.AccountId32): Promise<matrixV1023.AccountId32[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<matrixV1023.AccountId32[]>
    getKeysPaged(pageSize: number, block: Block, key: matrixV1023.AccountId32): AsyncIterable<matrixV1023.AccountId32[]>
    getPairs(block: Block): Promise<[k: matrixV1023.AccountId32, v: matrixV1023.IdAmount[] | undefined][]>
    getPairs(
        block: Block,
        key: matrixV1023.AccountId32
    ): Promise<[k: matrixV1023.AccountId32, v: matrixV1023.IdAmount[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: matrixV1023.AccountId32, v: matrixV1023.IdAmount[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: matrixV1023.AccountId32
 ...
 *  Holds on account balances.
 */
export interface HoldsMatrixV1030 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): matrixV1030.IdAmount[]
    get(block: Block, key: matrixV1030.AccountId32): Promise<matrixV1030.IdAmount[] | undefined>
    getMany(block: Block, keys: matrixV1030.AccountId32[]): Promise<(matrixV1030.IdAmount[] | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: matrixV1030.AccountId32, v: matrixV1030.IdAmount[] | undefined][]>
    getPairs(
        block: Block,
        key: matrixV1030.AccountId32
    ): Promise<[k: matrixV1030.AccountId32, v: matrixV1030.IdAmount[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: matrixV1030.AccountId32, v: matrixV1030.IdAmount[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: matrixV1030.AccountId32
 ...
 *  Holds on account balances.
 */
export interface HoldsMatrixV1040 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): matrixV1040.IdAmount[]
    get(block: Block, key: matrixV1040.AccountId32): Promise<matrixV1040.IdAmount[] | undefined>
    getMany(block: Block, keys: matrixV1040.AccountId32[]): Promise<(matrixV1040.IdAmount[] | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: matrixV1040.AccountId32, v: matrixV1040.IdAmount[] | undefined][]>
    getPairs(
        block: Block,
        key: matrixV1040.AccountId32
    ): Promise<[k: matrixV1040.AccountId32, v: matrixV1040.IdAmount[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: matrixV1040.AccountId32, v: matrixV1040.IdAmount[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: matrixV1040.AccountId32
 ...
 *  Holds on account balances.
 */
export interface HoldsEnjinV1062 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): enjinV1062.IdAmount[]
    get(block: Block, key: enjinV1062.AccountId32): Promise<enjinV1062.IdAmount[] | undefined>
    getMany(block: Block, keys: enjinV1062.AccountId32[]): Promise<(enjinV1062.IdAmount[] | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: enjinV1062.AccountId32, v: enjinV1062.IdAmount[] | undefined][]>
    getPairs(
        block: Block,
        key: enjinV1062.AccountId32
    ): Promise<[k: enjinV1062.AccountId32, v: enjinV1062.IdAmount[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
 ...
 *  Holds on account balances.
 */
export interface HoldsV1060 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): v1060.IdAmount[]
    get(block: Block, key: v1060.AccountId32): Promise<v1060.IdAmount[] | undefined>
    getMany(block: Block, keys: v1060.AccountId32[]): Promise<(v1060.IdAmount[] | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: v1060.AccountId32, v: v1060.IdAmount[] | undefined][]>
    getPairs(block: Block, key: v1060.AccountId32): Promise<[k: v1060.AccountId32, v: v1060.IdAmount[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block

...
exports.Type_828 = support_1.sts.struct(function () {
    return {
...
exports.DefaultTokenMutation = support_1.sts.struct(function () {
    return {
        behavior: exports.Type_191,
        listingForbidden: exports.Type_194,
        metadata: exports.Type_195,
    }
})
...
exports.Type_191 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
...
exports.Type_177 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.DefaultRoyalty
...
exports.Type_569 = support_1.sts.struct(function () {
    return {
...
exports.Type_513 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Origins: exports.Type_402,
        ParachainsOrigin: exports.Origin,
        Void: exports.Void,
        XcmPallet: exports.Type_401,
...
exports.Type_401 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_479 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_482
        }),
        V3: support_1.sts.array(function () {
...
exports.Type_483 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
exports.Type_482 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
            fees: exports.V2MultiAsset,
            weightLimit: exports.V2WeightLimit,
...
exports.StakingCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_staking_configs: support_1.sts.enumStruct({
            ...
            maxNominatorCount: exports.Type_361,
            maxValidatorCount: exports.Type_361,
            chillThreshold: exports.Type_362,
            minCommission: exports.Type_363,
        }),
...
exports.Type_363 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_362 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Percent,
...
exports.Type_361 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
...
exports.NominationPoolsCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_configs: support_1.sts.enumStruct({
            minJoinBond: exports.Type_393,
            minCreateBond: exports.Type_393,
            globalMaxCommission: exports.Type_394,
        }),
        unbond: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
...
exports.Type_394 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Perbill,
...
exports.Type_393 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: support_1.sts.bigint(),
...
exports.GrandpaCall = support_1.sts.closedEnum(function () {
    return {
        ...
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_370,
...
exports.Type_370 = support_1.sts.struct(function () {
    return {
...
exports.Equivocation = support_1.sts.closedEnum(function () {
    return {
        Precommit: exports.Type_377,
        Prevote: exports.Type_372,
    }
})
exports.Type_372 = support_1.sts.struct(function () {
    return {
...
exports.PoolRolesMutation = support_1.sts.struct(function () {
    return {
        newAdmin: exports.Type_78,
        newNominator: exports.Type_78,
    }
})
exports.Type_78 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.AccountId32
...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_249,
...
exports.Type_249 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.UserAccountManagement

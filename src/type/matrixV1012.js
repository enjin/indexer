...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Council: exports.Type_361,
        CumulusXcm: exports.Type_364,
        PolkadotXcm: exports.Origin,
        TechnicalCommittee: exports.Type_362,
        Void: exports.Void,
...
exports.Type_414 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_417
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_421
        }),
        V4: support_1.sts.array(function () {
            return exports.Type_424
        }),
    }
})
...
exports.Type_418 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
...
exports.Type_417 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
            fees: exports.V2MultiAsset,
            weightLimit: exports.V2WeightLimit,
...
exports.Type_463 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
        params: exports.DefaultMintParams,
    }

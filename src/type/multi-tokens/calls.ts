...
export const createCollection = {
    ...
    matrixEnjinV1031: new CallType(
        'MultiTokens.create_collection',
        sts.struct({
            descriptor: matrixEnjinV1031.DefaultCollectionDescriptor,
        })
    ),
    /**
     * Creates a new [`Collection`](ep_multi_tokens::Collection) from `descriptor`
    ...
    matrixV1040: new CallType(
        'MultiTokens.create_collection',
        sts.struct({
            descriptor: matrixV1040.DefaultCollectionDescriptor,
        })
    ),
    /**
     * Creates a new [`Collection`](ep_multi_tokens::Collection) from `descriptor`
    ...
    enjinV1062: new CallType(
        'MultiTokens.create_collection',
        sts.struct({
            descriptor: enjinV1062.DefaultCollectionDescriptor,
        })
    ),
    /**
     * Creates a new [`Collection`](ep_multi_tokens::Collection) from `descriptor`
...
export const mint = {
    ...
    matrixEnjinV1031: new CallType(
        'MultiTokens.mint',
        sts.struct({
            recipient: matrixEnjinV1031.MultiAddress,
            collectionId: sts.bigint(),
            params: matrixEnjinV1031.DefaultMintParams,
        })
    ),
    /**
     * `origin` mints to `recipient` for `collection_id` with `params` using the pallet's
    ...
    matrixV1040: new CallType(
        'MultiTokens.mint',
        sts.struct({
            recipient: matrixV1040.MultiAddress,
            collectionId: sts.bigint(),
            params: matrixV1040.DefaultMintParams,
        })
    ),
    /**
     * `origin` mints to `recipient` for `collection_id` with `params` using the pallet's
    ...
    enjinV1062: new CallType(
        'MultiTokens.mint',
        sts.struct({
            recipient: enjinV1062.MultiAddress,
            collectionId: sts.bigint(),
            params: enjinV1062.DefaultMintParams,
        })
    ),
    /**
     * `origin` mints to `recipient` for `collection_id` with `params` using the pallet's
...
export const transfer = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            recipient: matrixEnjinV1031.MultiAddress,
            collectionId: sts.bigint(),
            params: matrixEnjinV1031.DefaultTransferParams,
        })
    ),
    /**
     * `operator` transfers to `recipient` for `collection_id` with `params`
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            recipient: enjinV1062.MultiAddress,
            collectionId: sts.bigint(),
            params: enjinV1062.DefaultTransferParams,
        })
    ),
    /**
     * `operator` transfers to `recipient` for `collection_id` with `params`
    ...
    v1060: new CallType(
        ...
        sts.struct({
            recipient: v1060.MultiAddress,
            collectionId: sts.bigint(),
            params: v1060.DefaultTransferParams,
        })
    ),
}
...
export const batchTransfer = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            recipients: sts.array(() => matrixEnjinV1031.Recipient),
        })
    ),
    /**
     * Transfers the specific amount of tokens of `collection` to `recipients` from `origin`
    ...
    matrixV1020: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            recipients: sts.array(() => matrixV1020.Recipient),
        })
    ),
    /**
     * Transfers the specific amount of tokens of `collection` to `recipients` from `origin`
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            recipients: sts.array(() => enjinV1062.Recipient),
        })
    ),
    /**
     * Transfers the specific amount of tokens of `collection` to `recipients` from `origin`
    ...
    v1060: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            recipients: sts.array(() => v1060.Recipient),
        })
    ),
}
...
export const batchMint = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            recipients: sts.array(() => matrixEnjinV1031.Type_510),
        })
    ),
    /**
     * Collection owner mints tokens of `collection_id` to `recipients` consisting of an
    ...
    matrixV1020: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            recipients: sts.array(() => matrixV1020.Type_476),
        })
    ),
    /**
     * Collection owner mints tokens of `collection_id` to `recipients` consisting of an
    ...
    matrixV1030: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            recipients: sts.array(() => matrixV1030.Type_522),
        })
    ),
    /**
     * Collection owner mints tokens of `collection_id` to `recipients` consisting of an
    ...
    matrixV1040: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            recipients: sts.array(() => matrixV1040.Type_460),
        })
    ),
    /**
     * Collection owner mints tokens of `collection_id` to `recipients` consisting of an
    ...
    enjinV1050: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            recipients: sts.array(() => enjinV1050.Type_611),
        })
    ),
    /**
     * Collection owner mints tokens of `collection_id` to `recipients` consisting of an
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            recipients: sts.array(() => enjinV1062.Type_619),
        })
    ),
    /**
     * Collection owner mints tokens of `collection_id` to `recipients` consisting of an
...
export const batchSetAttribute = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
            attributes: sts.array(() => matrixEnjinV1031.AttributeKeyValuePair),
        })
    ),
    /**
     * Collection owner sets `attributes` to `collection_id`
    ...
    matrixV1040: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
            attributes: sts.array(() => matrixV1040.AttributeKeyValuePair),
        })
    ),
    /**
     * Collection owner sets `attributes` to `collection_id`
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
            attributes: sts.array(() => enjinV1062.AttributeKeyValuePair),
        })
    ),
    /**
     * Collection owner sets `attributes` to `collection_id`
...
export const forceTransfer = {
    ...
    matrixEnjinV1031: new CallType(
        'MultiTokens.force_transfer',
        sts.struct({
            source: matrixEnjinV1031.MultiAddress,
            destination: matrixEnjinV1031.MultiAddress,
            collectionId: sts.bigint(),
            params: matrixEnjinV1031.DefaultTransferParams,
        })
    ),
    ...
    enjinV1062: new CallType(
        'MultiTokens.force_transfer',
        sts.struct({
            source: enjinV1062.MultiAddress,
            destination: enjinV1062.MultiAddress,
            collectionId: sts.bigint(),
            params: enjinV1062.DefaultTransferParams,
        })
    ),
    ...
    v1060: new CallType(
        'MultiTokens.force_transfer',
        sts.struct({
            source: v1060.MultiAddress,
            destination: v1060.MultiAddress,
            collectionId: sts.bigint(),
            params: v1060.DefaultTransferParams,
        })
    ),
...
export const forceSetCollection = {
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            value: sts.option(() => enjinV1062.Collection),
        })
    ),
    /**
     * Set the Collections storage to the given `value`, origin must be root
...
export const forceSetToken = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            value: sts.option(() => matrixEnjinV1031.Token),
        })
    ),
    /**
     * Set the Tokens storage to the given `value`, origin must be root
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            value: sts.option(() => enjinV1062.Token),
        })
    ),
    /**
     * Set the Tokens storage to the given `value`, origin must be root
...
export const forceSetAttribute = {
    ...
    matrixV1040: new CallType(
        ...
        sts.struct({
            ...
            tokenId: sts.option(() => sts.bigint()),
            key: sts.bytes(),
            value: sts.option(() => matrixV1040.Attribute),
        })
    ),
    /**
     * Set the Tokens storage to the given `value`, origin must be root
...
export const forceSetTokenAccount = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            accountId: matrixEnjinV1031.MultiAddress,
            value: sts.option(() => matrixEnjinV1031.TokenAccount),
        })
    ),
    /**
     * Set the TokenAccounts storage to the given `value`, origin must be root
    ...
    matrixV1040: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            accountId: matrixV1040.MultiAddress,
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            accountId: enjinV1062.MultiAddress,
            value: sts.option(() => enjinV1062.TokenAccount),
        })
    ),
    /**
     * Set the TokenAccounts storage to the given `value`, origin must be root
    ...
    v1070: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            accountId: v1070.MultiAddress,
            value: sts.option(() => v1070.TokenAccount),
        })
    ),
}
...
export const forceCreateCollection = {
    ...
    matrixEnjinV1031: new CallType(
        'MultiTokens.force_create_collection',
        sts.struct({
            owner: matrixEnjinV1031.AccountId32,
            collectionId: sts.bigint(),
            descriptor: matrixEnjinV1031.DefaultCollectionDescriptor,
            depositor: sts.option(() => matrixEnjinV1031.AccountId32),
        })
    ),
    /**
     * Creates a new collection from `descriptor` at `collection_id`, origin must be root
    ...
    matrixV1040: new CallType(
        'MultiTokens.force_create_collection',
        sts.struct({
            owner: matrixV1040.AccountId32,
            collectionId: sts.bigint(),
            descriptor: matrixV1040.DefaultCollectionDescriptor,
            depositor: sts.option(() => matrixV1040.AccountId32),
        })
    ),
    /**
     * Creates a new collection from `descriptor` at `collection_id`, origin must be root
    ...
    enjinV1062: new CallType(
        'MultiTokens.force_create_collection',
        sts.struct({
            owner: enjinV1062.AccountId32,
            collectionId: sts.bigint(),
            descriptor: enjinV1062.DefaultCollectionDescriptor,
            depositor: sts.option(() => enjinV1062.AccountId32),
        })
    ),
    /**
     * Creates a new collection from `descriptor` at `collection_id`, origin must be root
...
export const forceMint = {
    ...
    matrixEnjinV1031: new CallType(
        'MultiTokens.force_mint',
        sts.struct({
            caller: sts.option(() => matrixEnjinV1031.MultiAddress),
            recipient: matrixEnjinV1031.MultiAddress,
            collectionId: sts.bigint(),
            params: matrixEnjinV1031.FlexibleMintParams,
            depositor: sts.option(() => matrixEnjinV1031.MultiAddress),
        })
    ),
    /**
     * Same as [`mint`](Self::mint), but it is callable by
    ...
    matrixV1020: new CallType(
        'MultiTokens.force_mint',
        sts.struct({
            caller: sts.option(() => matrixV1020.MultiAddress),
            recipient: matrixV1020.MultiAddress,
            collectionId: sts.bigint(),
    ...
    matrixV1040: new CallType(
        'MultiTokens.force_mint',
        sts.struct({
            caller: sts.option(() => matrixV1040.MultiAddress),
            recipient: matrixV1040.MultiAddress,
            collectionId: sts.bigint(),
            params: matrixV1040.FlexibleMintParams,
            depositor: sts.option(() => matrixV1040.MultiAddress),
        })
    ),
    /**
     * Same as [`mint`](Self::mint), but it is callable by
    ...
    enjinV1050: new CallType(
        'MultiTokens.force_mint',
        sts.struct({
            caller: sts.option(() => enjinV1050.MultiAddress),
            recipient: enjinV1050.MultiAddress,
            collectionId: sts.bigint(),
    ...
    enjinV1062: new CallType(
        'MultiTokens.force_mint',
        sts.struct({
            caller: sts.option(() => enjinV1062.MultiAddress),
            recipient: enjinV1062.MultiAddress,
            collectionId: sts.bigint(),
            params: enjinV1062.FlexibleMintParams,
            depositor: sts.option(() => enjinV1062.MultiAddress),
        })
    ),
    /**
     * Same as [`mint`](Self::mint), but it is callable by
    ...
    v1060: new CallType(
        'MultiTokens.force_mint',
        sts.struct({
            caller: sts.option(() => v1060.MultiAddress),
            recipient: v1060.MultiAddress,
            collectionId: sts.bigint(),
            params: v1060.FlexibleMintParams,
...
export const batchInfuse = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            infusions: sts.array(() => matrixEnjinV1031.BatchInfusion),
        })
    ),
}

export const cleanupExpiredEphemeral = {
    name: 'MultiTokens.cleanup_expired_ephemeral',
    /**
     ...
     */
    matrixV1040: new CallType(
        'MultiTokens.cleanup_expired_ephemeral',
        sts.struct({
            maxItems: sts.number(),
        })
    ),
...
export const retryFailedEphemeralCleanup = {
    name: 'MultiTokens.retry_failed_ephemeral_cleanup',
    /**
     ...
     */
    matrixV1040: new CallType(
        'MultiTokens.retry_failed_ephemeral_cleanup',
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            maxUnits: sts.number(),
...
export const upgradeAttributes = {
    name: 'MultiTokens.upgrade_attributes',
    /**
     ...
     */
    matrixV1040: new CallType(
        'MultiTokens.upgrade_attributes',
        sts.struct({
...
export const lend = {
    ...
    matrixV1040: new CallType(
        ...
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            borrower: matrixV1040.MultiAddress,
...
export const processExpiredLoans = {
    name: 'MultiTokens.process_expired_loans',
    /**
     ...
     */
    matrixV1040: new CallType(
        'MultiTokens.process_expired_loans',
        sts.struct({
            maxItems: sts.number(),
        })
    ),
...
export const retryFailedLoanReturn = {
    name: 'MultiTokens.retry_failed_loan_return',
    /**
     ...
     */
    matrixV1040: new CallType(
        'MultiTokens.retry_failed_loan_return',
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
        })
...
export const cleanupOrphanedAttributes = {
    name: 'MultiTokens.cleanup_orphaned_attributes',
    /**
     ...
     */
    matrixV1040: new CallType(
        'MultiTokens.cleanup_orphaned_attributes',
        sts.struct({
            maxUnits: sts.number(),
        })
    ),
...
export const setMintRateLimit = {
    name: 'MultiTokens.set_mint_rate_limit',
    /**
     ...
     */
    matrixV1040: new CallType(
        'MultiTokens.set_mint_rate_limit',
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
...
export const cancelMintRateLimitChange = {
    name: 'MultiTokens.cancel_mint_rate_limit_change',
    /**
     ...
     */
    matrixV1040: new CallType(
        'MultiTokens.cancel_mint_rate_limit_change',
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
        })
...
export const forceSetMintRateLimit = {
    name: 'MultiTokens.force_set_mint_rate_limit',
    /**
     ...
     */
    matrixV1040: new CallType(
        'MultiTokens.force_set_mint_rate_limit',
        sts.struct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
            limit: sts.option(() => matrixV1040.MintRateLimit),

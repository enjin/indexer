...
export const leases = {
    ...
    enjinV100: new StorageType(
        ...
        'Default',
        [enjinV100.Id],
        sts.array(() => sts.option(() => sts.tuple(() => [enjinV100.AccountId32, sts.bigint()])))
    ) as LeasesEnjinV100,
}
...
export interface LeasesEnjinV100 {
    ...
    getMany(
        block: Block,
        keys: enjinV100.Id[]
    ): Promise<(([enjinV100.AccountId32, bigint] | undefined)[] | undefined)[]>
    ...
    getPairs(
        block: Block,
        key: enjinV100.Id
    ): Promise<[k: enjinV100.Id, v: ([enjinV100.AccountId32, bigint] | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.Id, v: ([enjinV100.AccountId32, bigint] | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.Id

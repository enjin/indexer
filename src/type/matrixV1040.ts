...
export type Type_934 =
    Type_934_Approved | Type_934_Cancelled | Type_934_Killed | Type_934_Ongoing | Type_934_Rejected | Type_934_TimedOut

export interface Type_934_Approved {
    __kind: 'Approved'
    value: [number, Type_911 | undefined, Type_911 | undefined]
}

export interface Type_934_Cancelled {
    __kind: 'Cancelled'
    value: [number, Type_911 | undefined, Type_911 | undefined]
}

export interface Type_934_Killed {
    __kind: 'Killed'
    value: number
}

export interface Type_934_Ongoing {
    __kind: 'Ongoing'
    value: Type_935
}

export interface Type_934_Rejected {
    __kind: 'Rejected'
    value: [number, Type_911 | undefined, Type_911 | undefined]
}

export interface Type_934_TimedOut {
    __kind: 'TimedOut'
    value: [number, Type_911 | undefined, Type_911 | undefined]
}

export interface Type_935 {
    track: number
    origin: OriginCaller
    proposal: Bounded
    enactment: DispatchTime
    submitted: number
    submissionDeposit: Type_911
    decisionDeposit?: Type_911 | undefined
...
export type Type_379 =
    ...
    | Type_379_Emergency
    | Type_379_Fellows
    | Type_379_Fellowship1Dan
    | Type_379_Fellowship2Dan
    | Type_379_Fellowship3Dan
    | Type_379_Fellowship4Dan
    | Type_379_Fellowship5Dan
    | Type_379_Fellowship6Dan
    | Type_379_Fellowship7Dan
    | Type_379_Fellowship8Dan
    | Type_379_Fellowship9Dan
    | Type_379_FellowshipAdmin
    | Type_379_FellowshipExperts
    | Type_379_FellowshipInitiates
    | Type_379_FellowshipMasters
    | Type_379_FuelTanksAdmin
    | Type_379_GeneralAdmin
    | Type_379_MediumSpender
    | Type_379_MultiTokensAdmin
    | Type_379_ReferendumCanceller
    | Type_379_ReferendumKiller
    | Type_379_SmallSpender
    | Type_379_SmallTipper
    | Type_379_StakingAdmin
    | Type_379_TreasuryAdmin
    | Type_379_WhitelistedCaller

export interface Type_379_BigSpender {
    __kind: 'BigSpender'
}

export interface Type_379_BigTipper {
    __kind: 'BigTipper'
}

export interface Type_379_Emergency {
    __kind: 'Emergency'
}

export interface Type_379_Fellows {
    __kind: 'Fellows'
}

export interface Type_379_Fellowship1Dan {
    __kind: 'Fellowship1Dan'
}

export interface Type_379_Fellowship2Dan {
    __kind: 'Fellowship2Dan'
}

export interface Type_379_Fellowship3Dan {
    __kind: 'Fellowship3Dan'
}

export interface Type_379_Fellowship4Dan {
    __kind: 'Fellowship4Dan'
}

export interface Type_379_Fellowship5Dan {
    __kind: 'Fellowship5Dan'
}

export interface Type_379_Fellowship6Dan {
    __kind: 'Fellowship6Dan'
}

export interface Type_379_Fellowship7Dan {
    __kind: 'Fellowship7Dan'
}

export interface Type_379_Fellowship8Dan {
    __kind: 'Fellowship8Dan'
}

export interface Type_379_Fellowship9Dan {
    __kind: 'Fellowship9Dan'
}

export interface Type_379_FellowshipAdmin {
    __kind: 'FellowshipAdmin'
}

export interface Type_379_FellowshipExperts {
    __kind: 'FellowshipExperts'
}

export interface Type_379_FellowshipInitiates {
    __kind: 'FellowshipInitiates'
}

export interface Type_379_FellowshipMasters {
    __kind: 'FellowshipMasters'
}

export interface Type_379_FuelTanksAdmin {
    __kind: 'FuelTanksAdmin'
}

export interface Type_379_GeneralAdmin {
    __kind: 'GeneralAdmin'
}

export interface Type_379_MediumSpender {
    __kind: 'MediumSpender'
}

export interface Type_379_MultiTokensAdmin {
    __kind: 'MultiTokensAdmin'
}

export interface Type_379_ReferendumCanceller {
    __kind: 'ReferendumCanceller'
}

export interface Type_379_ReferendumKiller {
    __kind: 'ReferendumKiller'
}

export interface Type_379_SmallSpender {
    __kind: 'SmallSpender'
}

export interface Type_379_SmallTipper {
    __kind: 'SmallTipper'
}

export interface Type_379_StakingAdmin {
    __kind: 'StakingAdmin'
}

export interface Type_379_TreasuryAdmin {
    __kind: 'TreasuryAdmin'
}

export interface Type_379_WhitelistedCaller {
    __kind: 'WhitelistedCaller'
}

export type Type_378 = Type_378_FuelTank

export interface Type_378_FuelTank {
    __kind: 'FuelTank'
    caller: AccountId32
    tankId: AccountId32
...
export interface Type_911 {
    who: AccountId32
    amount: bigint
}

export const Type_934: sts.Type<Type_934> = sts.closedEnum(() => {
    return {
        Approved: sts.tuple(() => [sts.number(), sts.option(() => Type_911), sts.option(() => Type_911)]),
        Cancelled: sts.tuple(() => [sts.number(), sts.option(() => Type_911), sts.option(() => Type_911)]),
        Killed: sts.number(),
        Ongoing: Type_935,
        Rejected: sts.tuple(() => [sts.number(), sts.option(() => Type_911), sts.option(() => Type_911)]),
        TimedOut: sts.tuple(() => [sts.number(), sts.option(() => Type_911), sts.option(() => Type_911)]),
    }
})

export const Type_935: sts.Type<Type_935> = sts.struct(() => {
    return {
        track: sts.number(),
        origin: OriginCaller,
        proposal: Bounded,
        ...
        submissionDeposit: Type_911,
        decisionDeposit: sts.option(() => Type_911),
...
export const Type_911: sts.Type<Type_911> = sts.struct(() => {
    return {
        who: AccountId32,
        amount: sts.bigint(),
    }
...
export interface Token {
    ...
    mintRateLimit?: MintRateLimitState | undefined
}

export interface MintRateLimitState {
    limit: MintRateLimit
    window: MintRateWindow
    pending?: PendingMintRateLimitChange | undefined
}

export interface PendingMintRateLimitChange {
    newLimit?: MintRateLimit | undefined
    effectiveBlock: number
}

export interface MintRateWindow {
    lastSlot: number
    buckets: bigint[]
}
...
export type Type_47 = Type_47_Keys

export interface Type_47_Keys {
    __kind: 'Keys'
}

export type Type_52 = Type_52_EnterOrExtend

export interface Type_52_EnterOrExtend {
...
export type Type_48 = Type_48_AuthorizeAlias

export interface Type_48_AuthorizeAlias {
    __kind: 'AuthorizeAlias'
}

export type Type_49 = Type_49_MultiTokens

export interface Type_49_MultiTokens {
    __kind: 'MultiTokens'
}

export type Type_50 = Type_50_Marketplace

export interface Type_50_Marketplace {
    __kind: 'Marketplace'
}

export type Type_51 = Type_51_FuelTanks

export interface Type_51_FuelTanks {
    __kind: 'FuelTanks'
}

export type Type_46 = Type_46_CollatorStaking

export interface Type_46_CollatorStaking {
    __kind: 'CollatorStaking'
}
...
export const OutboundChannelDetails: sts.Type<OutboundChannelDetails> = sts.struct(() => {
    return {
        recipient: Id,
        state: OutboundState,
        signalsExist: sts.boolean(),
        firstIndex: sts.number(),
        lastIndex: sts.number(),
        flags: sts.number(),
        queuedBytes: sts.number(),
    }
})

export const OutboundState: sts.Type<OutboundState> = sts.closedEnum(() => {
    return {
        Ok: sts.unit(),
        Suspended: sts.unit(),
    }
...
export const Round: sts.Type<Round> = sts.struct(() => {
    return {
        number: sts.number(),
        startingBlock: sts.number(),
        collators: sts.array(() => Collator),
    }
})
...
export const Nomination: sts.Type<Nomination> = sts.struct(() => {
    return {
        account: AccountId32,
        collator: AccountId32,
        amount: sts.bigint(),
...
export const Collator: sts.Type<Collator> = sts.struct(() => {
    return {
        ...
        nominators: sts.array(() => AccountId32),
    }
})

export interface NoDrop {
    amount: bigint
}

export const NoDrop: sts.Type<NoDrop> = sts.struct(() => {
    return {
        amount: sts.bigint(),
    }
})
...
export interface InboundMessageId {
    sentAt: number
    reverseIdx: number
}

export const InboundMessageId: sts.Type<InboundMessageId> = sts.struct(() => {
    return {
        sentAt: sts.number(),
        reverseIdx: sts.number(),
    }
})
 ...
 */
export type PoolsEvent = PoolsEvent_FeeDistributionFailed | PoolsEvent_PoolsMutated
 ...
 */
export interface PoolsEvent_FeeDistributionFailed {
    __kind: 'FeeDistributionFailed'
    pool: AccountId32
    amount: bigint
    error: DispatchError
}
...
export type MultiTokensEvent =
    ...
    | MultiTokensEvent_AttributeUpgraded
    ...
    | MultiTokensEvent_EphemeralCleanupFailed
    | MultiTokensEvent_EphemeralTokenDestroyed
    | MultiTokensEvent_Frozen
    | MultiTokensEvent_Infused
    | MultiTokensEvent_LoanExtended
    | MultiTokensEvent_LoanReturnFailed
    | MultiTokensEvent_Locked
    | MultiTokensEvent_MigrationStep
    | MultiTokensEvent_MintRateLimitChangeCancelled
    | MultiTokensEvent_MintRateLimitChangeScheduled
    | MultiTokensEvent_MintRateLimitUpdated
    ...
    | MultiTokensEvent_TokenLent
    | MultiTokensEvent_TokenMutated
    | MultiTokensEvent_TokenReturned
 ...
 */
export interface MultiTokensEvent_AttributeUpgraded {
    __kind: 'AttributeUpgraded'
    /**
 ...
 */
export interface MultiTokensEvent_EphemeralCleanupFailed {
    __kind: 'EphemeralCleanupFailed'
    /**
 ...
 */
export interface MultiTokensEvent_EphemeralTokenDestroyed {
    __kind: 'EphemeralTokenDestroyed'
    /**
     * id of the collection
     */
    collectionId: bigint
 ...
 */
export interface MultiTokensEvent_LoanExtended {
    __kind: 'LoanExtended'
    /**
     * id of the collection
     */
 ...
 */
export interface MultiTokensEvent_LoanReturnFailed {
    __kind: 'LoanReturnFailed'
    /**
     * id of the collection
     */
    collectionId: bigint
 ...
 */
export interface MultiTokensEvent_MintRateLimitChangeCancelled {
    __kind: 'MintRateLimitChangeCancelled'
    /**
 ...
 */
export interface MultiTokensEvent_MintRateLimitChangeScheduled {
    __kind: 'MintRateLimitChangeScheduled'
    /**
 ...
 */
export interface MultiTokensEvent_MintRateLimitUpdated {
    __kind: 'MintRateLimitUpdated'
    /**
 ...
 */
export interface MultiTokensEvent_TokenLent {
    __kind: 'TokenLent'
    /**
     * id of the collection
     */
 ...
 */
export interface MultiTokensEvent_TokenReturned {
    __kind: 'TokenReturned'
    /**
     * id of the collection
     */
    collectionId: bigint
...
/**
 * A token was upgraded to the latest storage encoding
 */
...
export interface DefaultTokenMutation {
    behavior: Type_177
    listingForbidden: Type_180
    isLendable: Type_180
    anyoneCanInfuse: Type_180
    name: Type_181
}

export type Type_181 = Type_181_NoMutation | Type_181_SomeMutation

export interface Type_181_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_181_SomeMutation {
    __kind: 'SomeMutation'
    value: BoundedString
}

export type Type_180 = Type_180_NoMutation | Type_180_SomeMutation

export interface Type_180_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_180_SomeMutation {
    __kind: 'SomeMutation'
    value: boolean
}

export type Type_177 = Type_177_NoMutation | Type_177_SomeMutation

export interface Type_177_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_177_SomeMutation {
    __kind: 'SomeMutation'
...
export interface FreezeType_Attribute {
    __kind: 'Attribute'
    tokenId?: bigint | undefined
    key: Bytes
}
...
export interface FreezeType_TokenGroupAttribute {
 ...
 * The `Event` enum of this pallet
 */
export type MatrixXcmEvent = MatrixXcmEvent_MinimumWeightUpdated
...
export type MarketplaceEvent =
    | MarketplaceEvent_AbandonedListingReleased
    ...
    | MarketplaceEvent_ListingNotIndexed
    | MarketplaceEvent_ListingRemovedUnderMinimum
    | MarketplaceEvent_ListingSettlementAbandoned
    | MarketplaceEvent_ListingUpgraded
    | MarketplaceEvent_MigrationCompleted
    | MarketplaceEvent_MigrationStep
    | MarketplaceEvent_OrderMatched
 ...
 */
export interface MarketplaceEvent_AbandonedListingReleased {
    __kind: 'AbandonedListingReleased'
    /**
     * Id for the listing
     */
    listingId: H256
 ...
 */
export interface MarketplaceEvent_ListingNotIndexed {
    __kind: 'ListingNotIndexed'
    /**
     * Id for the listing
     */
    listingId: H256
 ...
 */
export interface MarketplaceEvent_ListingSettlementAbandoned {
    __kind: 'ListingSettlementAbandoned'
    /**
     * Id for the listing
     */
    listingId: H256
 ...
 * available again
 */
export interface MarketplaceEvent_MigrationCompleted {
    __kind: 'MigrationCompleted'
    /**
 ...
 */
export interface MarketplaceEvent_OrderMatched {
    __kind: 'OrderMatched'
    /**
     ...
     */
    remainderListingId?: H256 | undefined
    /**
...
export interface DefaultTankMutation {
    userAccountManagement: Type_289
    coveragePolicy?: CoveragePolicy | undefined
    accountRules?: AccountRuleDescriptor[] | undefined
    owner?: AccountId32 | undefined
    accountExpiration: Type_303
    name?: Bytes | undefined
}

export type Type_303 = Type_303_NoMutation | Type_303_SomeMutation

export interface Type_303_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_303_SomeMutation {
    __kind: 'SomeMutation'
...
export type Type_289 = Type_289_NoMutation | Type_289_SomeMutation

export interface Type_289_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_289_SomeMutation {
    __kind: 'SomeMutation'
...
export interface ConvictionVotingEvent_Delegated {
    __kind: 'Delegated'
    value: [AccountId32, AccountId32, number]
}
...
export type CollatorStakingEvent =
    | CollatorStakingEvent_CandidateExitFailed
 ...
 */
export interface CollatorStakingEvent_CandidateExitFailed {
    __kind: 'CandidateExitFailed'
    /**
...
export type ClaimsEvent =
    ...
    | ClaimsEvent_ClaimRequestSkippedAtBound
    | ClaimsEvent_ClaimRequestSkippedZeroAmount
 ...
 */
export interface ClaimsEvent_ClaimRequestSkippedAtBound {
    __kind: 'ClaimRequestSkippedAtBound'
    /**
 ...
 * at all.
 */
export interface ClaimsEvent_ClaimRequestSkippedZeroAmount {
    __kind: 'ClaimRequestSkippedZeroAmount'
    /**
...
export const PoolsEvent: sts.Type<PoolsEvent> = sts.closedEnum(() => {
    return {
        FeeDistributionFailed: sts.enumStruct({
            pool: AccountId32,
            amount: sts.bigint(),
            error: DispatchError,
        }),
...
export const MultiTokensEvent: sts.Type<MultiTokensEvent> = sts.closedEnum(() => {
    return {
        ...
        AttributeUpgraded: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
            key: sts.bytes(),
        ...
        EphemeralCleanupFailed: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            expiration: sts.number(),
            error: DispatchError,
        }),
        EphemeralTokenDestroyed: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            expiration: sts.number(),
        }),
        ...
        LoanExtended: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            oldExpiration: sts.number(),
            newExpiration: sts.number(),
        }),
        LoanReturnFailed: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            expiration: sts.number(),
            error: DispatchError,
        ...
        MintRateLimitChangeCancelled: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
        }),
        MintRateLimitChangeScheduled: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
            newLimit: sts.option(() => MintRateLimit),
            effectiveBlock: sts.number(),
        }),
        MintRateLimitUpdated: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
            limit: sts.option(() => MintRateLimit),
        }),
...
export const MarketplaceEvent: sts.Type<MarketplaceEvent> = sts.closedEnum(() => {
    return {
        AbandonedListingReleased: sts.enumStruct({
            listingId: H256,
            returnedBid: sts.option(() => Bid),
        }),
        ...
        ListingNotIndexed: sts.enumStruct({
            listingId: H256,
        }),
        ListingRemovedUnderMinimum: sts.enumStruct({
            listingId: H256,
        }),
        ListingSettlementAbandoned: sts.enumStruct({
            listingId: H256,
            attempts: sts.number(),
        }),
        ...
        OrderMatched: sts.enumStruct({
            ...
            remainderListingId: sts.option(() => H256),
...
export const ConvictionVotingEvent: sts.Type<ConvictionVotingEvent> = sts.closedEnum(() => {
    return {
        Delegated: sts.tuple(() => [AccountId32, AccountId32, sts.number()]),
        Undelegated: sts.tuple(() => [AccountId32, sts.number()]),
...
export const CollatorStakingEvent: sts.Type<CollatorStakingEvent> = sts.closedEnum(() => {
    return {
        CandidateExitFailed: sts.enumStruct({
            accountId: AccountId32,
            error: DispatchError,
        }),
...
export const ClaimsEvent: sts.Type<ClaimsEvent> = sts.closedEnum(() => {
    return {
        ...
        ClaimRequestSkippedAtBound: sts.enumStruct({
            who: H160,
        ...
        ClaimRequestSkippedZeroAmount: sts.enumStruct({
            who: H160,
            amountBurned: sts.bigint(),
            transactionHash: H256,
            isEfiToken: sts.boolean(),
...
/**
 * Mutate the pools. Requires [`Config::ForceOrigin`], which runtimes may set wider than
 * root.
 *
 ...
 * # Errors
 *
 * - [`Error::InvalidFeeShares`] if the fee shares do not add up to exactly 100%
 * - [`Error::ZeroFeeShare`] if any pool is given a zero share
 */
...
export type Type_422 = Type_422_V3 | Type_422_V4 | Type_422_V5

export interface Type_422_V3 {
    __kind: 'V3'
    value: Type_425[]
}

export interface Type_422_V4 {
    __kind: 'V4'
    value: Type_429[]
}

export interface Type_422_V5 {
    __kind: 'V5'
    value: Type_432[]
}

export type Type_432 =
    | Type_432_AliasOrigin
    | Type_432_BurnAsset
    | Type_432_BuyExecution
    | Type_432_ClaimAsset
    | Type_432_ClearError
    | Type_432_ClearOrigin
    | Type_432_ClearTopic
    | Type_432_ClearTransactStatus
    | Type_432_DepositAsset
    | Type_432_DepositReserveAsset
    | Type_432_DescendOrigin
    | Type_432_ExchangeAsset
    | Type_432_ExecuteWithOrigin
    | Type_432_ExpectAsset
    | Type_432_ExpectError
    | Type_432_ExpectOrigin
    | Type_432_ExpectPallet
    | Type_432_ExpectTransactStatus
    | Type_432_ExportMessage
    | Type_432_HrmpChannelAccepted
    | Type_432_HrmpChannelClosing
    | Type_432_HrmpNewChannelOpenRequest
    | Type_432_InitiateReserveWithdraw
    | Type_432_InitiateTeleport
    | Type_432_InitiateTransfer
    | Type_432_LockAsset
    | Type_432_NoteUnlockable
    | Type_432_PayFees
    | Type_432_QueryPallet
    | Type_432_QueryResponse
    | Type_432_ReceiveTeleportedAsset
    | Type_432_RefundSurplus
    | Type_432_ReportError
    | Type_432_ReportHolding
    | Type_432_ReportTransactStatus
    | Type_432_RequestUnlock
    | Type_432_ReserveAssetDeposited
    | Type_432_SetAppendix
    | Type_432_SetErrorHandler
    | Type_432_SetFeesMode
    | Type_432_SetHints
    | Type_432_SetTopic
    | Type_432_SubscribeVersion
    | Type_432_Transact
    | Type_432_TransferAsset
    | Type_432_TransferReserveAsset
    | Type_432_Trap
    | Type_432_UniversalOrigin
    | Type_432_UnlockAsset
    | Type_432_UnpaidExecution
    | Type_432_UnsubscribeVersion
    | Type_432_WithdrawAsset
...
export interface Type_432_ExecuteWithOrigin {
    __kind: 'ExecuteWithOrigin'
    descendantOrigin?: V5Junctions | undefined
    xcm: Type_432[]
}
...
export interface Type_432_InitiateTransfer {
    __kind: 'InitiateTransfer'
    destination: V5Location
    remoteFees?: V5AssetTransferFilter | undefined
    preserveOrigin: boolean
...
export interface Type_432_PayFees {
    __kind: 'PayFees'
    asset: V5Asset
}
...
export interface Type_432_SetHints {
    __kind: 'SetHints'
    hints: V5Hint[]
}
...
export type Type_429 =
    | Type_429_AliasOrigin
    | Type_429_BurnAsset
    | Type_429_BuyExecution
    | Type_429_ClaimAsset
    | Type_429_ClearError
    | Type_429_ClearOrigin
    | Type_429_ClearTopic
    | Type_429_ClearTransactStatus
    | Type_429_DepositAsset
    | Type_429_DepositReserveAsset
    | Type_429_DescendOrigin
    | Type_429_ExchangeAsset
    | Type_429_ExpectAsset
    | Type_429_ExpectError
    | Type_429_ExpectOrigin
    | Type_429_ExpectPallet
    | Type_429_ExpectTransactStatus
    | Type_429_ExportMessage
    | Type_429_HrmpChannelAccepted
    | Type_429_HrmpChannelClosing
    | Type_429_HrmpNewChannelOpenRequest
    | Type_429_InitiateReserveWithdraw
    | Type_429_InitiateTeleport
    | Type_429_LockAsset
    | Type_429_NoteUnlockable
    | Type_429_QueryPallet
    | Type_429_QueryResponse
    | Type_429_ReceiveTeleportedAsset
    | Type_429_RefundSurplus
    | Type_429_ReportError
    | Type_429_ReportHolding
    | Type_429_ReportTransactStatus
    | Type_429_RequestUnlock
    | Type_429_ReserveAssetDeposited
    | Type_429_SetAppendix
    | Type_429_SetErrorHandler
    | Type_429_SetFeesMode
    | Type_429_SetTopic
    | Type_429_SubscribeVersion
    | Type_429_Transact
    | Type_429_TransferAsset
    | Type_429_TransferReserveAsset
    | Type_429_Trap
    | Type_429_UniversalOrigin
    | Type_429_UnlockAsset
    | Type_429_UnpaidExecution
    | Type_429_UnsubscribeVersion
    | Type_429_WithdrawAsset

export interface Type_429_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V4Location
}

export interface Type_429_BurnAsset {
    __kind: 'BurnAsset'
    value: V4Asset[]
}
...
export interface Type_429_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V4Asset[]
    ticket: V4Location
}

export interface Type_429_ClearError {
    __kind: 'ClearError'
}

export interface Type_429_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_429_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_429_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_429_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V4Junctions
}
...
export interface Type_429_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V4Asset[]
}

export interface Type_429_ExpectError {
    __kind: 'ExpectError'
    value?: [number, V3Error] | undefined
}

export interface Type_429_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: V4Location | undefined
}

export interface Type_429_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_429_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_429_ExportMessage {
    __kind: 'ExportMessage'
    network: V4NetworkId
    destination: V4Junctions
    xcm: V4Instruction[]
...
export interface Type_429_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_429_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_429_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_429_LockAsset {
    __kind: 'LockAsset'
    asset: V4Asset
    unlocker: V4Location
}

export interface Type_429_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V4Asset
    owner: V4Location
}

export interface Type_429_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V4QueryResponseInfo
}

export interface Type_429_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V4Response
    maxWeight: Weight
...
export interface Type_429_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V4Asset[]
}

export interface Type_429_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_429_ReportError {
    __kind: 'ReportError'
    value: V4QueryResponseInfo
}

export interface Type_429_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V4QueryResponseInfo
    assets: V4AssetFilter
}

export interface Type_429_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V4QueryResponseInfo
}

export interface Type_429_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V4Asset
    locker: V4Location
}

export interface Type_429_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V4Asset[]
}

export interface Type_429_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_429[]
}

export interface Type_429_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_429[]
}

export interface Type_429_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_429_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_429_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_429_Transact {
    __kind: 'Transact'
    originKind: V3OriginKind
    requireWeightAtMost: Weight
    call: Type_426
...
export interface Type_429_TransferAsset {
    __kind: 'TransferAsset'
    assets: V4Asset[]
    beneficiary: V4Location
}

export interface Type_429_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V4Asset[]
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_429_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_429_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V4Junction
}

export interface Type_429_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V4Asset
    target: V4Location
}

export interface Type_429_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: V4Location | undefined
}

export interface Type_429_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_429_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V4Asset[]
}

export type Type_425 =
    | Type_425_AliasOrigin
    | Type_425_BurnAsset
    | Type_425_BuyExecution
    | Type_425_ClaimAsset
    | Type_425_ClearError
    | Type_425_ClearOrigin
    | Type_425_ClearTopic
    | Type_425_ClearTransactStatus
    | Type_425_DepositAsset
    | Type_425_DepositReserveAsset
    | Type_425_DescendOrigin
    | Type_425_ExchangeAsset
    | Type_425_ExpectAsset
    | Type_425_ExpectError
    | Type_425_ExpectOrigin
    | Type_425_ExpectPallet
    | Type_425_ExpectTransactStatus
    | Type_425_ExportMessage
    | Type_425_HrmpChannelAccepted
    | Type_425_HrmpChannelClosing
    | Type_425_HrmpNewChannelOpenRequest
    | Type_425_InitiateReserveWithdraw
    | Type_425_InitiateTeleport
    | Type_425_LockAsset
    | Type_425_NoteUnlockable
    | Type_425_QueryPallet
    | Type_425_QueryResponse
    | Type_425_ReceiveTeleportedAsset
    | Type_425_RefundSurplus
    | Type_425_ReportError
    | Type_425_ReportHolding
    | Type_425_ReportTransactStatus
    | Type_425_RequestUnlock
    | Type_425_ReserveAssetDeposited
    | Type_425_SetAppendix
    | Type_425_SetErrorHandler
    | Type_425_SetFeesMode
    | Type_425_SetTopic
    | Type_425_SubscribeVersion
    | Type_425_Transact
    | Type_425_TransferAsset
    | Type_425_TransferReserveAsset
    | Type_425_Trap
    | Type_425_UniversalOrigin
    | Type_425_UnlockAsset
    | Type_425_UnpaidExecution
    | Type_425_UnsubscribeVersion
    | Type_425_WithdrawAsset

export interface Type_425_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_425_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_425_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_425_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_425_ClearError {
    __kind: 'ClearError'
}

export interface Type_425_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_425_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_425_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_425_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_425_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_425_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_425_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_425_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_425_ExpectError {
    __kind: 'ExpectError'
    value?: [number, V3Error] | undefined
}

export interface Type_425_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: V3MultiLocation | undefined
}

export interface Type_425_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_425_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_425_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_425_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_425_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_425_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_425_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_425_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_425_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_425_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_425_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_425_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_425_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_425_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_425_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_425_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_425[]
}

export interface Type_425_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_425[]
}

export interface Type_425_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_425_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_425_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}
...
export interface Type_425_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_425_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_425_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_425_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: V3MultiLocation | undefined
}

export interface Type_425_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export interface InboundMessagesData {
    downwardMessages: AbridgedInboundMessagesCollection
    horizontalMessages: Type_357
}

export interface Type_357 {
    fullMessages: [Id, InboundHrmpMessage][]
    hashedMessages: [Id, HashedMessage][]
}
...
export interface AbridgedInboundMessagesCollection {
    fullMessages: InboundDownwardMessage[]
    hashedMessages: HashedMessage[]
}
...
export interface BasicParachainInherentData {
    validationData: V9PersistedValidationData
...
export interface V9PersistedValidationData {
    parentHead: HeadData
...
export type MultiTokensCall =
    ...
    | MultiTokensCall_cancel_mint_rate_limit_change
    | MultiTokensCall_claim_collections
    | MultiTokensCall_claim_tokens
    | MultiTokensCall_cleanup_expired_ephemeral
    | MultiTokensCall_cleanup_orphaned_attributes
    ...
    | MultiTokensCall_force_set_mint_rate_limit
    ...
    | MultiTokensCall_retry_failed_ephemeral_cleanup
    | MultiTokensCall_retry_failed_loan_return
    | MultiTokensCall_set_attribute
    | MultiTokensCall_set_mint_rate_limit
    ...
    | MultiTokensCall_upgrade_attributes
    | MultiTokensCall_upgrade_tokens
 ...
 * - [`Error::LiquidityRestrictions`] if the amount would draw on a locked balance. Note
 *   that a *frozen* balance is deliberately still burnable; only locks block a burn.
 ...
 *   still in a group
 *
 * Remaining attributes (e.g. frozen ones) do not block token-storage removal: they
 * are orphaned and swept later by `on_idle` (see [`PendingAttributeCleanups`]). The
 * token id cannot be re-created until the sweep completes.
 */
...
/**
 * Cancel a pending mint rate limit change scheduled with
 * [`set_mint_rate_limit`](Self::set_mint_rate_limit) before it takes effect.
 * Cancellation is a tightening action and applies immediately. Only callable by the
 * collection owner.
 *
 * # Errors
 *
 * - [`Error::CollectionNotFound`] if `collection_id` does not exist
 * - [`Error::TokenNotFound`] if `token_id` is `Some` and the token does not exist
 * - [`Error::NoPermission`] if `origin` is not the owner of the collection
 * - [`Error::NoPendingMintRateLimitChange`] if there is no pending change, including when
 *   the change has already taken effect
 */
export interface MultiTokensCall_cancel_mint_rate_limit_change {
    __kind: 'cancel_mint_rate_limit_change'
    collectionId: bigint
    tokenId?: bigint | undefined
}
...
/**
 * Permissionless fallback that performs up to `max_items` units of expired
 * ephemeral-token cleanup (one unit per token destroyed, attribute removed, or
 * schedule bucket visited).
 *
 * Acts as a manual nudge when `on_idle` cleanup is not keeping up with the schedule.
 * Anyone may call it; the fee is waived (`Pays::No`) when at least one token was
 * destroyed, and unused weight is refunded.
 *
 * # Errors
 * This extrinsic does not produce errors for an empty schedule or zero work
 * performed; it simply returns `Ok(())`.
 */
export interface MultiTokensCall_cleanup_expired_ephemeral {
    __kind: 'cleanup_expired_ephemeral'
    maxItems: number
}

/**
 * Permissionless fallback that performs up to `max_units` units of orphaned-attribute
 * removal (one unit per attribute removed or drained queue entry; see
 * [`PendingAttributeCleanups`] and [`PendingGroupAttributeCleanups`]).
 *
 * Acts as a manual nudge when `on_idle` sweeping is not keeping up — for example to
 * unblock the re-creation of a destroyed token id
 * ([`Error::PendingAttributeCleanup`]). Anyone may call it; the fee is waived
 * (`Pays::No`) whenever the call made progress — removed an attribute or drained a
 * queue entry (which is what unblocks re-creation) — and unused weight is refunded.
 *
 * # Errors
 * This extrinsic does not produce errors for empty queues or zero work performed;
 * it simply returns `Ok(())`.
 */
export interface MultiTokensCall_cleanup_orphaned_attributes {
    __kind: 'cleanup_orphaned_attributes'
    maxUnits: number
}
 ...
 *
 * Remaining collection attributes (e.g. frozen ones) do not block destruction: they
 * are orphaned and swept later by `on_idle` (see [`PendingAttributeCleanups`]). The
 * collection id cannot be reused until the sweep completes.
 */
 ...
 *
 * Remaining group attributes (e.g. frozen ones) do not block destruction: they are
 * orphaned and swept later by `on_idle` (see [`PendingGroupAttributeCleanups`]).
 */
...
/**
 * Extend the expiration of an active loan to a strictly later block. Only the
 * lender may extend, and only before the current expiration has been reached.
 *
 * # Errors
 * - [`Error::TokenNotFound`] if the token does not exist
 * - [`Error::LoanNotFound`] if the token is not lent
 * - [`Error::NoPermission`] if the caller is not the lender
 * - [`Error::LoanExpired`] if the loan has already reached its expiration block
 * - [`Error::LoanExpirationNotLater`] if `new_expiration` is not strictly later
 * - [`Error::LoanScheduleFull`] if too many loans already come due on `new_expiration`
 */
export interface MultiTokensCall_extend_loan {
    __kind: 'extend_loan'
    collectionId: bigint
    tokenId: bigint
    newExpiration: number
 ...
 * [`Config::EthereumMigrationOrigin`]. Executes the burn by `caller`.
 *
 * Unlike [`burn`](Self::burn), this ignores balance locks on `caller`'s token account and
 * destroys the lock along with the account — see the crate-private `do_burn_forced`.
 */
...
/**
 * Same as [`set_mint_rate_limit`](Self::set_mint_rate_limit), but only callable by
 * [`Config::ForceOrigin`] and every change — including loosening and removal — takes
 * effect immediately. Serves as the governance escape hatch, e.g. to tighten a limit
 * or clear a malicious pending loosening on a collection with a compromised owner key.
 *
 * # Errors
 *
 * - [`Error::CollectionNotFound`] if `collection_id` does not exist
 * - [`Error::TokenNotFound`] if `token_id` is `Some` and the token does not exist
 * - [`Error::InvalidMintRateLimit`] if `limit` has a zero `period` or `max`
 * - [`Error::MintRateLimitNotFound`] if removing while no limit is set
 */
export interface MultiTokensCall_force_set_mint_rate_limit {
    __kind: 'force_set_mint_rate_limit'
    collectionId: bigint
    tokenId?: bigint | undefined
    limit?: MintRateLimit | undefined
}
...
/**
 * Lend a token to `borrower` until `expiration`, at which block it is automatically
 * returned to the caller. The token moves to the borrower through the standard
 * transfer path; the caller funds the borrower's token account deposit.
 *
 * While lent, the token cannot be listed or burned and can only be transferred back
 * to the lender — a return supersedes freeze and transferability restrictions. The
 * borrower may return early by transferring the token back; the lender may extend
 * the loan via [`Self::extend_loan`] but cannot claw it back early.
 *
 * Only single-supply NFTs (cap == `Supply(1)` or `CollapsingSupply(1)`) with
 * lending enabled may be lent. Ephemeral tokens may be lent, but destruction
 * supersedes return: once the ephemeral expiration is reached the token is
 * destroyed, not returned.
 *
 * # Errors
 * - [`Error::LoanExpirationInPast`] if `expiration` is not in the future
 * - [`Error::TokenNotFound`] if the token does not exist
 * - [`Error::TokenNotLendable`] if lending is disabled for the token
 * - [`Error::TokenAlreadyLent`] if the token is already lent
 * - [`Error::LendingRequiresSingleSupply`] if the token is not a single-supply NFT
 * - [`Error::LoanScheduleFull`] if too many loans already come due on `expiration`
 * - any error from the transfer itself (e.g. [`Error::Frozen`], [`Error::BalanceLow`],
 *   [`Error::CannotTransferToSelf`])
 */
export interface MultiTokensCall_lend {
    __kind: 'lend'
    collectionId: bigint
    tokenId: bigint
    borrower: MultiAddress
    expiration: number
}
...
/**
 * Permissionless fallback that performs up to `max_items` units of expired-loan
 * processing (one unit per token returned or schedule bucket visited).
 *
 * Acts as a manual nudge when `on_idle` processing is not keeping up with the
 * schedule. Anyone may call it; the fee is waived (`Pays::No`) when at least one
 * token was returned, and unused weight is refunded.
 *
 * # Errors
 * This extrinsic does not produce errors for an empty schedule or zero work
 * performed; it simply returns `Ok(())`.
 */
export interface MultiTokensCall_process_expired_loans {
    __kind: 'process_expired_loans'
    maxItems: number
}

/**
 * Removes all attributes from the given `collection_id` or `token_id`. Frozen
 * attributes are skipped: they can never be removed.
 *
 * # Errors
...
/**
 * Permissionless retry for an ephemeral token whose automatic destruction failed and
 * was parked in [`FailedEphemeralCleanups`]. `max_units` caps the weight charged up
 * front (see [`Self::cleanup_expired_ephemeral`] for the unit definition); a retry
 * consumes one unit.
 *
 * The fee is waived (`Pays::No`) when the token is fully destroyed.
 *
 * # Errors
 * - [`Error::NoFailedEphemeralCleanup`] if the token is not parked
 * - any error from the destruction attempt itself (state is rolled back and the token
 *   remains parked)
 */
export interface MultiTokensCall_retry_failed_ephemeral_cleanup {
    __kind: 'retry_failed_ephemeral_cleanup'
    collectionId: bigint
    tokenId: bigint
    maxUnits: number
}
...
/**
 * Permissionless retry for a lent token whose automatic return failed and was
 * parked in [`FailedLoanReturns`]. The fee is waived (`Pays::No`) on success.
 *
 * # Errors
 * - [`Error::NoFailedLoanReturn`] if the token is not parked
 * - any error from the return attempt itself (state is rolled back and the token remains
 *   parked)
 */
export interface MultiTokensCall_retry_failed_loan_return {
    __kind: 'retry_failed_loan_return'
    collectionId: bigint
    tokenId: bigint
}
...
/**
 * Set, change, or remove the mint rate limit of a collection (`token_id` = `None`) or
 * a single token. Only callable by the collection owner.
 *
 * Adding a limit or tightening it (a lower `max` and a period that is not shorter)
 * takes effect immediately. Any other change — loosening, mixed changes, and removal
 * (`limit` = `None`) — is scheduled to take effect after
 * [`Config::MintRateLimitLooseningDelay`] blocks and can be cancelled until then with
 * [`cancel_mint_rate_limit_change`](Self::cancel_mint_rate_limit_change). A new
 * request overwrites a pending one and restarts the delay.
 *
 * # Errors
 *
 * - [`Error::CollectionNotFound`] if `collection_id` does not exist
 ...
 * - [`Error::MintRateLimitNotFound`] if removing while no limit is set
 */
export interface MultiTokensCall_set_mint_rate_limit {
    __kind: 'set_mint_rate_limit'
    collectionId: bigint
    tokenId?: bigint | undefined
    limit?: MintRateLimit | undefined
}
...
/**
 * Upgrade a list of attributes in storage to the latest encoding (storage version 6).
 *
 * Pre-v6 attribute values are upgraded lazily whenever they are mutated; this
 * extrinsic rewrites them proactively so off-chain consumers that decode raw storage
 * see the current encoding. Permissionless; a no-op for keys that are missing or
 * already upgraded.
 */
export interface MultiTokensCall_upgrade_attributes {
    __kind: 'upgrade_attributes'
    attributeKeys: [bigint, bigint | undefined, Bytes][]
}

/**
 * Upgrade a list of tokens in storage to the latest encoding (storage version 6).
 *
 * Pre-v6 token values are upgraded lazily whenever they are mutated; this extrinsic
 * rewrites them proactively so off-chain consumers that decode raw storage see the
 * current encoding. Permissionless; a no-op for keys that are missing or already
 * upgraded.
 */
export interface MultiTokensCall_upgrade_tokens {
    __kind: 'upgrade_tokens'
    tokenKeys: [bigint, bigint][]
}
...
/**
 * Used by governance/sudo in order to set the minimum weight for an `XcmOperation`.
 * Primarily used for chains like Statemint when transferring multiple assets as a way to
 * determine the correct fee for the fee-payment asset. Emits the `MinimumWeightUpdated`
 * event.
 */
 ...
 * requires specifying the [Account](ep_core::Account) format in addition to other
...
export type MarketplaceCall =
    ...
    | MarketplaceCall_create_listing_and_match
 ...
 * - [`Error::TooManyPriceLevels`], [`Error::TooManyOrdersAtPrice`], or
 *   [`Error::TooManyPendingActivations`] if the listing does not fit in the matching book
 */
 ...
 */
export interface MarketplaceCall_create_listing_and_match {
    __kind: 'create_listing_and_match'
    descriptor: ListingDescriptor
 ...
 */
export interface MarketplaceCall_migrate {
    __kind: 'migrate'
    weightLimit: Weight
}
 ...
 *
 * Expired offers are normally removed automatically by the `on_idle` expiration sweep;
 * this call is the manual backstop.
 */
 ...
 */
export interface MarketplaceCall_resolve_abandoned_listing {
    __kind: 'resolve_abandoned_listing'
    listingId: H256
}
 ...
 * - [`Error::DuplicateInvulnerable`] if the same account appears more than once
 * - [`Error::InvulnerableIsCandidate`] if an account is already a staking candidate
 */
 ...
 *
 * Weight scales with the number of matured claim entries for `ethereum_address` that carry
 * a burn transaction hash: each one costs `process_claim` a `TransactionHashLookup`
 * removal on the legacy zero-amount path. That count is bounded by the length of the
 * address's `Claims` vector, i.e. by `MaxBatchAccounts`, and it cannot be known before
 * dispatch without reading storage from the weight annotation — which
 * `get_dispatch_info` must not do. So the worst case is declared up front and the unused
 * portion is refunded below — on every exit, including the failing ones.
 *
 * Total Complexity: O(N) in the number of matured hashes removed
 * </weight>
 */
...
export const CreateTokenParams: sts.Type<CreateTokenParams> = sts.struct(() => {
    return {
        ...
        ephemeralExpiration: sts.option(() => sts.number()),
        isLendable: sts.boolean(),
        mintRateLimit: sts.option(() => MintRateLimit),
    }
})
...
export const Type_378: sts.Type<Type_378> = sts.closedEnum(() => {
    return {
        FuelTank: sts.enumStruct({
            ...
            ruleSetId: sts.option(() => sts.number()),
            billedDeposit: sts.bigint(),
        }),
    }
})

export const Type_377: sts.Type<Type_377> = sts.closedEnum(() => {
    return {
        Relay: sts.unit(),
        SiblingParachain: Id,
    }
...
export const Type_422: sts.Type<Type_422> = sts.closedEnum(() => {
    return {
        V3: sts.array(() => Type_425),
        V4: sts.array(() => Type_429),
        V5: sts.array(() => Type_432),
    }
})
...
export const Type_429: sts.Type<Type_429> = sts.closedEnum(() => {
    return {
        ...
        ReserveAssetDeposited: sts.array(() => V4Asset),
        SetAppendix: sts.array(() => Type_429),
        SetErrorHandler: sts.array(() => Type_429),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_425: sts.Type<Type_425> = sts.closedEnum(() => {
    return {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_425),
        SetErrorHandler: sts.array(() => Type_425),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const MultiTokensCall: sts.Type<MultiTokensCall> = sts.closedEnum(() => {
    return {
        ...
        cancel_mint_rate_limit_change: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
        }),
        ...
        cleanup_expired_ephemeral: sts.enumStruct({
            maxItems: sts.number(),
        }),
        cleanup_orphaned_attributes: sts.enumStruct({
            maxUnits: sts.number(),
        }),
        ...
        force_set_mint_rate_limit: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
            limit: sts.option(() => MintRateLimit),
        }),
        ...
        process_expired_loans: sts.enumStruct({
            maxItems: sts.number(),
        }),
        ...
        retry_failed_ephemeral_cleanup: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
            maxUnits: sts.number(),
        }),
        retry_failed_loan_return: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.bigint(),
        }),
        ...
        set_mint_rate_limit: sts.enumStruct({
            collectionId: sts.bigint(),
            tokenId: sts.option(() => sts.bigint()),
            limit: sts.option(() => MintRateLimit),
        }),
        ...
        upgrade_attributes: sts.enumStruct({
            attributeKeys: sts.array(() =>
                sts.tuple(() => [sts.bigint(), sts.option(() => sts.bigint()), sts.bytes()])
            ),
        }),
        upgrade_tokens: sts.enumStruct({
...
export const MarketplaceCall: sts.Type<MarketplaceCall> = sts.closedEnum(() => {
    return {
        ...
        create_listing_and_match: sts.enumStruct({
            descriptor: ListingDescriptor,
        ...
        resolve_abandoned_listing: sts.enumStruct({
            listingId: H256,
        }),
...
export const InboundMessagesData: sts.Type<InboundMessagesData> = sts.struct(() => {
    return {
        downwardMessages: AbridgedInboundMessagesCollection,
        horizontalMessages: Type_357,
    }
...
export const Type_357: sts.Type<Type_357> = sts.struct(() => {
    return {
        fullMessages: sts.array(() => sts.tuple(() => [Id, InboundHrmpMessage])),
        hashedMessages: sts.array(() => sts.tuple(() => [Id, HashedMessage])),
    }
})

export const HashedMessage: sts.Type<HashedMessage> = sts.struct(() => {
    return {
        sentAt: sts.number(),
        msgHash: H256,
    }
...
export const AbridgedInboundMessagesCollection: sts.Type<AbridgedInboundMessagesCollection> = sts.struct(() => {
    return {
        fullMessages: sts.array(() => InboundDownwardMessage),
        hashedMessages: sts.array(() => HashedMessage),
    }
})
...
export const BasicParachainInherentData: sts.Type<BasicParachainInherentData> = sts.struct(() => {
    return {
        validationData: V9PersistedValidationData,
        relayChainState: StorageProof,
...
export const V9PersistedValidationData: sts.Type<V9PersistedValidationData> = sts.struct(() => {
    return {
        parentHead: HeadData,
...
export const MintRateLimit: sts.Type<MintRateLimit> = sts.struct(() => {
    return {
        period: sts.number(),
        max: sts.bigint(),
    }
...
export const Token: sts.Type<Token> = sts.struct(() => {
    return {
        ...
        ephemeralExpiration: sts.option(() => sts.number()),
        isLendable: sts.boolean(),
        lending: sts.option(() => LendingInfo),
        mintRateLimit: sts.option(() => MintRateLimitState),
    }
})

export const MintRateLimitState: sts.Type<MintRateLimitState> = sts.struct(() => {
    return {
        limit: MintRateLimit,
        window: MintRateWindow,
        pending: sts.option(() => PendingMintRateLimitChange),
    }
})

export const PendingMintRateLimitChange: sts.Type<PendingMintRateLimitChange> = sts.struct(() => {
    return {
        newLimit: sts.option(() => MintRateLimit),
        effectiveBlock: sts.number(),
    }
...
export const MintRateWindow: sts.Type<MintRateWindow> = sts.struct(() => {
    return {
        lastSlot: sts.number(),
        buckets: sts.array(() => sts.bigint()),
    }
})

export const LendingInfo: sts.Type<LendingInfo> = sts.struct(() => {
    return {
        lender: AccountId32,
        expiration: sts.number(),
    }
...
export const FreezeType: sts.Type<FreezeType> = sts.closedEnum(() => {
    return {
        ...
        TokenGroupAttribute: sts.enumStruct({
            tokenGroupId: sts.bigint(),
            key: sts.bytes(),
        }),
    }
...
export const Type_180: sts.Type<Type_180> = sts.closedEnum(() => {
    return {
        NoMutation: sts.unit(),
...
export const Type_177: sts.Type<Type_177> = sts.closedEnum(() => {
    return {
        NoMutation: sts.unit(),
...
export const Type_47: sts.Type<Type_47> = sts.closedEnum(() => {
    return {
        Keys: sts.unit(),
    }
})
...
export const Type_48: sts.Type<Type_48> = sts.closedEnum(() => {
    return {
...
export const Type_50: sts.Type<Type_50> = sts.closedEnum(() => {
    return {
        Marketplace: sts.unit(),
    }
})

export const Type_51: sts.Type<Type_51> = sts.closedEnum(() => {
    return {
        FuelTanks: sts.unit(),
    }
})

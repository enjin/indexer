...
export const voteCurrencies = {
    ...
    enjinV120: new StorageType(
        ...
        'Optional',
        [enjinV120.AccountId32, sts.number()],
        enjinV120.VoteCurrency
    ) as VoteCurrenciesEnjinV120,
}
...
export interface VoteCurrenciesEnjinV120 {
    ...
    getKeysPaged(
        pageSize: number,
        block: Block,
        key1: enjinV120.AccountId32
    ): AsyncIterable<[enjinV120.AccountId32, number][]>
    getKeysPaged(
        pageSize: number,
        block: Block,
        key1: enjinV120.AccountId32,
    ...
    getPairs(
        block: Block,
        key1: enjinV120.AccountId32
    ): Promise<[k: [enjinV120.AccountId32, number], v: enjinV120.VoteCurrency | undefined][]>
    getPairs(
        block: Block,
        key1: enjinV120.AccountId32,
        key2: number
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [enjinV120.AccountId32, number], v: enjinV120.VoteCurrency | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: enjinV120.AccountId32
...
export interface VotesToUnlockEnjinV120 {
    ...
    getPairs(
        block: Block,
        key1: enjinV120.AccountId32
    ): Promise<[k: [enjinV120.AccountId32, number], v: enjinV120.BalanceToUnlock | undefined][]>
    getPairs(
        block: Block,
        key1: enjinV120.AccountId32,
        key2: number
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [enjinV120.AccountId32, number], v: enjinV120.BalanceToUnlock | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: enjinV120.AccountId32

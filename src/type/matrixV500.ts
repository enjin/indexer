...
export type Type_345 =
    | Type_345_AliasOrigin
    | Type_345_BurnAsset
    | Type_345_BuyExecution
    | Type_345_ClaimAsset
    | Type_345_ClearError
    | Type_345_ClearOrigin
    | Type_345_ClearTopic
    | Type_345_ClearTransactStatus
    | Type_345_DepositAsset
    | Type_345_DepositReserveAsset
    | Type_345_DescendOrigin
    | Type_345_ExchangeAsset
    | Type_345_ExpectAsset
    | Type_345_ExpectError
    | Type_345_ExpectOrigin
    | Type_345_ExpectPallet
    | Type_345_ExpectTransactStatus
    | Type_345_ExportMessage
    | Type_345_HrmpChannelAccepted
    | Type_345_HrmpChannelClosing
    | Type_345_HrmpNewChannelOpenRequest
    | Type_345_InitiateReserveWithdraw
    | Type_345_InitiateTeleport
    | Type_345_LockAsset
    | Type_345_NoteUnlockable
    | Type_345_QueryPallet
    | Type_345_QueryResponse
    | Type_345_ReceiveTeleportedAsset
    | Type_345_RefundSurplus
    | Type_345_ReportError
    | Type_345_ReportHolding
    | Type_345_ReportTransactStatus
    | Type_345_RequestUnlock
    | Type_345_ReserveAssetDeposited
    | Type_345_SetAppendix
    | Type_345_SetErrorHandler
    | Type_345_SetFeesMode
    | Type_345_SetTopic
    | Type_345_SubscribeVersion
    | Type_345_Transact
    | Type_345_TransferAsset
    | Type_345_TransferReserveAsset
    | Type_345_Trap
    | Type_345_UniversalOrigin
    | Type_345_UnlockAsset
    | Type_345_UnpaidExecution
...
export type Type_341 =
    | Type_341_BuyExecution
    | Type_341_ClaimAsset
    | Type_341_ClearError
    | Type_341_ClearOrigin
    | Type_341_DepositAsset
    | Type_341_DepositReserveAsset
    | Type_341_DescendOrigin
    | Type_341_ExchangeAsset
    ...
    | Type_341_InitiateTeleport
    | Type_341_QueryHolding
    | Type_341_QueryResponse
    | Type_341_ReceiveTeleportedAsset
    | Type_341_RefundSurplus
    | Type_341_ReportError
    | Type_341_ReserveAssetDeposited
    | Type_341_SetAppendix
    | Type_341_SetErrorHandler
    | Type_341_SubscribeVersion
    | Type_341_Transact
    | Type_341_TransferAsset
    | Type_341_TransferReserveAsset
    | Type_341_Trap
    | Type_341_UnsubscribeVersion
    | Type_341_WithdrawAsset
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type EfinityXcmCall =
    | EfinityXcmCall_force_set_minimum_weight
    | EfinityXcmCall_transfer_asset_to_parachain
    | EfinityXcmCall_transfer_asset_with_fee
    | EfinityXcmCall_transfer_to_parachain
...
export type ClaimsCall =
    | ClaimsCall_approve_claims
    | ClaimsCall_claim
    | ClaimsCall_claim_from_efinity
    | ClaimsCall_mint_claim
    | ClaimsCall_mint_enj_from_native_efi
 ...
 */
export type EfinityUtilityEvent =
    EfinityUtilityEvent_BatchDispatched | EfinityUtilityEvent_BatchFailed | EfinityUtilityEvent_BatchPartiallyDispatched

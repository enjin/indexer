...
exports.EraPayout = support_1.sts.struct(function () {
    return {
        era: support_1.sts.number(),
        payoutCount: support_1.sts.number(),
        payoutsProcessed: support_1.sts.boolean(),
    }
})
...
exports.DefaultTokenMutation = support_1.sts.struct(function () {
    return {
        behavior: exports.Type_193,
        listingForbidden: exports.Type_196,
        metadata: exports.Type_197,
    }
})
...
exports.Type_193 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
...
exports.Type_180 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.DefaultRoyalty
...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_256,
...
exports.Type_256 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
...
exports.Type_641 = support_1.sts.struct(function () {
    return {
...
exports.Type_644 = support_1.sts.closedEnum(function () {
    return {
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Origins: exports.Type_419,
        ParachainsOrigin: exports.Origin,
        Void: exports.Void,
        XcmPallet: exports.Type_418,
...
exports.Type_418 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_419 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_495 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_498
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_502
        }),
    }
})
exports.Type_502 = support_1.sts.closedEnum(function () {
    return {
        AliasOrigin: exports.V3MultiLocation,
        BurnAsset: support_1.sts.array(function () {
            return exports.V3MultiAsset
...
exports.Type_499 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
exports.Type_498 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
            fees: exports.V2MultiAsset,
            weightLimit: exports.V2WeightLimit,
...
exports.StakingCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_staking_configs: support_1.sts.enumStruct({
            ...
            maxNominatorCount: exports.Type_378,
            maxValidatorCount: exports.Type_378,
            chillThreshold: exports.Type_379,
            minCommission: exports.Type_380,
        }),
...
exports.Type_380 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_379 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Percent,
...
exports.Type_378 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
...
exports.NominationPoolsCall = support_1.sts.closedEnum(function () {
    return {
        ...
        queue_early_bird_bonus: support_1.sts.enumStruct({
            poolCount: support_1.sts.number(),
        }),
        set_configs: support_1.sts.enumStruct({
            minJoinBond: exports.Type_409,
            minCreateBond: exports.Type_409,
            globalMaxCommission: exports.Type_410,
        }),
...
exports.Type_410 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Perbill,
...
exports.Type_409 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: support_1.sts.bigint(),
...
exports.Type_530 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
        params: exports.DefaultMintParams,
    }
...
exports.GrandpaCall = support_1.sts.closedEnum(function () {
    return {
        ...
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_387,
            keyOwnerProof: exports.MembershipProof,
        }),
...
exports.Equivocation = support_1.sts.closedEnum(function () {
    return {
        Precommit: exports.Type_394,
        Prevote: exports.Type_389,
    }
})
exports.Type_389 = support_1.sts.struct(function () {
    return {
...
exports.Type_394 = support_1.sts.struct(function () {
    return {
        roundNumber: support_1.sts.bigint(),
        identity: exports.Public,
        first: support_1.sts.tuple(function () {
...
exports.BeefyCall = support_1.sts.closedEnum(function () {
    return {
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_570,
            keyOwnerProof: exports.MembershipProof,
        }),
        report_equivocation_unsigned: support_1.sts.enumStruct({
            equivocationProof: exports.Type_570,
...
exports.Type_570 = support_1.sts.struct(function () {
    return {

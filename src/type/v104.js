...
exports.DefaultTokenMutation = support_1.sts.struct(function () {
    return {
        behavior: exports.Type_195,
        listingForbidden: exports.Type_198,
        metadata: exports.Type_199,
    }
})
...
exports.Type_195 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
...
exports.Type_182 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.DefaultRoyalty
...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_253,
...
exports.Type_253 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
...
exports.ClaimsEvent = support_1.sts.closedEnum(function () {
    return {
        ...
        ClaimedEarlyBirdReward: support_1.sts.enumStruct({
            who: exports.AccountId32,
            amount: support_1.sts.bigint(),
        }),
...
exports.Type_374 = support_1.sts.struct(function () {
    return {
...
exports.Equivocation = support_1.sts.closedEnum(function () {
    return {
        Precommit: exports.Type_381,
        Prevote: exports.Type_376,
    }
})
exports.Type_376 = support_1.sts.struct(function () {
    return {
...
exports.Type_381 = support_1.sts.struct(function () {
    return {
        roundNumber: support_1.sts.bigint(),
        identity: exports.Public,
        first: support_1.sts.tuple(function () {
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Origins: exports.Type_405,
        ParachainsOrigin: exports.Origin,
        Void: exports.Void,
        XcmPallet: exports.Type_404,
...
exports.Type_405 = support_1.sts.closedEnum(function () {
    return {
...
exports.StakingCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_staking_configs: support_1.sts.enumStruct({
            ...
            maxNominatorCount: exports.Type_365,
            maxValidatorCount: exports.Type_365,
            chillThreshold: exports.Type_366,
            minCommission: exports.Type_367,
        }),
...
exports.NominationPoolsCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_configs: support_1.sts.enumStruct({
            minJoinBond: exports.Type_396,
            minCreateBond: exports.Type_396,
            globalMaxCommission: exports.Type_397,
        }),
        unbond: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
...
exports.Type_397 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Perbill,
...
exports.GrandpaCall = support_1.sts.closedEnum(function () {
    return {
        ...
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_374,
            keyOwnerProof: exports.MembershipProof,
        }),

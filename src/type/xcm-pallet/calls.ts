...
export const send = {
    ...
    enjinV1062: new CallType(
        'XcmPallet.send',
        sts.struct({
            dest: enjinV1062.VersionedLocation,
            message: enjinV1062.VersionedXcm,
        })
    ),
    v100: new CallType(
        'XcmPallet.send',
    ...
    v1060: new CallType(
        'XcmPallet.send',
        sts.struct({
            dest: v1060.VersionedLocation,
            message: v1060.VersionedXcm,
        })
    ),
}
...
export const teleportAssets = {
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            dest: enjinV1062.VersionedLocation,
            beneficiary: enjinV1062.VersionedLocation,
    ...
    v1060: new CallType(
        ...
        sts.struct({
            dest: v1060.VersionedLocation,
            beneficiary: v1060.VersionedLocation,
...
export const limitedReserveTransferAssets = {
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            ...
            assets: enjinV1062.VersionedAssets,
            feeAssetItem: sts.number(),
            weightLimit: enjinV1062.V3WeightLimit,
        })
    ),
    /**
     * Transfer some assets from the local chain to the sovereign account of a destination
...
export const transferAssetsUsingTypeAndThen = {
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            dest: enjinV1062.VersionedLocation,
            assets: enjinV1062.VersionedAssets,
            assetsTransferType: enjinV1062.TransferType,
            remoteFeesId: enjinV1062.VersionedAssetId,
            feesTransferType: enjinV1062.TransferType,
            customXcmOnDest: enjinV1062.VersionedXcm,
            weightLimit: enjinV1062.V3WeightLimit,
        })
    ),
    /**
    ...
    v1060: new CallType(
        ...
        sts.struct({
            dest: v1060.VersionedLocation,
            assets: v1060.VersionedAssets,
            assetsTransferType: v1060.TransferType,
            remoteFeesId: v1060.VersionedAssetId,
            feesTransferType: v1060.TransferType,
            customXcmOnDest: v1060.VersionedXcm,
            weightLimit: v1060.V3WeightLimit,
        })
    ),
}
...
export const addAuthorizedAlias = {
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            aliaser: enjinV1062.VersionedLocation,
...
export const removeAllAuthorizedAliases = {
     ...
     * making this call.
     */
    enjinV1062: new CallType('XcmPallet.remove_all_authorized_aliases', sts.unit()),
}

...
export interface Type_1106_Approved {
    __kind: 'Approved'
    value: [number, Type_1086 | undefined, Type_1086 | undefined]
}

export interface Type_1106_Cancelled {
    __kind: 'Cancelled'
    value: [number, Type_1086 | undefined, Type_1086 | undefined]
}

export interface Type_1106_Killed {
    __kind: 'Killed'
    value: number
}

export interface Type_1106_Ongoing {
    __kind: 'Ongoing'
    value: Type_1107
}

export interface Type_1106_Rejected {
    __kind: 'Rejected'
    value: [number, Type_1086 | undefined, Type_1086 | undefined]
}

export interface Type_1106_TimedOut {
    __kind: 'TimedOut'
    value: [number, Type_1086 | undefined, Type_1086 | undefined]
}

export interface Type_1107 {
    track: number
    origin: OriginCaller
    proposal: Bounded
    enactment: DispatchTime
    submitted: number
    submissionDeposit: Type_1086
    decisionDeposit?: Type_1086 | undefined
...
export type Type_358 = Type_358_Response | Type_358_Xcm

export interface Type_358_Response {
    __kind: 'Response'
    value: V5Location
}

export interface Type_358_Xcm {
    __kind: 'Xcm'
    value: V5Location
}
...
export type Type_359 =
    | Type_359_AuctionAdmin
    | Type_359_BigSpender
    | Type_359_BigTipper
    | Type_359_Emergency
    | Type_359_Fellows
    | Type_359_Fellowship1Dan
    | Type_359_Fellowship2Dan
    | Type_359_Fellowship3Dan
    | Type_359_Fellowship4Dan
    | Type_359_Fellowship5Dan
    | Type_359_Fellowship6Dan
    | Type_359_Fellowship7Dan
    | Type_359_Fellowship8Dan
    | Type_359_Fellowship9Dan
    | Type_359_FellowshipAdmin
    | Type_359_FellowshipExperts
    | Type_359_FellowshipInitiates
    | Type_359_FellowshipMasters
    | Type_359_FuelTanksAdmin
    | Type_359_GeneralAdmin
    | Type_359_LeaseAdmin
    | Type_359_MediumSpender
    | Type_359_MultiTokensAdmin
    | Type_359_ParachainsAdmin
    | Type_359_ReferendumCanceller
    | Type_359_ReferendumKiller
    | Type_359_SmallSpender
    | Type_359_SmallTipper
    | Type_359_StakingAdmin
    | Type_359_TreasuryAdmin
    | Type_359_WhitelistAdmin
    | Type_359_WhitelistedCaller

export interface Type_359_AuctionAdmin {
    __kind: 'AuctionAdmin'
}

export interface Type_359_BigSpender {
    __kind: 'BigSpender'
}

export interface Type_359_BigTipper {
    __kind: 'BigTipper'
}

export interface Type_359_Emergency {
    __kind: 'Emergency'
}

export interface Type_359_Fellows {
    __kind: 'Fellows'
}

export interface Type_359_Fellowship1Dan {
    __kind: 'Fellowship1Dan'
}

export interface Type_359_Fellowship2Dan {
    __kind: 'Fellowship2Dan'
}

export interface Type_359_Fellowship3Dan {
    __kind: 'Fellowship3Dan'
}

export interface Type_359_Fellowship4Dan {
    __kind: 'Fellowship4Dan'
}

export interface Type_359_Fellowship5Dan {
    __kind: 'Fellowship5Dan'
}

export interface Type_359_Fellowship6Dan {
    __kind: 'Fellowship6Dan'
}

export interface Type_359_Fellowship7Dan {
    __kind: 'Fellowship7Dan'
}

export interface Type_359_Fellowship8Dan {
    __kind: 'Fellowship8Dan'
}

export interface Type_359_Fellowship9Dan {
    __kind: 'Fellowship9Dan'
}

export interface Type_359_FellowshipAdmin {
    __kind: 'FellowshipAdmin'
}

export interface Type_359_FellowshipExperts {
    __kind: 'FellowshipExperts'
}

export interface Type_359_FellowshipInitiates {
    __kind: 'FellowshipInitiates'
}

export interface Type_359_FellowshipMasters {
    __kind: 'FellowshipMasters'
}

export interface Type_359_FuelTanksAdmin {
    __kind: 'FuelTanksAdmin'
}

export interface Type_359_GeneralAdmin {
    __kind: 'GeneralAdmin'
}

export interface Type_359_LeaseAdmin {
    __kind: 'LeaseAdmin'
}

export interface Type_359_MediumSpender {
    __kind: 'MediumSpender'
}

export interface Type_359_MultiTokensAdmin {
    __kind: 'MultiTokensAdmin'
}

export interface Type_359_ParachainsAdmin {
    __kind: 'ParachainsAdmin'
}

export interface Type_359_ReferendumCanceller {
    __kind: 'ReferendumCanceller'
}

export interface Type_359_ReferendumKiller {
    __kind: 'ReferendumKiller'
}

export interface Type_359_SmallSpender {
    __kind: 'SmallSpender'
}

export interface Type_359_SmallTipper {
    __kind: 'SmallTipper'
}

export interface Type_359_StakingAdmin {
    __kind: 'StakingAdmin'
}

export interface Type_359_TreasuryAdmin {
    __kind: 'TreasuryAdmin'
}

export interface Type_359_WhitelistAdmin {
    __kind: 'WhitelistAdmin'
}

export interface Type_359_WhitelistedCaller {
    __kind: 'WhitelistedCaller'
}

export type Type_360 = Type_360_FuelTank

export interface Type_360_FuelTank {
    __kind: 'FuelTank'
    caller: AccountId32
    tankId: AccountId32
...
export interface Type_1086 {
    who: AccountId32
    amount: bigint
}

export const Type_1106: sts.Type<Type_1106> = sts.closedEnum(() => {
    return {
        Approved: sts.tuple(() => [sts.number(), sts.option(() => Type_1086), sts.option(() => Type_1086)]),
        Cancelled: sts.tuple(() => [sts.number(), sts.option(() => Type_1086), sts.option(() => Type_1086)]),
        Killed: sts.number(),
        Ongoing: Type_1107,
        Rejected: sts.tuple(() => [sts.number(), sts.option(() => Type_1086), sts.option(() => Type_1086)]),
        TimedOut: sts.tuple(() => [sts.number(), sts.option(() => Type_1086), sts.option(() => Type_1086)]),
    }
})

export const Type_1107: sts.Type<Type_1107> = sts.struct(() => {
    return {
        track: sts.number(),
        origin: OriginCaller,
        proposal: Bounded,
        ...
        submissionDeposit: Type_1086,
        decisionDeposit: sts.option(() => Type_1086),
...
export const Type_756: sts.Type<Type_756> = sts.struct(() => {
    return {
        bareAyes: sts.number(),
        ayes: sts.number(),
        nays: sts.number(),
...
export const Type_1086: sts.Type<Type_1086> = sts.struct(() => {
    return {
        who: AccountId32,
        amount: sts.bigint(),
    }
...
export interface DefaultTokenMutation {
    behavior: Type_604
    listingForbidden: Type_607
    anyoneCanInfuse: Type_607
    name: Type_608
}

export type Type_608 = Type_608_NoMutation | Type_608_SomeMutation

export interface Type_608_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_608_SomeMutation {
    __kind: 'SomeMutation'
    value: BoundedString
}

export type Type_607 = Type_607_NoMutation | Type_607_SomeMutation

export interface Type_607_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_607_SomeMutation {
    __kind: 'SomeMutation'
    value: boolean
}

export type Type_604 = Type_604_NoMutation | Type_604_SomeMutation

export interface Type_604_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_604_SomeMutation {
    __kind: 'SomeMutation'
...
export type Type_598 = Type_598_NoMutation | Type_598_SomeMutation

export interface Type_598_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_598_SomeMutation {
    __kind: 'SomeMutation'
...
export interface DefaultTankMutation {
    userAccountManagement: Type_733
    coveragePolicy?: CoveragePolicy | undefined
    accountRules?: AccountRuleDescriptor[] | undefined
    owner?: AccountId32 | undefined
    accountExpiration: Type_736
    name?: Bytes | undefined
}

export type Type_736 = Type_736_NoMutation | Type_736_SomeMutation

export interface Type_736_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_736_SomeMutation {
    __kind: 'SomeMutation'
...
export type Type_733 = Type_733_NoMutation | Type_733_SomeMutation

export interface Type_733_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_733_SomeMutation {
    __kind: 'SomeMutation'
...
export type Type_784 = Type_784_ApplyExtrinsic | Type_784_Finalization | Type_784_Initialization

export interface Type_784_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_784_Finalization {
    __kind: 'Finalization'
}

export interface Type_784_Initialization {
...
export const Type_607: sts.Type<Type_607> = sts.closedEnum(() => {
    return {
        NoMutation: sts.unit(),
...
export const Type_604: sts.Type<Type_604> = sts.closedEnum(() => {
    return {
        NoMutation: sts.unit(),
...
export const Type_598: sts.Type<Type_598> = sts.closedEnum(() => {
    return {
        NoMutation: sts.unit(),
...
export const Type_736: sts.Type<Type_736> = sts.closedEnum(() => {
    return {
        NoMutation: sts.unit(),
...
export const Type_733: sts.Type<Type_733> = sts.closedEnum(() => {
    return {
        NoMutation: sts.unit(),
...
export const Type_784: sts.Type<Type_784> = sts.closedEnum(() => {
    return {
...
export type Type_469 = Type_469_V3 | Type_469_V4 | Type_469_V5

export interface Type_469_V3 {
    __kind: 'V3'
    value: Type_472[]
}

export interface Type_469_V4 {
    __kind: 'V4'
    value: Type_476[]
}

export interface Type_469_V5 {
    __kind: 'V5'
    value: Type_479[]
}

export type Type_479 =
    | Type_479_AliasOrigin
    | Type_479_BurnAsset
    | Type_479_BuyExecution
    | Type_479_ClaimAsset
    | Type_479_ClearError
    | Type_479_ClearOrigin
    | Type_479_ClearTopic
    | Type_479_ClearTransactStatus
    | Type_479_DepositAsset
    | Type_479_DepositReserveAsset
    | Type_479_DescendOrigin
    | Type_479_ExchangeAsset
    | Type_479_ExecuteWithOrigin
    | Type_479_ExpectAsset
    | Type_479_ExpectError
    | Type_479_ExpectOrigin
    | Type_479_ExpectPallet
    | Type_479_ExpectTransactStatus
    | Type_479_ExportMessage
    | Type_479_HrmpChannelAccepted
    | Type_479_HrmpChannelClosing
    | Type_479_HrmpNewChannelOpenRequest
    | Type_479_InitiateReserveWithdraw
    | Type_479_InitiateTeleport
    | Type_479_InitiateTransfer
    | Type_479_LockAsset
    | Type_479_NoteUnlockable
    | Type_479_PayFees
    | Type_479_QueryPallet
    | Type_479_QueryResponse
    | Type_479_ReceiveTeleportedAsset
    | Type_479_RefundSurplus
    | Type_479_ReportError
    | Type_479_ReportHolding
    | Type_479_ReportTransactStatus
    | Type_479_RequestUnlock
    | Type_479_ReserveAssetDeposited
    | Type_479_SetAppendix
    | Type_479_SetErrorHandler
    | Type_479_SetFeesMode
    | Type_479_SetHints
    | Type_479_SetTopic
    | Type_479_SubscribeVersion
    | Type_479_Transact
    | Type_479_TransferAsset
    | Type_479_TransferReserveAsset
    | Type_479_Trap
    | Type_479_UniversalOrigin
    | Type_479_UnlockAsset
    | Type_479_UnpaidExecution
    | Type_479_UnsubscribeVersion
    | Type_479_WithdrawAsset

export interface Type_479_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V5Location
}

export interface Type_479_BurnAsset {
    __kind: 'BurnAsset'
    value: V5Asset[]
}

export interface Type_479_BuyExecution {
    __kind: 'BuyExecution'
    fees: V5Asset
    weightLimit: V3WeightLimit
}

export interface Type_479_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V5Asset[]
    ticket: V5Location
}

export interface Type_479_ClearError {
    __kind: 'ClearError'
}

export interface Type_479_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_479_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_479_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_479_DepositAsset {
    __kind: 'DepositAsset'
    assets: V5AssetFilter
    beneficiary: V5Location
}

export interface Type_479_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V5AssetFilter
    dest: V5Location
    xcm: V5Instruction[]
...
export interface Type_479_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V5Junctions
}

export interface Type_479_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V5AssetFilter
    want: V5Asset[]
    maximal: boolean
...
export interface Type_479_ExecuteWithOrigin {
    __kind: 'ExecuteWithOrigin'
    descendantOrigin?: V5Junctions | undefined
    xcm: Type_479[]
}

export interface Type_479_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V5Asset[]
}

export interface Type_479_ExpectError {
    __kind: 'ExpectError'
    value?: [number, V5Error] | undefined
}

export interface Type_479_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: V5Location | undefined
}

export interface Type_479_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_479_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_479_ExportMessage {
    __kind: 'ExportMessage'
    network: V5NetworkId
    destination: V5Junctions
    xcm: V5Instruction[]
...
export interface Type_479_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_479_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_479_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_479_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V5AssetFilter
    reserve: V5Location
    xcm: V5Instruction[]
...
export interface Type_479_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V5AssetFilter
    dest: V5Location
    xcm: V5Instruction[]
...
export interface Type_479_InitiateTransfer {
    __kind: 'InitiateTransfer'
    destination: V5Location
    remoteFees?: V5AssetTransferFilter | undefined
    preserveOrigin: boolean
...
export interface Type_479_LockAsset {
    __kind: 'LockAsset'
    asset: V5Asset
    unlocker: V5Location
}

export interface Type_479_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V5Asset
    owner: V5Location
}

export interface Type_479_PayFees {
    __kind: 'PayFees'
    asset: V5Asset
}

export interface Type_479_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V5QueryResponseInfo
}

export interface Type_479_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V5Response
    maxWeight: Weight
...
export interface Type_479_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V5Asset[]
}

export interface Type_479_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_479_ReportError {
    __kind: 'ReportError'
    value: V5QueryResponseInfo
}

export interface Type_479_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V5QueryResponseInfo
    assets: V5AssetFilter
}

export interface Type_479_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V5QueryResponseInfo
}

export interface Type_479_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V5Asset
    locker: V5Location
}

export interface Type_479_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V5Asset[]
}

export interface Type_479_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_479[]
}

export interface Type_479_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_479[]
}

export interface Type_479_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_479_SetHints {
    __kind: 'SetHints'
    hints: V5Hint[]
}

export interface Type_479_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_479_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_479_Transact {
    __kind: 'Transact'
    originKind: V3OriginKind
    fallbackMaxWeight?: Weight | undefined
    call: Type_473
...
export interface Type_479_TransferAsset {
    __kind: 'TransferAsset'
    assets: V5Asset[]
    beneficiary: V5Location
}

export interface Type_479_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V5Asset[]
    dest: V5Location
    xcm: V5Instruction[]
...
export interface Type_479_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_479_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V5Junction
}

export interface Type_479_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V5Asset
    target: V5Location
}

export interface Type_479_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: V5Location | undefined
}

export interface Type_479_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_479_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V5Asset[]
}
...
export type Type_476 =
    | Type_476_AliasOrigin
    | Type_476_BurnAsset
    | Type_476_BuyExecution
    | Type_476_ClaimAsset
    | Type_476_ClearError
    | Type_476_ClearOrigin
    | Type_476_ClearTopic
    | Type_476_ClearTransactStatus
    | Type_476_DepositAsset
    | Type_476_DepositReserveAsset
    | Type_476_DescendOrigin
    | Type_476_ExchangeAsset
    | Type_476_ExpectAsset
    | Type_476_ExpectError
    | Type_476_ExpectOrigin
    | Type_476_ExpectPallet
    | Type_476_ExpectTransactStatus
    | Type_476_ExportMessage
    | Type_476_HrmpChannelAccepted
    | Type_476_HrmpChannelClosing
    | Type_476_HrmpNewChannelOpenRequest
    | Type_476_InitiateReserveWithdraw
    | Type_476_InitiateTeleport
    | Type_476_LockAsset
    | Type_476_NoteUnlockable
    | Type_476_QueryPallet
    | Type_476_QueryResponse
    | Type_476_ReceiveTeleportedAsset
    | Type_476_RefundSurplus
    | Type_476_ReportError
    | Type_476_ReportHolding
    | Type_476_ReportTransactStatus
    | Type_476_RequestUnlock
    | Type_476_ReserveAssetDeposited
    | Type_476_SetAppendix
    | Type_476_SetErrorHandler
    | Type_476_SetFeesMode
    | Type_476_SetTopic
    | Type_476_SubscribeVersion
    | Type_476_Transact
    | Type_476_TransferAsset
    | Type_476_TransferReserveAsset
    | Type_476_Trap
    | Type_476_UniversalOrigin
    | Type_476_UnlockAsset
    | Type_476_UnpaidExecution
    | Type_476_UnsubscribeVersion
    | Type_476_WithdrawAsset

export interface Type_476_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V4Location
}

export interface Type_476_BurnAsset {
    __kind: 'BurnAsset'
    value: V4Asset[]
}

export interface Type_476_BuyExecution {
    __kind: 'BuyExecution'
    fees: V4Asset
    weightLimit: V3WeightLimit
}

export interface Type_476_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V4Asset[]
    ticket: V4Location
}

export interface Type_476_ClearError {
    __kind: 'ClearError'
}

export interface Type_476_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_476_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_476_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_476_DepositAsset {
    __kind: 'DepositAsset'
    assets: V4AssetFilter
    beneficiary: V4Location
}

export interface Type_476_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V4AssetFilter
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_476_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V4Junctions
}

export interface Type_476_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V4AssetFilter
    want: V4Asset[]
    maximal: boolean
...
export interface Type_476_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V4Asset[]
}

export interface Type_476_ExpectError {
    __kind: 'ExpectError'
    value?: [number, V3Error] | undefined
}

export interface Type_476_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: V4Location | undefined
}

export interface Type_476_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_476_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_476_ExportMessage {
    __kind: 'ExportMessage'
    network: V4NetworkId
    destination: V4Junctions
    xcm: V4Instruction[]
...
export interface Type_476_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_476_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_476_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_476_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V4AssetFilter
    reserve: V4Location
    xcm: V4Instruction[]
...
export interface Type_476_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V4AssetFilter
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_476_LockAsset {
    __kind: 'LockAsset'
    asset: V4Asset
    unlocker: V4Location
}

export interface Type_476_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V4Asset
    owner: V4Location
}

export interface Type_476_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V4QueryResponseInfo
}

export interface Type_476_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V4Response
    maxWeight: Weight
...
export interface Type_476_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V4Asset[]
}

export interface Type_476_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_476_ReportError {
    __kind: 'ReportError'
    value: V4QueryResponseInfo
}

export interface Type_476_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V4QueryResponseInfo
    assets: V4AssetFilter
}

export interface Type_476_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V4QueryResponseInfo
}

export interface Type_476_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V4Asset
    locker: V4Location
}

export interface Type_476_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V4Asset[]
}

export interface Type_476_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_476[]
}

export interface Type_476_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_476[]
}

export interface Type_476_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_476_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_476_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_476_Transact {
    __kind: 'Transact'
    originKind: V3OriginKind
    requireWeightAtMost: Weight
    call: Type_473
...
export interface Type_476_TransferAsset {
    __kind: 'TransferAsset'
    assets: V4Asset[]
    beneficiary: V4Location
}

export interface Type_476_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V4Asset[]
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_476_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_476_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V4Junction
}

export interface Type_476_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V4Asset
    target: V4Location
}

export interface Type_476_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: V4Location | undefined
}

export interface Type_476_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_476_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V4Asset[]
}

export type Type_472 =
    | Type_472_AliasOrigin
    | Type_472_BurnAsset
    | Type_472_BuyExecution
    | Type_472_ClaimAsset
    | Type_472_ClearError
    | Type_472_ClearOrigin
    | Type_472_ClearTopic
    | Type_472_ClearTransactStatus
    | Type_472_DepositAsset
    | Type_472_DepositReserveAsset
    | Type_472_DescendOrigin
    | Type_472_ExchangeAsset
    | Type_472_ExpectAsset
    | Type_472_ExpectError
    | Type_472_ExpectOrigin
    | Type_472_ExpectPallet
    | Type_472_ExpectTransactStatus
    | Type_472_ExportMessage
    | Type_472_HrmpChannelAccepted
    | Type_472_HrmpChannelClosing
    | Type_472_HrmpNewChannelOpenRequest
    | Type_472_InitiateReserveWithdraw
    | Type_472_InitiateTeleport
    | Type_472_LockAsset
    | Type_472_NoteUnlockable
    | Type_472_QueryPallet
    | Type_472_QueryResponse
    | Type_472_ReceiveTeleportedAsset
    | Type_472_RefundSurplus
    | Type_472_ReportError
    | Type_472_ReportHolding
    | Type_472_ReportTransactStatus
    | Type_472_RequestUnlock
    | Type_472_ReserveAssetDeposited
    | Type_472_SetAppendix
    | Type_472_SetErrorHandler
    | Type_472_SetFeesMode
    | Type_472_SetTopic
    | Type_472_SubscribeVersion
    | Type_472_Transact
    | Type_472_TransferAsset
    | Type_472_TransferReserveAsset
    | Type_472_Trap
    | Type_472_UniversalOrigin
    | Type_472_UnlockAsset
    | Type_472_UnpaidExecution
    | Type_472_UnsubscribeVersion
    | Type_472_WithdrawAsset

export interface Type_472_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_472_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_472_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_472_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_472_ClearError {
    __kind: 'ClearError'
}

export interface Type_472_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_472_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_472_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_472_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_472_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_472_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_472_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_472_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_472_ExpectError {
    __kind: 'ExpectError'
    value?: [number, V3Error] | undefined
}

export interface Type_472_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: V3MultiLocation | undefined
}

export interface Type_472_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_472_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_472_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_472_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_472_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_472_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_472_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_472_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_472_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_472_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_472_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}

export interface Type_472_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_472_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_472_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_472_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_472_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_472_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_472_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_472_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_472_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_472[]
}

export interface Type_472_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_472[]
}

export interface Type_472_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_472_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_472_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_472_Transact {
    __kind: 'Transact'
    originKind: V3OriginKind
    requireWeightAtMost: Weight
    call: Type_473
...
export interface Type_472_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_472_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_472_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_472_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_472_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_472_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: V3MultiLocation | undefined
}

export interface Type_472_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_472_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_311
    maxValidatorCount: Type_311
    chillThreshold: Type_312
    minCommission: Type_313
    maxStakedRewards: Type_312
}
...
export interface NominationPoolsCall_set_configs {
    __kind: 'set_configs'
    minJoinBond: Type_341
    minCreateBond: Type_341
    globalMaxCommission: Type_342
}
...
export type Type_342 = Type_342_Noop | Type_342_Remove | Type_342_Set

export interface Type_342_Noop {
    __kind: 'Noop'
}

export interface Type_342_Remove {
    __kind: 'Remove'
}

export interface Type_342_Set {
    __kind: 'Set'
    value: Perbill
}

export type Type_341 = Type_341_Noop | Type_341_Remove | Type_341_Set

export interface Type_341_Noop {
    __kind: 'Noop'
}

export interface Type_341_Remove {
    __kind: 'Remove'
}

export interface Type_341_Set {
    __kind: 'Set'
    value: bigint
}
...
export const Type_469: sts.Type<Type_469> = sts.closedEnum(() => {
    return {
        V3: sts.array(() => Type_472),
        V4: sts.array(() => Type_476),
        V5: sts.array(() => Type_479),
    }
})
...
export const Type_479: sts.Type<Type_479> = sts.closedEnum(() => {
    return {
        ...
        ReserveAssetDeposited: sts.array(() => V5Asset),
        SetAppendix: sts.array(() => Type_479),
        SetErrorHandler: sts.array(() => Type_479),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetHints: sts.enumStruct({
...
export const Type_476: sts.Type<Type_476> = sts.closedEnum(() => {
    return {
        ...
        ReserveAssetDeposited: sts.array(() => V4Asset),
        SetAppendix: sts.array(() => Type_476),
        SetErrorHandler: sts.array(() => Type_476),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_472: sts.Type<Type_472> = sts.closedEnum(() => {
    return {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_472),
        SetErrorHandler: sts.array(() => Type_472),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_634: sts.Type<Type_634> = sts.struct(() => {
    return {
        accountId: AccountId32,
        params: DefaultMintParams,
    }
...
export const Type_328: sts.Type<Type_328> = sts.struct(() => {
    return {
        setId: sts.bigint(),
        equivocation: Equivocation,
    }

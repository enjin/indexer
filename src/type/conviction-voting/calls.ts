...
export const vote = {
    ...
    enjinV1070: new CallType(
        ...
        sts.struct({
            pollIndex: sts.number(),
            vote: enjinV1070.AccountVote,
            currency: enjinV1070.VoteCurrency,
        })
    ),
    /**
     * Vote in a poll. If `vote.is_aye()`, the vote is to enact the proposal;
...
export const delegate = {
    ...
    enjinV1070: new CallType(
        ...
        sts.struct({
            class: sts.number(),
            to: enjinV1070.MultiAddress,
            conviction: enjinV1070.Conviction,
            balance: sts.bigint(),
            currency: enjinV1070.VoteCurrency,
        })
    ),
    ...
    v100: new CallType(
        ...
        sts.struct({
            class: sts.number(),
            to: v100.MultiAddress,
            conviction: v100.Conviction,
            balance: sts.bigint(),
        })
    ),
    /**
    ...
    v1070: new CallType(
        ...
        sts.struct({
            class: sts.number(),
            to: v1070.MultiAddress,
            conviction: v1070.Conviction,
            balance: sts.bigint(),
            currency: v1070.VoteCurrency,
        })
    ),
...
export const unlock = {
    ...
    enjinV1070: new CallType(
        ...
        sts.struct({
            class: sts.number(),
            target: enjinV1070.MultiAddress,
            currency: enjinV1070.VoteCurrency,
        })
    ),
    /**

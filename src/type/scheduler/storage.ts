...
export const incompleteSince = {
    matrixEnjinV603: new StorageType(
        ...
        [],
        sts.number()
    ) as IncompleteSinceMatrixEnjinV603,
}
...
export const agenda = {
    ...
    matrixEnjinV603: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => matrixEnjinV603.Scheduled))
    ) as AgendaMatrixEnjinV603,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    matrixEnjinV1012: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => matrixEnjinV1012.Scheduled))
    ) as AgendaMatrixEnjinV1012,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    matrixEnjinV1031: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => matrixEnjinV1031.Scheduled))
    ) as AgendaMatrixEnjinV1031,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    matrixV500: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => matrixV500.Scheduled))
    ) as AgendaMatrixV500,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    matrixV1010: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => matrixV1010.Scheduled))
    ) as AgendaMatrixV1010,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    matrixV1030: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => matrixV1030.Scheduled))
    ) as AgendaMatrixV1030,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    ...
    enjinV100: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => enjinV100.Scheduled))
    ) as AgendaEnjinV100,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    enjinV101: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => enjinV101.Scheduled))
    ) as AgendaEnjinV101,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    enjinV1032: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => enjinV1032.Scheduled))
    ) as AgendaEnjinV1032,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    ...
    v100: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => v100.Scheduled))
    ) as AgendaV100,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    v105: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => v105.Scheduled))
    ) as AgendaV105,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    v1030: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => v1030.Scheduled))
    ) as AgendaV1030,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
    v1060: new StorageType(
        ...
        'Default',
        [sts.number()],
        sts.array(() => sts.option(() => v1060.Scheduled))
    ) as AgendaV1060,
    /**
     *  Items to be executed, indexed by the block number that they should be executed on.
     */
...
export interface AgendaMatrixEnjinV603 {
    ...
    getPairs(
        block: Block,
        key: number
    ): Promise<[k: number, v: (matrixEnjinV603.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (matrixEnjinV603.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export interface AgendaMatrixEnjinV1012 {
    ...
    getPairs(
        block: Block,
        key: number
    ): Promise<[k: number, v: (matrixEnjinV1012.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (matrixEnjinV1012.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
 ...
 *  Items to be executed, indexed by the block number that they should be executed on.
 */
export interface AgendaMatrixEnjinV1031 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): (matrixEnjinV1031.Scheduled | undefined)[]
    get(block: Block, key: number): Promise<(matrixEnjinV1031.Scheduled | undefined)[] | undefined>
    getMany(block: Block, keys: number[]): Promise<((matrixEnjinV1031.Scheduled | undefined)[] | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (matrixEnjinV1031.Scheduled | undefined)[] | undefined][]>
    getPairs(
        block: Block,
        key: number
    ): Promise<[k: number, v: (matrixEnjinV1031.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (matrixEnjinV1031.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export interface AgendaMatrixV500 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (matrixV500.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export interface AgendaMatrixV1010 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (matrixV1010.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
 ...
 *  Items to be executed, indexed by the block number that they should be executed on.
 */
export interface AgendaMatrixV1030 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): (matrixV1030.Scheduled | undefined)[]
    get(block: Block, key: number): Promise<(matrixV1030.Scheduled | undefined)[] | undefined>
    getMany(block: Block, keys: number[]): Promise<((matrixV1030.Scheduled | undefined)[] | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (matrixV1030.Scheduled | undefined)[] | undefined][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (matrixV1030.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (matrixV1030.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
 ...
 *  Items to be executed, indexed by the block number that they should be executed on.
 */
export interface AgendaMatrixV1040 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): (matrixV1040.Scheduled | undefined)[]
    get(block: Block, key: number): Promise<(matrixV1040.Scheduled | undefined)[] | undefined>
    getMany(block: Block, keys: number[]): Promise<((matrixV1040.Scheduled | undefined)[] | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (matrixV1040.Scheduled | undefined)[] | undefined][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (matrixV1040.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
...
export interface AgendaEnjinV100 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (enjinV100.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export interface AgendaEnjinV101 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (enjinV101.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export interface AgendaEnjinV1032 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (enjinV1032.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
 ...
 *  Items to be executed, indexed by the block number that they should be executed on.
 */
export interface AgendaEnjinV1062 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): (enjinV1062.Scheduled | undefined)[]
    get(block: Block, key: number): Promise<(enjinV1062.Scheduled | undefined)[] | undefined>
    getMany(block: Block, keys: number[]): Promise<((enjinV1062.Scheduled | undefined)[] | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (enjinV1062.Scheduled | undefined)[] | undefined][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (enjinV1062.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
...
export interface AgendaV100 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (v100.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export interface AgendaV105 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (v105.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
...
export interface AgendaV1030 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (v1030.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
 ...
 *  Items to be executed, indexed by the block number that they should be executed on.
 */
export interface AgendaV1060 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): (v1060.Scheduled | undefined)[]
    get(block: Block, key: number): Promise<(v1060.Scheduled | undefined)[] | undefined>
    getMany(block: Block, keys: number[]): Promise<((v1060.Scheduled | undefined)[] | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (v1060.Scheduled | undefined)[] | undefined][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (v1060.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: number, v: (v1060.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: number
 ...
 *  Items to be executed, indexed by the block number that they should be executed on.
 */
export interface AgendaV1070 {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): (v1070.Scheduled | undefined)[]
    get(block: Block, key: number): Promise<(v1070.Scheduled | undefined)[] | undefined>
    getMany(block: Block, keys: number[]): Promise<((v1070.Scheduled | undefined)[] | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (v1070.Scheduled | undefined)[] | undefined][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (v1070.Scheduled | undefined)[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
...
export interface LookupMatrixEnjinV603 {
    ...
    getPairsPaged(
        ...
        block: Block,
        key: Bytes
    ): AsyncIterable<[k: Bytes, v: [number, number] | undefined][]>
}
...
export interface RetriesMatrixEnjinV1012 {
    ...
    getPairs(
        block: Block,
        key: [number, number]
    ): Promise<[k: [number, number], v: matrixEnjinV1012.RetryConfig | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [number, number], v: matrixEnjinV1012.RetryConfig | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: [number, number]

...
export const transferToParachain = {
    ...
    matrixEnjinV1031: new CallType(
        'MatrixXcm.transfer_to_parachain',
        sts.struct({
            paraId: matrixEnjinV1031.ParachainId,
            beneficiary: matrixEnjinV1031.Account,
            amount: sts.bigint(),
            destWeight: sts.option(() => sts.bigint()),
        })
    ),
    ...
    matrixV604: new CallType(
        'MatrixXcm.transfer_to_parachain',
        sts.struct({
            paraId: matrixV604.ParachainId,
            beneficiary: matrixV604.Account,
            amount: sts.bigint(),
            destWeight: sts.option(() => sts.bigint()),
        })
    ),
...
export const transferAssetToParachain = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            paraId: matrixEnjinV1031.ParachainId,
            beneficiary: matrixEnjinV1031.Account,
            currencyId: matrixEnjinV1031.AssetId,
            amount: sts.bigint(),
            destWeight: sts.option(() => sts.bigint()),
        })
    ),
...
export const transferAssetWithFee = {
    ...
    matrixEnjinV1031: new CallType(
        'MatrixXcm.transfer_asset_with_fee',
        sts.struct({
            assetPair: matrixEnjinV1031.CurrencyIdAmountPair,
            feePair: matrixEnjinV1031.CurrencyIdAmountPair,
            paraId: matrixEnjinV1031.ParachainId,
            beneficiary: matrixEnjinV1031.Account,
            destWeight: sts.option(() => sts.bigint()),
        })
    ...
    matrixV604: new CallType(
        'MatrixXcm.transfer_asset_with_fee',
        sts.struct({
            assetPair: matrixV604.CurrencyIdAmountPair,
            feePair: matrixV604.CurrencyIdAmountPair,
            paraId: matrixV604.ParachainId,
            beneficiary: matrixV604.Account,
            destWeight: sts.option(() => sts.bigint()),
        })
...
export const forceSetMinimumWeight = {
    ...
    matrixEnjinV1031: new CallType(
        'MatrixXcm.force_set_minimum_weight',
        sts.struct({
            xcmCall: matrixEnjinV1031.XcmOperation,
            xcmWeightFeeMisc: matrixEnjinV1031.MinimumWeightFeePair,
        })
    ),
    /**
     * Update xcm fees amount to be used in xcm.Withdraw message

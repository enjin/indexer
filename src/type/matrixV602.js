...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_208,
...
exports.Type_208 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Council: exports.Type_302,
        CumulusXcm: exports.Type_305,
        PolkadotXcm: exports.Origin,
        TechnicalCommittee: exports.Type_303,
        Void: exports.Void,
...
exports.Type_303 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_305 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_339 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_342
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_346
        }),
    }
})
...
exports.Type_343 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
exports.Type_342 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
            fees: exports.V2MultiAsset,
            weightLimit: exports.V2WeightLimit,

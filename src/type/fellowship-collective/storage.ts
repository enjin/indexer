...
export interface MembersEnjinV100 {
    ...
    ): Promise<[k: enjinV100.AccountId32, v: enjinV100.MemberRecord | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.AccountId32, v: enjinV100.MemberRecord | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.AccountId32
...
export interface IndexToIdEnjinV100 {
    ...
    getPairs(
        ...
        key1: number,
        key2: number
    ): Promise<[k: [number, number], v: enjinV100.AccountId32 | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [number, number], v: enjinV100.AccountId32 | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: number
...
export interface VotingEnjinV100 {
    ...
    getPairs(
        block: Block,
        key1: number
    ): Promise<[k: [number, enjinV100.AccountId32], v: enjinV100.VoteRecord | undefined][]>
    getPairs(
        block: Block,
        key1: number,
        key2: enjinV100.AccountId32
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [number, enjinV100.AccountId32], v: enjinV100.VoteRecord | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key1: number

...
export const downwardMessageQueues = {
    ...
    enjinV100: new StorageType(
        ...
        'Default',
        [enjinV100.Id],
        sts.array(() => enjinV100.InboundDownwardMessage)
    ) as DownwardMessageQueuesEnjinV100,
}
...
export interface DownwardMessageQueuesEnjinV100 {
    ...
    getPairs(
        block: Block,
        key: enjinV100.Id
    ): Promise<[k: enjinV100.Id, v: enjinV100.InboundDownwardMessage[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.Id, v: enjinV100.InboundDownwardMessage[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.Id
...
export const downwardMessageQueueHeads = {
    ...
    enjinV100: new StorageType(
        ...
        [enjinV100.Id],
        enjinV100.H256
    ) as DownwardMessageQueueHeadsEnjinV100,
}
...
export interface DownwardMessageQueueHeadsEnjinV100 {
    ...
    getPairsPaged(
        ...
        block: Block,
        key: enjinV100.Id
    ): AsyncIterable<[k: enjinV100.Id, v: enjinV100.H256 | undefined][]>
}
...
export interface DeliveryFeeFactorEnjinV100 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.Id, v: enjinV100.FixedU128 | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.Id

...
exports.Type_1094 = support_1.sts.struct(function () {
    return {
        ...
        submissionDeposit: exports.Type_1073,
...
exports.Type_1073 = support_1.sts.struct(function () {
    return {
...
exports.BeefyCall = support_1.sts.closedEnum(function () {
    return {
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_645,
            keyOwnerProof: exports.MembershipProof,
        }),
        report_equivocation_unsigned: support_1.sts.enumStruct({
            equivocationProof: exports.Type_645,
...
exports.Type_645 = support_1.sts.struct(function () {
    return {
...
exports.OfferState = support_1.sts.struct(function () {
    return {
        counter: support_1.sts.option(function () {
            return exports.CounterOffer
        }),
    }
})

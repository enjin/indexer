...
export const execute = {
    ...
    matrixEnjinV1031: new CallType(
        'TechnicalCommittee.execute',
        sts.struct({
            proposal: matrixEnjinV1031.Call,
            lengthBound: sts.number(),
        })
    ),
    /**
...
export const releaseProposalCost = {
    name: 'TechnicalCommittee.release_proposal_cost',
    /**
     ...
     */
    matrixEnjinV1031: new CallType(
        'TechnicalCommittee.release_proposal_cost',
        sts.struct({
            proposalHash: matrixEnjinV1031.H256,
        })
    ),

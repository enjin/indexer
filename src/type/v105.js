...
exports.Type_935 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_936 = support_1.sts.struct(function () {
    return {
...
exports.Type_586 = support_1.sts.struct(function () {
    return {
...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_254,
...
exports.Type_254 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
...
exports.Type_588 = support_1.sts.closedEnum(function () {
    return {
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Origins: exports.Type_407,
        ParachainsOrigin: exports.Origin,
        Void: exports.Void,
        XcmPallet: exports.Type_406,
...
exports.Type_406 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_407 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_483 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_486
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_490
        }),
    }
})
exports.Type_490 = support_1.sts.closedEnum(function () {
    return {
        AliasOrigin: exports.V3MultiLocation,
        BurnAsset: support_1.sts.array(function () {
            return exports.V3MultiAsset
...
exports.Type_487 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
exports.Type_486 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
            fees: exports.V2MultiAsset,
            weightLimit: exports.V2WeightLimit,
...
exports.StakingCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_staking_configs: support_1.sts.enumStruct({
            ...
            maxNominatorCount: exports.Type_366,
            maxValidatorCount: exports.Type_366,
            chillThreshold: exports.Type_367,
            minCommission: exports.Type_368,
        }),
...
exports.NominationPoolsCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_configs: support_1.sts.enumStruct({
            minJoinBond: exports.Type_397,
            minCreateBond: exports.Type_397,
            globalMaxCommission: exports.Type_398,
        }),
...
exports.Type_398 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Perbill,
...
exports.Type_518 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
        params: exports.DefaultMintParams,
    }
...
exports.GrandpaCall = support_1.sts.closedEnum(function () {
    return {
        ...
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_375,
            keyOwnerProof: exports.MembershipProof,
        }),
...
exports.Equivocation = support_1.sts.closedEnum(function () {
    return {
        Precommit: exports.Type_382,
        Prevote: exports.Type_377,
    }
})
exports.Type_377 = support_1.sts.struct(function () {
    return {
...
exports.BeefyCall = support_1.sts.closedEnum(function () {
    return {
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_554,
            keyOwnerProof: exports.MembershipProof,
        }),
        report_equivocation_unsigned: support_1.sts.enumStruct({
            equivocationProof: exports.Type_554,
...
exports.Type_554 = support_1.sts.struct(function () {
    return {

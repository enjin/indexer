...
exports.DispatchInfo =
    ...
    exports.RelayDispatchQueueRemainingCapacity =
    exports.V6AbridgedHrmpChannel =
    exports.MessagingStateSnapshot =
    exports.V6AsyncBackingParams =
    exports.V6AbridgedHostConfiguration =
    exports.Ancestor =
    exports.HrmpChannelUpdate =
    exports.UsedBandwidth =
    exports.SegmentTracker =
    exports.V6UpgradeGoAhead =
    exports.FixedU128 =
    exports.HoldConsideration =
...
exports.Announcement = support_1.sts.struct(function () {
    return {
...
exports.AuthorityProperties = support_1.sts.struct(function () {
    return {
...
exports.MigrationState = support_1.sts.closedEnum(function () {
    return {
        ...
        StartedCleanup: support_1.sts.enumStruct({
            cursor: support_1.sts.option(function () {
                return support_1.sts.bytes()
            }),
        }),
        StartedExport: support_1.sts.enumStruct({
            nextBeginUsed: support_1.sts.number(),
        }),
        StartedOverweightExport: support_1.sts.enumStruct({
            nextOverweightIndex: support_1.sts.bigint(),
        }),
    }
})
...
exports.RuntimeHoldReason = support_1.sts.closedEnum(function () {
    return {
        Preimage: exports.HoldReason,
        SafeMode: exports.Type_604,
    }
})
exports.Type_604 = support_1.sts.closedEnum(function () {
    return {
...
exports.RetryConfig = support_1.sts.struct(function () {
    return {
        totalRetries: support_1.sts.number(),
        remaining: support_1.sts.number(),
...
exports.RequestStatus = support_1.sts.closedEnum(function () {
    return {
        Requested: support_1.sts.enumStruct({
            maybeTicket: support_1.sts.option(function () {
                return support_1.sts.tuple(function () {
                    return [exports.AccountId32, exports.HoldConsideration]
                })
            }),
            count: support_1.sts.number(),
            maybeLen: support_1.sts.option(function () {
                return support_1.sts.number()
            }),
        }),
        Unrequested: support_1.sts.enumStruct({
            ticket: support_1.sts.tuple(function () {
                return [exports.AccountId32, exports.HoldConsideration]
            }),
            len: support_1.sts.number(),
        }),
...
exports.HoldConsideration = support_1.sts.bigint()
exports.FixedU128 = support_1.sts.bigint()
exports.V6UpgradeGoAhead = support_1.sts.closedEnum(function () {
    return {
        Abort: support_1.sts.unit(),
        GoAhead: support_1.sts.unit(),
    }
})
exports.SegmentTracker = support_1.sts.struct(function () {
    return {
        usedBandwidth: exports.UsedBandwidth,
        hrmpWatermark: support_1.sts.option(function () {
            return support_1.sts.number()
        }),
        consumedGoAheadSignal: support_1.sts.option(function () {
            return exports.V6UpgradeGoAhead
        }),
    }
})
exports.UsedBandwidth = support_1.sts.struct(function () {
    return {
        umpMsgCount: support_1.sts.number(),
        umpTotalBytes: support_1.sts.number(),
        hrmpOutgoing: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
                return [exports.Id, exports.HrmpChannelUpdate]
            })
        }),
    }
})
exports.HrmpChannelUpdate = support_1.sts.struct(function () {
    return {
        msgCount: support_1.sts.number(),
        totalBytes: support_1.sts.number(),
    }
})
exports.Ancestor = support_1.sts.struct(function () {
    return {
        usedBandwidth: exports.UsedBandwidth,
        paraHeadHash: support_1.sts.option(function () {
            return exports.H256
        }),
        consumedGoAheadSignal: support_1.sts.option(function () {
            return exports.V6UpgradeGoAhead
...
exports.V6AbridgedHostConfiguration = support_1.sts.struct(function () {
    return {
...
exports.MessagingStateSnapshot = support_1.sts.struct(function () {
    return {
        ...
        relayDispatchQueueRemainingCapacity: exports.RelayDispatchQueueRemainingCapacity,
        ingressChannels: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
                return [exports.Id, exports.V6AbridgedHrmpChannel]
            })
        }),
...
exports.V6AbridgedHrmpChannel = support_1.sts.struct(function () {
    return {
...
exports.RelayDispatchQueueRemainingCapacity = support_1.sts.struct(function () {
    return {
...
exports.Type_472 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
...
exports.VersionedAsset = support_1.sts.closedEnum(function () {
    return {
...
exports.XcmOperation = support_1.sts.closedEnum(function () {
    return {
        ParachainFee: exports.V4Location,
...
exports.Type_423 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_426
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_430
        }),
        V4: support_1.sts.array(function () {
            return exports.Type_433
        }),
    }
})
exports.Type_433 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_427 = support_1.sts.struct(function () {
    return {
...
exports.Type_430 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_426 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Council: exports.Type_373,
        CumulusXcm: exports.Type_376,
        PolkadotXcm: exports.Origin,
        TechnicalCommittee: exports.Type_374,
        Void: exports.Void,
...
exports.Type_374 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_376 = support_1.sts.closedEnum(function () {
    return {
...
exports.Call = support_1.sts.closedEnum(function () {
    return {
        ...
        ParachainInfo: exports.ParachainInfoCall,
...
exports.XTokensCall = support_1.sts.closedEnum(function () {
    return {
        ...
        transfer_multiasset: support_1.sts.enumStruct({
            asset: exports.VersionedAsset,
            dest: exports.VersionedLocation,
            destWeightLimit: exports.V3WeightLimit,
        }),
        transfer_multiasset_with_fee: support_1.sts.enumStruct({
            asset: exports.VersionedAsset,
            fee: exports.VersionedAsset,
            dest: exports.VersionedLocation,
            destWeightLimit: exports.V3WeightLimit,
        }),
...
exports.ParachainInherentData = support_1.sts.struct(function () {
    return {
        validationData: exports.V6PersistedValidationData,
...
exports.V6PersistedValidationData = support_1.sts.struct(function () {
    return {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
exports.ParachainInfoCall = support_1.sts.closedEnum(function () {
    return {}
})
/**
 * Contains a variant per dispatchable extrinsic that this pallet has.
...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_240,
...
exports.Type_240 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.UserAccountManagement
...
exports.DefaultTokenMutation = support_1.sts.struct(function () {
    return {
        behavior: exports.Type_163,
        listingForbidden: exports.Type_166,
        anyoneCanInfuse: exports.Type_166,
        name: exports.Type_167,
    }
})
...
exports.Type_166 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.boolean(),
    }
})
exports.Type_163 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.TokenMarketBehavior

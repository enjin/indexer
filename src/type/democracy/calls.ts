...
export const undelegate = {
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    matrixEnjinV603: new CallType('Democracy.undelegate', sts.unit()),
}
...
export const clearPublicProposals = {
     ...
     * Weight: `O(1)`.
     */
    matrixEnjinV603: new CallType('Democracy.clear_public_proposals', sts.unit()),
}
...
export const setMetadata = {
    ...
    matrixEnjinV603: new CallType(
        ...
        sts.struct({
            ...
            maybeHash: sts.option(() => matrixEnjinV603.H256),
        })
    ),
}

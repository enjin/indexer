...
export const hrmpOpenChannelRequests = {
    ...
    ) as HrmpOpenChannelRequestsEnjinV100,
}
...
export interface HrmpOpenChannelRequestsEnjinV100 {
    ...
    getPairs(
        block: Block,
        key: enjinV100.HrmpChannelId
    ): Promise<[k: enjinV100.HrmpChannelId, v: enjinV100.HrmpOpenChannelRequest | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.HrmpChannelId, v: enjinV100.HrmpOpenChannelRequest | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.HrmpChannelId
...
export const hrmpOpenChannelRequestsList = {
    enjinV100: new StorageType(
        ...
        'Default',
        [],
        sts.array(() => enjinV100.HrmpChannelId)
    ) as HrmpOpenChannelRequestsListEnjinV100,
}
...
export const hrmpOpenChannelRequestCount = {
    ...
    enjinV100: new StorageType(
        ...
        [enjinV100.Id],
        sts.number()
    ) as HrmpOpenChannelRequestCountEnjinV100,
}
...
export const hrmpAcceptedChannelRequestCount = {
    ...
    enjinV100: new StorageType(
        ...
        [enjinV100.Id],
        sts.number()
    ) as HrmpAcceptedChannelRequestCountEnjinV100,
}
...
export const hrmpCloseChannelRequests = {
    ...
    enjinV100: new StorageType(
        ...
        [enjinV100.HrmpChannelId],
        sts.unit()
    ) as HrmpCloseChannelRequestsEnjinV100,
}
...
export interface HrmpCloseChannelRequestsEnjinV100 {
    ...
    getPairsPaged(
        ...
        block: Block,
        key: enjinV100.HrmpChannelId
    ): AsyncIterable<[k: enjinV100.HrmpChannelId, v: null | undefined][]>
}
...
export const hrmpCloseChannelRequestsList = {
    enjinV100: new StorageType(
        ...
        [],
        sts.array(() => enjinV100.HrmpChannelId)
    ) as HrmpCloseChannelRequestsListEnjinV100,
}
...
export interface HrmpChannelsEnjinV100 {
    ...
    getPairs(
        block: Block,
        key: enjinV100.HrmpChannelId
    ): Promise<[k: enjinV100.HrmpChannelId, v: enjinV100.HrmpChannel | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.HrmpChannelId, v: enjinV100.HrmpChannel | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.HrmpChannelId
...
export const hrmpIngressChannelsIndex = {
    ...
    ) as HrmpIngressChannelsIndexEnjinV100,
}
...
export interface HrmpIngressChannelsIndexEnjinV100 {
    ...
    getPairsPaged(
        ...
        block: Block,
        key: enjinV100.Id
    ): AsyncIterable<[k: enjinV100.Id, v: enjinV100.Id[] | undefined][]>
}
...
export const hrmpEgressChannelsIndex = {
    enjinV100: new StorageType(
        ...
        [enjinV100.Id],
        sts.array(() => enjinV100.Id)
    ) as HrmpEgressChannelsIndexEnjinV100,
}
...
export const hrmpChannelContents = {
    ...
    enjinV100: new StorageType(
        ...
        'Default',
        [enjinV100.HrmpChannelId],
        sts.array(() => enjinV100.InboundHrmpMessage)
    ) as HrmpChannelContentsEnjinV100,
}
...
export interface HrmpChannelContentsEnjinV100 {
    ...
    getPairs(
        block: Block,
        key: enjinV100.HrmpChannelId
    ): Promise<[k: enjinV100.HrmpChannelId, v: enjinV100.InboundHrmpMessage[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.HrmpChannelId, v: enjinV100.InboundHrmpMessage[] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.HrmpChannelId
...
export const hrmpChannelDigests = {
    ...
    enjinV100: new StorageType(
        ...
        'Default',
        [enjinV100.Id],
        sts.array(() => sts.tuple(() => [sts.number(), sts.array(() => enjinV100.Id)]))
    ) as HrmpChannelDigestsEnjinV100,
}
...
export interface HrmpChannelDigestsEnjinV100 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV100.Id, v: [number, enjinV100.Id[]][] | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV100.Id

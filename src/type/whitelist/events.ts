...
export const whitelistedCallDispatched = {
    ...
    enjinV100: new EventType(
        ...
        sts.struct({
            callHash: enjinV100.H256,
            result: sts.result(
                () => enjinV100.PostDispatchInfo,
                () => enjinV100.DispatchErrorWithPostInfo
            ),
        })
    ),
    ...
    v100: new EventType(
        ...
        sts.struct({
            callHash: v100.H256,
            result: sts.result(
                () => v100.PostDispatchInfo,
                () => v100.DispatchErrorWithPostInfo
            ),
        })
    ),
    v104: new EventType(
        ...
        sts.struct({
            callHash: v104.H256,
            result: sts.result(
                () => v104.PostDispatchInfo,
                () => v104.DispatchErrorWithPostInfo
            ),
        })
    ),
    v105: new EventType(
        ...
        sts.struct({
            callHash: v105.H256,
            result: sts.result(
                () => v105.PostDispatchInfo,
                () => v105.DispatchErrorWithPostInfo
            ),
        })
    ),
    v1060: new EventType(
        ...
        sts.struct({
            callHash: v1060.H256,
            result: sts.result(
                () => v1060.PostDispatchInfo,
                () => v1060.DispatchErrorWithPostInfo
            ),
        })
    ),
}

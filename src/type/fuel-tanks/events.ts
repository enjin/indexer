...
export const fuelTankMutated = {
    ...
    matrixEnjinV1031: new EventType(
        ...
        sts.struct({
             ...
             */
            tankId: matrixEnjinV1031.AccountId32,
            /**
             * The mutation that was applied
             */
...
export const accountAdded = {
    ...
    matrixEnjinV1031: new EventType(
        ...
        sts.struct({
             ...
             */
            userId: matrixEnjinV1031.AccountId32,
            /**
...
export const dispatchFailed = {
    ...
    matrixEnjinV1031: new EventType(
        ...
        sts.struct({
             ...
             */
            caller: matrixEnjinV1031.AccountId32,
            /**
             * The error
             */
...
export const destroyFuelTankScheduled = {
    name: 'FuelTanks.DestroyFuelTankScheduled',
    /**
     * A fuel tank has been scheduled to be destroyed
     */
    matrixEnjinV1031: new EventType(
        'FuelTanks.DestroyFuelTankScheduled',
        sts.struct({
            /**
             * The account id
             */

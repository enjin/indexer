...
export const createFuelTank = {
    ...
    matrixEnjinV1031: new CallType(
        'FuelTanks.create_fuel_tank',
        sts.struct({
            descriptor: matrixEnjinV1031.FuelTankDescriptor,
        })
    ),
    /**
     * Creates a fuel tank, given a descriptor
    ...
    matrixV1030: new CallType(
        'FuelTanks.create_fuel_tank',
        sts.struct({
            descriptor: matrixV1030.FuelTankDescriptor,
        })
    ),
    /**
     * Creates a fuel tank, given a `descriptor`.
    ...
    matrixV1040: new CallType(
        'FuelTanks.create_fuel_tank',
        sts.struct({
            descriptor: matrixV1040.FuelTankDescriptor,
        })
    ),
    /**
     * Creates a fuel tank, given a descriptor
    ...
    v1060: new CallType(
        'FuelTanks.create_fuel_tank',
        sts.struct({
            descriptor: v1060.FuelTankDescriptor,
        })
    ),
    /**
     * Creates a fuel tank, given a `descriptor`.
...
export const mutateFuelTank = {
    ...
    matrixEnjinV1031: new CallType(
        'FuelTanks.mutate_fuel_tank',
        sts.struct({
            tankId: matrixEnjinV1031.MultiAddress,
            mutation: matrixEnjinV1031.DefaultTankMutation,
        })
    ),
    /**
     * Apply `mutation` to fuel tank with `tank_id`.
    ...
    matrixV1030: new CallType(
        'FuelTanks.mutate_fuel_tank',
        sts.struct({
            tankId: matrixV1030.MultiAddress,
    ...
    enjinV1062: new CallType(
        'FuelTanks.mutate_fuel_tank',
        sts.struct({
            tankId: enjinV1062.MultiAddress,
            mutation: enjinV1062.DefaultTankMutation,
        })
    ),
    /**
     * Apply `mutation` to fuel tank with `tank_id`.
...
export const dispatch = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            ...
            settings: sts.option(() => matrixEnjinV1031.DispatchSettings),
        })
    ),
    /**
     * Dispatch a call using the `tank_id` subject to the rules of `rule_set_id`
    ...
    matrixV1030: new CallType(
        ...
        sts.struct({
            ...
            settings: sts.option(() => matrixV1030.DispatchSettings),
        })
    ),
    /**
    ...
    matrixV1040: new CallType(
        'FuelTanks.dispatch',
        sts.struct({
            tankId: matrixV1040.MultiAddress,
            ruleSetId: sts.option(() => sts.number()),
            call: matrixV1040.Call,
            settings: sts.option(() => matrixV1040.DispatchSettings),
        })
    ),
    /**
     * Dispatch a call using the `tank_id` subject to the rules of `rule_set_id`
    ...
    v1060: new CallType(
        ...
        sts.struct({
            ...
            ruleSetId: sts.number(),
            call: v1060.Call,
            settings: sts.option(() => v1060.DispatchSettings),
        })
    ),
    /**
     * Dispatch a call using the `tank_id` subject to the rules of `rule_set_id`
...
export const insertRuleSet = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            tankId: matrixEnjinV1031.MultiAddress,
            ruleSetId: sts.number(),
            ruleSet: matrixEnjinV1031.RuleSetDescriptor,
        })
    ),
    /**
     * Insert a new rule set for `tank_id` and `rule_set_id`. It can be a new rule set
    ...
    matrixV1030: new CallType(
        ...
        sts.struct({
            tankId: matrixV1030.MultiAddress,
            ruleSetId: sts.number(),
            ruleSet: matrixV1030.RuleSetDescriptor,
        })
    ),
    /**
     * Insert a new rule set for `tank_id` and `rule_set_id`. It can be a new rule set
    ...
    matrixV1040: new CallType(
        ...
        sts.struct({
            tankId: matrixV1040.MultiAddress,
            ruleSetId: sts.number(),
            ruleSet: matrixV1040.RuleSetDescriptor,
        })
    ),
    /**
     * Insert a new rule set for `tank_id` and `rule_set_id`. It can be a new rule set
    ...
    enjinV1062: new CallType(
        ...
        sts.struct({
            tankId: enjinV1062.MultiAddress,
            ruleSetId: sts.number(),
            ruleSet: enjinV1062.RuleSetDescriptor,
        })
    ),
    /**
     * Insert a new rule set for `tank_id` and `rule_set_id`. It can be a new rule set
...
export const forceCreateFuelTank = {
    ...
    matrixEnjinV1031: new CallType(
        'FuelTanks.force_create_fuel_tank',
        sts.struct({
            owner: matrixEnjinV1031.MultiAddress,
            descriptor: matrixEnjinV1031.FuelTankDescriptor,
        })
    ),
    /**
    ...
    matrixV1030: new CallType(
        'FuelTanks.force_create_fuel_tank',
        sts.struct({
            owner: matrixV1030.MultiAddress,
            descriptor: matrixV1030.FuelTankDescriptor,
        })
    ),
    /**
    ...
    matrixV1040: new CallType(
        'FuelTanks.force_create_fuel_tank',
        sts.struct({
            owner: matrixV1040.MultiAddress,
            descriptor: matrixV1040.FuelTankDescriptor,
        })
    ),
    /**
...
export const removeExpiredAccount = {
    name: 'FuelTanks.remove_expired_account',
    /**
     ...
     */
    matrixEnjinV1031: new CallType(
        'FuelTanks.remove_expired_account',
        sts.struct({
            tankId: matrixEnjinV1031.MultiAddress,
            userId: matrixEnjinV1031.MultiAddress,
        })
    ),
}

export const forceInsertRuleSet = {
    name: 'FuelTanks.force_insert_rule_set',
    /**
...
export const removeExpiredAccountUnsigned = {
    name: 'FuelTanks.remove_expired_account_unsigned',
    /**
    ...
    matrixV1040: new CallType(
        'FuelTanks.remove_expired_account_unsigned',
        sts.struct({
            payload: matrixV1040.RemoveExpiredAccountPayload,
            signature: matrixV1040.MultiSignature,
        })
    ),
    /**
     * Remove an expired account via unsigned transaction.
    ...
    enjinV1062: new CallType(
        'FuelTanks.remove_expired_account_unsigned',
        sts.struct({
            payload: enjinV1062.RemoveExpiredAccountPayload,
    ...
    v1070: new CallType(
        'FuelTanks.remove_expired_account_unsigned',
        sts.struct({
            payload: v1070.RemoveExpiredAccountPayload,

...
export const proxy = {
    ...
    matrixEnjinV1031: new CallType(
        'Proxy.proxy',
        sts.struct({
            real: matrixEnjinV1031.MultiAddress,
            forceProxyType: sts.option(() => matrixEnjinV1031.ProxyType),
    ...
    enjinV1070: new CallType(
        'Proxy.proxy',
        sts.struct({
            real: enjinV1070.MultiAddress,
            forceProxyType: sts.option(() => enjinV1070.ProxyType),
...
export const addProxy = {
    ...
    matrixEnjinV1031: new CallType(
        'Proxy.add_proxy',
        sts.struct({
            delegate: matrixEnjinV1031.MultiAddress,
    ...
    enjinV1032: new CallType(
        ...
        sts.struct({
            ...
            proxyType: enjinV1032.ProxyType,
            delay: sts.number(),
        })
    ),
    /**
...
export const killPure = {
    ...
    matrixEnjinV1031: new CallType(
        'Proxy.kill_pure',
        sts.struct({
            spawner: matrixEnjinV1031.MultiAddress,
            proxyType: matrixEnjinV1031.ProxyType,
            index: sts.number(),
            height: sts.number(),
            extIndex: sts.number(),
    ...
    matrixV1010: new CallType(
        'Proxy.kill_pure',
        sts.struct({
            spawner: matrixV1010.MultiAddress,
            proxyType: matrixV1010.ProxyType,
            index: sts.number(),
            height: sts.number(),
            extIndex: sts.number(),
    ...
    enjinV1032: new CallType(
        'Proxy.kill_pure',
        sts.struct({
            spawner: enjinV1032.MultiAddress,
            proxyType: enjinV1032.ProxyType,
            index: sts.number(),
            height: sts.number(),
            extIndex: sts.number(),
...
export const proxyAnnounced = {
    ...
    matrixV1040: new CallType(
        'Proxy.proxy_announced',
        sts.struct({
            delegate: matrixV1040.MultiAddress,
            real: matrixV1040.MultiAddress,
            forceProxyType: sts.option(() => matrixV1040.ProxyType),
            call: matrixV1040.Call,
        })
    ...
    enjinV1070: new CallType(
        'Proxy.proxy_announced',
        sts.struct({
            delegate: enjinV1070.MultiAddress,
            real: enjinV1070.MultiAddress,
            forceProxyType: sts.option(() => enjinV1070.ProxyType),
            call: enjinV1070.Call,
        })
...
export const pokeDeposit = {
     ...
     */
    matrixEnjinV1031: new CallType('Proxy.poke_deposit', sts.unit()),
}

...
exports.PoolBonusInfo = support_1.sts.struct(function () {
    return {
        amount: support_1.sts.bigint(),
        shareCaptureBlock: support_1.sts.option(function () {
            return support_1.sts.number()
        }),
        lastPaymentId: support_1.sts.option(function () {
            return support_1.sts.number()
        }),
        totalPaid: support_1.sts.bigint(),
    }
})
exports.EarlyBirdInfo = support_1.sts.struct(function () {
    return {
        bonusCalculated: support_1.sts.boolean(),
        currentPaymentId: support_1.sts.option(function () {
            return support_1.sts.number()
        }),
        nextPaymentBlock: support_1.sts.option(function () {
            return support_1.sts.number()
        }),
        totalPaid: support_1.sts.bigint(),
    }
...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_257,
...
exports.Type_257 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
...
exports.Type_649 = support_1.sts.struct(function () {
    return {
...
exports.Type_653 = support_1.sts.closedEnum(function () {
    return {
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Origins: exports.Type_421,
        ParachainsOrigin: exports.Origin,
        Void: exports.Void,
        XcmPallet: exports.Type_420,
...
exports.Type_420 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_421 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_497 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_500
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_504
        }),
    }
})
exports.Type_504 = support_1.sts.closedEnum(function () {
    return {
        AliasOrigin: exports.V3MultiLocation,
        BurnAsset: support_1.sts.array(function () {
            return exports.V3MultiAsset
...
exports.Type_501 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
exports.Type_500 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
            fees: exports.V2MultiAsset,
            weightLimit: exports.V2WeightLimit,
...
exports.StakingCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_staking_configs: support_1.sts.enumStruct({
            ...
            maxNominatorCount: exports.Type_379,
            maxValidatorCount: exports.Type_379,
            chillThreshold: exports.Type_380,
            minCommission: exports.Type_381,
        }),
...
exports.Type_381 = support_1.sts.closedEnum(function () {
    return {
...
exports.NominationPoolsCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_configs: support_1.sts.enumStruct({
            minJoinBond: exports.Type_410,
            minCreateBond: exports.Type_410,
            globalMaxCommission: exports.Type_411,
            requiredPayoutCount: exports.Type_411,
        }),
...
exports.Type_532 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
        params: exports.DefaultMintParams,
    }
...
exports.GrandpaCall = support_1.sts.closedEnum(function () {
    return {
        ...
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_388,
            keyOwnerProof: exports.MembershipProof,
        }),
...
exports.Equivocation = support_1.sts.closedEnum(function () {
    return {
        Precommit: exports.Type_395,
        Prevote: exports.Type_390,
    }
})
exports.Type_390 = support_1.sts.struct(function () {
    return {
...
exports.BeefyCall = support_1.sts.closedEnum(function () {
    return {
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_576,
            keyOwnerProof: exports.MembershipProof,
        }),
        report_equivocation_unsigned: support_1.sts.enumStruct({
            equivocationProof: exports.Type_576,
...
exports.Type_576 = support_1.sts.struct(function () {
    return {

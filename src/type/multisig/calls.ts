...
export const asMultiThreshold1 = {
    ...
    matrixEnjinV1022: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => matrixEnjinV1022.AccountId32),
    ...
    matrixEnjinV1031: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => matrixEnjinV1031.AccountId32),
    ...
    matrixV1022: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => matrixV1022.AccountId32),
    ...
    matrixV1023: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => matrixV1023.AccountId32),
    ...
    matrixV1030: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => matrixV1030.AccountId32),
    ...
    matrixV1040: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => matrixV1040.AccountId32),
    ...
    v1060: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => v1060.AccountId32),
            call: v1060.Call,
        })
    ),
    /**
    ...
    v1070: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => v1070.AccountId32),
            call: v1070.Call,
        })
    ),
}
...
export const asMulti = {
    ...
    matrixEnjinV1022: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => matrixEnjinV1022.AccountId32),
            maybeTimepoint: sts.option(() => matrixEnjinV1022.Timepoint),
            call: matrixEnjinV1022.Call,
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => matrixEnjinV1031.AccountId32),
            maybeTimepoint: sts.option(() => matrixEnjinV1031.Timepoint),
            call: matrixEnjinV1031.Call,
            maxWeight: matrixEnjinV1031.Weight,
        })
    ),
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
    ...
    matrixV1022: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => matrixV1022.AccountId32),
            maybeTimepoint: sts.option(() => matrixV1022.Timepoint),
            call: matrixV1022.Call,
    ...
    matrixV1023: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => matrixV1023.AccountId32),
            maybeTimepoint: sts.option(() => matrixV1023.Timepoint),
            call: matrixV1023.Call,
            maxWeight: matrixV1023.Weight,
        })
    ),
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
    ...
    matrixV1030: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => matrixV1030.AccountId32),
            maybeTimepoint: sts.option(() => matrixV1030.Timepoint),
            call: matrixV1030.Call,
    ...
    matrixV1040: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => matrixV1040.AccountId32),
            maybeTimepoint: sts.option(() => matrixV1040.Timepoint),
            call: matrixV1040.Call,
            maxWeight: matrixV1040.Weight,
        })
    ),
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
    ...
    v1060: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => v1060.AccountId32),
            maybeTimepoint: sts.option(() => v1060.Timepoint),
            call: v1060.Call,
    ...
    v1070: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => v1070.AccountId32),
            maybeTimepoint: sts.option(() => v1070.Timepoint),
            call: v1070.Call,
            maxWeight: v1070.Weight,
        })
    ),
}

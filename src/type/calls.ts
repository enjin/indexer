...
export * as ismp from './ismp/calls'
export * as ismpGrandpa from './ismp-grandpa/calls'
export * as tokenGateway from './token-gateway/calls'
export * as assetConversion from './asset-conversion/calls'
export * as onDemandAssignmentProvider from './on-demand-assignment-provider/calls'
export * as coretime from './coretime/calls'

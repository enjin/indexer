...
exports.BalanceToUnlock = support_1.sts.struct(function () {
    return {
        balance: support_1.sts.bigint(),
        currency: exports.VoteCurrency,
        unlocksAt: support_1.sts.number(),
    }
})
exports.EraPayout = support_1.sts.struct(function () {
    return {
        ...
        requiredPaymentsPercent: exports.Perbill,
    }
})
exports.EventRecord = support_1.sts.struct(function () {
    return {
        phase: exports.Type_651,
        event: exports.Event,
...
exports.DefaultTokenMutation = support_1.sts.struct(function () {
    return {
        behavior: exports.Type_192,
        listingForbidden: exports.Type_195,
        metadata: exports.Type_196,
    }
})
...
exports.Type_192 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.TokenMarketBehavior
...
exports.Type_179 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
            return exports.DefaultRoyalty
...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_255,
...
exports.Type_255 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: support_1.sts.option(function () {
...
exports.Type_647 = support_1.sts.struct(function () {
    return {
...
exports.Type_651 = support_1.sts.closedEnum(function () {
    return {
...
exports.CreateOffer = support_1.sts.struct(function () {
    return {
        ...
        minAverageRewardRate: exports.Perbill,
    }
})
...
exports.Type_408 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
...
exports.StakingCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_staking_configs: support_1.sts.enumStruct({
            ...
            maxNominatorCount: exports.Type_377,
            maxValidatorCount: exports.Type_377,
            chillThreshold: exports.Type_378,
            minCommission: exports.Type_379,
        }),
...
exports.Type_377 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
...
exports.NominationPoolsCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_configs: support_1.sts.enumStruct({
            minJoinBond: exports.Type_408,
            minCreateBond: exports.Type_408,
            globalMaxCommission: exports.Type_409,
            requiredPayoutCount: exports.Type_409,
        }),
...
exports.MultiTokensCall = support_1.sts.closedEnum(function () {
    return {
        ...
        force_create_ethereum_collection: support_1.sts.enumStruct({
            ...
            ethereumCollectionId: support_1.sts.bigint(),
            tokenRange: exports.RangeInclusive,
            descriptor: exports.DefaultCollectionDescriptor,
        }),
...
exports.GrandpaCall = support_1.sts.closedEnum(function () {
    return {
        ...
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_386,
            keyOwnerProof: exports.MembershipProof,
        }),
...
exports.Type_386 = support_1.sts.struct(function () {
    return {
...
exports.Equivocation = support_1.sts.closedEnum(function () {
    return {
        Precommit: exports.Type_393,
        Prevote: exports.Type_388,
    }
})
...
exports.Type_393 = support_1.sts.struct(function () {
    return {
        roundNumber: support_1.sts.bigint(),
        identity: exports.Public,
        first: support_1.sts.tuple(function () {
...
exports.BeefyCall = support_1.sts.closedEnum(function () {
    return {
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_574,
            keyOwnerProof: exports.MembershipProof,
        }),
        report_equivocation_unsigned: support_1.sts.enumStruct({
            equivocationProof: exports.Type_574,
...
exports.Type_574 = support_1.sts.struct(function () {
    return {

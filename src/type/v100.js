...
exports.WrapperOpaque =
    ...
    exports.V2CandidateReceipt =
    exports.V2ValidatorIndex =
    exports.V2ValidityAttestation =
    exports.V2InvalidDisputeStatementKind =
    exports.V2ValidDisputeStatementKind =
    exports.V2DisputeStatement =
    exports.V2DisputeStatementSet =
    exports.V2ScrapedOnChainVotes =
    exports.V2Public =
    exports.V2ParathreadClaim =
    exports.V2ParathreadEntry =
    exports.V2CoreOccupied =
...
exports.RawOrigin =
    ...
    exports.Type_359 =
    exports.Type_360 =
    exports.V2AvailabilityBitfield =
    exports.V2UncheckedSigned =
    exports.OutboundHrmpMessage =
    exports.ValidationCode =
    exports.V2CandidateCommitments =
    exports.V2CommittedCandidateReceipt =
    exports.V2BackedCandidate =
    exports.DigestItem =
    exports.Digest =
        void 0
exports.DmpCall =
...
exports.Type_780 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_781 = support_1.sts.struct(function () {
    return {
...
exports.Type_495 = support_1.sts.struct(function () {
    return {
...
exports.V2CoreOccupied = support_1.sts.closedEnum(function () {
    return {
        Parachain: support_1.sts.unit(),
        Parathread: exports.V2ParathreadEntry,
    }
})
exports.V2ParathreadEntry = support_1.sts.struct(function () {
    return {
        claim: exports.V2ParathreadClaim,
        retries: support_1.sts.number(),
    }
})
exports.V2ParathreadClaim = support_1.sts.tuple(function () {
    return [exports.Id, exports.V2Public]
})
exports.V2Public = support_1.sts.bytes()
exports.V2ScrapedOnChainVotes = support_1.sts.struct(function () {
    return {
            ...
            return support_1.sts.tuple(function () {
                return [
                    ...
                    support_1.sts.array(function () {
                        return support_1.sts.tuple(function () {
                            return [exports.V2ValidatorIndex, exports.V2ValidityAttestation]
                        })
                    }),
                ]
            })
        ...
        disputes: support_1.sts.array(function () {
            return exports.V2DisputeStatementSet
        }),
    }
})
exports.V2DisputeStatementSet = support_1.sts.struct(function () {
    return {
        candidateHash: exports.CandidateHash,
        session: support_1.sts.number(),
        statements: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
                return [exports.V2DisputeStatement, exports.V2ValidatorIndex, support_1.sts.bytes()]
            })
        }),
    }
})
exports.V2DisputeStatement = support_1.sts.closedEnum(function () {
    return {
        Invalid: exports.V2InvalidDisputeStatementKind,
        Valid: exports.V2ValidDisputeStatementKind,
    }
})
exports.V2ValidDisputeStatementKind = support_1.sts.closedEnum(function () {
    return {
...
exports.V2InvalidDisputeStatementKind = support_1.sts.closedEnum(function () {
    return {
        Explicit: support_1.sts.unit(),
    }
})
exports.V2ValidityAttestation = support_1.sts.closedEnum(function () {
    return {
        Explicit: support_1.sts.bytes(),
        Implicit: support_1.sts.bytes(),
    }
})
exports.V2ValidatorIndex = support_1.sts.number()
exports.V2CandidateReceipt = support_1.sts.struct(function () {
    return {
        descriptor: exports.V2CandidateDescriptor,
        commitmentsHash: exports.H256,
    }
})
exports.V2CandidateDescriptor = support_1.sts.struct(function () {
    return {
        paraId: exports.Id,
        relayParent: exports.H256,
        collator: exports.V2Public,
        persistedValidationDataHash: exports.H256,
        povHash: exports.H256,
        erasureRoot: exports.H256,
        signature: exports.V2Signature,
        paraHead: exports.H256,
        validationCodeHash: exports.ValidationCodeHash,
    }
})
exports.V2Signature = support_1.sts.bytes()
exports.HostConfiguration = support_1.sts.struct(function () {
    return {
        ...
        disputeConclusionByTimeOutPeriod: support_1.sts.number(),
...
exports.Commission = support_1.sts.struct(function () {
    return {
        current: support_1.sts.option(function () {
            return support_1.sts.tuple(function () {
                return [exports.Perbill, exports.AccountId32]
            })
        }),
...
exports.SecondaryVRFPreDigest = support_1.sts.struct(function () {
    return {
        ...
        slot: exports.Slot,
        vrfOutput: support_1.sts.bytes(),
        vrfProof: support_1.sts.bytes(),
    }
})
...
exports.AccountData = support_1.sts.struct(function () {
    return {
        free: support_1.sts.bigint(),
        reserved: support_1.sts.bigint(),
        miscFrozen: support_1.sts.bigint(),
        feeFrozen: support_1.sts.bigint(),
    }
})
...
exports.ParasDisputesEvent = support_1.sts.closedEnum(function () {
    return {
        ...
        DisputeTimedOut: exports.CandidateHash,
...
exports.ParaInclusionEvent = support_1.sts.closedEnum(function () {
    return {
        CandidateBacked: support_1.sts.tuple(function () {
            return [exports.V2CandidateReceipt, exports.HeadData, exports.V2CoreIndex, exports.V2GroupIndex]
        }),
        CandidateIncluded: support_1.sts.tuple(function () {
            return [exports.V2CandidateReceipt, exports.HeadData, exports.V2CoreIndex, exports.V2GroupIndex]
        }),
        CandidateTimedOut: support_1.sts.tuple(function () {
            return [exports.V2CandidateReceipt, exports.HeadData, exports.V2CoreIndex]
        }),
    }
})
exports.V2GroupIndex = support_1.sts.number()
exports.V2CoreIndex = support_1.sts.number()
...
exports.NominationPoolsEvent = support_1.sts.closedEnum(function () {
    return {
        ...
        PoolCommissionChangeRateUpdated: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            changeRate: exports.CommissionChangeRate,
        }),
        PoolCommissionClaimed: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            commission: support_1.sts.bigint(),
        }),
        PoolCommissionUpdated: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            current: support_1.sts.option(function () {
                return support_1.sts.tuple(function () {
                    return [exports.Perbill, exports.AccountId32]
        ...
        PoolMaxCommissionUpdated: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            maxCommission: exports.Perbill,
        }),
        PoolSlashed: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            balance: support_1.sts.bigint(),
        }),
        RolesUpdated: support_1.sts.enumStruct({
            root: support_1.sts.option(function () {
                return exports.AccountId32
            }),
            nominator: support_1.sts.option(function () {
...
exports.Type_497 = support_1.sts.closedEnum(function () {
    return {
...
exports.AccountInfo = support_1.sts.struct(function () {
    return {
        nonce: support_1.sts.number(),
        consumers: support_1.sts.number(),
        providers: support_1.sts.number(),
        sufficients: support_1.sts.number(),
        data: exports.AccountData,
    }
})
...
exports.Type_435 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_438
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_442
        }),
    }
})
exports.Type_442 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_438 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
...
exports.V2InherentData = support_1.sts.struct(function () {
    return {
        bitfields: support_1.sts.array(function () {
            return exports.V2UncheckedSigned
        }),
        backedCandidates: support_1.sts.array(function () {
            return exports.V2BackedCandidate
        }),
        disputes: support_1.sts.array(function () {
            return exports.V2DisputeStatementSet
        }),
...
exports.V2BackedCandidate = support_1.sts.struct(function () {
    return {
        candidate: exports.V2CommittedCandidateReceipt,
        validityVotes: support_1.sts.array(function () {
            return exports.V2ValidityAttestation
        }),
        validatorIndices: support_1.sts.bitseq(),
    }
})
exports.V2CommittedCandidateReceipt = support_1.sts.struct(function () {
    return {
        descriptor: exports.V2CandidateDescriptor,
        commitments: exports.V2CandidateCommitments,
    }
})
exports.V2CandidateCommitments = support_1.sts.struct(function () {
    return {
...
exports.V2UncheckedSigned = support_1.sts.struct(function () {
    return {
        payload: exports.V2AvailabilityBitfield,
        validatorIndex: exports.V2ValidatorIndex,
        signature: support_1.sts.bytes(),
    }
})
exports.V2AvailabilityBitfield = support_1.sts.bitseq()
exports.Type_360 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.AccountId32,
    }
})
exports.Type_359 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Perbill,
...
exports.Type_358 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
...
exports.BondExtra = support_1.sts.closedEnum(function () {
    return {
        FreeBalance: support_1.sts.bigint(),
    }
})
...
exports.Type_335 = support_1.sts.struct(function () {
    return {
...
exports.Equivocation = support_1.sts.closedEnum(function () {
    return {
        Precommit: exports.Type_342,
        Prevote: exports.Type_337,
    }
})
exports.Type_337 = support_1.sts.struct(function () {
    return {
...
exports.Type_342 = support_1.sts.struct(function () {
    return {
        roundNumber: support_1.sts.bigint(),
        identity: exports.Public,
        first: support_1.sts.tuple(function () {
...
exports.Type_328 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Perbill,
...
exports.Type_327 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Percent,
...
exports.Type_326 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
...
exports.Type_469 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Origins: exports.Type_368,
        ParachainsOrigin: exports.Origin,
        Void: exports.Void,
        XcmPallet: exports.Type_367,
...
exports.Type_367 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_368 = support_1.sts.closedEnum(function () {
    return {
...
exports.StakingCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_staking_configs: support_1.sts.enumStruct({
            ...
            maxNominatorCount: exports.Type_326,
            maxValidatorCount: exports.Type_326,
            chillThreshold: exports.Type_327,
            minCommission: exports.Type_328,
        }),
...
exports.ParasCall = support_1.sts.closedEnum(function () {
    return {
        ...
        include_pvf_check_statement: support_1.sts.enumStruct({
            stmt: exports.V2PvfCheckStatement,
            signature: support_1.sts.bytes(),
        }),
...
exports.V2PvfCheckStatement = support_1.sts.struct(function () {
    return {
...
exports.NominationPoolsCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_commission: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
        ...
        set_commission_change_rate: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            changeRate: exports.CommissionChangeRate,
        }),
        set_commission_max: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            maxCommission: exports.Perbill,
        }),
        set_configs: support_1.sts.enumStruct({
            minJoinBond: exports.Type_358,
            minCreateBond: exports.Type_358,
            globalMaxCommission: exports.Type_359,
        }),
        unbond: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
        ...
        update_roles: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            newRoot: exports.Type_360,
            newNominator: exports.Type_360,
        }),
        withdraw_unbonded: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            memberAccount: exports.MultiAddress,
...
exports.GrandpaCall = support_1.sts.closedEnum(function () {
    return {
        ...
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_335,
            keyOwnerProof: exports.Void,
        }),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
exports.DmpCall = support_1.sts.closedEnum(function () {
    return {}
})
/**
 * Contains one variant per dispatchable that can be called by an extrinsic.
...
exports.ConfigurationCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_dispute_conclusion_by_time_out_period: support_1.sts.enumStruct({
            new: support_1.sts.number(),
        }),
...
exports.Offer = support_1.sts.struct(function () {
    return {
        ...
        total: support_1.sts.bigint(),
        rate: exports.FixedU128,
        maxPoolDuration: support_1.sts.number(),
        minAverageCommission: exports.Percent,
    }
})
...
exports.DefaultTokenMutation = support_1.sts.struct(function () {
    return {
        behavior: exports.Type_181,
        listingForbidden: exports.Type_184,
        metadata: exports.Type_185,
    }
})
exports.Type_185 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: exports.DefaultTokenMetadata,
    }
})
exports.Type_184 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),

...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Council: exports.Type_317,
        CumulusXcm: exports.Type_320,
        PolkadotXcm: exports.Origin,
        TechnicalCommittee: exports.Type_318,
        Void: exports.Void,
...
exports.Type_320 = support_1.sts.closedEnum(function () {
    return {
        Relay: support_1.sts.unit(),
        SiblingParachain: exports.Id,
    }
})
exports.Type_317 = support_1.sts.closedEnum(function () {
    return {
        Member: exports.AccountId32,
        Members: support_1.sts.tuple(function () {
            return [support_1.sts.number(), support_1.sts.number()]
...
exports.Type_352 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_355
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_359
        }),
    }
})
...
exports.Type_356 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
exports.Type_355 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
            fees: exports.V2MultiAsset,
            weightLimit: exports.V2WeightLimit,

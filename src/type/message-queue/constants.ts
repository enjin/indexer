...
export const heapSize = {
     ...
     */
    matrixEnjinV1012: new ConstantType('MessageQueue.HeapSize', sts.number()),
}
...
export const maxStale = {
     ...
     */
    matrixEnjinV1012: new ConstantType('MessageQueue.MaxStale', sts.number()),
}
...
export const idleMaxServiceWeight = {
    ...
    matrixEnjinV1022: new ConstantType(
        ...
        sts.option(() => matrixEnjinV1022.Weight)
    ),
}

...
export const createListing = {
    ...
    enjinV1062: new CallType(
        'Marketplace.create_listing',
        sts.struct({
            descriptor: enjinV1062.ListingDescriptor,
        })
    ),
    /**
     * Places a sell order. Requires `make_asset_id` or `take_asset_id` to be a currency.
    ...
    v1060: new CallType(
        'Marketplace.create_listing',
        sts.struct({
            descriptor: v1060.ListingDescriptor,
        })
    ),
}
...
export const removeExpiredListingUnsigned = {
    name: 'Marketplace.remove_expired_listing_unsigned',
    /**
    ...
    matrixV1030: new CallType(
        ...
        sts.struct({
            payload: matrixV1030.RemoveExpiredListingPayload,
...
export const finalizeAuctionUnsigned = {
    name: 'Marketplace.finalize_auction_unsigned',
    /**
    ...
    matrixV1030: new CallType(
        ...
        sts.struct({
            payload: matrixV1030.FinalizeAuctionPayload,
            signature: matrixV1030.MultiSignature,
        })
    ),
}

...
exports.XTokensEvent =
    ...
    exports.EventRecord =
    exports.Id =
    exports.V2AbridgedHrmpChannel =
    exports.MessagingStateSnapshot =
    exports.V2AbridgedHostConfiguration =
    exports.Bounded =
    exports.Scheduled =
    exports.AccountData =
    ...
    exports.IdleOperation =
    exports.WeightedIdleOperation =
...
exports.MarketPlaceInfo = support_1.sts.struct(function () {
    return {
        ...
        fixedPriceListingCount: support_1.sts.number(),
        auctionListingCount: support_1.sts.number(),
    }
})
...
exports.WeightedIdleOperation = support_1.sts.struct(function () {
    return {
        operation: exports.IdleOperation,
        estimatedWeight: exports.Weight,
    }
})
exports.IdleOperation = support_1.sts.closedEnum(function () {
    return {
        DeleteAttributes: support_1.sts.enumStruct({
            collectionId: support_1.sts.bigint(),
...
exports.V2AbridgedHostConfiguration = support_1.sts.struct(function () {
    return {
...
exports.MessagingStateSnapshot = support_1.sts.struct(function () {
    return {
        ...
        relayDispatchQueueSize: support_1.sts.tuple(function () {
            return [support_1.sts.number(), support_1.sts.number()]
        }),
        ingressChannels: support_1.sts.array(function () {
            return support_1.sts.tuple(function () {
                return [exports.Id, exports.V2AbridgedHrmpChannel]
            })
        }),
...
exports.V2AbridgedHrmpChannel = support_1.sts.struct(function () {
    return {
...
exports.Type_338 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_341
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_345
        }),
    }
})
exports.Type_345 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_341 = support_1.sts.closedEnum(function () {
    return {
        BuyExecution: support_1.sts.enumStruct({
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Council: exports.Type_299,
        CumulusXcm: exports.Type_302,
        PolkadotXcm: exports.Origin,
        TechnicalCommittee: exports.Type_300,
        Void: exports.Void,
...
exports.Type_302 = support_1.sts.closedEnum(function () {
    return {
        Relay: support_1.sts.unit(),
        SiblingParachain: exports.Id,
    }
})
exports.Type_299 = support_1.sts.closedEnum(function () {
    return {
        Member: exports.AccountId32,
        Members: support_1.sts.tuple(function () {
            return [support_1.sts.number(), support_1.sts.number()]
...
exports.DefaultTankMutation = support_1.sts.struct(function () {
    return {
        userAccountManagement: exports.Type_207,
...
exports.Type_207 = support_1.sts.closedEnum(function () {
    return {

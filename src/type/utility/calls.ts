...
export const batch = {
    ...
    matrixEnjinV1031: new CallType(
        'Utility.batch',
        sts.struct({
            calls: sts.array(() => matrixEnjinV1031.Call),
        })
    ),
    /**
     * Send a batch of dispatch calls.
    ...
    matrixV1030: new CallType(
        'Utility.batch',
        sts.struct({
            calls: sts.array(() => matrixV1030.Call),
        })
    ),
    /**
     * Send a batch of dispatch calls.
    ...
    matrixV1040: new CallType(
        'Utility.batch',
        sts.struct({
            calls: sts.array(() => matrixV1040.Call),
        })
    ),
    /**
     * Send a batch of dispatch calls.
    ...
    enjinV1062: new CallType(
        'Utility.batch',
        sts.struct({
            calls: sts.array(() => enjinV1062.Call),
        })
    ),
    /**
     * Send a batch of dispatch calls.
    ...
    enjinV1070: new CallType(
        'Utility.batch',
        sts.struct({
            calls: sts.array(() => enjinV1070.Call),
        })
    ),
    /**
     * Send a batch of dispatch calls.
...
export const dispatchAs = {
    ...
    matrixEnjinV1031: new CallType(
        'Utility.dispatch_as',
        sts.struct({
            asOrigin: matrixEnjinV1031.OriginCaller,
            call: matrixEnjinV1031.Call,
        })
    ),
    /**
    ...
    matrixV1030: new CallType(
        'Utility.dispatch_as',
        sts.struct({
            asOrigin: matrixV1030.OriginCaller,
            call: matrixV1030.Call,
        })
    ),
    /**
    ...
    enjinV1062: new CallType(
        'Utility.dispatch_as',
        sts.struct({
            asOrigin: enjinV1062.OriginCaller,
            call: enjinV1062.Call,
        })
    ),
    /**
    ...
    enjinV1070: new CallType(
        'Utility.dispatch_as',
        sts.struct({
            asOrigin: enjinV1070.OriginCaller,
            call: enjinV1070.Call,
        })
    ),
    /**
...
export const withWeight = {
    ...
    matrixEnjinV1031: new CallType(
        ...
        sts.struct({
            call: matrixEnjinV1031.Call,
            weight: matrixEnjinV1031.Weight,
        })
    ),
    /**
     * Dispatch a function call with a specified weight.
...
export const ifElse = {
    ...
    matrixEnjinV1031: new CallType(
        'Utility.if_else',
        sts.struct({
            main: matrixEnjinV1031.Call,
            fallback: matrixEnjinV1031.Call,
        })
    ),
    /**
     * Dispatch a fallback call in the event the main call fails to execute.
    ...
    matrixV1030: new CallType(
        'Utility.if_else',
        sts.struct({
            main: matrixV1030.Call,
            fallback: matrixV1030.Call,
        })
    ),
    /**
     * Dispatch a fallback call in the event the main call fails to execute.
    ...
    enjinV1062: new CallType(
        'Utility.if_else',
        sts.struct({
            main: enjinV1062.Call,
            fallback: enjinV1062.Call,
        })
    ),
    /**
     * Dispatch a fallback call in the event the main call fails to execute.
    ...
    enjinV1070: new CallType(
        'Utility.if_else',
        sts.struct({
            main: enjinV1070.Call,
            fallback: enjinV1070.Call,
        })
    ),
    /**
     * Dispatch a fallback call in the event the main call fails to execute.

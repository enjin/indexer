...
exports.NominationPoolsEvent = support_1.sts.closedEnum(function () {
    return {
        ...
        BonusReceived: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            amount: support_1.sts.bigint(),
        }),
        CommissionChangeRateUpdated: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            changeRate: exports.CommissionChangeRate,
        }),
        CommissionPaid: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            beneficiary: exports.AccountId32,
            amount: support_1.sts.bigint(),
        }),
        ...
        MaxCommissionUpdated: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
        ...
        RewardReinvested: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            amount: support_1.sts.bigint(),
        }),
...
exports.DefaultTokenMutation = support_1.sts.struct(function () {
    return {
        behavior: exports.Type_184,
        listingForbidden: exports.Type_187,
        metadata: exports.Type_188,
    }
})
exports.Type_188 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
        SomeMutation: exports.DefaultTokenMetadata,
    }
})
exports.Type_187 = support_1.sts.closedEnum(function () {
    return {
        NoMutation: support_1.sts.unit(),
...
exports.Type_508 = support_1.sts.struct(function () {
    return {
...
exports.ClaimsEvent = support_1.sts.closedEnum(function () {
    return {
        ...
        ClaimedEnj: support_1.sts.enumStruct({
            who: exports.AccountId32,
            amount: support_1.sts.bigint(),
        }),
    }
...
exports.Type_510 = support_1.sts.closedEnum(function () {
    return {
...
exports.OriginCaller = support_1.sts.closedEnum(function () {
    return {
        Origins: exports.Type_371,
        ParachainsOrigin: exports.Origin,
        Void: exports.Void,
        XcmPallet: exports.Type_370,
...
exports.Type_370 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_448 = support_1.sts.closedEnum(function () {
    return {
        V2: support_1.sts.array(function () {
            return exports.Type_451
        }),
        V3: support_1.sts.array(function () {
            return exports.Type_455
        }),
    }
})
...
exports.Type_452 = support_1.sts.struct(function () {
    return {
        encoded: support_1.sts.bytes(),
    }
})
...
exports.StakingCall = support_1.sts.closedEnum(function () {
    return {
        ...
        set_staking_configs: support_1.sts.enumStruct({
            ...
            maxNominatorCount: exports.Type_329,
            maxValidatorCount: exports.Type_329,
            chillThreshold: exports.Type_330,
            minCommission: exports.Type_331,
        }),
...
exports.Type_331 = support_1.sts.closedEnum(function () {
    return {
...
exports.Type_330 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
        Set: exports.Percent,
...
exports.Type_329 = support_1.sts.closedEnum(function () {
    return {
        Noop: support_1.sts.unit(),
        Remove: support_1.sts.unit(),
...
exports.NominationPoolsCall = support_1.sts.closedEnum(function () {
    return {
        ...
        mutate_pool: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            mutation: exports.PoolMutation,
        }),
        nominate: support_1.sts.enumStruct({
        ...
        set_configs: support_1.sts.enumStruct({
            minJoinBond: exports.Type_361,
            minCreateBond: exports.Type_361,
            globalMaxCommission: exports.Type_362,
        }),
        unbond: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
        ...
        update_roles: support_1.sts.enumStruct({
            poolId: support_1.sts.number(),
            newRoot: exports.Type_363,
            newNominator: exports.Type_363,
        }),
...
exports.Type_482 = support_1.sts.struct(function () {
    return {
        accountId: exports.AccountId32,
        params: exports.DefaultMintParams,
    }
...
exports.GrandpaCall = support_1.sts.closedEnum(function () {
    return {
        ...
        report_equivocation: support_1.sts.enumStruct({
            equivocationProof: exports.Type_338,
...
exports.Type_338 = support_1.sts.struct(function () {
    return {
...
exports.Equivocation = support_1.sts.closedEnum(function () {
    return {
        Precommit: exports.Type_345,
        Prevote: exports.Type_340,
    }
})
...
exports.Type_345 = support_1.sts.struct(function () {
    return {
        roundNumber: support_1.sts.bigint(),
        identity: exports.Public,
        first: support_1.sts.tuple(function () {
...
exports.ClaimsCall = support_1.sts.closedEnum(function () {
    return {
        approve_claims: support_1.sts.enumStruct({
            blockNumber: support_1.sts.number(),
        ...
        claim_from_efinity: support_1.sts.enumStruct({
        ...
        mint_enj_from_native_efi: support_1.sts.enumStruct({
            amount: support_1.sts.bigint(),
        }),

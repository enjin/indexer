...
export const attributeDepositBase =  {
    ...
    matrixEnjinV603: new ConstantType(
        'MultiTokens.AttributeDepositBase',
        sts.bigint()
    ),
}
...
export const attributeDepositPerByte =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.AttributeDepositPerByte',
        sts.bigint()
    ),
}
...
export const maxRecipientsPerBatchTransfer =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MaxRecipientsPerBatchTransfer',
        sts.number()
    ),
}
...
export const maxTokensPerBatchTransfer =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MaxTokensPerBatchTransfer',
        sts.number()
    ),
}
...
export const maxBatchAttributesPerCall =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MaxBatchAttributesPerCall',
        sts.number()
    ),
}
...
export const maxRecipientsPerBatchMint =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MaxRecipientsPerBatchMint',
        sts.number()
    ),
}
...
export const collectionCreationDeposit =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.CollectionCreationDeposit',
        sts.bigint()
    ),
}
...
export const tokenAccountDeposit =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.TokenAccountDeposit',
        sts.bigint()
    ),
}
...
export const maxIdleOperationQueueLength =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MaxIdleOperationQueueLength',
        sts.number()
    ),
}
...
export const maxIdleOperationQueueWeight =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MaxIdleOperationQueueWeight',
...
export const maxOperatorsPerAccount =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MaxOperatorsPerAccount',
        sts.number()
    ),
}
...
export const maxExplicitRoyaltyCurrencies =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MaxExplicitRoyaltyCurrencies',
        sts.number()
    ),
}
...
export const nativeAssetInfo =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.NativeAssetInfo',
        matrixEnjinV603.NativeAssetInfo
    ),
}
...
export const tokenMetadataMaxNameLength =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.TokenMetadataMaxNameLength',
        sts.number()
    ),
}
...
export const tokenMetadataMaxSymbolLength =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.TokenMetadataMaxSymbolLength',
        sts.number()
    ),
}
...
export const maxMigrationKeyLength =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MaxMigrationKeyLength',
        sts.number()
    ),
}
...
export const migrationWeightLimitPercentage =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MigrationWeightLimitPercentage',
...
export const maxClaimableTokensPerCall =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.MaxClaimableTokensPerCall',
        sts.number()
    ),
}
...
export const claimCollectionsPrefix =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'MultiTokens.ClaimCollectionsPrefix',
        sts.bytes()
    ),
}
...
export const ethereumMigrationAccountId =  {
     ...
     */
    matrixEnjinV1002: new ConstantType(
...
export const maxTokenGroupsPerToken =  {
    ...
    matrixEnjinV1012: new ConstantType(
        'MultiTokens.MaxTokenGroupsPerToken',
        sts.number()
    ),
}
...
export const migrationReimburser =  {
     ...
     */
    matrixEnjinV1012: new ConstantType(
        'MultiTokens.MigrationReimburser',
...
export const tokenGroupDeposit =  {
     ...
     *  maintained
     */
    matrixEnjinV1022: new ConstantType(
        'MultiTokens.TokenGroupDeposit',
        sts.bigint()
    ),
}
...
export const maxRoyaltyBeneficiaries =  {
     ...
     */
    matrixEnjinV1022: new ConstantType(
        'MultiTokens.MaxRoyaltyBeneficiaries',
        sts.number()
    ),
}
...
export const maxAttributesToRead =  {
     ...
     */
    matrixEnjinV1022: new ConstantType(
        'MultiTokens.MaxAttributesToRead',
        sts.number()
    ),
}
...
export const maxUpgradeBatchSize =  {
     ...
     */
    matrixEnjinV1022: new ConstantType(
        'MultiTokens.MaxUpgradeBatchSize',
        sts.number()
    ),
}
...
export const maxCollectionAccountUpdateCount =  {
     ...
     */
    matrixEnjinV1022: new ConstantType(
        'MultiTokens.MaxCollectionAccountUpdateCount',
        sts.number()
    ),
}

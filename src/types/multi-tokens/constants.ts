...
export const tokenGroupDeposit = {
     ...
     *  maintained
     */
    matrixEnjinV1022: new ConstantType('MultiTokens.TokenGroupDeposit', sts.bigint()),
}
...
export const maxRoyaltyBeneficiaries = {
     ...
     */
    matrixEnjinV1022: new ConstantType('MultiTokens.MaxRoyaltyBeneficiaries', sts.number()),
}
...
export const maxTokensToRead = {
     ...
     */
    matrixEnjinV1022: new ConstantType('MultiTokens.MaxTokensToRead', sts.number()),
}
...
export const maxAttributesToRead = {
     ...
     */
    matrixEnjinV1022: new ConstantType('MultiTokens.MaxAttributesToRead', sts.number()),
}
...
export const maxKeyLength = {
     ...
     */
    matrixEnjinV1022: new ConstantType('MultiTokens.MaxKeyLength', sts.number()),
}
...
export const maxUpgradeBatchSize = {
     ...
     */
    matrixEnjinV1022: new ConstantType('MultiTokens.MaxUpgradeBatchSize', sts.number()),
}

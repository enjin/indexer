...
export const account =  {
     ...
     *  NOTE: This is only used in the case that this pallet is used to store balances.
     */
    matrixV500: new StorageType('Balances.Account', 'Default', [matrixV500.AccountId32], matrixV500.AccountData) as AccountMatrixV500,
    /**
     *  The Balances pallet example of storing the balance of an account.
     * 
     *  # Example
     ...
     *  NOTE: This is only used in the case that this pallet is used to store balances.
     */
    matrixV602: new StorageType('Balances.Account', 'Default', [matrixV602.AccountId32], matrixV602.AccountData) as AccountMatrixV602,
    /**
     *  The Balances pallet example of storing the balance of an account.
     * 
     *  # Example
...
export interface AccountMatrixV500  {
    ...
    getPairs(block: Block, key: matrixV500.AccountId32): Promise<[k: matrixV500.AccountId32, v: (matrixV500.AccountData | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: matrixV500.AccountId32, v: (matrixV500.AccountData | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: matrixV500.AccountId32): AsyncIterable<[k: matrixV500.AccountId32, v: (matrixV500.AccountData | undefined)][]>
}
...
export interface AccountMatrixV602  {
    ...
    getPairs(block: Block, key: matrixV602.AccountId32): Promise<[k: matrixV602.AccountId32, v: (matrixV602.AccountData | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: matrixV602.AccountId32, v: (matrixV602.AccountData | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: matrixV602.AccountId32): AsyncIterable<[k: matrixV602.AccountId32, v: (matrixV602.AccountData | undefined)][]>
}
...
export interface AccountV104  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v104.AccountId32, v: (v104.AccountData | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v104.AccountId32): AsyncIterable<[k: v104.AccountId32, v: (v104.AccountData | undefined)][]>
}
...
export const holds =  {
     ...
     *  Holds on account balances.
     */
    matrixEnjinV1012: new StorageType('Balances.Holds', 'Default', [matrixEnjinV1012.AccountId32], sts.array(() => matrixEnjinV1012.IdAmount)) as HoldsMatrixEnjinV1012,
    /**
     *  Holds on account balances.
     */
    matrixEnjinV1022: new StorageType('Balances.Holds', 'Default', [matrixEnjinV1022.AccountId32], sts.array(() => matrixEnjinV1022.IdAmount)) as HoldsMatrixEnjinV1022,
    /**
     *  Holds on account balances.
     */
    matrixV602: new StorageType('Balances.Holds', 'Default', [matrixV602.AccountId32], sts.array(() => matrixV602.IdAmount)) as HoldsMatrixV602,
    /**
     *  Holds on account balances.
     */
    matrixV1010: new StorageType('Balances.Holds', 'Default', [matrixV1010.AccountId32], sts.array(() => matrixV1010.IdAmount)) as HoldsMatrixV1010,
    /**
     *  Holds on account balances.
     */
    matrixV1020: new StorageType('Balances.Holds', 'Default', [matrixV1020.AccountId32], sts.array(() => matrixV1020.IdAmount)) as HoldsMatrixV1020,
    /**
     *  Holds on account balances.
     */
    enjinV100: new StorageType('Balances.Holds', 'Default', [enjinV100.AccountId32], sts.array(() => enjinV100.IdAmount)) as HoldsEnjinV100,
    /**
     *  Holds on account balances.
     */
    enjinV1032: new StorageType('Balances.Holds', 'Default', [enjinV1032.AccountId32], sts.array(() => enjinV1032.IdAmount)) as HoldsEnjinV1032,
    /**
     *  Holds on account balances.
     */
    enjinV1050: new StorageType('Balances.Holds', 'Default', [enjinV1050.AccountId32], sts.array(() => enjinV1050.IdAmount)) as HoldsEnjinV1050,
    /**
     *  Holds on account balances.
     */
    v104: new StorageType('Balances.Holds', 'Default', [v104.AccountId32], sts.array(() => v104.IdAmount)) as HoldsV104,
    /**
     *  Holds on account balances.
     */
    v1030: new StorageType('Balances.Holds', 'Default', [v1030.AccountId32], sts.array(() => v1030.IdAmount)) as HoldsV1030,
    /**
     *  Holds on account balances.
     */
    v1050: new StorageType('Balances.Holds', 'Default', [v1050.AccountId32], sts.array(() => v1050.IdAmount)) as HoldsV1050,
}
...
export interface HoldsMatrixEnjinV1012  {
    ...
    getPairs(block: Block, key: matrixEnjinV1012.AccountId32): Promise<[k: matrixEnjinV1012.AccountId32, v: (matrixEnjinV1012.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: matrixEnjinV1012.AccountId32, v: (matrixEnjinV1012.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: matrixEnjinV1012.AccountId32): AsyncIterable<[k: matrixEnjinV1012.AccountId32, v: (matrixEnjinV1012.IdAmount[] | undefined)][]>
}
...
export interface HoldsMatrixEnjinV1022  {
    ...
    getKeysPaged(pageSize: number, block: Block, key: matrixEnjinV1022.AccountId32): AsyncIterable<matrixEnjinV1022.AccountId32[]>
    getPairs(block: Block): Promise<[k: matrixEnjinV1022.AccountId32, v: (matrixEnjinV1022.IdAmount[] | undefined)][]>
    getPairs(block: Block, key: matrixEnjinV1022.AccountId32): Promise<[k: matrixEnjinV1022.AccountId32, v: (matrixEnjinV1022.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: matrixEnjinV1022.AccountId32, v: (matrixEnjinV1022.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: matrixEnjinV1022.AccountId32): AsyncIterable<[k: matrixEnjinV1022.AccountId32, v: (matrixEnjinV1022.IdAmount[] | undefined)][]>
}
...
export interface HoldsMatrixV602  {
    ...
    getPairs(block: Block, key: matrixV602.AccountId32): Promise<[k: matrixV602.AccountId32, v: (matrixV602.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: matrixV602.AccountId32, v: (matrixV602.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: matrixV602.AccountId32): AsyncIterable<[k: matrixV602.AccountId32, v: (matrixV602.IdAmount[] | undefined)][]>
}
...
export interface HoldsMatrixV1010  {
    ...
    getPairs(block: Block, key: matrixV1010.AccountId32): Promise<[k: matrixV1010.AccountId32, v: (matrixV1010.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: matrixV1010.AccountId32, v: (matrixV1010.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: matrixV1010.AccountId32): AsyncIterable<[k: matrixV1010.AccountId32, v: (matrixV1010.IdAmount[] | undefined)][]>
}
...
export interface HoldsMatrixV1020  {
    ...
    getPairs(block: Block, key: matrixV1020.AccountId32): Promise<[k: matrixV1020.AccountId32, v: (matrixV1020.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: matrixV1020.AccountId32, v: (matrixV1020.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: matrixV1020.AccountId32): AsyncIterable<[k: matrixV1020.AccountId32, v: (matrixV1020.IdAmount[] | undefined)][]>
}
...
export interface HoldsEnjinV100  {
    ...
    getPairs(block: Block, key: enjinV100.AccountId32): Promise<[k: enjinV100.AccountId32, v: (enjinV100.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.AccountId32, v: (enjinV100.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.AccountId32): AsyncIterable<[k: enjinV100.AccountId32, v: (enjinV100.IdAmount[] | undefined)][]>
}
...
export interface HoldsEnjinV1032  {
    ...
    getPairs(block: Block, key: enjinV1032.AccountId32): Promise<[k: enjinV1032.AccountId32, v: (enjinV1032.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV1032.AccountId32, v: (enjinV1032.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV1032.AccountId32): AsyncIterable<[k: enjinV1032.AccountId32, v: (enjinV1032.IdAmount[] | undefined)][]>
}
...
export interface HoldsEnjinV1050  {
    ...
    getPairs(block: Block, key: enjinV1050.AccountId32): Promise<[k: enjinV1050.AccountId32, v: (enjinV1050.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV1050.AccountId32, v: (enjinV1050.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV1050.AccountId32): AsyncIterable<[k: enjinV1050.AccountId32, v: (enjinV1050.IdAmount[] | undefined)][]>
}
...
export interface HoldsV104  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v104.AccountId32, v: (v104.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v104.AccountId32): AsyncIterable<[k: v104.AccountId32, v: (v104.IdAmount[] | undefined)][]>
}
...
export interface HoldsV1030  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v1030.AccountId32, v: (v1030.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v1030.AccountId32): AsyncIterable<[k: v1030.AccountId32, v: (v1030.IdAmount[] | undefined)][]>
}
...
export interface HoldsV1050  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v1050.AccountId32, v: (v1050.IdAmount[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v1050.AccountId32): AsyncIterable<[k: v1050.AccountId32, v: (v1050.IdAmount[] | undefined)][]>
}

...
export const bookStateFor =  {
     ...
     *  The index of the first and last (non-empty) pages.
     */
    enjinV101: new StorageType('MessageQueue.BookStateFor', 'Default', [enjinV101.AggregateMessageOrigin], enjinV101.BookState) as BookStateForEnjinV101,
}
...
export interface BookStateForEnjinV101  {
    ...
    getKeysPaged(pageSize: number, block: Block, key: enjinV101.AggregateMessageOrigin): AsyncIterable<enjinV101.AggregateMessageOrigin[]>
    getPairs(block: Block): Promise<[k: enjinV101.AggregateMessageOrigin, v: (enjinV101.BookState | undefined)][]>
    getPairs(block: Block, key: enjinV101.AggregateMessageOrigin): Promise<[k: enjinV101.AggregateMessageOrigin, v: (enjinV101.BookState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV101.AggregateMessageOrigin, v: (enjinV101.BookState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV101.AggregateMessageOrigin): AsyncIterable<[k: enjinV101.AggregateMessageOrigin, v: (enjinV101.BookState | undefined)][]>
}
...
export const serviceHead =  {
     ...
     *  The origin at which we should begin servicing.
     */
    enjinV101: new StorageType('MessageQueue.ServiceHead', 'Optional', [], enjinV101.AggregateMessageOrigin) as ServiceHeadEnjinV101,
}
...
export const pages =  {
     ...
     *  The map of page indices to pages.
     */
    enjinV101: new StorageType('MessageQueue.Pages', 'Optional', [enjinV101.AggregateMessageOrigin, sts.number()], enjinV101.Page) as PagesEnjinV101,
}
...
export interface PagesEnjinV101  {
    ...
    getKeys(block: Block, key1: enjinV101.AggregateMessageOrigin, key2: number): Promise<[enjinV101.AggregateMessageOrigin, number][]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<[enjinV101.AggregateMessageOrigin, number][]>
    getKeysPaged(pageSize: number, block: Block, key1: enjinV101.AggregateMessageOrigin): AsyncIterable<[enjinV101.AggregateMessageOrigin, number][]>
    getKeysPaged(pageSize: number, block: Block, key1: enjinV101.AggregateMessageOrigin, key2: number): AsyncIterable<[enjinV101.AggregateMessageOrigin, number][]>
    getPairs(block: Block): Promise<[k: [enjinV101.AggregateMessageOrigin, number], v: (enjinV101.Page | undefined)][]>
    getPairs(block: Block, key1: enjinV101.AggregateMessageOrigin): Promise<[k: [enjinV101.AggregateMessageOrigin, number], v: (enjinV101.Page | undefined)][]>
    getPairs(block: Block, key1: enjinV101.AggregateMessageOrigin, key2: number): Promise<[k: [enjinV101.AggregateMessageOrigin, number], v: (enjinV101.Page | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: [enjinV101.AggregateMessageOrigin, number], v: (enjinV101.Page | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: enjinV101.AggregateMessageOrigin): AsyncIterable<[k: [enjinV101.AggregateMessageOrigin, number], v: (enjinV101.Page | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: enjinV101.AggregateMessageOrigin, key2: number): AsyncIterable<[k: [enjinV101.AggregateMessageOrigin, number], v: (enjinV101.Page | undefined)][]>
}

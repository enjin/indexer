...
export interface BalanceToUnlock {
    balance: bigint
    currency: VoteCurrency
    unlocksAt: number
}

export const BalanceToUnlock: sts.Type<BalanceToUnlock> = sts.struct(() => {
    return  {
        balance: sts.bigint(),
        currency: VoteCurrency,
        unlocksAt: sts.number(),
    }
})
...
export interface EraPayout {
    ...
    requiredPaymentsPercent: Perbill
}

export const EraPayout: sts.Type<EraPayout> = sts.struct(() => {
    return  {
        era: sts.number(),
        payoutCount: sts.number(),
        payoutsProcessed: sts.boolean(),
        requiredPaymentsPercent: Perbill,
    }
})
...
export type Event = Event_AssignedSlots | Event_Auctions | Event_Balances | Event_ConvictionVoting | Event_Crowdloan | Event_ElectionProviderMultiPhase | Event_ExtrinsicPause | Event_FellowshipCollective | Event_FellowshipReferenda | Event_FuelTanks | Event_Grandpa | Event_Hrmp | Event_Identity | Event_ImOnline | Event_Marketplace | Event_MessageQueue | Event_MultiTokens | Event_Multisig | Event_NominationPools | Event_Offences | Event_ParaInclusion | Event_Paras | Event_ParasDisputes | Event_Preimage | Event_Referenda | Event_Registrar | Event_Scheduler | Event_Session | Event_Slots | Event_StakeExchange | Event_Staking | Event_Sudo | Event_System | Event_TransactionPayment | Event_Treasury | Event_Utility | Event_ValidatorManager | Event_VoteManager | Event_VoterList | Event_Whitelist | Event_XcmPallet
...
export interface NominationPoolsEvent_EarlyBirdBonusQueued {
    __kind: 'EarlyBirdBonusQueued'
    /**
...
export interface MultiTokensEvent_ClaimedCollections {
     ...
     */
    collectionIds: CollectionIdPair[]
}
...
export type Type_195 = Type_195_NoMutation | Type_195_SomeMutation

export interface Type_195_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_195_SomeMutation {
    __kind: 'SomeMutation'
    value: boolean
}
...
export interface DefaultTankMutation {
    userAccountManagement: Type_255
...
export type Type_255 = Type_255_NoMutation | Type_255_SomeMutation

export interface Type_255_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_255_SomeMutation {
    __kind: 'SomeMutation'
...
export type Type_651 = Type_651_ApplyExtrinsic | Type_651_Finalization | Type_651_Initialization

export interface Type_651_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_651_Finalization {
    __kind: 'Finalization'
}

export interface Type_651_Initialization {
...
export const NominationPoolsEvent: sts.Type<NominationPoolsEvent> = sts.closedEnum(() => {
    return  {
        ...
        EarlyBirdBonusQueued: sts.enumStruct({
            totalAmount: sts.bigint(),
        }),
...
export const MultiTokensEvent: sts.Type<MultiTokensEvent> = sts.closedEnum(() => {
    return  {
        ...
        ClaimedCollections: sts.enumStruct({
            accountId: AccountId32,
            ethereumAddress: H160,
            collectionIds: sts.array(() => CollectionIdPair),
        }),
...
export const CollectionIdPair: sts.Type<CollectionIdPair> = sts.struct(() => {
    return  {
        ethereum: sts.bigint(),
        native: sts.bigint(),
    }
...
export const Type_647: sts.Type<Type_647> = sts.struct(() => {
    return  {
        bareAyes: sts.number(),
        ayes: sts.number(),
        nays: sts.number(),
...
export const Type_651: sts.Type<Type_651> = sts.closedEnum(() => {
    return  {
...
export type Type_409 = Type_409_Noop | Type_409_Remove | Type_409_Set

export interface Type_409_Noop {
    __kind: 'Noop'
}

export interface Type_409_Remove {
    __kind: 'Remove'
}

export interface Type_409_Set {
    __kind: 'Set'
    value: Perbill
}
...
export type Type_408 = Type_408_Noop | Type_408_Remove | Type_408_Set

export interface Type_408_Noop {
    __kind: 'Noop'
}

export interface Type_408_Remove {
    __kind: 'Remove'
}

export interface Type_408_Set {
    __kind: 'Set'
    value: bigint
}
...
export type Type_495 = Type_495_V2 | Type_495_V3

export interface Type_495_V2 {
    __kind: 'V2'
    value: Type_498[]
}

export interface Type_495_V3 {
    __kind: 'V3'
    value: Type_502[]
}

export type Type_502 = Type_502_AliasOrigin | Type_502_BurnAsset | Type_502_BuyExecution | Type_502_ClaimAsset | Type_502_ClearError | Type_502_ClearOrigin | Type_502_ClearTopic | Type_502_ClearTransactStatus | Type_502_DepositAsset | Type_502_DepositReserveAsset | Type_502_DescendOrigin | Type_502_ExchangeAsset | Type_502_ExpectAsset | Type_502_ExpectError | Type_502_ExpectOrigin | Type_502_ExpectPallet | Type_502_ExpectTransactStatus | Type_502_ExportMessage | Type_502_HrmpChannelAccepted | Type_502_HrmpChannelClosing | Type_502_HrmpNewChannelOpenRequest | Type_502_InitiateReserveWithdraw | Type_502_InitiateTeleport | Type_502_LockAsset | Type_502_NoteUnlockable | Type_502_QueryPallet | Type_502_QueryResponse | Type_502_ReceiveTeleportedAsset | Type_502_RefundSurplus | Type_502_ReportError | Type_502_ReportHolding | Type_502_ReportTransactStatus | Type_502_RequestUnlock | Type_502_ReserveAssetDeposited | Type_502_SetAppendix | Type_502_SetErrorHandler | Type_502_SetFeesMode | Type_502_SetTopic | Type_502_SubscribeVersion | Type_502_Transact | Type_502_TransferAsset | Type_502_TransferReserveAsset | Type_502_Trap | Type_502_UniversalOrigin | Type_502_UnlockAsset | Type_502_UnpaidExecution | Type_502_UnsubscribeVersion | Type_502_WithdrawAsset

export interface Type_502_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_502_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_502_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_502_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_502_ClearError {
    __kind: 'ClearError'
}

export interface Type_502_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_502_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_502_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_502_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_502_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_502_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_502_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_502_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_502_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_502_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_502_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_502_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_502_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_502_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_502_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_502_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_502_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_502_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_502_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_502_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_502_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}

export interface Type_502_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_502_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_502_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_502_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_502_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_502_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_502_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_502_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_502_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_502[]
}

export interface Type_502_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_502[]
}

export interface Type_502_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_502_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_502_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_502_Transact {
    __kind: 'Transact'
    originKind: V2OriginKind
    requireWeightAtMost: Weight
    call: Type_499
...
export interface Type_502_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_502_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_502_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_502_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_502_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_502_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_502_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_502_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}
...
export type Type_498 = Type_498_BuyExecution | Type_498_ClaimAsset | Type_498_ClearError | Type_498_ClearOrigin | Type_498_DepositAsset | Type_498_DepositReserveAsset | Type_498_DescendOrigin | Type_498_ExchangeAsset | Type_498_HrmpChannelAccepted | Type_498_HrmpChannelClosing | Type_498_HrmpNewChannelOpenRequest | Type_498_InitiateReserveWithdraw | Type_498_InitiateTeleport | Type_498_QueryHolding | Type_498_QueryResponse | Type_498_ReceiveTeleportedAsset | Type_498_RefundSurplus | Type_498_ReportError | Type_498_ReserveAssetDeposited | Type_498_SetAppendix | Type_498_SetErrorHandler | Type_498_SubscribeVersion | Type_498_Transact | Type_498_TransferAsset | Type_498_TransferReserveAsset | Type_498_Trap | Type_498_UnsubscribeVersion | Type_498_WithdrawAsset

export interface Type_498_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_498_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_498_ClearError {
    __kind: 'ClearError'
}

export interface Type_498_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_498_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_498_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_498_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_498_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}

export interface Type_498_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_498_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_498_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_498_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_498_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_498_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_498_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_498_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_498_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_498_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_498_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_498_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_498[]
}

export interface Type_498_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_498[]
}

export interface Type_498_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_498_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: Type_499
...
export interface Type_498_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_498_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_498_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_498_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_498_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}
...
export type Type_418 = Type_418_Response | Type_418_Xcm
...
export type Type_419 = Type_419_AuctionAdmin | Type_419_BigSpender | Type_419_BigTipper | Type_419_ClaimsAdmin | Type_419_ExtrinsicPauseAdmin | Type_419_Fellows | Type_419_Fellowship1Dan | Type_419_Fellowship2Dan | Type_419_Fellowship3Dan | Type_419_Fellowship4Dan | Type_419_Fellowship5Dan | Type_419_Fellowship6Dan | Type_419_Fellowship7Dan | Type_419_Fellowship8Dan | Type_419_Fellowship9Dan | Type_419_FellowshipAdmin | Type_419_FellowshipExperts | Type_419_FellowshipInitiates | Type_419_FellowshipMasters | Type_419_FuelTanksAdmin | Type_419_GeneralAdmin | Type_419_LeaseAdmin | Type_419_MediumSpender | Type_419_MultiTokensAdmin | Type_419_ParachainsAdmin | Type_419_PreimageAdmin | Type_419_ReferendumCanceller | Type_419_ReferendumKiller | Type_419_SmallSpender | Type_419_SmallTipper | Type_419_StakingAdmin | Type_419_TreasuryAdmin | Type_419_WhitelistAdmin | Type_419_WhitelistedCaller

export interface Type_419_AuctionAdmin {
    __kind: 'AuctionAdmin'
}

export interface Type_419_BigSpender {
    __kind: 'BigSpender'
}

export interface Type_419_BigTipper {
    __kind: 'BigTipper'
}

export interface Type_419_ClaimsAdmin {
    __kind: 'ClaimsAdmin'
}

export interface Type_419_ExtrinsicPauseAdmin {
    __kind: 'ExtrinsicPauseAdmin'
}

export interface Type_419_Fellows {
    __kind: 'Fellows'
}

export interface Type_419_Fellowship1Dan {
    __kind: 'Fellowship1Dan'
}

export interface Type_419_Fellowship2Dan {
    __kind: 'Fellowship2Dan'
}

export interface Type_419_Fellowship3Dan {
    __kind: 'Fellowship3Dan'
}

export interface Type_419_Fellowship4Dan {
    __kind: 'Fellowship4Dan'
}

export interface Type_419_Fellowship5Dan {
    __kind: 'Fellowship5Dan'
}

export interface Type_419_Fellowship6Dan {
    __kind: 'Fellowship6Dan'
}

export interface Type_419_Fellowship7Dan {
    __kind: 'Fellowship7Dan'
}

export interface Type_419_Fellowship8Dan {
    __kind: 'Fellowship8Dan'
}

export interface Type_419_Fellowship9Dan {
    __kind: 'Fellowship9Dan'
}

export interface Type_419_FellowshipAdmin {
    __kind: 'FellowshipAdmin'
}

export interface Type_419_FellowshipExperts {
    __kind: 'FellowshipExperts'
}

export interface Type_419_FellowshipInitiates {
    __kind: 'FellowshipInitiates'
}

export interface Type_419_FellowshipMasters {
    __kind: 'FellowshipMasters'
}

export interface Type_419_FuelTanksAdmin {
    __kind: 'FuelTanksAdmin'
}

export interface Type_419_GeneralAdmin {
    __kind: 'GeneralAdmin'
}

export interface Type_419_LeaseAdmin {
    __kind: 'LeaseAdmin'
}

export interface Type_419_MediumSpender {
    __kind: 'MediumSpender'
}

export interface Type_419_MultiTokensAdmin {
    __kind: 'MultiTokensAdmin'
}

export interface Type_419_ParachainsAdmin {
    __kind: 'ParachainsAdmin'
}

export interface Type_419_PreimageAdmin {
    __kind: 'PreimageAdmin'
}

export interface Type_419_ReferendumCanceller {
    __kind: 'ReferendumCanceller'
}

export interface Type_419_ReferendumKiller {
    __kind: 'ReferendumKiller'
}

export interface Type_419_SmallSpender {
    __kind: 'SmallSpender'
}

export interface Type_419_SmallTipper {
    __kind: 'SmallTipper'
}

export interface Type_419_StakingAdmin {
    __kind: 'StakingAdmin'
}

export interface Type_419_TreasuryAdmin {
    __kind: 'TreasuryAdmin'
}

export interface Type_419_WhitelistAdmin {
    __kind: 'WhitelistAdmin'
}

export interface Type_419_WhitelistedCaller {
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_377
    maxValidatorCount: Type_377
    chillThreshold: Type_378
    minCommission: Type_379
}
...
export type Type_377 = Type_377_Noop | Type_377_Remove | Type_377_Set

export interface Type_377_Noop {
    __kind: 'Noop'
}

export interface Type_377_Remove {
    __kind: 'Remove'
}

export interface Type_377_Set {
    __kind: 'Set'
    value: number
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type NominationPoolsCall = NominationPoolsCall_bond | NominationPoolsCall_chill | NominationPoolsCall_create | NominationPoolsCall_destroy | NominationPoolsCall_distribute_early_bird_bonus | NominationPoolsCall_mutate | NominationPoolsCall_nominate | NominationPoolsCall_payout_rewards | NominationPoolsCall_pool_withdraw_unbonded | NominationPoolsCall_process_payouts | NominationPoolsCall_queue_early_bird_bonus | NominationPoolsCall_set_configs | NominationPoolsCall_set_staking_info | NominationPoolsCall_unbond | NominationPoolsCall_unbond_deposit | NominationPoolsCall_withdraw_deposit | NominationPoolsCall_withdraw_free_balance | NominationPoolsCall_withdraw_unbonded
 ...
 */
export interface NominationPoolsCall_distribute_early_bird_bonus {
    __kind: 'distribute_early_bird_bonus'
 ...
 */
export interface NominationPoolsCall_queue_early_bird_bonus {
    __kind: 'queue_early_bird_bonus'
    poolCount: number
}
...
export interface NominationPoolsCall_set_configs {
    __kind: 'set_configs'
    minJoinBond: Type_408
    minCreateBond: Type_408
    globalMaxCommission: Type_409
    requiredPayoutCount: Type_409
}
...
export interface MultiTokensCall_force_create_ethereum_collection {
    ...
    owner: AccountId32
    nativeCollectionId: bigint
    ethereumCollectionId: bigint
    tokenRange: RangeInclusive
    descriptor: DefaultCollectionDescriptor
}
...
export interface MultiTokensCall_force_set_unmintable_token_ids {
    ...
    collectionId: bigint
    value?: (RangeInclusive | undefined)
}
...
export const Type_418: sts.Type<Type_418> = sts.closedEnum(() => {
    return  {
...
export const Type_419: sts.Type<Type_419> = sts.closedEnum(() => {
    return  {
...
export const Type_495: sts.Type<Type_495> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_498),
        V3: sts.array(() => Type_502),
    }
})

export const Type_502: sts.Type<Type_502> = sts.closedEnum(() => {
    return  {
        AliasOrigin: V3MultiLocation,
        BurnAsset: sts.array(() => V3MultiAsset),
        BuyExecution: sts.enumStruct({
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_502),
        SetErrorHandler: sts.array(() => Type_502),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_498: sts.Type<Type_498> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            fees: V2MultiAsset,
            weightLimit: V2WeightLimit,
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_498),
        SetErrorHandler: sts.array(() => Type_498),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const NominationPoolsCall: sts.Type<NominationPoolsCall> = sts.closedEnum(() => {
    return  {
        ...
        distribute_early_bird_bonus: sts.enumStruct({
        ...
        queue_early_bird_bonus: sts.enumStruct({
            poolCount: sts.number(),
        }),
...
export const MultiTokensCall: sts.Type<MultiTokensCall> = sts.closedEnum(() => {
    return  {
        ...
        force_set_unmintable_token_ids: sts.enumStruct({
            collectionId: sts.bigint(),
            value: sts.option(() => RangeInclusive),
        }),
...
export const Type_530: sts.Type<Type_530> = sts.struct(() => {
    return  {
        accountId: AccountId32,
        params: DefaultMintParams,
    }

...
export const enter = {
     ...
     */
    matrixEnjinV1012: new CallType('SafeMode.enter', sts.unit()),
}
...
export const forceEnter = {
     ...
     */
    matrixEnjinV1012: new CallType('SafeMode.force_enter', sts.unit()),
}
...
export const extend = {
     ...
     */
    matrixEnjinV1012: new CallType('SafeMode.extend', sts.unit()),
}
...
export const forceExtend = {
     ...
     */
    matrixEnjinV1012: new CallType('SafeMode.force_extend', sts.unit()),
}
...
export const forceExit = {
     ...
     * hook.
     */
    matrixEnjinV1012: new CallType('SafeMode.force_exit', sts.unit()),
}

...
export const virtualStakers =  {
     ...
     */
    v1050: new StorageType('Staking.VirtualStakers', 'Optional', [v1050.AccountId32], sts.unit()) as VirtualStakersV1050,
}
...
export interface VirtualStakersV1050  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: v1050.AccountId32): AsyncIterable<[k: v1050.AccountId32, v: (null | undefined)][]>
}
...
export const counterForVirtualStakers =  {
     ...
     * Counter for the related counted storage map
     */
    v1050: new StorageType('Staking.CounterForVirtualStakers', 'Default', [], sts.number()) as CounterForVirtualStakersV1050,
}
...
export const disabledValidators =  {
     ...
     */
    v1050: new StorageType('Staking.DisabledValidators', 'Default', [], sts.array(() => sts.number())) as DisabledValidatorsV1050,
}

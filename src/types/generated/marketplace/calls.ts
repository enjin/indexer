...
export const createListing =  {
    ...
    matrixEnjinV1010: new CallType(
        'Marketplace.create_listing',
        sts.struct({
            makeAssetId: matrixEnjinV1010.AssetId,
            takeAssetId: matrixEnjinV1010.AssetId,
            amount: sts.bigint(),
            price: sts.bigint(),
            salt: sts.bytes(),
            listingData: matrixEnjinV1010.ListingData,
...
export const forceCreateListing =  {
    ...
    matrixEnjinV1010: new CallType(
        'Marketplace.force_create_listing',
        sts.struct({
            seller: matrixEnjinV1010.MultiAddress,
            makeAssetId: matrixEnjinV1010.AssetId,
            takeAssetId: matrixEnjinV1010.AssetId,
            amount: sts.bigint(),
            price: sts.bigint(),
            salt: sts.bytes(),
            listingData: matrixEnjinV1010.ListingData,
            depositBacker: sts.option(() => matrixEnjinV1010.MultiAddress),
        })
    ),
    /**
     * Force create a listing. This is only callable by the [`Config::ForceOrigin`].

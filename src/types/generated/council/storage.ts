...
export const proposalOf =  {
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v500: new StorageType('Council.ProposalOf', 'Optional', [v500.H256], v500.Call) as ProposalOfV500,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v600: new StorageType('Council.ProposalOf', 'Optional', [v600.H256], v600.Call) as ProposalOfV600,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v601: new StorageType('Council.ProposalOf', 'Optional', [v601.H256], v601.Call) as ProposalOfV601,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v602: new StorageType('Council.ProposalOf', 'Optional', [v602.H256], v602.Call) as ProposalOfV602,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v1003: new StorageType('Council.ProposalOf', 'Optional', [v1003.H256], v1003.Call) as ProposalOfV1003,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v1005: new StorageType('Council.ProposalOf', 'Optional', [v1005.H256], v1005.Call) as ProposalOfV1005,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v1012: new StorageType('Council.ProposalOf', 'Optional', [v1012.H256], v1012.Call) as ProposalOfV1012,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1020: new StorageType('Council.ProposalOf', 'Optional', [v1020.H256], v1020.Call) as ProposalOfV1020,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1022: new StorageType('Council.ProposalOf', 'Optional', [v1022.H256], v1022.Call) as ProposalOfV1022,
}
 ...
 *  Actual proposal for a given hash, if it's current.
 */
export interface ProposalOfV1012  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: v1012.H256): Promise<(v1012.Call | undefined)>
    getMany(block: Block, keys: v1012.H256[]): Promise<(v1012.Call | undefined)[]>
    getKeys(block: Block): Promise<v1012.H256[]>
    getKeys(block: Block, key: v1012.H256): Promise<v1012.H256[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<v1012.H256[]>
    getKeysPaged(pageSize: number, block: Block, key: v1012.H256): AsyncIterable<v1012.H256[]>
    getPairs(block: Block): Promise<[k: v1012.H256, v: (v1012.Call | undefined)][]>
    getPairs(block: Block, key: v1012.H256): Promise<[k: v1012.H256, v: (v1012.Call | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v1012.H256, v: (v1012.Call | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v1012.H256): AsyncIterable<[k: v1012.H256, v: (v1012.Call | undefined)][]>
}
...
export interface ProposalOfV1020  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: v1020.H256): Promise<(v1020.Call | undefined)>
    getMany(block: Block, keys: v1020.H256[]): Promise<(v1020.Call | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: v1020.H256, v: (v1020.Call | undefined)][]>
    getPairs(block: Block, key: v1020.H256): Promise<[k: v1020.H256, v: (v1020.Call | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v1020.H256, v: (v1020.Call | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v1020.H256): AsyncIterable<[k: v1020.H256, v: (v1020.Call | undefined)][]>
}
...
export interface ProposalOfV1022  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: v1022.H256): Promise<(v1022.Call | undefined)>
    getMany(block: Block, keys: v1022.H256[]): Promise<(v1022.Call | undefined)[]>
    getKeys(block: Block): Promise<v1022.H256[]>
    getKeys(block: Block, key: v1022.H256): Promise<v1022.H256[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<v1022.H256[]>
    getKeysPaged(pageSize: number, block: Block, key: v1022.H256): AsyncIterable<v1022.H256[]>
    getPairs(block: Block): Promise<[k: v1022.H256, v: (v1022.Call | undefined)][]>
    getPairs(block: Block, key: v1022.H256): Promise<[k: v1022.H256, v: (v1022.Call | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v1022.H256, v: (v1022.Call | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v1022.H256): AsyncIterable<[k: v1022.H256, v: (v1022.Call | undefined)][]>
}

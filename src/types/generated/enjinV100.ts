...
export type Type_404 = Type_404_AuctionAdmin | Type_404_BigSpender | Type_404_BigTipper | Type_404_Fellows | Type_404_Fellowship1Dan | Type_404_Fellowship2Dan | Type_404_Fellowship3Dan | Type_404_Fellowship4Dan | Type_404_Fellowship5Dan | Type_404_Fellowship6Dan | Type_404_Fellowship7Dan | Type_404_Fellowship8Dan | Type_404_Fellowship9Dan | Type_404_FellowshipAdmin | Type_404_FellowshipExperts | Type_404_FellowshipInitiates | Type_404_FellowshipMasters | Type_404_GeneralAdmin | Type_404_LeaseAdmin | Type_404_MediumSpender | Type_404_ReferendumCanceller | Type_404_ReferendumKiller | Type_404_SmallSpender | Type_404_SmallTipper | Type_404_StakingAdmin | Type_404_Treasurer | Type_404_WhitelistedCaller
...
export interface ParachainTemporarySlot {
    manager: AccountId32
    periodBegin: number
    periodCount: number
...
export const ParachainTemporarySlot: sts.Type<ParachainTemporarySlot> = sts.struct(() => {
    return  {
        manager: AccountId32,
        periodBegin: sts.number(),
        periodCount: sts.number(),
        lastLease: sts.option(() => sts.number()),
        leaseCount: sts.number(),
    }
})
...
export type VersionMigrationStage = VersionMigrationStage_MigrateAndNotifyOldTargets | VersionMigrationStage_MigrateSupportedVersion | VersionMigrationStage_MigrateVersionNotifiers | VersionMigrationStage_NotifyCurrentTargets
...
export const VersionMigrationStage: sts.Type<VersionMigrationStage> = sts.closedEnum(() => {
    return  {
        MigrateAndNotifyOldTargets: sts.unit(),
        MigrateSupportedVersion: sts.unit(),
        MigrateVersionNotifiers: sts.unit(),
        NotifyCurrentTargets: sts.option(() => sts.bytes()),
    }
})
...
export const QueryStatus: sts.Type<QueryStatus> = sts.closedEnum(() => {
    return  {
        Pending: sts.enumStruct({
            responder: VersionedMultiLocation,
            maybeMatchQuerier: sts.option(() => VersionedMultiLocation),
...
export const PendingSlashes: sts.Type<PendingSlashes> = sts.struct(() => {
    return  {
        keys: sts.array(() => sts.tuple(() => [V4ValidatorIndex, sts.bytes()])),
        kind: SlashingOffenceKind,
    }
})
...
export interface V4DisputeState {
...
export const V4DisputeState: sts.Type<V4DisputeState> = sts.struct(() => {
    return  {
        validatorsFor: sts.bitseq(),
        validatorsAgainst: sts.bitseq(),
        start: sts.number(),
        concludedAt: sts.option(() => sts.number()),
    }
})
...
export interface V4SessionInfo {
    activeValidatorIndices: V4ValidatorIndex[]
    randomSeed: Bytes
    disputePeriod: number
    validators: Bytes[]
    discoveryKeys: Bytes[]
    assignmentKeys: Bytes[]
    validatorGroups: V4ValidatorIndex[][]
    nCores: number
...
export const V4SessionInfo: sts.Type<V4SessionInfo> = sts.struct(() => {
    return  {
        activeValidatorIndices: sts.array(() => V4ValidatorIndex),
        randomSeed: sts.bytes(),
        disputePeriod: sts.number(),
        validators: sts.array(() => sts.bytes()),
        discoveryKeys: sts.array(() => sts.bytes()),
        assignmentKeys: sts.array(() => sts.bytes()),
        validatorGroups: sts.array(() => sts.array(() => V4ValidatorIndex)),
        nCores: sts.number(),
...
export const HrmpChannel: sts.Type<HrmpChannel> = sts.struct(() => {
    return  {
        ...
        senderDeposit: sts.bigint(),
        recipientDeposit: sts.bigint(),
    }
})
...
export const HrmpOpenChannelRequest: sts.Type<HrmpOpenChannelRequest> = sts.struct(() => {
    return  {
        confirmed: sts.boolean(),
        age: sts.number(),
        senderDeposit: sts.bigint(),
        maxMessageSize: sts.number(),
        maxCapacity: sts.number(),
...
export const BufferedSessionChange: sts.Type<BufferedSessionChange> = sts.struct(() => {
    return  {
        validators: sts.array(() => sts.bytes()),
        queued: sts.array(() => sts.bytes()),
...
export type V4UpgradeRestriction = V4UpgradeRestriction_Present

export interface V4UpgradeRestriction_Present {
    __kind: 'Present'
}

export const V4UpgradeRestriction: sts.Type<V4UpgradeRestriction> = sts.closedEnum(() => {
    return  {
        Present: sts.unit(),
    }
})

export type V4UpgradeGoAhead = V4UpgradeGoAhead_Abort | V4UpgradeGoAhead_GoAhead

export interface V4UpgradeGoAhead_Abort {
    __kind: 'Abort'
}

export interface V4UpgradeGoAhead_GoAhead {
    __kind: 'GoAhead'
}

export const V4UpgradeGoAhead: sts.Type<V4UpgradeGoAhead> = sts.closedEnum(() => {
    return  {
        Abort: sts.unit(),
        GoAhead: sts.unit(),
    }
...
export const ParaPastCodeMeta: sts.Type<ParaPastCodeMeta> = sts.struct(() => {
    return  {
        upgradeTimes: sts.array(() => ReplacementTimes),
        lastPruned: sts.option(() => sts.number()),
    }
})

export const ReplacementTimes: sts.Type<ReplacementTimes> = sts.struct(() => {
    return  {
        expectedAt: sts.number(),
        activatedAt: sts.number(),
    }
})

export type HeadData = Bytes

export type ParaLifecycle = ParaLifecycle_DowngradingParachain | ParaLifecycle_OffboardingParachain | ParaLifecycle_OffboardingParathread | ParaLifecycle_Onboarding | ParaLifecycle_Parachain | ParaLifecycle_Parathread | ParaLifecycle_UpgradingParathread

export interface ParaLifecycle_DowngradingParachain {
    __kind: 'DowngradingParachain'
}

export interface ParaLifecycle_OffboardingParachain {
    __kind: 'OffboardingParachain'
}

export interface ParaLifecycle_OffboardingParathread {
    __kind: 'OffboardingParathread'
}

export interface ParaLifecycle_Onboarding {
    __kind: 'Onboarding'
}

export interface ParaLifecycle_Parachain {
    __kind: 'Parachain'
}

export interface ParaLifecycle_Parathread {
    __kind: 'Parathread'
}

export interface ParaLifecycle_UpgradingParathread {
    __kind: 'UpgradingParathread'
}

export const ParaLifecycle: sts.Type<ParaLifecycle> = sts.closedEnum(() => {
    return  {
        DowngradingParachain: sts.unit(),
        OffboardingParachain: sts.unit(),
        OffboardingParathread: sts.unit(),
        Onboarding: sts.unit(),
        Parachain: sts.unit(),
        Parathread: sts.unit(),
        UpgradingParathread: sts.unit(),
    }
})
...
export interface CoreAssignment {
    ...
    paraId: Id
    kind: AssignmentKind
    groupIdx: V4GroupIndex
}

export type V4GroupIndex = number

export type AssignmentKind = AssignmentKind_Parachain | AssignmentKind_Parathread

export interface AssignmentKind_Parachain {
    __kind: 'Parachain'
}

export interface AssignmentKind_Parathread {
    __kind: 'Parathread'
    value: [V4Public, number]
}

export type V4Public = Bytes

export type V4CoreIndex = number

export const CoreAssignment: sts.Type<CoreAssignment> = sts.struct(() => {
    return  {
        core: V4CoreIndex,
        paraId: Id,
        kind: AssignmentKind,
...
export const AssignmentKind: sts.Type<AssignmentKind> = sts.closedEnum(() => {
    return  {
        Parachain: sts.unit(),
        Parathread: sts.tuple(() => [V4Public, sts.number()]),
    }
})

export const V4Public = sts.bytes()

export type V4CoreOccupied = V4CoreOccupied_Parachain | V4CoreOccupied_Parathread

export interface V4CoreOccupied_Parachain {
    __kind: 'Parachain'
}

export interface V4CoreOccupied_Parathread {
    __kind: 'Parathread'
    value: V4ParathreadEntry
}

export interface V4ParathreadEntry {
    claim: V4ParathreadClaim
    retries: number
}

export type V4ParathreadClaim = [Id, V4Public]

export const V4CoreOccupied: sts.Type<V4CoreOccupied> = sts.closedEnum(() => {
    return  {
        Parachain: sts.unit(),
        Parathread: V4ParathreadEntry,
    }
})

export const V4ParathreadEntry: sts.Type<V4ParathreadEntry> = sts.struct(() => {
    return  {
        claim: V4ParathreadClaim,
        retries: sts.number(),
    }
...
export const V4ParathreadClaim = sts.tuple(() => [Id, V4Public])

export interface ParathreadClaimQueue {
    queue: QueuedParathread[]
    nextCoreOffset: number
}

export interface QueuedParathread {
    claim: V4ParathreadEntry
    coreOffset: number
}

export const ParathreadClaimQueue: sts.Type<ParathreadClaimQueue> = sts.struct(() => {
    return  {
        queue: sts.array(() => QueuedParathread),
        nextCoreOffset: sts.number(),
    }
})

export const QueuedParathread: sts.Type<QueuedParathread> = sts.struct(() => {
    return  {
        claim: V4ParathreadEntry,
        coreOffset: sts.number(),
    }
})

export interface V4ScrapedOnChainVotes {
    session: number
    backingValidatorsPerCandidate: [V4CandidateReceipt, [V4ValidatorIndex, V4ValidityAttestation][]][]
...
export const V4ScrapedOnChainVotes: sts.Type<V4ScrapedOnChainVotes> = sts.struct(() => {
    return  {
        session: sts.number(),
        backingValidatorsPerCandidate: sts.array(() => sts.tuple(() => [V4CandidateReceipt, sts.array(() => sts.tuple(() => [V4ValidatorIndex, V4ValidityAttestation]))])),
...
export interface AvailabilityBitfieldRecord {
    bitfield: V4AvailabilityBitfield
    submittedAt: number
}

export type V4AvailabilityBitfield = BitSequence

export const AvailabilityBitfieldRecord: sts.Type<AvailabilityBitfieldRecord> = sts.struct(() => {
    return  {
        bitfield: V4AvailabilityBitfield,
        submittedAt: sts.number(),
    }
})
...
export const HostConfiguration: sts.Type<HostConfiguration> = sts.struct(() => {
    return  {
        ...
        hrmpMaxParathreadOutboundChannels: sts.number(),
        ...
        hrmpMaxParathreadInboundChannels: sts.number(),
        hrmpChannelMaxMessageSize: sts.number(),
        executorParams: sts.array(() => V4ExecutorParam),
        codeRetentionPeriod: sts.number(),
        parathreadCores: sts.number(),
        parathreadRetries: sts.number(),
        groupRotationFrequency: sts.number(),
        chainAvailabilityPeriod: sts.number(),
        threadAvailabilityPeriod: sts.number(),
        ...
        relayVrfModuloSamples: sts.number(),
        umpMaxIndividualWeight: Weight,
        pvfCheckingEnabled: sts.boolean(),
...
export const Bag: sts.Type<Bag> = sts.struct(() => {
    return  {
        head: sts.option(() => AccountId32),
        tail: sts.option(() => AccountId32),
    }
})
...
export const Node: sts.Type<Node> = sts.struct(() => {
    return  {
        id: AccountId32,
        prev: sts.option(() => AccountId32),
        next: sts.option(() => AccountId32),
        bagUpper: sts.bigint(),
        score: sts.bigint(),
    }
})
...
export const BoundedOpaqueNetworkState: sts.Type<BoundedOpaqueNetworkState> = sts.struct(() => {
    return  {
        peerId: sts.bytes(),
        externalAddresses: sts.array(() => sts.bytes()),
    }
})
...
export const StoredPendingChange: sts.Type<StoredPendingChange> = sts.struct(() => {
    return  {
        ...
        delay: sts.number(),
        nextAuthorities: sts.array(() => sts.tuple(() => [Public, sts.bigint()])),
        forced: sts.option(() => sts.number()),
    }
})
...
export const StoredState: sts.Type<StoredState> = sts.closedEnum(() => {
    return  {
        Live: sts.unit(),
        Paused: sts.unit(),
        PendingPause: sts.enumStruct({
            scheduledAt: sts.number(),
            delay: sts.number(),
        }),
        PendingResume: sts.enumStruct({
            scheduledAt: sts.number(),
            delay: sts.number(),
        }),
    }
...
export const SignedSubmission: sts.Type<SignedSubmission> = sts.struct(() => {
    return  {
        who: AccountId32,
        deposit: sts.bigint(),
        rawSolution: RawSolution,
...
export interface RoundSnapshot {
    voters: [AccountId32, bigint, AccountId32[]][]
    targets: AccountId32[]
}

export const RoundSnapshot: sts.Type<RoundSnapshot> = sts.struct(() => {
    return  {
        voters: sts.array(() => sts.tuple(() => [AccountId32, sts.bigint(), sts.array(() => AccountId32)])),
        targets: sts.array(() => AccountId32),
    }
})
...
export interface OffenceDetails {
    offender: [AccountId32, Exposure]
    reporters: AccountId32[]
}

export const OffenceDetails: sts.Type<OffenceDetails> = sts.struct(() => {
    return  {
        offender: sts.tuple(() => [AccountId32, Exposure]),
        reporters: sts.array(() => AccountId32),
    }
})
...
export const BabeEpochConfiguration: sts.Type<BabeEpochConfiguration> = sts.struct(() => {
    return  {
...
export interface EarlyBirdRewardsData {
    ...
    earlyBirdRewards?: (EarlyBirdReward | undefined)
}

export interface EarlyBirdReward {
    amount: bigint
    poolId: number
    startBlockNumber: number
}

export const EarlyBirdRewardsData: sts.Type<EarlyBirdRewardsData> = sts.struct(() => {
    return  {
        eligibleAmount: sts.bigint(),
        earlyBirdRewards: sts.option(() => EarlyBirdReward),
    }
})

export const EarlyBirdReward: sts.Type<EarlyBirdReward> = sts.struct(() => {
    return  {
        amount: sts.bigint(),
        poolId: sts.number(),
        startBlockNumber: sts.number(),
    }
})
...
export const TrackedBlockNumbers: sts.Type<TrackedBlockNumbers> = sts.struct(() => {
    return  {
        ethereum: sts.number(),
        parachain: sts.number(),
    }
...
export const ClaimData: sts.Type<ClaimData> = sts.struct(() => {
    return  {
        hash: sts.option(() => H256),
        amount: sts.bigint(),
...
export const DispatchRuleWrapper: sts.Type<DispatchRuleWrapper> = sts.closedEnum(() => {
    return  {
        ...
        PermittedExtrinsics: sts.array(() => Type_855),
        RequireToken: RequireTokenRule,
...
export const Type_855: sts.Type<Type_855> = sts.struct(() => {
    return  {
...
export type Event = Event_AssignedSlots | Event_Auctions | Event_Balances | Event_Claims | Event_ConvictionVoting | Event_Crowdloan | Event_ElectionProviderMultiPhase | Event_ExtrinsicPause | Event_FellowshipCollective | Event_FellowshipReferenda | Event_FuelTanks | Event_Grandpa | Event_Hrmp | Event_ImOnline | Event_MultiTokens | Event_NominationPools | Event_Offences | Event_ParaInclusion | Event_Paras | Event_ParasDisputes | Event_Preimage | Event_Referenda | Event_Registrar | Event_Scheduler | Event_Session | Event_Slots | Event_StakeExchange | Event_Staking | Event_Sudo | Event_System | Event_TransactionPayment | Event_Treasury | Event_Ump | Event_Utility | Event_ValidatorManager | Event_VoterList | Event_Whitelist | Event_XcmPallet
...
export interface ParaInclusionEvent_CandidateBacked {
    ...
    value: [V4CandidateReceipt, HeadData, V4CoreIndex, V4GroupIndex]
}
...
export interface ParaInclusionEvent_CandidateTimedOut {
    ...
    value: [V4CandidateReceipt, HeadData, V4CoreIndex]
}
 ...
 */
export type NominationPoolsEvent = NominationPoolsEvent_Bonded | NominationPoolsEvent_CommissionUpdated | NominationPoolsEvent_Created | NominationPoolsEvent_Destroyed | NominationPoolsEvent_EraRewardsProcessed | NominationPoolsEvent_PaidOut | NominationPoolsEvent_PoolMutated | NominationPoolsEvent_PoolSlashed | NominationPoolsEvent_RewardPaid | NominationPoolsEvent_StateChanged | NominationPoolsEvent_Unbonded | NominationPoolsEvent_UnbondingPoolSlashed | NominationPoolsEvent_Withdrawn
...
export interface PoolMutation {
    ...
    changeRate?: (CommissionChangeRate | undefined)
    roles?: (PoolRolesMutation | undefined)
    capacity?: (bigint | undefined)
}

export interface PoolRolesMutation {
    newAdmin: Type_79
    newNominator: Type_79
}

export type Type_79 = Type_79_NoMutation | Type_79_SomeMutation

export interface Type_79_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_79_SomeMutation {
    __kind: 'SomeMutation'
    value?: (AccountId32 | undefined)
}
...
export interface DefaultTokenMutation {
    behavior: Type_194
    listingForbidden: Type_197
    metadata: Type_198
}

export type Type_198 = Type_198_NoMutation | Type_198_SomeMutation

export interface Type_198_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_198_SomeMutation {
    __kind: 'SomeMutation'
    value: DefaultTokenMetadata
}

export type Type_197 = Type_197_NoMutation | Type_197_SomeMutation

export interface Type_197_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_197_SomeMutation {
    __kind: 'SomeMutation'
    value: boolean
}

export type Type_194 = Type_194_NoMutation | Type_194_SomeMutation

export interface Type_194_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_194_SomeMutation {
    __kind: 'SomeMutation'
 ...
 */
export type FuelTanksEvent = FuelTanksEvent_AccountAdded | FuelTanksEvent_AccountRemoved | FuelTanksEvent_AccountRuleDataRemoved | FuelTanksEvent_CallDispatched | FuelTanksEvent_ConsumptionSet | FuelTanksEvent_DispatchFailed | FuelTanksEvent_FreezeStateMutated | FuelTanksEvent_FuelTankCreated | FuelTanksEvent_FuelTankDestroyed | FuelTanksEvent_FuelTankMutated | FuelTanksEvent_MutateFreezeStateScheduled | FuelTanksEvent_RuleSetInserted | FuelTanksEvent_RuleSetRemoved | FuelTanksEvent_ScheduleMutateFreezeStateFailed
...
export interface DefaultTankMutation {
    userAccountManagement: Type_252
...
export type Type_252 = Type_252_NoMutation | Type_252_SomeMutation

export interface Type_252_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_252_SomeMutation {
    __kind: 'SomeMutation'
 ...
 */
export type ClaimsEvent = ClaimsEvent_Claimed | ClaimsEvent_EarlyBirdRewardCreated
 ...
 * amount]`
 */
export interface ClaimsEvent_EarlyBirdRewardCreated {
    __kind: 'EarlyBirdRewardCreated'
    /**
...
export type Type_592 = Type_592_ApplyExtrinsic | Type_592_Finalization | Type_592_Initialization

export interface Type_592_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_592_Finalization {
    __kind: 'Finalization'
}

export interface Type_592_Initialization {
...
export const ParaInclusionEvent: sts.Type<ParaInclusionEvent> = sts.closedEnum(() => {
    return  {
        CandidateBacked: sts.tuple(() => [V4CandidateReceipt, HeadData, V4CoreIndex, V4GroupIndex]),
        CandidateIncluded: sts.tuple(() => [V4CandidateReceipt, HeadData, V4CoreIndex, V4GroupIndex]),
        CandidateTimedOut: sts.tuple(() => [V4CandidateReceipt, HeadData, V4CoreIndex]),
    }
})
...
export const FuelTanksEvent: sts.Type<FuelTanksEvent> = sts.closedEnum(() => {
    return  {
        ...
        MutateFreezeStateScheduled: sts.enumStruct({
            tankId: AccountId32,
            ruleSetId: sts.option(() => sts.number()),
            isFrozen: sts.boolean(),
        }),
        ...
        ScheduleMutateFreezeStateFailed: sts.enumStruct({
            tankId: AccountId32,
            ruleSetId: sts.option(() => sts.number()),
            isFrozen: sts.boolean(),
            error: DispatchError,
...
export const ClaimsEvent: sts.Type<ClaimsEvent> = sts.closedEnum(() => {
    return  {
        ...
        EarlyBirdRewardCreated: sts.enumStruct({
            who: AccountId32,
            amount: sts.bigint(),
        }),
    }
...
export const Type_489: sts.Type<Type_489> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_492),
        V3: sts.array(() => Type_496),
    }
})

export const Type_496: sts.Type<Type_496> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_496),
        SetErrorHandler: sts.array(() => Type_496),
...
export const Type_493: sts.Type<Type_493> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_493 {
    encoded: Bytes
}
...
export type Type_496 = Type_496_AliasOrigin | Type_496_BurnAsset | Type_496_BuyExecution | Type_496_ClaimAsset | Type_496_ClearError | Type_496_ClearOrigin | Type_496_ClearTopic | Type_496_ClearTransactStatus | Type_496_DepositAsset | Type_496_DepositReserveAsset | Type_496_DescendOrigin | Type_496_ExchangeAsset | Type_496_ExpectAsset | Type_496_ExpectError | Type_496_ExpectOrigin | Type_496_ExpectPallet | Type_496_ExpectTransactStatus | Type_496_ExportMessage | Type_496_HrmpChannelAccepted | Type_496_HrmpChannelClosing | Type_496_HrmpNewChannelOpenRequest | Type_496_InitiateReserveWithdraw | Type_496_InitiateTeleport | Type_496_LockAsset | Type_496_NoteUnlockable | Type_496_QueryPallet | Type_496_QueryResponse | Type_496_ReceiveTeleportedAsset | Type_496_RefundSurplus | Type_496_ReportError | Type_496_ReportHolding | Type_496_ReportTransactStatus | Type_496_RequestUnlock | Type_496_ReserveAssetDeposited | Type_496_SetAppendix | Type_496_SetErrorHandler | Type_496_SetFeesMode | Type_496_SetTopic | Type_496_SubscribeVersion | Type_496_Transact | Type_496_TransferAsset | Type_496_TransferReserveAsset | Type_496_Trap | Type_496_UniversalOrigin | Type_496_UnlockAsset | Type_496_UnpaidExecution | Type_496_UnsubscribeVersion | Type_496_WithdrawAsset

export interface Type_496_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_496_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_496_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_496_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_496_ClearError {
    __kind: 'ClearError'
}

export interface Type_496_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_496_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_496_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_496_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_496_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_496_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_496_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_496_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_496_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_496_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_496_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_496_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_496_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_496_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_496_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_496_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_496_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_496_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_496_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_496_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_496_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}

export interface Type_496_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_496_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_496_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_496_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_496_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_496_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_496_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_496_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_496_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_496[]
}

export interface Type_496_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_496[]
}

export interface Type_496_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_496_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_496_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_496_Transact {
    __kind: 'Transact'
    originKind: V2OriginKind
    requireWeightAtMost: Weight
    call: Type_493
...
export interface Type_496_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_496_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_496_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_496_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_496_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_496_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_496_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_496_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}
...
export const Type_492: sts.Type<Type_492> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_492),
        SetErrorHandler: sts.array(() => Type_492),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_492 = Type_492_BuyExecution | Type_492_ClaimAsset | Type_492_ClearError | Type_492_ClearOrigin | Type_492_DepositAsset | Type_492_DepositReserveAsset | Type_492_DescendOrigin | Type_492_ExchangeAsset | Type_492_HrmpChannelAccepted | Type_492_HrmpChannelClosing | Type_492_HrmpNewChannelOpenRequest | Type_492_InitiateReserveWithdraw | Type_492_InitiateTeleport | Type_492_QueryHolding | Type_492_QueryResponse | Type_492_ReceiveTeleportedAsset | Type_492_RefundSurplus | Type_492_ReportError | Type_492_ReserveAssetDeposited | Type_492_SetAppendix | Type_492_SetErrorHandler | Type_492_SubscribeVersion | Type_492_Transact | Type_492_TransferAsset | Type_492_TransferReserveAsset | Type_492_Trap | Type_492_UnsubscribeVersion | Type_492_WithdrawAsset

export interface Type_492_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_492_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_492_ClearError {
    __kind: 'ClearError'
}

export interface Type_492_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_492_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_492_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_492_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_492_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}

export interface Type_492_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_492_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_492_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_492_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_492_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_492_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_492_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_492_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_492_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_492_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_492_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_492_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_492[]
}

export interface Type_492_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_492[]
}

export interface Type_492_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_492_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: Type_493
...
export interface Type_492_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_492_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_492_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_492_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_492_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}

export type Type_489 = Type_489_V2 | Type_489_V3

export interface Type_489_V2 {
    __kind: 'V2'
    value: Type_492[]
}

export interface Type_489_V3 {
    __kind: 'V3'
    value: Type_496[]
}
...
export type Type_396 = Type_396_Noop | Type_396_Remove | Type_396_Set

export interface Type_396_Noop {
    __kind: 'Noop'
}

export interface Type_396_Remove {
    __kind: 'Remove'
}

export interface Type_396_Set {
    __kind: 'Set'
    value: Perbill
}
...
export type Type_395 = Type_395_Noop | Type_395_Remove | Type_395_Set

export interface Type_395_Noop {
    __kind: 'Noop'
}

export interface Type_395_Remove {
    __kind: 'Remove'
}

export interface Type_395_Set {
    __kind: 'Set'
    value: bigint
}
...
export const Type_366: sts.Type<Type_366> = sts.closedEnum(() => {
    return  {
        Noop: sts.unit(),
        Remove: sts.unit(),
        Set: Perbill,
...
export type Type_366 = Type_366_Noop | Type_366_Remove | Type_366_Set

export interface Type_366_Noop {
    __kind: 'Noop'
}

export interface Type_366_Remove {
    __kind: 'Remove'
}

export interface Type_366_Set {
    __kind: 'Set'
    value: Perbill
}
...
export type Type_365 = Type_365_Noop | Type_365_Remove | Type_365_Set

export interface Type_365_Noop {
    __kind: 'Noop'
}

export interface Type_365_Remove {
    __kind: 'Remove'
}

export interface Type_365_Set {
    __kind: 'Set'
    value: Percent
}
...
export type Type_364 = Type_364_Noop | Type_364_Remove | Type_364_Set

export interface Type_364_Noop {
    __kind: 'Noop'
}

export interface Type_364_Remove {
    __kind: 'Remove'
}

export interface Type_364_Set {
    __kind: 'Set'
    value: number
}
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_364
    maxValidatorCount: Type_364
    chillThreshold: Type_365
    minCommission: Type_366
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type NominationPoolsCall = NominationPoolsCall_bond_extra | NominationPoolsCall_chill | NominationPoolsCall_create | NominationPoolsCall_destroy | NominationPoolsCall_join | NominationPoolsCall_mutate | NominationPoolsCall_nominate | NominationPoolsCall_payout_rewards | NominationPoolsCall_pool_withdraw_unbonded | NominationPoolsCall_set_configs | NominationPoolsCall_unbond | NominationPoolsCall_unbond_deposit | NominationPoolsCall_withdraw_deposit | NominationPoolsCall_withdraw_unbonded
...
export interface NominationPoolsCall_set_configs {
    __kind: 'set_configs'
    minJoinBond: Type_395
    minCreateBond: Type_395
    globalMaxCommission: Type_396
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type FuelTanksCall = FuelTanksCall_add_account | FuelTanksCall_batch_add_account | FuelTanksCall_batch_remove_account | FuelTanksCall_create_fuel_tank | FuelTanksCall_destroy_fuel_tank | FuelTanksCall_dispatch | FuelTanksCall_dispatch_and_touch | FuelTanksCall_force_set_consumption | FuelTanksCall_insert_rule_set | FuelTanksCall_mutate_fuel_tank | FuelTanksCall_remove_account | FuelTanksCall_remove_account_rule_data | FuelTanksCall_remove_rule_set | FuelTanksCall_schedule_mutate_freeze_state
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ClaimsCall = ClaimsCall_claim | ClaimsCall_claim_early_bird_reward | ClaimsCall_claim_from_efinity | ClaimsCall_mint_claim | ClaimsCall_move_claim | ClaimsCall_reject_claims | ClaimsCall_request_claims | ClaimsCall_set_delay_time | ClaimsCall_set_exchange_rate
 ...
 */
export interface ClaimsCall_claim_early_bird_reward {
    __kind: 'claim_early_bird_reward'
}
...
export const Type_403: sts.Type<Type_403> = sts.closedEnum(() => {
    return  {
...
export const FuelTanksCall: sts.Type<FuelTanksCall> = sts.closedEnum(() => {
    return  {
        ...
        schedule_mutate_freeze_state: sts.enumStruct({
            tankId: MultiAddress,
            ruleSetId: sts.option(() => sts.number()),
            isFrozen: sts.boolean(),
        }),
...
export const ClaimsCall: sts.Type<ClaimsCall> = sts.closedEnum(() => {
    return  {
        ...
        claim_early_bird_reward: sts.unit(),
        claim_from_efinity: sts.unit(),
...
export const V4GroupIndex = sts.number()

export const V4CoreIndex = sts.number()

export const HeadData = sts.bytes()

export const V4CandidateReceipt: sts.Type<V4CandidateReceipt> = sts.struct(() => {
    return  {
        descriptor: V4CandidateDescriptor,
        commitmentsHash: H256,
    }
...
export const PoolMutation: sts.Type<PoolMutation> = sts.struct(() => {
    return  {
        ...
        changeRate: sts.option(() => CommissionChangeRate),
        roles: sts.option(() => PoolRolesMutation),
        capacity: sts.option(() => sts.bigint()),
    }
})

export const PoolRolesMutation: sts.Type<PoolRolesMutation> = sts.struct(() => {
    return  {
        newAdmin: Type_79,
        newNominator: Type_79,
    }
...
export const Type_79: sts.Type<Type_79> = sts.closedEnum(() => {
    return  {
        NoMutation: sts.unit(),
        SomeMutation: sts.option(() => AccountId32),
    }
})

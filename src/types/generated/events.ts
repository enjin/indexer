...
export class MultiTokensApprovedEvent {
   ...
   * An approval took place. If `token_id` is `None`, it applies to the whole collection.
   */
  get asV4(): {collectionId: bigint, tokenId: (bigint | undefined), owner: v4.AccountId32, operator: v4.AccountId32, amount: (bigint | undefined), expiration: (number | undefined)} {
    assert(this.isV4)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {collectionId: bigint, tokenId: (bigint | undefined), owner: v4.AccountId32, operator: v4.AccountId32, amount: (bigint | undefined), expiration: (number | undefined)} {
    deprecateLatest()
    return this.asV4
  }
}
...
export class MultiTokensMintedEvent {
   ...
   * Units of a `Token` were minted
   */
  get asV4(): {collectionId: bigint, tokenId: bigint, issuer: v4.AccountId32, recipient: v4.AccountId32, amount: bigint} {
    assert(this.isV4)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {collectionId: bigint, tokenId: bigint, issuer: v4.AccountId32, recipient: v4.AccountId32, amount: bigint} {
    deprecateLatest()
    return this.asV4
  }
}
...
export class MultiTokensTransferredEvent {
   ...
   * Units of a `Token` were transferred
   */
  get asV4(): {collectionId: bigint, tokenId: bigint, operator: v4.AccountId32, from: v4.AccountId32, to: v4.AccountId32, amount: bigint} {
    assert(this.isV4)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): {collectionId: bigint, tokenId: bigint, operator: v4.AccountId32, from: v4.AccountId32, to: v4.AccountId32, amount: bigint} {
    deprecateLatest()
    return this.asV4
  }
}
...
export class MultiTokensUnapprovedEvent {
  ...
  get asLatest(): {collectionId: bigint, tokenId: (bigint | undefined), owner: v4.AccountId32, operator: v4.AccountId32} {
    deprecateLatest()
    return this.asV4
  }
}

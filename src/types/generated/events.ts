...
export class FuelTanksAccountAddedEvent {
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.AccountAdded') === '68c06139ebce44800ab90cc0b1a51a826916bb01651d70166208da8e21bfac23'
  }

  /**
   * An account was added to a `FuelTank`
   */
  get asV6(): {tankAccountId: Uint8Array, userAccountId: Uint8Array, tankDeposit: bigint, userDeposit: bigint} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class FuelTanksAccountRemovedEvent {
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.AccountRemoved') === 'c99a0f0838ec78b4fa16a838f7552e971a134d141ceb3de6152b52e79bc3f745'
  }

  /**
   * An account was removed from a `FuelTank`
   */
  get asV6(): {tankAccountId: Uint8Array, userAccountId: Uint8Array} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class FuelTanksAccountRuleDataRemovedEvent {
  ...
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.AccountRuleDataRemoved') === 'd692b8412d584ce1ce30056f7083486c35aac90b3dc488e0b2ae10d513eff723'
  }

  get asV6(): {tankAccountId: Uint8Array, userAccountId: Uint8Array, ruleSetId: number, ruleKind: v6.RuleKind} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class FuelTanksCallDispatchedEvent {
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.CallDispatched') === 'a61fc1ac422a54a4029ba3756f0fd9505d039cc480ddf7f0989646b434d99019'
  }

  /**
   * A call was dispatched through a `FuelTank`.
   */
  get asV6(): {caller: Uint8Array, fuelTank: Uint8Array} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class FuelTanksFreezeStateMutatedEvent {
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.FreezeStateMutated') === 'c06fa93b54dad60fc413857bcd68fedda8470ad9fbb39a960c3198dd0bb705a6'
  }

  /**
   * The freeze state change for fuel tank or its rule set was executed in `on_finalize`
   */
  get asV6(): {tankAccountId: Uint8Array, ruleSetId: (number | undefined), isFrozen: boolean} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class FuelTanksFuelTankCreatedEvent {
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.FuelTankCreated') === '46f74b58902ab0140f6d429572db98de73bdbf4fa6cafd93f4f0c7c77456dc9c'
  }

  /**
   * A new `FuelTank` was created.
   */
  get asV6(): {owner: Uint8Array, name: Uint8Array, fuelTank: Uint8Array} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class FuelTanksFuelTankDestroyedEvent {
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.FuelTankDestroyed') === '2fb22d20303b9be233903d771dfe379d549df028ecbe5591a3396ffe355f70bd'
  }

  /**
   * A `FuelTank` was destroyed
   */
  get asV6(): {fuelTank: Uint8Array} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class FuelTanksFuelTankMutatedEvent {
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.FuelTankMutated') === '4ebad722d7c52fe903daf1f5f8c40deaa870f6ef4b8d933581ba8c2700b9b6b1'
  }

  /**
   * A `FuelTank` was mutated
   */
  get asV6(): {fuelTank: Uint8Array, mutation: v6.DefaultTankMutation} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class FuelTanksMutateFreezeStateScheduledEvent {
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.MutateFreezeStateScheduled') === 'c06fa93b54dad60fc413857bcd68fedda8470ad9fbb39a960c3198dd0bb705a6'
  }
...
export class FuelTanksRuleSetInsertedEvent {
  ...
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.RuleSetInserted') === '03ed0ff20c1aa404aac670cdf6f87bf905b85b0f797d4e66cfa0987f138eeb75'
  }

  get asV6(): {tankAccountId: Uint8Array, ruleSetId: number} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class FuelTanksRuleSetRemovedEvent {
  ...
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.RuleSetRemoved') === '03ed0ff20c1aa404aac670cdf6f87bf905b85b0f797d4e66cfa0987f138eeb75'
  }
...
export class FuelTanksScheduleMutateFreezeStateFailedEvent {
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('FuelTanks.ScheduleMutateFreezeStateFailed') === '433fd79b7f143dfe50dbfac580aeab922bb7a5a56542fbe9c490b5c22bcfe678'
  }

  /**
   * The freeze state change for fuel tank or its rule set failed in `on_finalize`
   */
  get asV6(): {tankAccountId: Uint8Array, ruleSetId: (number | undefined), isFrozen: boolean, error: v6.DispatchError} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class MultiTokensCollectionMutatedEvent {
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('MultiTokens.CollectionMutated') === '488b34d593e8c32d5b6186b4e73d48fce339c0a2f9763fbf0a6d560b38a6ec18'
  }
...
export class MultiTokensRoyaltySetEvent {
  private readonly _chain: Chain
  private readonly event: Event
  ...
  constructor(ctx: EventContext, event?: Event) {
    event = event || ctx.event
    assert(event.name === 'MultiTokens.RoyaltySet')
    this._chain = ctx._chain
    this.event = event
  }
   ...
   */
  get isV6(): boolean {
    return this._chain.getEventHash('MultiTokens.RoyaltySet') === '91c2715ac09cc47ad3342635eb85f028482ac8ab78e7e3767c8f7ae70d13eeeb'
  }

  /**
   * Royalty were set for a Collection or Token
   */
  get asV6(): {collectionId: bigint, tokenId: (bigint | undefined), royalty: v6.DefaultRoyalty} {
    assert(this.isV6)
    return this._chain.decodeEvent(this.event)
  }
}

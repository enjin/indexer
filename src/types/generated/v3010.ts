...
export interface FailedBatchCall {
    index: number
    error: DispatchError
}

export interface DefaultTankMutation {
    userAccountManagement: Type_193
...
export interface DefaultTokenMutation {
    ...
    metadata: (DefaultTokenMetadata | undefined)
}
 ...
 */
export interface MultiTokensEvent_BatchCallsFailed {
    __kind: 'BatchCallsFailed'
    failures: FailedBatchCall[]
}
 ...
 * One or more calls in a batch have failed
 */
export interface FuelTanksEvent_BatchCallsFailed {
    __kind: 'BatchCallsFailed'
    failures: FailedBatchCall[]
}

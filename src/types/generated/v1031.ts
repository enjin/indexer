...
export type Type_721 = Type_721_ApplyExtrinsic | Type_721_Finalization | Type_721_Initialization

export interface Type_721_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_721_Finalization {
    __kind: 'Finalization'
}

export interface Type_721_Initialization {
...
export const Type_717: sts.Type<Type_717> = sts.struct(() => {
    return  {
        bareAyes: sts.number(),
        ayes: sts.number(),
        nays: sts.number(),
...
export const Type_721: sts.Type<Type_721> = sts.closedEnum(() => {
    return  {
...
export const Type_643: sts.Type<Type_643> = sts.struct(() => {
    return  {
        first: VoteMessage,
        second: VoteMessage,
    }

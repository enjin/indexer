...
export const whitelistedCall =  {
    enjinV100: new StorageType('Whitelist.WhitelistedCall', 'Optional', [enjinV100.H256], sts.unit()) as WhitelistedCallEnjinV100,
}
...
export interface WhitelistedCallEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.H256): AsyncIterable<[k: enjinV100.H256, v: (null | undefined)][]>
}

...
export const proposalOf =  {
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v1010: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1010.H256], v1010.Call) as ProposalOfV1010,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1011: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1011.H256], v1011.Call) as ProposalOfV1011,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1012: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1012.H256], v1012.Call) as ProposalOfV1012,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1020: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1020.H256], v1020.Call) as ProposalOfV1020,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1022: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1022.H256], v1022.Call) as ProposalOfV1022,
}

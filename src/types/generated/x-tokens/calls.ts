...
export const transfer =  {
    ...
    matrixEnjinV1010: new CallType(
        'XTokens.transfer',
        sts.struct({
            currencyId: matrixEnjinV1010.AssetId,
            amount: sts.bigint(),
            dest: matrixEnjinV1010.VersionedLocation,
            destWeightLimit: matrixEnjinV1010.V3WeightLimit,
        })
    ),
    /**
     * Transfer native currencies.
...
export const transferMultiasset =  {
    ...
    matrixEnjinV1010: new CallType(
        'XTokens.transfer_multiasset',
        sts.struct({
            asset: matrixEnjinV1010.VersionedAsset,
            dest: matrixEnjinV1010.VersionedLocation,
            destWeightLimit: matrixEnjinV1010.V3WeightLimit,
        })
    ),
...
export const transferMultiassetWithFee =  {
    ...
    matrixEnjinV1010: new CallType(
        ...
        sts.struct({
            asset: matrixEnjinV1010.VersionedAsset,
            fee: matrixEnjinV1010.VersionedAsset,
            dest: matrixEnjinV1010.VersionedLocation,
            destWeightLimit: matrixEnjinV1010.V3WeightLimit,
        })
    ),
...
export const transferMulticurrencies =  {
    ...
    matrixEnjinV1010: new CallType(
        'XTokens.transfer_multicurrencies',
        sts.struct({
            currencies: sts.array(() => sts.tuple(() => [matrixEnjinV1010.AssetId, sts.bigint()])),
            feeItem: sts.number(),
            dest: matrixEnjinV1010.VersionedLocation,
            destWeightLimit: matrixEnjinV1010.V3WeightLimit,
        })

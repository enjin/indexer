...
export const spendCount =  {
     ...
     */
    matrixEnjinV1010: new StorageType('CommunityPool.SpendCount', 'Default', [], sts.number()) as SpendCountMatrixEnjinV1010,
}

/**
 *  The count of spends that have been made.
 */
export interface SpendCountMatrixEnjinV1010  {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): number
    get(block: Block): Promise<(number | undefined)>
}
...
export const spends =  {
     ...
     */
    matrixEnjinV1010: new StorageType('CommunityPool.Spends', 'Optional', [sts.number()], matrixEnjinV1010.SpendStatus) as SpendsMatrixEnjinV1010,
}

/**
 *  Spends that have been approved and being processed.
 */
export interface SpendsMatrixEnjinV1010  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: number): Promise<(matrixEnjinV1010.SpendStatus | undefined)>
    getMany(block: Block, keys: number[]): Promise<(matrixEnjinV1010.SpendStatus | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (matrixEnjinV1010.SpendStatus | undefined)][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (matrixEnjinV1010.SpendStatus | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (matrixEnjinV1010.SpendStatus | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (matrixEnjinV1010.SpendStatus | undefined)][]>
}

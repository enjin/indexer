...
export const reports =  {
     ...
     */
    enjinV100: new StorageType('Offences.Reports', 'Optional', [enjinV100.H256], enjinV100.OffenceDetails) as ReportsEnjinV100,
}
...
export interface ReportsEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.H256, v: (enjinV100.OffenceDetails | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.H256): AsyncIterable<[k: enjinV100.H256, v: (enjinV100.OffenceDetails | undefined)][]>
}
...
export const concurrentReportsIndex =  {
     ...
     */
    enjinV100: new StorageType('Offences.ConcurrentReportsIndex', 'Default', [sts.bytes(), sts.bytes()], sts.array(() => enjinV100.H256)) as ConcurrentReportsIndexEnjinV100,
}
...
export interface ConcurrentReportsIndexEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key1: Bytes): AsyncIterable<[k: [Bytes, Bytes], v: (enjinV100.H256[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: Bytes, key2: Bytes): AsyncIterable<[k: [Bytes, Bytes], v: (enjinV100.H256[] | undefined)][]>
}
...
export const reportsByKindIndex =  {
     ...
     */
    v100: new StorageType('Offences.ReportsByKindIndex', 'Default', [sts.bytes()], sts.bytes()) as ReportsByKindIndexV100,
}

...
export const MarketPlaceInfo: sts.Type<MarketPlaceInfo> = sts.struct(() => {
    return  {
        protocolFee: sts.number(),
    }
})
...
export const FreezeQueueItem: sts.Type<FreezeQueueItem> = sts.struct(() => {
    return  {
        tankId: AccountId32,
...
export const DispatchRuleWrapper: sts.Type<DispatchRuleWrapper> = sts.closedEnum(() => {
    return  {
        ...
        PermittedExtrinsics: sts.array(() => Type_621),
        RequireToken: RequireTokenRule,
...
export interface EthereumAccount {
    claimableCollectionIds: bigint[]
    nonce: number
}

export const EthereumAccount: sts.Type<EthereumAccount> = sts.struct(() => {
    return  {
        claimableCollectionIds: sts.array(() => sts.bigint()),
        nonce: sts.number(),
    }
})
...
export interface EthereumToken {
    name: Bytes
    creator: H160
    supplyModel: EthereumSupplyModel
    totalSupply: bigint
    circulatingSupply: bigint
    transferable: EthereumTransferable
    fungible: boolean
    uri: Bytes
}

export type EthereumTransferable = EthereumTransferable_Bound | EthereumTransferable_Permanent | EthereumTransferable_Temporary

export interface EthereumTransferable_Bound {
    __kind: 'Bound'
}

export interface EthereumTransferable_Permanent {
    __kind: 'Permanent'
}

export interface EthereumTransferable_Temporary {
    __kind: 'Temporary'
}

export type EthereumSupplyModel = EthereumSupplyModel_AnnualPercentage | EthereumSupplyModel_AnnualValue | EthereumSupplyModel_Collapsing | EthereumSupplyModel_Fixed | EthereumSupplyModel_Infinite | EthereumSupplyModel_Settable

export interface EthereumSupplyModel_AnnualPercentage {
    __kind: 'AnnualPercentage'
}

export interface EthereumSupplyModel_AnnualValue {
    __kind: 'AnnualValue'
}

export interface EthereumSupplyModel_Collapsing {
    __kind: 'Collapsing'
}

export interface EthereumSupplyModel_Fixed {
    __kind: 'Fixed'
}

export interface EthereumSupplyModel_Infinite {
    __kind: 'Infinite'
}

export interface EthereumSupplyModel_Settable {
    __kind: 'Settable'
}

export const EthereumToken: sts.Type<EthereumToken> = sts.struct(() => {
    return  {
        name: sts.bytes(),
        creator: H160,
        supplyModel: EthereumSupplyModel,
        totalSupply: sts.bigint(),
        circulatingSupply: sts.bigint(),
        transferable: EthereumTransferable,
        fungible: sts.boolean(),
        uri: sts.bytes(),
    }
})

export const EthereumTransferable: sts.Type<EthereumTransferable> = sts.closedEnum(() => {
    return  {
        Bound: sts.unit(),
        Permanent: sts.unit(),
        Temporary: sts.unit(),
...
export const EthereumSupplyModel: sts.Type<EthereumSupplyModel> = sts.closedEnum(() => {
    return  {
        AnnualPercentage: sts.unit(),
        AnnualValue: sts.unit(),
        Collapsing: sts.unit(),
        Fixed: sts.unit(),
        Infinite: sts.unit(),
        Settable: sts.unit(),
...
export interface Migration {
    ...
    lastIteratedKey?: (Bytes | undefined)
}

export const Migration: sts.Type<Migration> = sts.struct(() => {
    return  {
        stage: MigrationStage,
        lastIteratedKey: sts.option(() => sts.bytes()),
    }
})
...
export const InboundChannelDetails: sts.Type<InboundChannelDetails> = sts.struct(() => {
    return  {
        sender: Id,
        state: InboundState,
        messageMetadata: sts.array(() => sts.tuple(() => [sts.number(), XcmpMessageFormat])),
    }
})
...
export const InboundState: sts.Type<InboundState> = sts.closedEnum(() => {
    return  {
        Ok: sts.unit(),
        Suspended: sts.unit(),
    }
...
export const CollatorSessionInfo: sts.Type<CollatorSessionInfo> = sts.struct(() => {
    return  {
        authoredBlockCount: sts.number(),
        uptime: sts.number(),
    }
})
...
export const Votes: sts.Type<Votes> = sts.struct(() => {
    return  {
        ...
        ayes: sts.array(() => AccountId32),
        nays: sts.array(() => AccountId32),
        end: sts.number(),
    }
})

export type Call = Call_Balances | Call_Bounties | Call_Claims | Call_CollatorStaking | Call_CommunityPool | Call_Council | Call_CumulusXcm | Call_Democracy | Call_DmpQueue | Call_ExtrinsicPause | Call_FuelTanks | Call_Marketplace | Call_MatrixUtility | Call_MatrixXcm | Call_MultiTokens | Call_MultiTokensMigration | Call_Multisig | Call_OrmlXcm | Call_ParachainSystem | Call_PolkadotXcm | Call_Pools | Call_Preimage | Call_Scheduler | Call_Session | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Utility | Call_XTokens | Call_XcmpQueue
...
export type Type_319 = Type_319_Member | Type_319_Members | Type_319__Phantom
...
export type Type_353 = Type_353_V2 | Type_353_V3

export interface Type_353_V2 {
    __kind: 'V2'
    value: Type_356[]
}

export interface Type_353_V3 {
    __kind: 'V3'
    value: Type_360[]
}
...
export type Type_356 = Type_356_BuyExecution | Type_356_ClaimAsset | Type_356_ClearError | Type_356_ClearOrigin | Type_356_DepositAsset | Type_356_DepositReserveAsset | Type_356_DescendOrigin | Type_356_ExchangeAsset | Type_356_HrmpChannelAccepted | Type_356_HrmpChannelClosing | Type_356_HrmpNewChannelOpenRequest | Type_356_InitiateReserveWithdraw | Type_356_InitiateTeleport | Type_356_QueryHolding | Type_356_QueryResponse | Type_356_ReceiveTeleportedAsset | Type_356_RefundSurplus | Type_356_ReportError | Type_356_ReserveAssetDeposited | Type_356_SetAppendix | Type_356_SetErrorHandler | Type_356_SubscribeVersion | Type_356_Transact | Type_356_TransferAsset | Type_356_TransferReserveAsset | Type_356_Trap | Type_356_UnsubscribeVersion | Type_356_WithdrawAsset
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type MultiTokensMigrationCall = MultiTokensMigrationCall_finalize | MultiTokensMigrationCall_migrate_attributes | MultiTokensMigrationCall_migrate_collection_accounts | MultiTokensMigrationCall_migrate_collections | MultiTokensMigrationCall_migrate_token_accounts | MultiTokensMigrationCall_migrate_tokens
...
export interface V4AbridgedHostConfiguration {
    maxCodeSize: number
...
export const V4AbridgedHostConfiguration: sts.Type<V4AbridgedHostConfiguration> = sts.struct(() => {
    return  {
...
export interface MessagingStateSnapshot {
    ...
    ingressChannels: [Id, V4AbridgedHrmpChannel][]
    egressChannels: [Id, V4AbridgedHrmpChannel][]
}
...
export const MessagingStateSnapshot: sts.Type<MessagingStateSnapshot> = sts.struct(() => {
    return  {
        dmqMqcHead: H256,
        relayDispatchQueueSize: RelayDispachQueueSize,
        ingressChannels: sts.array(() => sts.tuple(() => [Id, V4AbridgedHrmpChannel])),
        egressChannels: sts.array(() => sts.tuple(() => [Id, V4AbridgedHrmpChannel])),
    }
})

export const V4AbridgedHrmpChannel: sts.Type<V4AbridgedHrmpChannel> = sts.struct(() => {
    return  {
...
export const RelayDispachQueueSize: sts.Type<RelayDispachQueueSize> = sts.struct(() => {
    return  {
...
export type Event = Event_Balances | Event_Bounties | Event_Claims | Event_CollatorStaking | Event_CommunityPool | Event_Council | Event_CumulusXcm | Event_Democracy | Event_DmpQueue | Event_ExtrinsicPause | Event_FuelTanks | Event_Marketplace | Event_MatrixUtility | Event_MatrixXcm | Event_MultiTokens | Event_MultiTokensMigration | Event_Multisig | Event_OrmlXcm | Event_ParachainSystem | Event_PolkadotXcm | Event_Pools | Event_Preimage | Event_Scheduler | Event_Session | Event_System | Event_TechnicalCommittee | Event_TechnicalMembership | Event_TransactionPayment | Event_UnknownTokens | Event_Utility | Event_XTokens | Event_XcmpQueue
 ...
 */
export type MultiTokensMigrationEvent = MultiTokensMigrationEvent_MigratedAttributes | MultiTokensMigrationEvent_MigratedCollectionAccounts | MultiTokensMigrationEvent_MigratedCollections | MultiTokensMigrationEvent_MigratedTokenAccounts | MultiTokensMigrationEvent_MigratedTokens | MultiTokensMigrationEvent_MigrationFinished
...
export const Type_395: sts.Type<Type_395> = sts.struct(() => {
    return  {
        accountId: AccountId32,
        params: DefaultMintParams,
    }
...
export const Type_356: sts.Type<Type_356> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_356),
        SetErrorHandler: sts.array(() => Type_356),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const MultiTokensMigrationCall: sts.Type<MultiTokensMigrationCall> = sts.closedEnum(() => {
    return  {
        ...
        migrate_attributes: sts.enumStruct({
            attributes: sts.array(() => sts.tuple(() => [sts.bigint(), sts.option(() => sts.bigint()), sts.bytes(), Attribute])),
        }),

...
export class BalancesForceTransferCall {
    constructor(private ctx: CallContext) {
        assert(
            this.ctx.extrinsic.name === 'system.forceTransfer' || this.ctx.extrinsic.name === 'system.force_transfer'
        )
    }
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('system.force_transfer') ===
            'e5944fbe8224a17fe49f9c1d1d01efaf87fb1778fd39618512af54c9ba6f9dff'
        )
    }
...
export class BalancesTransferCall {
    constructor(private ctx: CallContext) {
        assert(this.ctx.extrinsic.name === 'system.transfer')
    }
     ...
     *   - Transferring system to accounts that did not exist before will cause
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('system.transfer') ===
            'fc85bea9d0d171982f66e8a55667d58dc9a1612bcafe84309942bf47e23e3094'
        )
    }
...
export class BalancesTransferAllCall {
    constructor(private ctx: CallContext) {
        assert(this.ctx.extrinsic.name === 'system.transferAll' || this.ctx.extrinsic.name === 'system.transfer_all')
    }

    /**
     * Transfer the entire transferable balance from the caller account.
     *
     * NOTE: This function only attempts to transfer _transferable_ system. This means that
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('system.transfer_all') ===
            '9c94c2ca9979f6551af6e123fb6b6ba14d026f862f9a023706f8f88c556b355f'
        )
    }
...
export class BalancesTransferKeepAliveCall {
    constructor(private ctx: CallContext) {
        assert(
            this.ctx.extrinsic.name === 'system.transferKeepAlive' ||
                this.ctx.extrinsic.name === 'system.transfer_keep_alive'
        )
    }
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('system.transfer_keep_alive') ===
            'fc85bea9d0d171982f66e8a55667d58dc9a1612bcafe84309942bf47e23e3094'
        )
    }
...
export class MultiTokensApproveCollectionCall {
    constructor(private ctx: CallContext) {
        assert(
            this.ctx.extrinsic.name === 'multiTokens.approveCollection' ||
                this.ctx.extrinsic.name === 'multiTokens.approve_collection'
        )
    }
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.approve_collection') ===
            '488accbd8a7ccff93c1ce6b5609ef67874c52cc8fc80b3b48a2cad226450c092'
        )
    }
...
export class MultiTokensApproveTokenCall {
    constructor(private ctx: CallContext) {
        assert(
            this.ctx.extrinsic.name === 'multiTokens.approveToken' ||
                this.ctx.extrinsic.name === 'multiTokens.approve_token'
        )
    }
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.approve_token') ===
            '7266369f860222731cfac3b4dc9f7b3eb8550de09ee165a184b933efc53cd27a'
        )
    }
...
export class MultiTokensBurnCall {
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.burn') ===
            '5e518fd41f2e62474b4a1bae295d7c2b0bec3f70f20ccbfeb4517ee9e7984bc3'
        )
    }
...
export class MultiTokensCreateCollectionCall {
    constructor(private ctx: CallContext) {
        assert(
            this.ctx.extrinsic.name === 'multiTokens.createCollection' ||
                this.ctx.extrinsic.name === 'multiTokens.create_collection'
        )
    }
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.create_collection') ===
            'c93ec84acdd32c46f33bfe2493efe0a285c1491f6e3d72c98d705a6ac5165146'
        )
    }
...
export class MultiTokensDestroyCollectionCall {
    constructor(private ctx: CallContext) {
        assert(
            this.ctx.extrinsic.name === 'multiTokens.destroyCollection' ||
                this.ctx.extrinsic.name === 'multiTokens.destroy_collection'
        )
    }
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.destroy_collection') ===
            '5213672185bfcdfd14c0e7c97d6a1d1c6244ef0903db4317a9b0bd4a1ab10375'
        )
    }
...
export class MultiTokensFreezeCall {
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.freeze') ===
            '019c3973873981e43338b40ff63c8765c270b4956d51a9937f393b0e8e31d9a7'
        )
    }
...
export class MultiTokensMintCall {
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.mint') ===
            'eaebb17dc952303dfd16624a15d2cde22e3b66a7f91ca95f2f92cd3104cb2499'
        )
    }
...
export class MultiTokensRemoveAttributeCall {
    constructor(private ctx: CallContext) {
        assert(
            this.ctx.extrinsic.name === 'multiTokens.removeAttribute' ||
                this.ctx.extrinsic.name === 'multiTokens.remove_attribute'
        )
    }
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.remove_attribute') ===
            '5e8dda41d19b04f7e051283b9b20aed0a83222ef4bc596239942a512d10e143c'
        )
    }
...
export class MultiTokensSetAttributeCall {
    constructor(private ctx: CallContext) {
        assert(
            this.ctx.extrinsic.name === 'multiTokens.setAttribute' ||
                this.ctx.extrinsic.name === 'multiTokens.set_attribute'
        )
    }
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.set_attribute') ===
            '1442e960b51ef446ff50fc6d27284693378495f9905ed8fbc35811b81dcf7c7b'
        )
    }
...
export class MultiTokensThawCall {
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.thaw') ===
            '019c3973873981e43338b40ff63c8765c270b4956d51a9937f393b0e8e31d9a7'
        )
    }
...
export class MultiTokensTransferCall {
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.transfer') ===
            '3a904597294b52262716ac476178f413a640c58c5df5fdee9d6a42b369dab12a'
        )
    }
...
export class MultiTokensUnapproveCollectionCall {
    constructor(private ctx: CallContext) {
        assert(
            this.ctx.extrinsic.name === 'multiTokens.unapproveCollection' ||
                this.ctx.extrinsic.name === 'multiTokens.unapprove_collection'
        )
    }
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.unapprove_collection') ===
            'e5170bfdb3c4351aa216ff597896abe5ecc75ec89c47b522a97790870cc3b5ef'
        )
    }
...
export class MultiTokensUnapproveTokenCall {
    constructor(private ctx: CallContext) {
        assert(
            this.ctx.extrinsic.name === 'multiTokens.unapproveToken' ||
                this.ctx.extrinsic.name === 'multiTokens.unapprove_token'
        )
    }
    ...
    get isV4(): boolean {
        return (
            this.ctx._chain.getCallHash('multiTokens.unapprove_token') ===
            'bf808826dcdafcc9b31e08b287969eda26c2a350dbd9b501129943a436ab8854'
        )
    }

...
export const createFuelTank =  {
    ...
    v1011: new CallType(
        'FuelTanks.create_fuel_tank',
        sts.struct({
            descriptor: v1011.FuelTankDescriptor,
        })
    ),
    /**
     * Creates a fuel tank, given a `descriptor`.
    ...
    v1012: new CallType(
        'FuelTanks.create_fuel_tank',
        sts.struct({
            descriptor: v1012.FuelTankDescriptor,
        })
    ),
    /**
     * Creates a fuel tank, given a `descriptor`.
    ...
    v1020: new CallType(
        'FuelTanks.create_fuel_tank',
        sts.struct({
            descriptor: v1020.FuelTankDescriptor,
        })
    ),
    /**
     * Creates a fuel tank, given a `descriptor`.
...
export const removeAccountRuleData =  {
    ...
    v1012: new CallType(
        'FuelTanks.remove_account_rule_data',
        sts.struct({
            tankId: v1012.MultiAddress,
            userId: v1012.MultiAddress,
            ruleSetId: sts.number(),
...
export const dispatch =  {
    ...
    v1011: new CallType(
        'FuelTanks.dispatch',
        sts.struct({
            tankId: v1011.MultiAddress,
            ruleSetId: sts.number(),
            call: v1011.Call,
            settings: sts.option(() => v1011.DispatchSettings),
        })
    ),
    /**
     * Dispatch a call using the `tank_id` subject to the rules of `rule_set_id`
    ...
    v1012: new CallType(
        ...
        sts.struct({
            ...
            ruleSetId: sts.number(),
            call: v1012.Call,
            settings: sts.option(() => v1012.DispatchSettings),
        })
    ),
    /**
     * Dispatch a call using the `tank_id` subject to the rules of `rule_set_id`
    ...
    v1020: new CallType(
        'FuelTanks.dispatch',
        sts.struct({
            tankId: v1020.MultiAddress,
            ruleSetId: sts.number(),
            call: v1020.Call,
            settings: sts.option(() => v1020.DispatchSettings),
        })
    ),
    /**
     * Dispatch a call using the `tank_id` subject to the rules of `rule_set_id`
...
export const insertRuleSet =  {
    ...
    v1011: new CallType(
        ...
        sts.struct({
            tankId: v1011.MultiAddress,
            ruleSetId: sts.number(),
            ruleSet: v1011.RuleSetDescriptor,
        })
    ),
    /**
     * Insert a new rule set for `tank_id` and `rule_set_id`. It can be a new rule set
    ...
    v1012: new CallType(
        ...
        sts.struct({
            tankId: v1012.MultiAddress,
            ruleSetId: sts.number(),
            ruleSet: v1012.RuleSetDescriptor,
        })
    ),
    /**
     * Insert a new rule set for `tank_id` and `rule_set_id`. It can be a new rule set
    ...
    v1020: new CallType(
        ...
        sts.struct({
            tankId: v1020.MultiAddress,
            ruleSetId: sts.number(),
            ruleSet: v1020.RuleSetDescriptor,
        })
    ),
    /**
     * Insert a new rule set for `tank_id` and `rule_set_id`. It can be a new rule set
    ...
    v1022: new CallType(
        ...
        sts.struct({
            tankId: v1022.MultiAddress,
            ruleSetId: sts.number(),
            ruleSet: v1022.RuleSetDescriptor,
        })
    ),
}

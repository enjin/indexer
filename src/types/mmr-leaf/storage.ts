...
export const beefyAuthorities =  {
     ...
     */
    enjinV100: new StorageType('MmrLeaf.BeefyAuthorities', 'Default', [], enjinV100.BeefyAuthoritySet) as BeefyAuthoritiesEnjinV100,
    /**
     *  Details of current BEEFY authority set.
     */
    enjinV1032: new StorageType('MmrLeaf.BeefyAuthorities', 'Default', [], enjinV1032.BeefyAuthoritySet) as BeefyAuthoritiesEnjinV1032,
    /**
     *  Details of current BEEFY authority set.
     */
...
export const beefyNextAuthorities =  {
     ...
     */
    enjinV100: new StorageType('MmrLeaf.BeefyNextAuthorities', 'Default', [], enjinV100.BeefyAuthoritySet) as BeefyNextAuthoritiesEnjinV100,
    /**
     *  Details of next BEEFY authority set.
     * 
     *  This storage entry is used as cache for calls to `update_beefy_next_authority_set`.
     */
    enjinV1032: new StorageType('MmrLeaf.BeefyNextAuthorities', 'Default', [], enjinV1032.BeefyAuthoritySet) as BeefyNextAuthoritiesEnjinV1032,
    /**
     *  Details of next BEEFY authority set.
     * 
     *  This storage entry is used as cache for calls to `update_beefy_next_authority_set`.
     */
    v100: new StorageType('MmrLeaf.BeefyNextAuthorities', 'Default', [], v100.BeefyAuthoritySet) as BeefyNextAuthoritiesV100,
    /**
     *  Details of next BEEFY authority set.
     * 
     *  This storage entry is used as cache for calls to `update_beefy_next_authority_set`.
     */
    v1030: new StorageType('MmrLeaf.BeefyNextAuthorities', 'Default', [], v1030.BeefyAuthoritySet) as BeefyNextAuthoritiesV1030,
}

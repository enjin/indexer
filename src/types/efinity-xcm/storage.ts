...
export interface MinimumWeightsMatrixV500 {
    ...
    getPairs(
        block: Block,
        key: matrixV500.XcmOperation
    ): Promise<[k: matrixV500.XcmOperation, v: matrixV500.MinimumWeightFeePair | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: matrixV500.XcmOperation, v: matrixV500.MinimumWeightFeePair | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: matrixV500.XcmOperation

...
export const authorities = {
    ...
    enjinV100: new StorageType(
        ...
        'Default',
        [],
        sts.array(() => sts.tuple(() => [sts.bytes(), sts.bigint()]))
...
export const pendingEpochConfigChange = {
    ...
    ) as PendingEpochConfigChangeEnjinV100,
}
...
export const initialized = {
    ...
    enjinV100: new StorageType(
        ...
        'Optional',
        [],
        sts.option(() => enjinV100.PreDigest)
    ) as InitializedEnjinV100,
    /**
     *  Temporary value (cleared at block finalization) which is `Some`
     *  if per-block initialization has already been called for current block.
     */
    enjinV1032: new StorageType(
        ...
        'Optional',
        [],
        sts.option(() => enjinV1032.PreDigest)
    ) as InitializedEnjinV1032,
    /**
     *  Temporary value (cleared at block finalization) which is `Some`
     *  if per-block initialization has already been called for current block.
     */
...
export const authorVrfRandomness = {
    ...
    enjinV100: new StorageType(
        ...
        'Default',
        [],
        sts.option(() => sts.bytes())
    ) as AuthorVrfRandomnessEnjinV100,
}
...
export const epochConfig = {
    ...
    enjinV100: new StorageType(
        ...
        'Optional',
        [],
        enjinV100.BabeEpochConfiguration
    ) as EpochConfigEnjinV100,
}

...
export const pausedExtrinsics = {
    ...
    matrixEnjinV603: new StorageType(
        ...
        sts.unit()
    ) as PausedExtrinsicsMatrixEnjinV603,
}
...
export interface PausedExtrinsicsMatrixEnjinV603 {
    ...
    getKeysPaged(
        pageSize: number,
        block: Block,
        key: matrixEnjinV603.ExtrinsicInfo
    ): AsyncIterable<matrixEnjinV603.ExtrinsicInfo[]>
    getPairs(block: Block): Promise<[k: matrixEnjinV603.ExtrinsicInfo, v: null | undefined][]>
    getPairs(
        block: Block,
        key: matrixEnjinV603.ExtrinsicInfo
    ): Promise<[k: matrixEnjinV603.ExtrinsicInfo, v: null | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: matrixEnjinV603.ExtrinsicInfo, v: null | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: matrixEnjinV603.ExtrinsicInfo

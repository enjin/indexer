...
export const permanentSlots =  {
     ...
     */
    enjinV100: new StorageType('AssignedSlots.PermanentSlots', 'Optional', [enjinV100.Id], sts.tuple(() => [sts.number(), sts.number()])) as PermanentSlotsEnjinV100,
}
...
export const permanentSlotCount =  {
     ...
     */
    enjinV100: new StorageType('AssignedSlots.PermanentSlotCount', 'Default', [], sts.number()) as PermanentSlotCountEnjinV100,
}
...
export const temporarySlots =  {
     ...
     */
    enjinV100: new StorageType('AssignedSlots.TemporarySlots', 'Optional', [enjinV100.Id], enjinV100.ParachainTemporarySlot) as TemporarySlotsEnjinV100,
}
...
export interface TemporarySlotsEnjinV100  {
    ...
    getPairs(block: Block, key: enjinV100.Id): Promise<[k: enjinV100.Id, v: (enjinV100.ParachainTemporarySlot | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.ParachainTemporarySlot | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.Id): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.ParachainTemporarySlot | undefined)][]>
}
...
export const temporarySlotCount =  {
     ...
     */
    enjinV100: new StorageType('AssignedSlots.TemporarySlotCount', 'Default', [], sts.number()) as TemporarySlotCountEnjinV100,
}
...
export const activeTemporarySlotCount =  {
     ...
     */
    enjinV100: new StorageType('AssignedSlots.ActiveTemporarySlotCount', 'Default', [], sts.number()) as ActiveTemporarySlotCountEnjinV100,
}
...
export const maxTemporarySlots =  {
     ...
     */
    enjinV1032: new StorageType('AssignedSlots.MaxTemporarySlots', 'Default', [], sts.number()) as MaxTemporarySlotsEnjinV1032,
}
...
export const maxPermanentSlots =  {
     ...
     */
    enjinV1032: new StorageType('AssignedSlots.MaxPermanentSlots', 'Default', [], sts.number()) as MaxPermanentSlotsEnjinV1032,
}

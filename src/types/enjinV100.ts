...
export type VersionMigrationStage =
    | VersionMigrationStage_MigrateAndNotifyOldTargets
    | VersionMigrationStage_MigrateSupportedVersion
    | VersionMigrationStage_MigrateVersionNotifiers
    | VersionMigrationStage_NotifyCurrentTargets
...
export type V4ExecutorParam =
    | V4ExecutorParam_MaxMemoryPages
    | V4ExecutorParam_PrecheckingMaxMemory
    | V4ExecutorParam_PvfExecTimeout
    | V4ExecutorParam_PvfPrepTimeout
    | V4ExecutorParam_StackLogicalMax
    | V4ExecutorParam_StackNativeMax
    | V4ExecutorParam_WasmExtBulkMemory
...
export type ParaLifecycle =
    | ParaLifecycle_DowngradingParachain
    | ParaLifecycle_OffboardingParachain
    | ParaLifecycle_OffboardingParathread
    | ParaLifecycle_Onboarding
    | ParaLifecycle_Parachain
    | ParaLifecycle_Parathread
    | ParaLifecycle_UpgradingParathread
...
export type V4ValidDisputeStatementKind =
    | V4ValidDisputeStatementKind_ApprovalChecking
    | V4ValidDisputeStatementKind_BackingSeconded
    | V4ValidDisputeStatementKind_BackingValid
    | V4ValidDisputeStatementKind_Explicit
...
export const V4ScrapedOnChainVotes: sts.Type<V4ScrapedOnChainVotes> = sts.struct(() => {
    return {
        ...
        backingValidatorsPerCandidate: sts.array(() =>
            sts.tuple(() => [
                V4CandidateReceipt,
                sts.array(() => sts.tuple(() => [V4ValidatorIndex, V4ValidityAttestation])),
            ])
        ),
 ...
 */
export type UmpEvent =
    | UmpEvent_ExecutedUpward
    | UmpEvent_InvalidFormat
    | UmpEvent_OverweightEnqueued
    | UmpEvent_OverweightServiced
    | UmpEvent_UnsupportedVersion
    | UmpEvent_UpwardMessagesReceived
    | UmpEvent_WeightExhausted
...
export type FuelTanksEvent =
    ...
    | FuelTanksEvent_MutateFreezeStateScheduled
    | FuelTanksEvent_RuleSetInserted
    | FuelTanksEvent_RuleSetRemoved
    | FuelTanksEvent_ScheduleMutateFreezeStateFailed
...
export type Type_496 =
    | Type_496_AliasOrigin
    | Type_496_BurnAsset
    | Type_496_BuyExecution
    | Type_496_ClaimAsset
    | Type_496_ClearError
    | Type_496_ClearOrigin
    | Type_496_ClearTopic
    | Type_496_ClearTransactStatus
    | Type_496_DepositAsset
    | Type_496_DepositReserveAsset
    | Type_496_DescendOrigin
    | Type_496_ExchangeAsset
    | Type_496_ExpectAsset
    | Type_496_ExpectError
    | Type_496_ExpectOrigin
    | Type_496_ExpectPallet
    | Type_496_ExpectTransactStatus
    | Type_496_ExportMessage
    | Type_496_HrmpChannelAccepted
    | Type_496_HrmpChannelClosing
    | Type_496_HrmpNewChannelOpenRequest
    | Type_496_InitiateReserveWithdraw
    | Type_496_InitiateTeleport
    | Type_496_LockAsset
    | Type_496_NoteUnlockable
    | Type_496_QueryPallet
    | Type_496_QueryResponse
    | Type_496_ReceiveTeleportedAsset
    | Type_496_RefundSurplus
    | Type_496_ReportError
    | Type_496_ReportHolding
    | Type_496_ReportTransactStatus
    | Type_496_RequestUnlock
    | Type_496_ReserveAssetDeposited
    | Type_496_SetAppendix
    | Type_496_SetErrorHandler
    | Type_496_SetFeesMode
    | Type_496_SetTopic
    | Type_496_SubscribeVersion
    | Type_496_Transact
    | Type_496_TransferAsset
    | Type_496_TransferReserveAsset
    | Type_496_Trap
    | Type_496_UniversalOrigin
    | Type_496_UnlockAsset
    | Type_496_UnpaidExecution
    | Type_496_UnsubscribeVersion
    | Type_496_WithdrawAsset
...
export type Type_492 =
    | Type_492_BuyExecution
    | Type_492_ClaimAsset
    | Type_492_ClearError
    | Type_492_ClearOrigin
    | Type_492_DepositAsset
    | Type_492_DepositReserveAsset
    | Type_492_DescendOrigin
    | Type_492_ExchangeAsset
    | Type_492_HrmpChannelAccepted
    | Type_492_HrmpChannelClosing
    | Type_492_HrmpNewChannelOpenRequest
    | Type_492_InitiateReserveWithdraw
    | Type_492_InitiateTeleport
    | Type_492_QueryHolding
    | Type_492_QueryResponse
    | Type_492_ReceiveTeleportedAsset
    | Type_492_RefundSurplus
    | Type_492_ReportError
    | Type_492_ReserveAssetDeposited
    | Type_492_SetAppendix
    | Type_492_SetErrorHandler
    | Type_492_SubscribeVersion
    | Type_492_Transact
    | Type_492_TransferAsset
    | Type_492_TransferReserveAsset
    | Type_492_Trap
    | Type_492_UnsubscribeVersion
...
export type ClaimsCall =
    | ClaimsCall_claim
    | ClaimsCall_claim_early_bird_reward
    | ClaimsCall_claim_from_efinity

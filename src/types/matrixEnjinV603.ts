...
export type EthereumTransferable =
    | EthereumTransferable_Bound
    | EthereumTransferable_Permanent
    | EthereumTransferable_Temporary
...
export type XcmpMessageFormat =
    | XcmpMessageFormat_ConcatenatedEncodedBlob
    | XcmpMessageFormat_ConcatenatedVersionedXcm
    | XcmpMessageFormat_Signals

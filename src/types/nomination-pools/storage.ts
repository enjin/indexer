...
export const poolMembers =  {
     ...
     */
    enjinV100: new StorageType('NominationPools.PoolMembers', 'Optional', [sts.number(), enjinV100.AccountId32], enjinV100.PoolMember) as PoolMembersEnjinV100,
}
...
export interface PoolMembersEnjinV100  {
    ...
    getPairs(block: Block, key1: number): Promise<[k: [number, enjinV100.AccountId32], v: (enjinV100.PoolMember | undefined)][]>
    getPairs(block: Block, key1: number, key2: enjinV100.AccountId32): Promise<[k: [number, enjinV100.AccountId32], v: (enjinV100.PoolMember | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: [number, enjinV100.AccountId32], v: (enjinV100.PoolMember | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number): AsyncIterable<[k: [number, enjinV100.AccountId32], v: (enjinV100.PoolMember | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number, key2: enjinV100.AccountId32): AsyncIterable<[k: [number, enjinV100.AccountId32], v: (enjinV100.PoolMember | undefined)][]>
}
...
export const bondedPools =  {
     ...
     */
    enjinV100: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], enjinV100.BondedPoolInner) as BondedPoolsEnjinV100,
    /**
     *  Storage for bonded pools.
     */
    enjinV101: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], enjinV101.BondedPoolInner) as BondedPoolsEnjinV101,
    /**
     *  Storage for bonded pools.
     */
    enjinV110: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], enjinV110.BondedPoolInner) as BondedPoolsEnjinV110,
    /**
     *  Storage for bonded pools.
     */
    enjinV1023: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], enjinV1023.BondedPoolInner) as BondedPoolsEnjinV1023,
    /**
     *  Storage for bonded pools.
     */
    v100: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], v100.BondedPoolInner) as BondedPoolsV100,
    /**
     *  Storage for bonded pools.
     */
    v101: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], v101.BondedPoolInner) as BondedPoolsV101,
    /**
     *  Storage for bonded pools.
     */
    v102: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], v102.BondedPoolInner) as BondedPoolsV102,
    /**
     *  Storage for bonded pools.
     */
    v103: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], v103.BondedPoolInner) as BondedPoolsV103,
    /**
     *  Storage for bonded pools.
     */
    v104: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], v104.BondedPoolInner) as BondedPoolsV104,
    /**
     *  Storage for bonded pools.
     */
    v105: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], v105.BondedPoolInner) as BondedPoolsV105,
    /**
     *  Storage for bonded pools.
     */
    v110: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], v110.BondedPoolInner) as BondedPoolsV110,
    /**
     *  Storage for bonded pools.
     */
    v1023: new StorageType('NominationPools.BondedPools', 'Optional', [sts.number()], v1023.BondedPoolInner) as BondedPoolsV1023,
}
...
export interface BondedPoolsEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (enjinV100.BondedPoolInner | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV100.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsEnjinV101  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (enjinV101.BondedPoolInner | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV101.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsEnjinV110  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (enjinV110.BondedPoolInner | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV110.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsEnjinV1023  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (enjinV1023.BondedPoolInner | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV1023.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v100.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsV101  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v101.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsV102  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v102.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsV103  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v103.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsV104  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v104.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsV105  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v105.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsV110  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v110.BondedPoolInner | undefined)][]>
}
...
export interface BondedPoolsV1023  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v1023.BondedPoolInner | undefined)][]>
}
...
export const counterForBondedPools =  {
     ...
     */
    enjinV100: new StorageType('NominationPools.CounterForBondedPools', 'Default', [], sts.number()) as CounterForBondedPoolsEnjinV100,
}
...
export const subPoolsStorage =  {
     ...
     */
    enjinV100: new StorageType('NominationPools.SubPoolsStorage', 'Optional', [sts.number()], enjinV100.SubPools) as SubPoolsStorageEnjinV100,
}
...
export interface SubPoolsStorageEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV100.SubPools | undefined)][]>
}
...
export const counterForSubPoolsStorage =  {
     ...
     * Counter for the related counted storage map
     */
    enjinV100: new StorageType('NominationPools.CounterForSubPoolsStorage', 'Default', [], sts.number()) as CounterForSubPoolsStorageEnjinV100,
}
...
export const reversePoolIdLookup =  {
     ...
     */
    enjinV100: new StorageType('NominationPools.ReversePoolIdLookup', 'Optional', [enjinV100.AccountId32], sts.number()) as ReversePoolIdLookupEnjinV100,
}
...
export interface ReversePoolIdLookupEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.AccountId32): AsyncIterable<[k: enjinV100.AccountId32, v: (number | undefined)][]>
}
...
export const counterForReversePoolIdLookup =  {
     ...
     * Counter for the related counted storage map
     */
    enjinV100: new StorageType('NominationPools.CounterForReversePoolIdLookup', 'Default', [], sts.number()) as CounterForReversePoolIdLookupEnjinV100,
}
...
export const usedPoolTokenIds =  {
     ...
     */
    enjinV100: new StorageType('NominationPools.UsedPoolTokenIds', 'Optional', [sts.bigint()], sts.number()) as UsedPoolTokenIdsEnjinV100,
}
...
export const globalMaxCommission =  {
     ...
     */
    enjinV100: new StorageType('NominationPools.GlobalMaxCommission', 'Optional', [], enjinV100.Perbill) as GlobalMaxCommissionEnjinV100,
}
...
export const unbondingMembers =  {
     ...
     *  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
     */
    enjinV101: new StorageType('NominationPools.UnbondingMembers', 'Optional', [sts.number(), enjinV101.AccountId32], enjinV101.PoolMember) as UnbondingMembersEnjinV101,
}
...
export interface UnbondingMembersEnjinV101  {
    ...
    getKeysPaged(pageSize: number, block: Block, key1: number, key2: enjinV101.AccountId32): AsyncIterable<[number, enjinV101.AccountId32][]>
    getPairs(block: Block): Promise<[k: [number, enjinV101.AccountId32], v: (enjinV101.PoolMember | undefined)][]>
    getPairs(block: Block, key1: number): Promise<[k: [number, enjinV101.AccountId32], v: (enjinV101.PoolMember | undefined)][]>
    getPairs(block: Block, key1: number, key2: enjinV101.AccountId32): Promise<[k: [number, enjinV101.AccountId32], v: (enjinV101.PoolMember | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: [number, enjinV101.AccountId32], v: (enjinV101.PoolMember | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number): AsyncIterable<[k: [number, enjinV101.AccountId32], v: (enjinV101.PoolMember | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number, key2: enjinV101.AccountId32): AsyncIterable<[k: [number, enjinV101.AccountId32], v: (enjinV101.PoolMember | undefined)][]>
}
...
export const stakingInformation =  {
     ...
     */
    enjinV101: new StorageType('NominationPools.StakingInformation', 'Optional', [], enjinV101.StakingInfo) as StakingInformationEnjinV101,
    /**
     *  The general staking parameters
     */
    enjinV1032: new StorageType('NominationPools.StakingInformation', 'Optional', [], enjinV1032.StakingInfo) as StakingInformationEnjinV1032,
    /**
     *  The general staking parameters
     */
    v105: new StorageType('NominationPools.StakingInformation', 'Optional', [], v105.StakingInfo) as StakingInformationV105,
    /**
     *  The general staking parameters
     */
    v1030: new StorageType('NominationPools.StakingInformation', 'Optional', [], v1030.StakingInfo) as StakingInformationV1030,
}
...
export const earlyBirdBonusInfo =  {
     ...
     */
    enjinV101: new StorageType('NominationPools.EarlyBirdBonusInfo', 'Default', [], enjinV101.EarlyBirdInfo) as EarlyBirdBonusInfoEnjinV101,
    /**
     *  The queue of bonuses that should be distributed to the pools
     */
    enjinV1021: new StorageType('NominationPools.EarlyBirdBonusInfo', 'Default', [], enjinV1021.EarlyBirdInfo) as EarlyBirdBonusInfoEnjinV1021,
    /**
     *  The queue of bonuses that should be distributed to the pools
     */
    enjinV1023: new StorageType('NominationPools.EarlyBirdBonusInfo', 'Default', [], enjinV1023.EarlyBirdInfo) as EarlyBirdBonusInfoEnjinV1023,
    /**
     *  The queue of bonuses that should be distributed to the pools
     */
    v106: new StorageType('NominationPools.EarlyBirdBonusInfo', 'Default', [], v106.EarlyBirdInfo) as EarlyBirdBonusInfoV106,
    /**
     *  The queue of bonuses that should be distributed to the pools
     */
    v1021: new StorageType('NominationPools.EarlyBirdBonusInfo', 'Default', [], v1021.EarlyBirdInfo) as EarlyBirdBonusInfoV1021,
    /**
     *  The queue of bonuses that should be distributed to the pools
     */
    v1023: new StorageType('NominationPools.EarlyBirdBonusInfo', 'Default', [], v1023.EarlyBirdInfo) as EarlyBirdBonusInfoV1023,
}
...
export const eraPayoutInfo =  {
     ...
     */
    enjinV110: new StorageType('NominationPools.EraPayoutInfo', 'Default', [], enjinV110.EraPayout) as EraPayoutInfoEnjinV110,
    /**
     *  Tracks payout information for an era
     */
    enjinV120: new StorageType('NominationPools.EraPayoutInfo', 'Default', [], enjinV120.EraPayout) as EraPayoutInfoEnjinV120,
    /**
     *  Tracks payout information for an era
     */
...
export const poolBonusInfos =  {
     ...
     */
    enjinV1021: new StorageType('NominationPools.PoolBonusInfos', 'Optional', [sts.number()], enjinV1021.PoolBonusInfo) as PoolBonusInfosEnjinV1021,
    /**
     *  Storage for pool bonus info
     */
    enjinV1023: new StorageType('NominationPools.PoolBonusInfos', 'Optional', [sts.number()], enjinV1023.PoolBonusInfo) as PoolBonusInfosEnjinV1023,
    /**
     *  Storage for pool bonus info
     */
    v1021: new StorageType('NominationPools.PoolBonusInfos', 'Optional', [sts.number()], v1021.PoolBonusInfo) as PoolBonusInfosV1021,
    /**
     *  Storage for pool bonus info
     */
    v1023: new StorageType('NominationPools.PoolBonusInfos', 'Optional', [sts.number()], v1023.PoolBonusInfo) as PoolBonusInfosV1023,
}
...
export interface PoolBonusInfosEnjinV1021  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV1021.PoolBonusInfo | undefined)][]>
}
...
export interface PoolBonusInfosEnjinV1023  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV1023.PoolBonusInfo | undefined)][]>
}
...
export interface PoolBonusInfosV1021  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v1021.PoolBonusInfo | undefined)][]>
}
...
export interface PoolBonusInfosV1023  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v1023.PoolBonusInfo | undefined)][]>
}
...
export const earlyBirdShares =  {
     ...
     */
    enjinV1022: new StorageType('NominationPools.EarlyBirdShares', 'Optional', [sts.number(), enjinV1022.AccountId32], enjinV1022.Perquintill) as EarlyBirdSharesEnjinV1022,
}
...
export interface EarlyBirdSharesEnjinV1022  {
    ...
    getKeysPaged(pageSize: number, block: Block, key1: number, key2: enjinV1022.AccountId32): AsyncIterable<[number, enjinV1022.AccountId32][]>
    getPairs(block: Block): Promise<[k: [number, enjinV1022.AccountId32], v: (enjinV1022.Perquintill | undefined)][]>
    getPairs(block: Block, key1: number): Promise<[k: [number, enjinV1022.AccountId32], v: (enjinV1022.Perquintill | undefined)][]>
    getPairs(block: Block, key1: number, key2: enjinV1022.AccountId32): Promise<[k: [number, enjinV1022.AccountId32], v: (enjinV1022.Perquintill | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: [number, enjinV1022.AccountId32], v: (enjinV1022.Perquintill | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number): AsyncIterable<[k: [number, enjinV1022.AccountId32], v: (enjinV1022.Perquintill | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number, key2: enjinV1022.AccountId32): AsyncIterable<[k: [number, enjinV1022.AccountId32], v: (enjinV1022.Perquintill | undefined)][]>
}

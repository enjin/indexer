...
export type Type_193 = Type_193_NoMutation | Type_193_SomeMutation

export interface Type_193_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_193_SomeMutation {
    __kind: 'SomeMutation'
...
export interface DefaultTankMutation {
    userAccountManagement: Type_256
...
export type Type_256 = Type_256_NoMutation | Type_256_SomeMutation

export interface Type_256_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_256_SomeMutation {
    __kind: 'SomeMutation'
...
export type Type_644 = Type_644_ApplyExtrinsic | Type_644_Finalization | Type_644_Initialization

export interface Type_644_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_644_Finalization {
    __kind: 'Finalization'
}

export interface Type_644_Initialization {
...
export const Type_641: sts.Type<Type_641> = sts.struct(() => {
    return  {
        bareAyes: sts.number(),
        ayes: sts.number(),
        nays: sts.number(),
...
export const Type_644: sts.Type<Type_644> = sts.closedEnum(() => {
    return  {
...
export interface NominationPoolsCall_set_configs {
    __kind: 'set_configs'
    minJoinBond: Type_409
    minCreateBond: Type_409
    globalMaxCommission: Type_410
}
...
export type Type_410 = Type_410_Noop | Type_410_Remove | Type_410_Set

export interface Type_410_Noop {
    __kind: 'Noop'
}

export interface Type_410_Remove {
    __kind: 'Remove'
}

export interface Type_410_Set {
    __kind: 'Set'
    value: Perbill
}

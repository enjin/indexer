...
export const shouldRecordXcm =  {
     ...
     */
    matrixV1020: new StorageType('PolkadotXcm.ShouldRecordXcm', 'Default', [], sts.boolean()) as ShouldRecordXcmMatrixV1020,
}
...
export const recordedXcm =  {
     ...
     *  implementation in the XCM executor configuration.
     */
    matrixV1020: new StorageType('PolkadotXcm.RecordedXcm', 'Optional', [], sts.array(() => matrixV1020.V4Instruction)) as RecordedXcmMatrixV1020,
}

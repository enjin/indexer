...
export const pvfActiveVoteMap =  {
     ...
     */
    enjinV100: new StorageType('Paras.PvfActiveVoteMap', 'Optional', [enjinV100.ValidationCodeHash], enjinV100.PvfCheckActiveVoteState) as PvfActiveVoteMapEnjinV100,
    /**
     *  All currently active PVF pre-checking votes.
     * 
     *  Invariant:
     *  - There are no PVF pre-checking votes that exists in list but not in the set and vice versa.
     */
    enjinV1032: new StorageType('Paras.PvfActiveVoteMap', 'Optional', [enjinV1032.ValidationCodeHash], enjinV1032.PvfCheckActiveVoteState) as PvfActiveVoteMapEnjinV1032,
    /**
     *  All currently active PVF pre-checking votes.
     * 
     *  Invariant:
     *  - There are no PVF pre-checking votes that exists in list but not in the set and vice versa.
     */
    enjinV1050: new StorageType('Paras.PvfActiveVoteMap', 'Optional', [enjinV1050.ValidationCodeHash], enjinV1050.PvfCheckActiveVoteState) as PvfActiveVoteMapEnjinV1050,
    /**
     *  All currently active PVF pre-checking votes.
     * 
     *  Invariant:
     *  - There are no PVF pre-checking votes that exists in list but not in the set and vice versa.
     */
    v100: new StorageType('Paras.PvfActiveVoteMap', 'Optional', [v100.ValidationCodeHash], v100.PvfCheckActiveVoteState) as PvfActiveVoteMapV100,
    /**
     *  All currently active PVF pre-checking votes.
     * 
     *  Invariant:
     *  - There are no PVF pre-checking votes that exists in list but not in the set and vice versa.
     */
    v1030: new StorageType('Paras.PvfActiveVoteMap', 'Optional', [v1030.ValidationCodeHash], v1030.PvfCheckActiveVoteState) as PvfActiveVoteMapV1030,
    /**
     *  All currently active PVF pre-checking votes.
     * 
     *  Invariant:
     *  - There are no PVF pre-checking votes that exists in list but not in the set and vice versa.
     */
    v1050: new StorageType('Paras.PvfActiveVoteMap', 'Optional', [v1050.ValidationCodeHash], v1050.PvfCheckActiveVoteState) as PvfActiveVoteMapV1050,
}
...
export interface PvfActiveVoteMapEnjinV100  {
    ...
    getMany(block: Block, keys: enjinV100.ValidationCodeHash[]): Promise<(enjinV100.PvfCheckActiveVoteState | undefined)[]>
    ...
    getKeysPaged(pageSize: number, block: Block, key: enjinV100.ValidationCodeHash): AsyncIterable<enjinV100.ValidationCodeHash[]>
    getPairs(block: Block): Promise<[k: enjinV100.ValidationCodeHash, v: (enjinV100.PvfCheckActiveVoteState | undefined)][]>
    getPairs(block: Block, key: enjinV100.ValidationCodeHash): Promise<[k: enjinV100.ValidationCodeHash, v: (enjinV100.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.ValidationCodeHash, v: (enjinV100.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.ValidationCodeHash): AsyncIterable<[k: enjinV100.ValidationCodeHash, v: (enjinV100.PvfCheckActiveVoteState | undefined)][]>
}
...
export interface PvfActiveVoteMapEnjinV1032  {
    ...
    getMany(block: Block, keys: enjinV1032.ValidationCodeHash[]): Promise<(enjinV1032.PvfCheckActiveVoteState | undefined)[]>
    ...
    getKeysPaged(pageSize: number, block: Block, key: enjinV1032.ValidationCodeHash): AsyncIterable<enjinV1032.ValidationCodeHash[]>
    getPairs(block: Block): Promise<[k: enjinV1032.ValidationCodeHash, v: (enjinV1032.PvfCheckActiveVoteState | undefined)][]>
    getPairs(block: Block, key: enjinV1032.ValidationCodeHash): Promise<[k: enjinV1032.ValidationCodeHash, v: (enjinV1032.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV1032.ValidationCodeHash, v: (enjinV1032.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV1032.ValidationCodeHash): AsyncIterable<[k: enjinV1032.ValidationCodeHash, v: (enjinV1032.PvfCheckActiveVoteState | undefined)][]>
}
...
export interface PvfActiveVoteMapEnjinV1050  {
    ...
    getMany(block: Block, keys: enjinV1050.ValidationCodeHash[]): Promise<(enjinV1050.PvfCheckActiveVoteState | undefined)[]>
    ...
    getKeysPaged(pageSize: number, block: Block, key: enjinV1050.ValidationCodeHash): AsyncIterable<enjinV1050.ValidationCodeHash[]>
    getPairs(block: Block): Promise<[k: enjinV1050.ValidationCodeHash, v: (enjinV1050.PvfCheckActiveVoteState | undefined)][]>
    getPairs(block: Block, key: enjinV1050.ValidationCodeHash): Promise<[k: enjinV1050.ValidationCodeHash, v: (enjinV1050.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV1050.ValidationCodeHash, v: (enjinV1050.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV1050.ValidationCodeHash): AsyncIterable<[k: enjinV1050.ValidationCodeHash, v: (enjinV1050.PvfCheckActiveVoteState | undefined)][]>
}
...
export interface PvfActiveVoteMapV100  {
    ...
    getPairs(block: Block, key: v100.ValidationCodeHash): Promise<[k: v100.ValidationCodeHash, v: (v100.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v100.ValidationCodeHash, v: (v100.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v100.ValidationCodeHash): AsyncIterable<[k: v100.ValidationCodeHash, v: (v100.PvfCheckActiveVoteState | undefined)][]>
}
...
export interface PvfActiveVoteMapV1030  {
    ...
    getKeysPaged(pageSize: number, block: Block, key: v1030.ValidationCodeHash): AsyncIterable<v1030.ValidationCodeHash[]>
    getPairs(block: Block): Promise<[k: v1030.ValidationCodeHash, v: (v1030.PvfCheckActiveVoteState | undefined)][]>
    getPairs(block: Block, key: v1030.ValidationCodeHash): Promise<[k: v1030.ValidationCodeHash, v: (v1030.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v1030.ValidationCodeHash, v: (v1030.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v1030.ValidationCodeHash): AsyncIterable<[k: v1030.ValidationCodeHash, v: (v1030.PvfCheckActiveVoteState | undefined)][]>
}
...
export interface PvfActiveVoteMapV1050  {
    ...
    getKeysPaged(pageSize: number, block: Block, key: v1050.ValidationCodeHash): AsyncIterable<v1050.ValidationCodeHash[]>
    getPairs(block: Block): Promise<[k: v1050.ValidationCodeHash, v: (v1050.PvfCheckActiveVoteState | undefined)][]>
    getPairs(block: Block, key: v1050.ValidationCodeHash): Promise<[k: v1050.ValidationCodeHash, v: (v1050.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v1050.ValidationCodeHash, v: (v1050.PvfCheckActiveVoteState | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v1050.ValidationCodeHash): AsyncIterable<[k: v1050.ValidationCodeHash, v: (v1050.PvfCheckActiveVoteState | undefined)][]>
}
...
export const pvfActiveVoteList =  {
     ...
     */
    enjinV100: new StorageType('Paras.PvfActiveVoteList', 'Default', [], sts.array(() => enjinV100.ValidationCodeHash)) as PvfActiveVoteListEnjinV100,
}
...
export const parachains =  {
     ...
     */
    enjinV100: new StorageType('Paras.Parachains', 'Default', [], sts.array(() => enjinV100.Id)) as ParachainsEnjinV100,
}
...
export const paraLifecycles =  {
     ...
     */
    enjinV100: new StorageType('Paras.ParaLifecycles', 'Optional', [enjinV100.Id], enjinV100.ParaLifecycle) as ParaLifecyclesEnjinV100,
}
...
export interface ParaLifecyclesEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.ParaLifecycle | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.Id): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.ParaLifecycle | undefined)][]>
}
...
export interface HeadsEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.Id): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.HeadData | undefined)][]>
}
...
export const currentCodeHash =  {
     ...
     */
    enjinV100: new StorageType('Paras.CurrentCodeHash', 'Optional', [enjinV100.Id], enjinV100.ValidationCodeHash) as CurrentCodeHashEnjinV100,
}
...
export interface CurrentCodeHashEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.ValidationCodeHash | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.Id): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.ValidationCodeHash | undefined)][]>
}
...
export const pastCodeHash =  {
     ...
     *  Corresponding code can be retrieved with [`CodeByHash`].
     */
    enjinV100: new StorageType('Paras.PastCodeHash', 'Optional', [sts.tuple(() => [enjinV100.Id, sts.number()])], enjinV100.ValidationCodeHash) as PastCodeHashEnjinV100,
}
...
export interface PastCodeHashEnjinV100  {
    ...
    getPairs(block: Block, key: [enjinV100.Id, number]): Promise<[k: [enjinV100.Id, number], v: (enjinV100.ValidationCodeHash | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: [enjinV100.Id, number], v: (enjinV100.ValidationCodeHash | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: [enjinV100.Id, number]): AsyncIterable<[k: [enjinV100.Id, number], v: (enjinV100.ValidationCodeHash | undefined)][]>
}
...
export const pastCodeMeta =  {
     ...
     */
    enjinV100: new StorageType('Paras.PastCodeMeta', 'Default', [enjinV100.Id], enjinV100.ParaPastCodeMeta) as PastCodeMetaEnjinV100,
}
...
export interface PastCodeMetaEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.ParaPastCodeMeta | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.Id): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.ParaPastCodeMeta | undefined)][]>
}
...
export const pastCodePruning =  {
     ...
     */
    enjinV100: new StorageType('Paras.PastCodePruning', 'Default', [], sts.array(() => sts.tuple(() => [enjinV100.Id, sts.number()]))) as PastCodePruningEnjinV100,
}
...
export const futureCodeUpgrades =  {
     ...
     */
    enjinV100: new StorageType('Paras.FutureCodeUpgrades', 'Optional', [enjinV100.Id], sts.number()) as FutureCodeUpgradesEnjinV100,
}
...
export const futureCodeHash =  {
     ...
     *  Corresponding code can be retrieved with [`CodeByHash`].
     */
    enjinV100: new StorageType('Paras.FutureCodeHash', 'Optional', [enjinV100.Id], enjinV100.ValidationCodeHash) as FutureCodeHashEnjinV100,
}
...
export const upgradeGoAheadSignal =  {
     ...
     */
    enjinV100: new StorageType('Paras.UpgradeGoAheadSignal', 'Optional', [enjinV100.Id], enjinV100.V4UpgradeGoAhead) as UpgradeGoAheadSignalEnjinV100,
}
...
export interface UpgradeGoAheadSignalEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.V4UpgradeGoAhead | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.Id): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.V4UpgradeGoAhead | undefined)][]>
}
...
export const upgradeRestrictionSignal =  {
     ...
     *  the format will require migration of parachains.
     */
    enjinV100: new StorageType('Paras.UpgradeRestrictionSignal', 'Optional', [enjinV100.Id], enjinV100.V4UpgradeRestriction) as UpgradeRestrictionSignalEnjinV100,
}
...
export interface UpgradeRestrictionSignalEnjinV100  {
    ...
    getPairs(block: Block, key: enjinV100.Id): Promise<[k: enjinV100.Id, v: (enjinV100.V4UpgradeRestriction | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.V4UpgradeRestriction | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.Id): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.V4UpgradeRestriction | undefined)][]>
}
...
export const upgradeCooldowns =  {
     ...
     */
    enjinV100: new StorageType('Paras.UpgradeCooldowns', 'Default', [], sts.array(() => sts.tuple(() => [enjinV100.Id, sts.number()]))) as UpgradeCooldownsEnjinV100,
}
...
export const upcomingUpgrades =  {
     ...
     *  Ordered ascending by block number.
     */
    enjinV100: new StorageType('Paras.UpcomingUpgrades', 'Default', [], sts.array(() => sts.tuple(() => [enjinV100.Id, sts.number()]))) as UpcomingUpgradesEnjinV100,
}
...
export const actionsQueue =  {
     ...
     */
    enjinV100: new StorageType('Paras.ActionsQueue', 'Default', [sts.number()], sts.array(() => enjinV100.Id)) as ActionsQueueEnjinV100,
}
...
export interface ActionsQueueEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV100.Id[] | undefined)][]>
}
...
export const upcomingParasGenesis =  {
     ...
     */
    enjinV100: new StorageType('Paras.UpcomingParasGenesis', 'Optional', [enjinV100.Id], enjinV100.ParaGenesisArgs) as UpcomingParasGenesisEnjinV100,
}
...
export interface UpcomingParasGenesisEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.ParaGenesisArgs | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.Id): AsyncIterable<[k: enjinV100.Id, v: (enjinV100.ParaGenesisArgs | undefined)][]>
}
...
export const codeByHashRefs =  {
     ...
     */
    enjinV100: new StorageType('Paras.CodeByHashRefs', 'Default', [enjinV100.ValidationCodeHash], sts.number()) as CodeByHashRefsEnjinV100,
}
...
export interface CodeByHashRefsEnjinV100  {
    ...
    getPairs(block: Block, key: enjinV100.ValidationCodeHash): Promise<[k: enjinV100.ValidationCodeHash, v: (number | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.ValidationCodeHash, v: (number | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.ValidationCodeHash): AsyncIterable<[k: enjinV100.ValidationCodeHash, v: (number | undefined)][]>
}
...
export const codeByHash =  {
     ...
     *  [`PastCodeHash`].
     */
    enjinV100: new StorageType('Paras.CodeByHash', 'Optional', [enjinV100.ValidationCodeHash], enjinV100.ValidationCode) as CodeByHashEnjinV100,
}
...
export interface CodeByHashEnjinV100  {
    ...
    getPairs(block: Block, key: enjinV100.ValidationCodeHash): Promise<[k: enjinV100.ValidationCodeHash, v: (enjinV100.ValidationCode | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.ValidationCodeHash, v: (enjinV100.ValidationCode | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.ValidationCodeHash): AsyncIterable<[k: enjinV100.ValidationCodeHash, v: (enjinV100.ValidationCode | undefined)][]>
}
...
export const mostRecentContext =  {
     ...
     */
    enjinV1032: new StorageType('Paras.MostRecentContext', 'Optional', [enjinV1032.Id], sts.number()) as MostRecentContextEnjinV1032,
}
...
export interface MostRecentContextEnjinV1032  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: enjinV1032.Id): AsyncIterable<[k: enjinV1032.Id, v: (number | undefined)][]>
}
...
export const futureCodeUpgradesAt =  {
     ...
     *  Ordered ascending by block number.
     */
    enjinV1050: new StorageType('Paras.FutureCodeUpgradesAt', 'Default', [], sts.array(() => sts.tuple(() => [enjinV1050.Id, sts.number()]))) as FutureCodeUpgradesAtEnjinV1050,
}

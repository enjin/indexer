...
export const currentCodeUpdated = {
     ...
     */
    enjinV100: new EventType('Paras.CurrentCodeUpdated', enjinV100.Id),
}
...
export const currentHeadUpdated = {
     ...
     */
    enjinV100: new EventType('Paras.CurrentHeadUpdated', enjinV100.Id),
}
...
export const codeUpgradeScheduled = {
     ...
     */
    enjinV100: new EventType('Paras.CodeUpgradeScheduled', enjinV100.Id),
}
...
export const newHeadNoted = {
     ...
     */
    enjinV100: new EventType('Paras.NewHeadNoted', enjinV100.Id),
}
...
export const actionQueued = {
     ...
     */
    enjinV100: new EventType('Paras.ActionQueued', sts.tuple([enjinV100.Id, sts.number()])),
}
...
export const pvfCheckStarted = {
     ...
     */
    enjinV100: new EventType('Paras.PvfCheckStarted', sts.tuple([enjinV100.ValidationCodeHash, enjinV100.Id])),
}
...
export const pvfCheckAccepted = {
     ...
     * `code_hash` `para_id`
     */
    enjinV100: new EventType('Paras.PvfCheckAccepted', sts.tuple([enjinV100.ValidationCodeHash, enjinV100.Id])),
}

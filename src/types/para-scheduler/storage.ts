...
export const validatorGroups =  {
     ...
     */
    enjinV100: new StorageType('ParaScheduler.ValidatorGroups', 'Default', [], sts.array(() => sts.array(() => enjinV100.V4ValidatorIndex))) as ValidatorGroupsEnjinV100,
}
...
export const parathreadQueue =  {
     ...
     */
    enjinV100: new StorageType('ParaScheduler.ParathreadQueue', 'Default', [], enjinV100.ParathreadClaimQueue) as ParathreadQueueEnjinV100,
}
...
export const availabilityCores =  {
     ...
     */
    enjinV100: new StorageType('ParaScheduler.AvailabilityCores', 'Default', [], sts.array(() => sts.option(() => enjinV100.V4CoreOccupied))) as AvailabilityCoresEnjinV100,
    /**
     ...
     *    * The number of validators divided by `configuration.max_validators_per_core`.
     */
    enjinV1032: new StorageType('ParaScheduler.AvailabilityCores', 'Default', [], sts.array(() => enjinV1032.CoreOccupied)) as AvailabilityCoresEnjinV1032,
    /**
     *  One entry for each availability core. Entries are `None` if the core is not currently occupied. Can be
     *  temporarily `Some` if scheduled but not occupied.
     *  The i'th parachain belongs to the i'th core, with the remaining cores all being
     ...
     *    * The number of validators divided by `configuration.max_validators_per_core`.
     */
    v100: new StorageType('ParaScheduler.AvailabilityCores', 'Default', [], sts.array(() => sts.option(() => v100.V2CoreOccupied))) as AvailabilityCoresV100,
    /**
     *  One entry for each availability core. The i'th parachain belongs to the i'th core, with the
     *  remaining cores all being on demand parachain multiplexers.
     * 
     ...
     *    * The number of validators divided by `configuration.max_validators_per_core`.
     */
    v1030: new StorageType('ParaScheduler.AvailabilityCores', 'Default', [], sts.array(() => v1030.CoreOccupied)) as AvailabilityCoresV1030,
}
...
export const parathreadClaimIndex =  {
     ...
     */
    enjinV100: new StorageType('ParaScheduler.ParathreadClaimIndex', 'Default', [], sts.array(() => enjinV100.Id)) as ParathreadClaimIndexEnjinV100,
}
...
export const sessionStartBlock =  {
     ...
     */
    enjinV100: new StorageType('ParaScheduler.SessionStartBlock', 'Default', [], sts.number()) as SessionStartBlockEnjinV100,
}
...
export const scheduled =  {
     ...
     */
    enjinV100: new StorageType('ParaScheduler.Scheduled', 'Default', [], sts.array(() => enjinV100.CoreAssignment)) as ScheduledEnjinV100,
}
...
export const claimQueue =  {
     ...
     */
    enjinV1032: new StorageType('ParaScheduler.ClaimQueue', 'Default', [], sts.array(() => sts.tuple(() => [enjinV1032.V6CoreIndex, sts.array(() => enjinV1032.ParasEntry)]))) as ClaimQueueEnjinV1032,
}

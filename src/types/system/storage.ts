...
export const account =  {
     ...
     *  The full account information for a particular account ID.
     */
    matrixV500: new StorageType('System.Account', 'Default', [matrixV500.AccountId32], matrixV500.AccountInfo) as AccountMatrixV500,
    /**
     *  The full account information for a particular account ID.
     */
    matrixV602: new StorageType('System.Account', 'Default', [matrixV602.AccountId32], matrixV602.AccountInfo) as AccountMatrixV602,
    /**
     *  The full account information for a particular account ID.
     */
...
export interface AccountMatrixV500  {
    ...
    getPairs(block: Block, key: matrixV500.AccountId32): Promise<[k: matrixV500.AccountId32, v: (matrixV500.AccountInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: matrixV500.AccountId32, v: (matrixV500.AccountInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: matrixV500.AccountId32): AsyncIterable<[k: matrixV500.AccountId32, v: (matrixV500.AccountInfo | undefined)][]>
}
...
export interface AccountMatrixV602  {
    ...
    getPairs(block: Block, key: matrixV602.AccountId32): Promise<[k: matrixV602.AccountId32, v: (matrixV602.AccountInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: matrixV602.AccountId32, v: (matrixV602.AccountInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: matrixV602.AccountId32): AsyncIterable<[k: matrixV602.AccountId32, v: (matrixV602.AccountInfo | undefined)][]>
}
...
export interface AccountV104  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v104.AccountId32, v: (v104.AccountInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v104.AccountId32): AsyncIterable<[k: v104.AccountId32, v: (v104.AccountInfo | undefined)][]>
}
...
export const events =  {
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixEnjinV1014: new StorageType('System.Events', 'Default', [], sts.array(() => matrixEnjinV1014.EventRecord)) as EventsMatrixEnjinV1014,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixEnjinV1022: new StorageType('System.Events', 'Default', [], sts.array(() => matrixEnjinV1022.EventRecord)) as EventsMatrixEnjinV1022,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV500: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV500.EventRecord)) as EventsMatrixV500,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV600: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV600.EventRecord)) as EventsMatrixV600,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV601: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV601.EventRecord)) as EventsMatrixV601,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV602: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV602.EventRecord)) as EventsMatrixV602,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV604: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV604.EventRecord)) as EventsMatrixV604,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV1000: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV1000.EventRecord)) as EventsMatrixV1000,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV1004: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV1004.EventRecord)) as EventsMatrixV1004,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV1005: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV1005.EventRecord)) as EventsMatrixV1005,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV1010: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV1010.EventRecord)) as EventsMatrixV1010,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV1011: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV1011.EventRecord)) as EventsMatrixV1011,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV1012: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV1012.EventRecord)) as EventsMatrixV1012,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV1013: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV1013.EventRecord)) as EventsMatrixV1013,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV1020: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV1020.EventRecord)) as EventsMatrixV1020,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    matrixV1022: new StorageType('System.Events', 'Default', [], sts.array(() => matrixV1022.EventRecord)) as EventsMatrixV1022,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV100: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV100.EventRecord)) as EventsEnjinV100,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV101: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV101.EventRecord)) as EventsEnjinV101,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV110: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV110.EventRecord)) as EventsEnjinV110,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV120: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV120.EventRecord)) as EventsEnjinV120,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV1021: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV1021.EventRecord)) as EventsEnjinV1021,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV1022: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV1022.EventRecord)) as EventsEnjinV1022,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV1023: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV1023.EventRecord)) as EventsEnjinV1023,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV1026: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV1026.EventRecord)) as EventsEnjinV1026,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV1032: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV1032.EventRecord)) as EventsEnjinV1032,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV1033: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV1033.EventRecord)) as EventsEnjinV1033,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    enjinV1050: new StorageType('System.Events', 'Default', [], sts.array(() => enjinV1050.EventRecord)) as EventsEnjinV1050,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v101: new StorageType('System.Events', 'Default', [], sts.array(() => v101.EventRecord)) as EventsV101,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v102: new StorageType('System.Events', 'Default', [], sts.array(() => v102.EventRecord)) as EventsV102,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v103: new StorageType('System.Events', 'Default', [], sts.array(() => v103.EventRecord)) as EventsV103,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v105: new StorageType('System.Events', 'Default', [], sts.array(() => v105.EventRecord)) as EventsV105,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v106: new StorageType('System.Events', 'Default', [], sts.array(() => v106.EventRecord)) as EventsV106,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v110: new StorageType('System.Events', 'Default', [], sts.array(() => v110.EventRecord)) as EventsV110,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v120: new StorageType('System.Events', 'Default', [], sts.array(() => v120.EventRecord)) as EventsV120,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v1021: new StorageType('System.Events', 'Default', [], sts.array(() => v1021.EventRecord)) as EventsV1021,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v1023: new StorageType('System.Events', 'Default', [], sts.array(() => v1023.EventRecord)) as EventsV1023,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v1026: new StorageType('System.Events', 'Default', [], sts.array(() => v1026.EventRecord)) as EventsV1026,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.
     ...
     *  just in case someone still reads them from within the runtime.
     */
    v1033: new StorageType('System.Events', 'Default', [], sts.array(() => v1033.EventRecord)) as EventsV1033,
    /**
     *  Events deposited for the current block.
     * 
     *  NOTE: The item is unbound and should therefore never be read on chain.

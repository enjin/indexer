...
export interface StatusForMatrixEnjinV603 {
    ...
    ): Promise<[k: matrixEnjinV603.H256, v: matrixEnjinV603.RequestStatus | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: matrixEnjinV603.H256, v: matrixEnjinV603.RequestStatus | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: matrixEnjinV603.H256
...
export const preimageFor = {
    matrixEnjinV603: new StorageType(
        ...
        'Optional',
        [sts.tuple(() => [matrixEnjinV603.H256, sts.number()])],
        sts.bytes()
    ) as PreimageForMatrixEnjinV603,
}
...
export interface PreimageForMatrixEnjinV603 {
    ...
    getKeysPaged(
        pageSize: number,
        block: Block,
        key: [matrixEnjinV603.H256, number]
    ): AsyncIterable<[matrixEnjinV603.H256, number][]>
    getPairs(block: Block): Promise<[k: [matrixEnjinV603.H256, number], v: Bytes | undefined][]>
    getPairs(
        block: Block,
        key: [matrixEnjinV603.H256, number]
    ): Promise<[k: [matrixEnjinV603.H256, number], v: Bytes | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: [matrixEnjinV603.H256, number], v: Bytes | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: [matrixEnjinV603.H256, number]
...
export const requestStatusFor = {
    ...
    ) as RequestStatusForMatrixEnjinV1012,
}
...
export interface RequestStatusForMatrixEnjinV1012 {
    ...
    ): Promise<[k: matrixEnjinV1012.H256, v: matrixEnjinV1012.RequestStatus | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: matrixEnjinV1012.H256, v: matrixEnjinV1012.RequestStatus | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: matrixEnjinV1012.H256

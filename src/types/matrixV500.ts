...
export const MarketPlaceInfo: sts.Type<MarketPlaceInfo> = sts.struct(() => {
    return  {
        ...
        fixedPriceListingCount: sts.number(),
...
export const WeightedIdleOperation: sts.Type<WeightedIdleOperation> = sts.struct(() => {
    return  {
        operation: IdleOperation,
        estimatedWeight: Weight,
    }
...
export const IdleOperation: sts.Type<IdleOperation> = sts.closedEnum(() => {
    return  {
        DeleteAttributes: sts.enumStruct({
            collectionId: sts.bigint(),
...
export type Type_300 = Type_300_Member | Type_300_Members | Type_300__Phantom
...
export type Type_299 = Type_299_Member | Type_299_Members | Type_299__Phantom
...
export type Type_338 = Type_338_V2 | Type_338_V3
...
export interface Type_338_V3 {
    __kind: 'V3'
    value: Type_345[]
}

export type Type_345 = Type_345_AliasOrigin | Type_345_BurnAsset | Type_345_BuyExecution | Type_345_ClaimAsset | Type_345_ClearError | Type_345_ClearOrigin | Type_345_ClearTopic | Type_345_ClearTransactStatus | Type_345_DepositAsset | Type_345_DepositReserveAsset | Type_345_DescendOrigin | Type_345_ExchangeAsset | Type_345_ExpectAsset | Type_345_ExpectError | Type_345_ExpectOrigin | Type_345_ExpectPallet | Type_345_ExpectTransactStatus | Type_345_ExportMessage | Type_345_HrmpChannelAccepted | Type_345_HrmpChannelClosing | Type_345_HrmpNewChannelOpenRequest | Type_345_InitiateReserveWithdraw | Type_345_InitiateTeleport | Type_345_LockAsset | Type_345_NoteUnlockable | Type_345_QueryPallet | Type_345_QueryResponse | Type_345_ReceiveTeleportedAsset | Type_345_RefundSurplus | Type_345_ReportError | Type_345_ReportHolding | Type_345_ReportTransactStatus | Type_345_RequestUnlock | Type_345_ReserveAssetDeposited | Type_345_SetAppendix | Type_345_SetErrorHandler | Type_345_SetFeesMode | Type_345_SetTopic | Type_345_SubscribeVersion | Type_345_Transact | Type_345_TransferAsset | Type_345_TransferReserveAsset | Type_345_Trap | Type_345_UniversalOrigin | Type_345_UnlockAsset | Type_345_UnpaidExecution | Type_345_UnsubscribeVersion | Type_345_WithdrawAsset

export interface Type_345_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_345_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_345_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_345_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_345_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_345_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_345_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_345_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_345_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_345_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_345_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_345_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_345_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_345_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_345_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_345_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_345_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_345_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_345_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_345_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_345_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_341 = Type_341_BuyExecution | Type_341_ClaimAsset | Type_341_ClearError | Type_341_ClearOrigin | Type_341_DepositAsset | Type_341_DepositReserveAsset | Type_341_DescendOrigin | Type_341_ExchangeAsset | Type_341_HrmpChannelAccepted | Type_341_HrmpChannelClosing | Type_341_HrmpNewChannelOpenRequest | Type_341_InitiateReserveWithdraw | Type_341_InitiateTeleport | Type_341_QueryHolding | Type_341_QueryResponse | Type_341_ReceiveTeleportedAsset | Type_341_RefundSurplus | Type_341_ReportError | Type_341_ReserveAssetDeposited | Type_341_SetAppendix | Type_341_SetErrorHandler | Type_341_SubscribeVersion | Type_341_Transact | Type_341_TransferAsset | Type_341_TransferReserveAsset | Type_341_Trap | Type_341_UnsubscribeVersion | Type_341_WithdrawAsset
...
export interface Type_142_SomeMutation {
    __kind: 'SomeMutation'
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type MarketplaceCall = MarketplaceCall_cancel_listing | MarketplaceCall_create_listing | MarketplaceCall_fill_listing | MarketplaceCall_finalize_auction | MarketplaceCall_place_bid | MarketplaceCall_set_protocol_fee
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type EfinityXcmCall = EfinityXcmCall_force_set_minimum_weight | EfinityXcmCall_transfer_asset_to_parachain | EfinityXcmCall_transfer_asset_with_fee | EfinityXcmCall_transfer_to_parachain
...
export const V2AbridgedHostConfiguration: sts.Type<V2AbridgedHostConfiguration> = sts.struct(() => {
    return  {
...
export const MessagingStateSnapshot: sts.Type<MessagingStateSnapshot> = sts.struct(() => {
    return  {
        ...
        ingressChannels: sts.array(() => sts.tuple(() => [Id, V2AbridgedHrmpChannel])),
        egressChannels: sts.array(() => sts.tuple(() => [Id, V2AbridgedHrmpChannel])),
    }
})

export const V2AbridgedHrmpChannel: sts.Type<V2AbridgedHrmpChannel> = sts.struct(() => {
    return  {
...
export type Event = Event_Balances | Event_Bounties | Event_Claims | Event_CollatorStaking | Event_CommunityPool | Event_Council | Event_CumulusXcm | Event_Democracy | Event_DmpQueue | Event_EfinityUtility | Event_EfinityXcm | Event_ExtrinsicPause | Event_FuelTanks | Event_Marketplace | Event_MultiTokens | Event_Multisig | Event_OrmlXcm | Event_ParachainSystem | Event_PolkadotXcm | Event_Pools | Event_Preimage | Event_Scheduler | Event_Session | Event_Sudo | Event_System | Event_TechnicalCommittee | Event_TechnicalMembership | Event_TransactionPayment | Event_UnknownTokens | Event_Utility | Event_XTokens | Event_XcmpQueue
 ...
 */
export type EfinityUtilityEvent = EfinityUtilityEvent_BatchDispatched | EfinityUtilityEvent_BatchFailed | EfinityUtilityEvent_BatchPartiallyDispatched
...
export const Event: sts.Type<Event> = sts.closedEnum(() => {
    return  {
        ...
        EfinityUtility: EfinityUtilityEvent,
        EfinityXcm: EfinityXcmEvent,
 ...
 */
export const EfinityXcmEvent: sts.Type<EfinityXcmEvent> = sts.closedEnum(() => {
    return  {
 ...
 */
export const EfinityUtilityEvent: sts.Type<EfinityUtilityEvent> = sts.closedEnum(() => {
    return  {
...
export const Type_341: sts.Type<Type_341> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_341),
...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        EfinityUtility: EfinityUtilityCall,
        EfinityXcm: EfinityXcmCall,
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const EfinityXcmCall: sts.Type<EfinityXcmCall> = sts.closedEnum(() => {
    return  {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const EfinityUtilityCall: sts.Type<EfinityUtilityCall> = sts.closedEnum(() => {
    return  {
        batch: sts.enumStruct({
            calls: sts.array(() => Call),

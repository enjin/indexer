...
export const proposalBondMinimum =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'CommunityPool.ProposalBondMinimum',
        sts.bigint()
    ),
}
...
export const palletId =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'CommunityPool.PalletId',
        matrixEnjinV603.PalletId
    ),
}

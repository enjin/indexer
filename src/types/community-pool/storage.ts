...
export interface ProposalsMatrixEnjinV603 {
    ...
    getPairsPaged(
        ...
        block: Block,
        key: number
    ): AsyncIterable<[k: number, v: matrixEnjinV603.Proposal | undefined][]>
}
...
export const deactivated = {
     ...
     */
    matrixEnjinV603: new StorageType(
        'CommunityPool.Deactivated',
        'Default',
        [],
        sts.bigint()
    ) as DeactivatedMatrixEnjinV603,
}
...
export const spendCount = {
    ...
    matrixEnjinV1012: new StorageType(
        'CommunityPool.SpendCount',
        'Default',
        [],
        sts.number()
    ) as SpendCountMatrixEnjinV1012,
}

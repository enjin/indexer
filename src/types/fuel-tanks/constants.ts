...
export const maxWhitelistedCallers =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'FuelTanks.MaxWhitelistedCallers',
        sts.number()
    ),
}
...
export const maxAccountRuleDataLength =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'FuelTanks.MaxAccountRuleDataLength',
        sts.number()
    ),
}
...
export const maxWhitelistedCollections =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'FuelTanks.MaxWhitelistedCollections',
        sts.number()
    ),
}
...
export const maxFreezeQueueLength =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'FuelTanks.MaxFreezeQueueLength',
        sts.number()
    ),
}
...
export const maxFuelTankNameLength =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'FuelTanks.MaxFuelTankNameLength',
        sts.number()
    ),
}
...
export const maxExtrinsicNameLength =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'FuelTanks.MaxExtrinsicNameLength',
        sts.number()
    ),
}
...
export const maxPermittedExtrinsicLength =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'FuelTanks.MaxPermittedExtrinsicLength',
        sts.number()
    ),
}
...
export const accountCreationDeposit =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'FuelTanks.AccountCreationDeposit',
        sts.bigint()
    ),
}

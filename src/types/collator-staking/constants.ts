...
export const maxInvulnerables =  {
    ...
    matrixEnjinV603: new ConstantType(
        'CollatorStaking.MaxInvulnerables',
        sts.number()
    ),
}
...
export const maxNominationsPerCollator =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'CollatorStaking.MaxNominationsPerCollator',
        sts.number()
    ),
}
...
export const minNominationStakeAmount =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'CollatorStaking.MinNominationStakeAmount',
        sts.bigint()
    ),
}
...
export const collatorPoolAccountId =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'CollatorStaking.CollatorPoolAccountId',
...
export const feeDistributorAccountId =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'CollatorStaking.FeeDistributorAccountId',
        matrixEnjinV603.AccountId32
    ),
}
...
export const defaultMinCollatorStake =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'CollatorStaking.DefaultMinCollatorStake',
        sts.bigint()
    ),
}
...
export const collatorExitThreshold =  {
     ...
     */
    matrixEnjinV603: new ConstantType(
        'CollatorStaking.CollatorExitThreshold',
        sts.number()
    ),
}

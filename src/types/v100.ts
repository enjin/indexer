...
export type Type_780 = Type_780_Approved | Type_780_Cancelled | Type_780_Killed | Type_780_Ongoing | Type_780_Rejected | Type_780_TimedOut
...
export interface Type_780_Cancelled {
    __kind: 'Cancelled'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_780_Killed {
    __kind: 'Killed'
    value: number
}

export interface Type_780_Ongoing {
    __kind: 'Ongoing'
    value: Type_781
}

export interface Type_780_Rejected {
    __kind: 'Rejected'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_780_TimedOut {
    __kind: 'TimedOut'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_781 {
    track: number
    origin: OriginCaller
    proposal: Bounded
...
export type Type_367 = Type_367_Response | Type_367_Xcm

export interface Type_367_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_367_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}
...
export type Type_368 = Type_368_AuctionAdmin | Type_368_BigSpender | Type_368_BigTipper | Type_368_Fellows | Type_368_Fellowship1Dan | Type_368_Fellowship2Dan | Type_368_Fellowship3Dan | Type_368_Fellowship4Dan | Type_368_Fellowship5Dan | Type_368_Fellowship6Dan | Type_368_Fellowship7Dan | Type_368_Fellowship8Dan | Type_368_Fellowship9Dan | Type_368_FellowshipAdmin | Type_368_FellowshipExperts | Type_368_FellowshipInitiates | Type_368_FellowshipMasters | Type_368_GeneralAdmin | Type_368_LeaseAdmin | Type_368_MediumSpender | Type_368_ReferendumCanceller | Type_368_ReferendumKiller | Type_368_SmallSpender | Type_368_SmallTipper | Type_368_StakingAdmin | Type_368_Treasurer | Type_368_WhitelistedCaller

export interface Type_368_AuctionAdmin {
    __kind: 'AuctionAdmin'
}

export interface Type_368_BigSpender {
    __kind: 'BigSpender'
}

export interface Type_368_BigTipper {
    __kind: 'BigTipper'
}

export interface Type_368_Fellows {
    __kind: 'Fellows'
}

export interface Type_368_Fellowship1Dan {
    __kind: 'Fellowship1Dan'
}

export interface Type_368_Fellowship2Dan {
    __kind: 'Fellowship2Dan'
}

export interface Type_368_Fellowship3Dan {
    __kind: 'Fellowship3Dan'
}

export interface Type_368_Fellowship4Dan {
    __kind: 'Fellowship4Dan'
}

export interface Type_368_Fellowship5Dan {
    __kind: 'Fellowship5Dan'
}

export interface Type_368_Fellowship6Dan {
    __kind: 'Fellowship6Dan'
}

export interface Type_368_Fellowship7Dan {
    __kind: 'Fellowship7Dan'
}

export interface Type_368_Fellowship8Dan {
    __kind: 'Fellowship8Dan'
}

export interface Type_368_Fellowship9Dan {
    __kind: 'Fellowship9Dan'
}

export interface Type_368_FellowshipAdmin {
    __kind: 'FellowshipAdmin'
}

export interface Type_368_FellowshipExperts {
    __kind: 'FellowshipExperts'
}

export interface Type_368_FellowshipInitiates {
    __kind: 'FellowshipInitiates'
}

export interface Type_368_FellowshipMasters {
    __kind: 'FellowshipMasters'
}

export interface Type_368_GeneralAdmin {
    __kind: 'GeneralAdmin'
}

export interface Type_368_LeaseAdmin {
    __kind: 'LeaseAdmin'
}

export interface Type_368_MediumSpender {
    __kind: 'MediumSpender'
}

export interface Type_368_ReferendumCanceller {
    __kind: 'ReferendumCanceller'
}

export interface Type_368_ReferendumKiller {
    __kind: 'ReferendumKiller'
}

export interface Type_368_SmallSpender {
    __kind: 'SmallSpender'
}

export interface Type_368_SmallTipper {
    __kind: 'SmallTipper'
}

export interface Type_368_StakingAdmin {
    __kind: 'StakingAdmin'
}

export interface Type_368_Treasurer {
    __kind: 'Treasurer'
}

export interface Type_368_WhitelistedCaller {
...
export const Type_780: sts.Type<Type_780> = sts.closedEnum(() => {
    return  {
...
export const Type_781: sts.Type<Type_781> = sts.struct(() => {
    return  {
        track: sts.number(),
        origin: OriginCaller,
        proposal: Bounded,
...
export const Type_495: sts.Type<Type_495> = sts.struct(() => {
    return  {
        bareAyes: sts.number(),
        ayes: sts.number(),
        nays: sts.number(),
...
export type V2CoreOccupied = V2CoreOccupied_Parachain | V2CoreOccupied_Parathread

export interface V2CoreOccupied_Parachain {
    __kind: 'Parachain'
}

export interface V2CoreOccupied_Parathread {
    __kind: 'Parathread'
    value: V2ParathreadEntry
}

export interface V2ParathreadEntry {
    claim: V2ParathreadClaim
    retries: number
}

export type V2ParathreadClaim = [Id, V2Public]

export type V2Public = Bytes

export const V2CoreOccupied: sts.Type<V2CoreOccupied> = sts.closedEnum(() => {
    return  {
        Parachain: sts.unit(),
        Parathread: V2ParathreadEntry,
    }
})

export const V2ParathreadEntry: sts.Type<V2ParathreadEntry> = sts.struct(() => {
    return  {
        claim: V2ParathreadClaim,
        retries: sts.number(),
    }
...
export const V2ParathreadClaim = sts.tuple(() => [Id, V2Public])

export const V2Public = sts.bytes()

export interface V2ScrapedOnChainVotes {
    session: number
    backingValidatorsPerCandidate: [V2CandidateReceipt, [V2ValidatorIndex, V2ValidityAttestation][]][]
...
export const V2ScrapedOnChainVotes: sts.Type<V2ScrapedOnChainVotes> = sts.struct(() => {
    return  {
        session: sts.number(),
        backingValidatorsPerCandidate: sts.array(() => sts.tuple(() => [V2CandidateReceipt, sts.array(() => sts.tuple(() => [V2ValidatorIndex, V2ValidityAttestation]))])),
...
export interface HostConfiguration {
    ...
    disputeConclusionByTimeOutPeriod: number
    noShowSlots: number
...
export const HostConfiguration: sts.Type<HostConfiguration> = sts.struct(() => {
    return  {
        ...
        disputeConclusionByTimeOutPeriod: sts.number(),
...
export interface DefaultTokenMutation {
    behavior: Type_181
    listingForbidden: Type_184
    metadata: Type_185
}

export type Type_185 = Type_185_NoMutation | Type_185_SomeMutation

export interface Type_185_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_185_SomeMutation {
    __kind: 'SomeMutation'
...
export type Type_497 = Type_497_ApplyExtrinsic | Type_497_Finalization | Type_497_Initialization

export interface Type_497_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_497_Finalization {
    __kind: 'Finalization'
}

export interface Type_497_Initialization {
...
export const Type_442: sts.Type<Type_442> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_442),
        SetErrorHandler: sts.array(() => Type_442),
...
export type Type_442 = Type_442_AliasOrigin | Type_442_BurnAsset | Type_442_BuyExecution | Type_442_ClaimAsset | Type_442_ClearError | Type_442_ClearOrigin | Type_442_ClearTopic | Type_442_ClearTransactStatus | Type_442_DepositAsset | Type_442_DepositReserveAsset | Type_442_DescendOrigin | Type_442_ExchangeAsset | Type_442_ExpectAsset | Type_442_ExpectError | Type_442_ExpectOrigin | Type_442_ExpectPallet | Type_442_ExpectTransactStatus | Type_442_ExportMessage | Type_442_HrmpChannelAccepted | Type_442_HrmpChannelClosing | Type_442_HrmpNewChannelOpenRequest | Type_442_InitiateReserveWithdraw | Type_442_InitiateTeleport | Type_442_LockAsset | Type_442_NoteUnlockable | Type_442_QueryPallet | Type_442_QueryResponse | Type_442_ReceiveTeleportedAsset | Type_442_RefundSurplus | Type_442_ReportError | Type_442_ReportHolding | Type_442_ReportTransactStatus | Type_442_RequestUnlock | Type_442_ReserveAssetDeposited | Type_442_SetAppendix | Type_442_SetErrorHandler | Type_442_SetFeesMode | Type_442_SetTopic | Type_442_SubscribeVersion | Type_442_Transact | Type_442_TransferAsset | Type_442_TransferReserveAsset | Type_442_Trap | Type_442_UniversalOrigin | Type_442_UnlockAsset | Type_442_UnpaidExecution | Type_442_UnsubscribeVersion | Type_442_WithdrawAsset
...
export type Type_360 = Type_360_Noop | Type_360_Remove | Type_360_Set

export interface Type_360_Noop {
    __kind: 'Noop'
}

export interface Type_360_Remove {
    __kind: 'Remove'
}
...
export const Type_337: sts.Type<Type_337> = sts.struct(() => {
    return  {
...
export type Type_327 = Type_327_Noop | Type_327_Remove | Type_327_Set

export interface Type_327_Noop {
    __kind: 'Noop'
}

export interface Type_327_Remove {
    __kind: 'Remove'
}

export interface Type_327_Set {
    __kind: 'Set'
    value: Percent
}
...
export type Type_326 = Type_326_Noop | Type_326_Remove | Type_326_Set

export interface Type_326_Noop {
    __kind: 'Noop'
}

export interface Type_326_Remove {
    __kind: 'Remove'
}

export interface Type_326_Set {
    __kind: 'Set'
    value: number
}
...
export const StakingCall: sts.Type<StakingCall> = sts.closedEnum(() => {
    return  {
        ...
        set_staking_configs: sts.enumStruct({
            ...
            maxNominatorCount: Type_326,
            maxValidatorCount: Type_326,
            chillThreshold: Type_327,
            minCommission: Type_328,
        }),
...
export const NominationPoolsCall: sts.Type<NominationPoolsCall> = sts.closedEnum(() => {
    return  {
        ...
        set_configs: sts.enumStruct({
            minJoinBond: Type_358,
            minCreateBond: Type_358,
            globalMaxCommission: Type_359,
        }),
        unbond: sts.enumStruct({
            poolId: sts.number(),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type NominationPoolsCall = NominationPoolsCall_bond_extra | NominationPoolsCall_chill | NominationPoolsCall_create | NominationPoolsCall_destroy | NominationPoolsCall_join | NominationPoolsCall_nominate | NominationPoolsCall_pool_withdraw_unbonded | NominationPoolsCall_set_commission | NominationPoolsCall_set_commission_change_rate | NominationPoolsCall_set_commission_max | NominationPoolsCall_set_configs | NominationPoolsCall_unbond | NominationPoolsCall_update_roles | NominationPoolsCall_withdraw_unbonded

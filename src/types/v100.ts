...
export type Type_368 =
    | Type_368_AuctionAdmin
    | Type_368_BigSpender
    | Type_368_BigTipper
    | Type_368_Fellows
    | Type_368_Fellowship1Dan
    | Type_368_Fellowship2Dan
    | Type_368_Fellowship3Dan
    | Type_368_Fellowship4Dan
    | Type_368_Fellowship5Dan
    | Type_368_Fellowship6Dan
    | Type_368_Fellowship7Dan
    | Type_368_Fellowship8Dan
    | Type_368_Fellowship9Dan
    | Type_368_FellowshipAdmin
    | Type_368_FellowshipExperts
    | Type_368_FellowshipInitiates
    | Type_368_FellowshipMasters
    | Type_368_GeneralAdmin
    | Type_368_LeaseAdmin
    | Type_368_MediumSpender
    | Type_368_ReferendumCanceller
    | Type_368_ReferendumKiller
    | Type_368_SmallSpender
    | Type_368_SmallTipper
    | Type_368_StakingAdmin
    | Type_368_Treasurer
    | Type_368_WhitelistedCaller
...
export const V2ScrapedOnChainVotes: sts.Type<V2ScrapedOnChainVotes> = sts.struct(() => {
    return {
        ...
        backingValidatorsPerCandidate: sts.array(() =>
            sts.tuple(() => [
                V2CandidateReceipt,
                sts.array(() => sts.tuple(() => [V2ValidatorIndex, V2ValidityAttestation])),
            ])
        ),
...
export type NominationPoolsEvent =
    ...
    | NominationPoolsEvent_PoolCommissionChangeRateUpdated
    | NominationPoolsEvent_PoolCommissionClaimed
    | NominationPoolsEvent_PoolCommissionUpdated
    | NominationPoolsEvent_PoolMaxCommissionUpdated
    | NominationPoolsEvent_PoolSlashed
    | NominationPoolsEvent_RolesUpdated
...
export type NominationPoolsCall =
    ...
    | NominationPoolsCall_set_commission_change_rate
    | NominationPoolsCall_set_commission_max
    | NominationPoolsCall_set_configs
    | NominationPoolsCall_unbond
    | NominationPoolsCall_update_roles

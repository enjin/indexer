...
export const listNodes =  {
     ...
     */
    enjinV100: new StorageType('VoterList.ListNodes', 'Optional', [enjinV100.AccountId32], enjinV100.Node) as ListNodesEnjinV100,
}
...
export interface ListNodesEnjinV100  {
    ...
    getPairs(block: Block, key: enjinV100.AccountId32): Promise<[k: enjinV100.AccountId32, v: (enjinV100.Node | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: enjinV100.AccountId32, v: (enjinV100.Node | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: enjinV100.AccountId32): AsyncIterable<[k: enjinV100.AccountId32, v: (enjinV100.Node | undefined)][]>
}
...
export const counterForListNodes =  {
     ...
     */
    enjinV100: new StorageType('VoterList.CounterForListNodes', 'Default', [], sts.number()) as CounterForListNodesEnjinV100,
}
...
export interface ListBagsEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: bigint): AsyncIterable<[k: bigint, v: (enjinV100.Bag | undefined)][]>
}

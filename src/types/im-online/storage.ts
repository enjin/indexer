...
export const heartbeatAfter =  {
     ...
     */
    enjinV100: new StorageType('ImOnline.HeartbeatAfter', 'Default', [], sts.number()) as HeartbeatAfterEnjinV100,
}
...
export const keys =  {
     ...
     */
    enjinV100: new StorageType('ImOnline.Keys', 'Default', [], sts.array(() => sts.bytes())) as KeysEnjinV100,
}
...
export const receivedHeartbeats =  {
     ...
     */
    enjinV100: new StorageType('ImOnline.ReceivedHeartbeats', 'Optional', [sts.number(), sts.number()], enjinV100.WrapperOpaque) as ReceivedHeartbeatsEnjinV100,
    /**
     *  For each session index, we keep a mapping of `SessionIndex` and `AuthIndex`.
     */
    enjinV1026: new StorageType('ImOnline.ReceivedHeartbeats', 'Optional', [sts.number(), sts.number()], sts.boolean()) as ReceivedHeartbeatsEnjinV1026,
    /**
     *  For each session index, we keep a mapping of `SessionIndex` and `AuthIndex` to
     *  `WrapperOpaque<BoundedOpaqueNetworkState>`.
     */
    v100: new StorageType('ImOnline.ReceivedHeartbeats', 'Optional', [sts.number(), sts.number()], v100.WrapperOpaque) as ReceivedHeartbeatsV100,
    /**
     *  For each session index, we keep a mapping of `SessionIndex` and `AuthIndex`.
     */
    v1026: new StorageType('ImOnline.ReceivedHeartbeats', 'Optional', [sts.number(), sts.number()], sts.boolean()) as ReceivedHeartbeatsV1026,
}
...
export interface ReceivedHeartbeatsEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key1: number): AsyncIterable<[k: [number, number], v: (enjinV100.WrapperOpaque | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number, key2: number): AsyncIterable<[k: [number, number], v: (enjinV100.WrapperOpaque | undefined)][]>
}
...
export interface ReceivedHeartbeatsV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key1: number): AsyncIterable<[k: [number, number], v: (v100.WrapperOpaque | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number, key2: number): AsyncIterable<[k: [number, number], v: (v100.WrapperOpaque | undefined)][]>
}
...
export const authoredBlocks =  {
     ...
     */
    enjinV100: new StorageType('ImOnline.AuthoredBlocks', 'Default', [sts.number(), enjinV100.AccountId32], sts.number()) as AuthoredBlocksEnjinV100,
}

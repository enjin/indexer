...
export const claimDistributorAccountId =  {
     ...
     */
    matrixEnjinV605: new ConstantType(
        'Claims.ClaimDistributorAccountId',
        matrixEnjinV605.AccountId32
    ),
}

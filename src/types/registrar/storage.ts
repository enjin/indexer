...
export interface ParasEnjinV100 {
    ...
    getPairsPaged(
        ...
        block: Block,
        key: enjinV100.Id
    ): AsyncIterable<[k: enjinV100.Id, v: enjinV100.ParaInfo | undefined][]>
}
...
export interface ParasEnjinV1032 {
    ...
    getPairsPaged(
        pageSize: number,
        block: Block
    ): AsyncIterable<[k: enjinV1032.Id, v: enjinV1032.ParaInfo | undefined][]>
    getPairsPaged(
        pageSize: number,
        block: Block,
        key: enjinV1032.Id
...
export interface ParasV100 {
    ...
    getPairsPaged(
        ...
        block: Block,
        key: v100.Id
    ): AsyncIterable<[k: v100.Id, v: v100.ParaInfo | undefined][]>
}
...
export interface ParasV1030 {
    ...
    getPairsPaged(
        ...
        block: Block,
        key: v1030.Id
    ): AsyncIterable<[k: v1030.Id, v: v1030.ParaInfo | undefined][]>
}

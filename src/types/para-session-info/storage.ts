...
export const assignmentKeysUnsafe =  {
     ...
     */
    enjinV100: new StorageType('ParaSessionInfo.AssignmentKeysUnsafe', 'Default', [], sts.array(() => sts.bytes())) as AssignmentKeysUnsafeEnjinV100,
}
...
export const earliestStoredSession =  {
     ...
     */
    enjinV100: new StorageType('ParaSessionInfo.EarliestStoredSession', 'Default', [], sts.number()) as EarliestStoredSessionEnjinV100,
}
...
export const sessions =  {
     ...
     */
    enjinV100: new StorageType('ParaSessionInfo.Sessions', 'Optional', [sts.number()], enjinV100.V4SessionInfo) as SessionsEnjinV100,
}
...
export interface SessionsEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV100.V4SessionInfo | undefined)][]>
}
...
export const accountKeys =  {
     ...
     */
    enjinV100: new StorageType('ParaSessionInfo.AccountKeys', 'Optional', [sts.number()], sts.array(() => enjinV100.AccountId32)) as AccountKeysEnjinV100,
}
...
export interface AccountKeysEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV100.AccountId32[] | undefined)][]>
}
...
export const sessionExecutorParams =  {
     ...
     */
    enjinV100: new StorageType('ParaSessionInfo.SessionExecutorParams', 'Optional', [sts.number()], sts.array(() => enjinV100.V4ExecutorParam)) as SessionExecutorParamsEnjinV100,
    /**
     *  Executor parameter set for a given session index
     */
    enjinV1032: new StorageType('ParaSessionInfo.SessionExecutorParams', 'Optional', [sts.number()], sts.array(() => enjinV1032.V6ExecutorParam)) as SessionExecutorParamsEnjinV1032,
    /**
     *  Executor parameter set for a given session index
     */
    v104: new StorageType('ParaSessionInfo.SessionExecutorParams', 'Optional', [sts.number()], sts.array(() => v104.V4ExecutorParam)) as SessionExecutorParamsV104,
    /**
     *  Executor parameter set for a given session index
     */
    v1030: new StorageType('ParaSessionInfo.SessionExecutorParams', 'Optional', [sts.number()], sts.array(() => v1030.V6ExecutorParam)) as SessionExecutorParamsV1030,
}
...
export interface SessionExecutorParamsEnjinV100  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (enjinV100.V4ExecutorParam[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV100.V4ExecutorParam[] | undefined)][]>
}
...
export interface SessionExecutorParamsEnjinV1032  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (enjinV1032.V6ExecutorParam[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (enjinV1032.V6ExecutorParam[] | undefined)][]>
}
...
export interface SessionExecutorParamsV104  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v104.V4ExecutorParam[] | undefined)][]>
}
...
export interface SessionExecutorParamsV1030  {
    ...
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v1030.V6ExecutorParam[] | undefined)][]>
}

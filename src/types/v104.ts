...
export type Type_182 = Type_182_NoMutation | Type_182_SomeMutation

export interface Type_182_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_182_SomeMutation {
    __kind: 'SomeMutation'
...
export interface DefaultTankMutation {
    userAccountManagement: Type_253
...
export type Type_253 = Type_253_NoMutation | Type_253_SomeMutation

export interface Type_253_NoMutation {
    __kind: 'NoMutation'
}

export interface Type_253_SomeMutation {
    __kind: 'SomeMutation'
 ...
 */
export type ClaimsEvent = ClaimsEvent_ClaimRequested | ClaimsEvent_Claimed | ClaimsEvent_ClaimedEarlyBirdReward | ClaimsEvent_EarlyBirdRewardCreated
 ...
 * amount]`
 */
export interface ClaimsEvent_ClaimedEarlyBirdReward {
    __kind: 'ClaimedEarlyBirdReward'
    /**
...
export interface ClaimsEvent_EarlyBirdRewardCreated {
    ...
    who: AccountId32
    /**
     * The staked amount for early bird bonus received by account
     */
    amount: bigint
}
...
export const ClaimsEvent: sts.Type<ClaimsEvent> = sts.closedEnum(() => {
    return  {
        ...
        ClaimedEarlyBirdReward: sts.enumStruct({
            who: AccountId32,
            amount: sts.bigint(),
        }),
...
export const Type_376: sts.Type<Type_376> = sts.struct(() => {
    return  {
...
export const Type_381: sts.Type<Type_381> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
...
export type Type_404 = Type_404_Response | Type_404_Xcm

export interface Type_404_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_404_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}
...
export type Type_405 = Type_405_AuctionAdmin | Type_405_BigSpender | Type_405_BigTipper | Type_405_Fellows | Type_405_Fellowship1Dan | Type_405_Fellowship2Dan | Type_405_Fellowship3Dan | Type_405_Fellowship4Dan | Type_405_Fellowship5Dan | Type_405_Fellowship6Dan | Type_405_Fellowship7Dan | Type_405_Fellowship8Dan | Type_405_Fellowship9Dan | Type_405_FellowshipAdmin | Type_405_FellowshipExperts | Type_405_FellowshipInitiates | Type_405_FellowshipMasters | Type_405_GeneralAdmin | Type_405_LeaseAdmin | Type_405_MediumSpender | Type_405_ReferendumCanceller | Type_405_ReferendumKiller | Type_405_SmallSpender | Type_405_SmallTipper | Type_405_StakingAdmin | Type_405_Treasurer | Type_405_WhitelistedCaller

export interface Type_405_AuctionAdmin {
    __kind: 'AuctionAdmin'
}

export interface Type_405_BigSpender {
    __kind: 'BigSpender'
}

export interface Type_405_BigTipper {
    __kind: 'BigTipper'
}

export interface Type_405_Fellows {
    __kind: 'Fellows'
}

export interface Type_405_Fellowship1Dan {
    __kind: 'Fellowship1Dan'
}

export interface Type_405_Fellowship2Dan {
    __kind: 'Fellowship2Dan'
}

export interface Type_405_Fellowship3Dan {
    __kind: 'Fellowship3Dan'
}

export interface Type_405_Fellowship4Dan {
    __kind: 'Fellowship4Dan'
}

export interface Type_405_Fellowship5Dan {
    __kind: 'Fellowship5Dan'
}

export interface Type_405_Fellowship6Dan {
    __kind: 'Fellowship6Dan'
}

export interface Type_405_Fellowship7Dan {
    __kind: 'Fellowship7Dan'
}

export interface Type_405_Fellowship8Dan {
    __kind: 'Fellowship8Dan'
}

export interface Type_405_Fellowship9Dan {
    __kind: 'Fellowship9Dan'
}

export interface Type_405_FellowshipAdmin {
    __kind: 'FellowshipAdmin'
}

export interface Type_405_FellowshipExperts {
    __kind: 'FellowshipExperts'
}

export interface Type_405_FellowshipInitiates {
    __kind: 'FellowshipInitiates'
}

export interface Type_405_FellowshipMasters {
    __kind: 'FellowshipMasters'
}

export interface Type_405_GeneralAdmin {
    __kind: 'GeneralAdmin'
}

export interface Type_405_LeaseAdmin {
    __kind: 'LeaseAdmin'
}

export interface Type_405_MediumSpender {
    __kind: 'MediumSpender'
}

export interface Type_405_ReferendumCanceller {
    __kind: 'ReferendumCanceller'
}

export interface Type_405_ReferendumKiller {
    __kind: 'ReferendumKiller'
}

export interface Type_405_SmallSpender {
    __kind: 'SmallSpender'
}

export interface Type_405_SmallTipper {
    __kind: 'SmallTipper'
}

export interface Type_405_StakingAdmin {
    __kind: 'StakingAdmin'
}

export interface Type_405_Treasurer {
    __kind: 'Treasurer'
}

export interface Type_405_WhitelistedCaller {
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_365
    maxValidatorCount: Type_365
    chillThreshold: Type_366
    minCommission: Type_367
}
...
export type Type_367 = Type_367_Noop | Type_367_Remove | Type_367_Set

export interface Type_367_Noop {
    __kind: 'Noop'
}

export interface Type_367_Remove {
    __kind: 'Remove'
}

export interface Type_367_Set {
    __kind: 'Set'
    value: Perbill
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type NominationPoolsCall = NominationPoolsCall_bond | NominationPoolsCall_chill | NominationPoolsCall_create | NominationPoolsCall_destroy | NominationPoolsCall_mutate | NominationPoolsCall_nominate | NominationPoolsCall_payout_rewards | NominationPoolsCall_pool_withdraw_unbonded | NominationPoolsCall_set_configs | NominationPoolsCall_unbond | NominationPoolsCall_unbond_deposit | NominationPoolsCall_withdraw_deposit | NominationPoolsCall_withdraw_unbonded
...
export interface NominationPoolsCall_set_configs {
    __kind: 'set_configs'
    minJoinBond: Type_396
    minCreateBond: Type_396
    globalMaxCommission: Type_397
}
...
export type Type_397 = Type_397_Noop | Type_397_Remove | Type_397_Set

export interface Type_397_Noop {
    __kind: 'Noop'
}

export interface Type_397_Remove {
    __kind: 'Remove'
}

export interface Type_397_Set {
    __kind: 'Set'
    value: Perbill
}

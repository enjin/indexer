module.exports = class Data1770206409066 {
    ...
    async up(db) {
        await db.query(`CREATE TABLE "user_infusion" ("id" character varying NOT NULL, "amount" numeric NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "account_id" character varying, "token_id" character varying, CONSTRAINT "PK_2b9e170a79f15e877e282685236" PRIMARY KEY ("id"))`)

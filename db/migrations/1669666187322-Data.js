module.exports = class Data1669666187322 {
    name = 'Data1669666187322'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "extrinsic" ("id" character varying NOT NULL, "extrinsic_index" text NOT NULL, "extrinsic_hash" text NOT NULL, "block_number" integer NOT NULL, "block_hash" text NOT NULL, "success" boolean NOT NULL, "pallet" text NOT NULL, "method" text NOT NULL, "args" text, "signature" text NOT NULL, "nonce" integer NOT NULL, "tip" numeric, "fee" jsonb, "error" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "signer_id" character varying, CONSTRAINT "PK_80d7db0e4b1e83e30336bc76755" PRIMARY KEY ("id"))`)

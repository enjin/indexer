module.exports = class Data1753388040087 {
    ...
    async up(db) {
        ...
        await db.query(`ALTER TABLE "pool_member_rewards" ADD "early_bird_rewards" numeric`)
        ...
        await db.query(`UPDATE "pool_member_rewards" SET "early_bird_rewards" = 0 WHERE "early_bird_rewards" IS NULL`)
        ...
        await db.query(`ALTER TABLE "pool_member_rewards" ALTER COLUMN "early_bird_rewards" SET NOT NULL`)
    }
    ...
    async down(db) {
        ...
        await db.query(`ALTER TABLE "pool_member_rewards" DROP COLUMN "early_bird_rewards"`)
    }
}

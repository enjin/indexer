module.exports = class Data1706128872705 {
    name = 'Data1706128872705'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "collection" ("id" character varying NOT NULL, "collection_id" numeric NOT NULL, "mint_policy" jsonb NOT NULL, "market_policy" jsonb, "burn_policy" text, "transfer_policy" jsonb, "attribute_policy" text, "attribute_count" integer NOT NULL, "total_deposit" numeric NOT NULL, "metadata" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "flags" jsonb NOT NULL, "socials" jsonb NOT NULL, "category" text, "hidden" boolean NOT NULL, "stats" jsonb NOT NULL, "owner_id" character varying, CONSTRAINT "PK_ad3f485bbc99d875491f44d7c85" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "address" text NOT NULL, "nonce" integer NOT NULL, "balance" jsonb NOT NULL, "last_update_block" integer, "username" text, "verified_at" TIMESTAMP WITH TIME ZONE, "image" text, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "fuel_tank_rule_set" ("id" character varying NOT NULL, "index" integer NOT NULL, "is_frozen" boolean NOT NULL, "is_permitted_extrinsics_empty" boolean NOT NULL, "is_permitted_extrinsics_null" boolean NOT NULL, "whitelisted_callers" text array, "whitelisted_collections" text array, "whitelisted_pallets" text array, "max_fuel_burn_per_transaction" jsonb, "user_fuel_budget" jsonb, "tank_fuel_budget" jsonb, "require_token" jsonb, "permitted_calls" text array, "tank_id" character varying, CONSTRAINT "PK_6f08fe8ff628100f82f54f3744a" PRIMARY KEY ("id"))`)

module.exports = class Data1684938577410 {
    name = 'Data1684938577410'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "claim" ("id" character varying NOT NULL, "amount" numeric NOT NULL, "early_bird_amount" numeric NOT NULL, "extrinsic_id" text NOT NULL, "extrinsic_hash" text NOT NULL, "block_number" integer NOT NULL, "block_hash" text NOT NULL, "account_id" character varying, CONSTRAINT "PK_466b305cc2e591047fa1ce58f81" PRIMARY KEY ("id"))`)

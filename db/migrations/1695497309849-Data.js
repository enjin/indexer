module.exports = class Data1695497309849 {
    name = 'Data1695497309849'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "fuel_tank_rule_set" ("id" character varying NOT NULL, "index" integer NOT NULL, "is_frozen" boolean NOT NULL, "whitelisted_callers" jsonb, "whitelisted_collections" jsonb, "max_fuel_burn_per_transaction" jsonb, "user_fuel_budget" jsonb, "tank_fuel_budget" jsonb, "require_token" jsonb, "permitted_calls" jsonb, "permitted_extrinsics" jsonb, "tank_id" character varying, CONSTRAINT "PK_6f08fe8ff628100f82f54f3744a" PRIMARY KEY ("id"))`)

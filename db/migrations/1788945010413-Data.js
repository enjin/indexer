module.exports = class TokenLending1788945010413 {
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "IDX_a46b8836dc2050083dc95b28dc"`)
        await db.query(`DROP INDEX "IDX_e62e52f296d9aa400123dff5e7"`)
        await db.query(`DROP INDEX "IDX_9e654949e07d0c724e681afa4c"`)
        await db.query(`DROP INDEX "IDX_c12fc3bc351fdcec90007ae15c"`)
        await db.query(`DROP INDEX "IDX_efcbed3690944316aa1da41cc7"`)
        await db.query(`DROP TABLE "token_loan"`)
        await db.query(`DROP INDEX "IDX_0a86029ad7b6b609b598b5999c"`)

module.exports = class Data1745323597936 {
    name = 'Data1745323597936'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "nomination_pool" ("id" character varying NOT NULL, "name" text NOT NULL, "points" numeric NOT NULL, "state" character varying(10) NOT NULL, "commission" jsonb NOT NULL, "capacity" numeric NOT NULL, "deposit" numeric NOT NULL, "bonus_cycle" jsonb NOT NULL, "token_id" numeric NOT NULL, "balance" jsonb NOT NULL, "rate" numeric NOT NULL, "apy" numeric NOT NULL, "historical_apy" numeric NOT NULL, "saturation" numeric NOT NULL, "available_stake_amount" numeric NOT NULL, "available_stake_points" numeric NOT NULL, "early_bird_bonus" jsonb, "slashes" jsonb NOT NULL, "total_members" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "created_block" integer NOT NULL, "degen_token_id" character varying, CONSTRAINT "REL_5c1733fe78ae1230c9ff22dc6a" UNIQUE ("degen_token_id"), CONSTRAINT "PK_eca87fa483dc7c8e44d3d884b5b" PRIMARY KEY ("id"))`)

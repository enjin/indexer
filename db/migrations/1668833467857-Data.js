module.exports = class Data1668833467857 {
  name = 'Data1668833467857'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "token_id" numeric NOT NULL, "supply" numeric NOT NULL, "is_frozen" boolean NOT NULL, "cap" jsonb, "behavior" jsonb, "listing_forbidden" boolean NOT NULL, "unit_price" numeric NOT NULL, "minimum_balance" numeric NOT NULL, "mint_deposit" numeric NOT NULL, "attribute_count" integer NOT NULL, "metadata" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "collection_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "collection" ("id" character varying NOT NULL, "mint_policy" jsonb NOT NULL, "market_policy" jsonb, "burn_policy" text, "transfer_policy" jsonb, "attribute_policy" text, "token_count" integer NOT NULL, "attribute_count" integer NOT NULL, "total_deposit" numeric NOT NULL, "metadata" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "stats" jsonb NOT NULL, "owner_id" character varying, "floor_listing_id" character varying, "last_sale_id" character varying, "highest_sale_id" character varying, CONSTRAINT "PK_ad3f485bbc99d875491f44d7c85" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_01d689ecc7eba32eaf962ad9d9" ON "collection" ("owner_id") `)
    await db.query(`CREATE INDEX "IDX_ca1c5cffefc6596e597bb39474" ON "collection" ("floor_listing_id") `)
    await db.query(`CREATE INDEX "IDX_374d2a67c468aea11129cd2536" ON "collection" ("last_sale_id") `)
    await db.query(`CREATE INDEX "IDX_a07461e7fef0108fb46664afd7" ON "collection" ("highest_sale_id") `)
    ...
    await db.query(`ALTER TABLE "collection" ADD CONSTRAINT "FK_ca1c5cffefc6596e597bb394747" FOREIGN KEY ("floor_listing_id") REFERENCES "listing"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "collection" ADD CONSTRAINT "FK_374d2a67c468aea11129cd25361" FOREIGN KEY ("last_sale_id") REFERENCES "listing"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "collection" ADD CONSTRAINT "FK_a07461e7fef0108fb46664afd7b" FOREIGN KEY ("highest_sale_id") REFERENCES "listing"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_ca1c5cffefc6596e597bb39474"`)
    await db.query(`DROP INDEX "public"."IDX_374d2a67c468aea11129cd2536"`)
    await db.query(`DROP INDEX "public"."IDX_a07461e7fef0108fb46664afd7"`)
    ...
    await db.query(`ALTER TABLE "collection" DROP CONSTRAINT "FK_ca1c5cffefc6596e597bb394747"`)
    await db.query(`ALTER TABLE "collection" DROP CONSTRAINT "FK_374d2a67c468aea11129cd25361"`)
    await db.query(`ALTER TABLE "collection" DROP CONSTRAINT "FK_a07461e7fef0108fb46664afd7b"`)

module.exports = class Init1654780963747 {
  name = 'Init1654780963747'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "collection_account" ("id" character varying NOT NULL, "is_frozen" boolean NOT NULL, "approvals" jsonb, "account_count" integer NOT NULL, "account_id" character varying NOT NULL, "collection_id" character varying NOT NULL, CONSTRAINT "PK_149cc78cfb0b9c3da0f8a2ff5e9" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "balance" jsonb NOT NULL, "nonce" integer NOT NULL, "last_update_block" integer NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
